...
export const selectOpprinneligUttaksplan = createSelector([søknadSelector], (søknad = {}): Periode[] | undefined =>
    søknad.erEndringssøknad === true &&
    søknad.ekstrainfo !== undefined &&
...
export const selectSaksgrunnlag = createSelector([selectEkstrainfo], (ekstrainfo: SøknadEkstrainfo):
    | Saksgrunnlag
    | undefined => (ekstrainfo.eksisterendeSak !== undefined ? ekstrainfo.eksisterendeSak.grunnlag : undefined));
...
export const selectEndringstidspunkt = createSelector([søknadSelector], (søknad): Date | undefined =>
    søknad.ekstrainfo !== undefined ? (søknad.ekstrainfo.endringstidspunkt as Date) : undefined
);

export const selectEksisterendeSak = createSelector([søknadSelector], (søknad): EksisterendeSak | undefined =>
    søknad.ekstrainfo ? (søknad.ekstrainfo.eksisterendeSak as EksisterendeSak) : undefined
);

export const selectEksisterendeUttaksplan = createSelector([selectEksisterendeSak], (eksisterendeSak):
    | Periode[]
    | undefined => (eksisterendeSak ? (eksisterendeSak.uttaksplan as Periode[]) : undefined));
