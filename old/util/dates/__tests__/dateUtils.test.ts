...
describe('dateUtils', () => {
    ...
    describe('getEndringstidspunkt', () => {
        ...
        it('Hvis endret periode er siste i planen, har samme startdato som i opprinnelig plan men senere sluttdato, skal endringstidspunkt være starten på perioden .', () => {
            const nySistePeriodeSenereSlutt = {
            ...
            const endretPlan = [opprinneligPlan[0], opprinneligPlan[1], nySistePeriodeSenereSlutt];
            const endringstidspunkt = getEndringstidspunkt(opprinneligPlan as Periode[], endretPlan as Periode[], true);

            expect(endringstidspunkt).toBe(nySistePeriodeSenereSlutt.tidsperiode.fom);
        });
        it('Hvis endret periode er siste i planen, har samme startdato som i opprinnelig plan men tidligere sluttdato, skal endringstidspunkt være starten på perioden som er først i planen.', () => {
            const nySistePeriodeTidligereSlutt = {
                id: opprinneligPlan[2].id,
                tidsperiode: {
                    fom: opprinneligPlan[2].tidsperiode!.fom,
            ...
            const endretPlan = [opprinneligPlan[0], opprinneligPlan[1], nySistePeriodeTidligereSlutt];
            const endringstidspunkt = getEndringstidspunkt(opprinneligPlan as Periode[], endretPlan as Periode[], true);

            expect(endringstidspunkt).toBe(nySistePeriodeTidligereSlutt.tidsperiode.fom);
        });
        ...
        it('Hvis forlenger en periode i midten og sletter siste periode i den nye planen skal endringstidspunkt være startdatoen på den forlengede perioden.', () => {
        ...
        it('Hvis forkorter en periode i midten og sletter siste periode i den nye planen skal endringstidspunkt være startdatoen på den forkortede perioden.', () => {
        ...
        it('Hvis sletter siste periode og samtidig forkorter perioden som er før skal endringstidspunktet være starten på den forkortede perioden i endret plan.', () => {
