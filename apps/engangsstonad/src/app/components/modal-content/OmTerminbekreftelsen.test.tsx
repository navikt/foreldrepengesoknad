...
const { VisInfo } = composeStories(stories);
    ...
    it('skal rendre komponent ok', async () => {
        ...
        expect(
            await screen.findByText(
                'Du må legge ved en bekreftelse på termin. Denne må være datert og ' +
                    'signert av lege eller jordmor når du er i 22. svangerskapsuke eller senere.'
            )
        ).toBeInTheDocument();
    });
});
