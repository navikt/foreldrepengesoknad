...
import { EsPersonDto_fpoversikt, ForsendelseStatus } from '@navikt/fp-types';

export const urlPrefiks = import.meta.env.BASE_URL;

export const API_URLS = {
    personInfo: `${urlPrefiks}/fpoversikt/api/person/engangsstonad`,
...
export const personOptions = () =>
    queryOptions({
        queryKey: ['PERSONINFO'],
        queryFn: () => ky.get(API_URLS.personInfo).json<EsPersonDto_fpoversikt>(),
        staleTime: Infinity,
    });
