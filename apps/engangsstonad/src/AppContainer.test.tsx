...
describe('<AppContainer>', () => {
    ...
    it(
        ...
        mswWrapper(async ({ setHandlers }) => {
            ...
            expect(await screen.findByText(messages['OmBarnetOppsummering.SoknadenGjelder'])).toBeInTheDocument();
            ...
            await userEvent.click(screen.getByText('Forrige steg'));
            expect(screen.getByText(messages['Velkommen.Samtykke'])).toBeInTheDocument();
        }),
    );
});
