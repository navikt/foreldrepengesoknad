...
describe('<BruktOpplysningerOmArbeidsforhold>', () => {
    it('Skal vise side som informerer om at Nav har brukt opplysninger om arbeidsforholdet', async () => {
        ...
        expect(
            screen.getByText(
                /Nav har derfor hentet informasjon om arbeidsforholdene dine fra Arbeidsgiver\- og arbeidstakerregisteret \(Aa-registeret\)\. Vi bruker opplysningene når vi behandler søknaden. Vi kan også bruke opplysningene for andre perioder i nye søknader\. Du kan selv sjekke hva som er registrert på deg i/i,
            ),
        ).toBeInTheDocument();
