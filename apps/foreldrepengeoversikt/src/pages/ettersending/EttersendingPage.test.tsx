...
describe('<EttersendingPage>', () => {
    it('skal laste opp dokument uten feil', async () => {
        ...
        await userEvent.selectOptions(screen.getByLabelText('Hva inneholder dokumentene dine?'), 'I000060');
    ...
    it('skal få ES-relevante dokumentvalg', async () => {
        ...
        const select = screen.getByLabelText('Hva inneholder dokumentene dine?');
