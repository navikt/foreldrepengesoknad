...
describe('<MinidialogSkjema>', () => {
    mswTest('skal velge at en ikke ønsker å uttale seg og så sende inn', async ({ setHandlers }) => {
        const send = vi.fn();
    ...
    mswTest('skal velge at en ønsker å uttale seg og så sende inn', async ({ setHandlers }) => {
        const send = vi.fn();
