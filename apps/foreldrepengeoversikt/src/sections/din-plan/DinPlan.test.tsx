...
describe('<Default>', () => {
    it('Skal vise liste med fire perioder', async () => {
        ...
        expect(within(allButtons[1]).getAllByText('Du er i permisjon')).toHaveLength(2);
        ...
        expect(within(allButtons[3]).getAllByText('Du er i permisjon')).toHaveLength(2);
        ...
        expect(within(allButtons[4]).getAllByText('Du og Espen er i permisjon')).toHaveLength(2);
    });
