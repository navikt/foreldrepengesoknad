...
describe('<BarnehageplassSteg>', () => {
    it('skal vise barnehageplass i august for barn med termindato i desember', async () => {
        ...
        expect(await screen.findAllByText(messages['BarnehageplassOppsummering.Tittel'])).toHaveLength(2);
    ...
    it('skal vise barnehageplass basert på sluttdato for adoptert barn', async () => {
        ...
        expect(await screen.findByText(messages['BarnehageplassOppsummering.Tittel'])).toBeInTheDocument();
