...
describe('<UforutsetteEndringer>', () => {
    ...
    it('skal vise info for mor og far adopsjon hvor begge har rett', async () => {
        ...
        expect(await screen.findByText(messages['UforutsetteEndringer.UforutsetteEndringer'])).toBeInTheDocument();
        ...
        expect(screen.getByText(messages['UforutsetteEndringer.UforutsetteEndringer.HvisBarnetErSyktEllerInnlagt'])).toBeInTheDocument();

        expect(
            screen.queryByText('Hvis mor blir syk i de første seks ukene med foreldrepenger'),
        ).not.toBeInTheDocument();
        expect(screen.queryByText(messages['UforutsetteEndringer.UforutsetteEndringer.HvisBarnetErSykt'])).not.toBeInTheDocument();
        expect(
            screen.queryByText(messages['UforutsetteEndringer.UforutsetteEndringer.HvisBarnetErInnlagt']),
        ).not.toBeInTheDocument();
        expect(screen.queryByText(messages['UforutsetteEndringer.UforutsetteEndringer.FødtFørUke33'])).not.toBeInTheDocument();
    });
    ...
    it('mor og far fødsel hvor begge har rett', async () => {
        ...
        expect(screen.queryByText(messages['UforutsetteEndringer.UforutsetteEndringer.HvisBarnetErSyktEllerInnlagt'])).not.toBeInTheDocument();
        expect(screen.getByText(messages['UforutsetteEndringer.UforutsetteEndringer.HvisBarnetErSykt'])).toBeInTheDocument();
        expect(screen.getByText(messages['UforutsetteEndringer.UforutsetteEndringer.HvisBarnetErInnlagt'])).toBeInTheDocument();
        expect(screen.getByText(messages['UforutsetteEndringer.UforutsetteEndringer.FødtFørUke33'])).toBeInTheDocument();
        expect(screen.getByText('Hvis dere får et nytt barn før det har gått tre år')).toBeInTheDocument();
    });
