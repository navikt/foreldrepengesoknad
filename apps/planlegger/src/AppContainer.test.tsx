...
describe('<AppContainer>', () => {
    ...
    it('skal gå gjennom applikasjonen og så tilbake', async () => {
        ...
        expect(await screen.findByText('Planen deres', {}, { timeout: 10_000 })).toBeInTheDocument();
        ...
        await userEvent.click(await screen.findByText('Tilbake til spørsmålene', {}, { timeout: 10_000 }));
