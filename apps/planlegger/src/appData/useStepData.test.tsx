...
describe('useStepData', () => {
    ...
    it('skal ikke vise stegene hvor-lenge og oversikt når kun far2 har rett og det er fødsel', async () => {
        const barnet = {
            antallBarn: '1',
            erFødsel: true,
            erBarnetFødt: true,
    ...
    it('skal vise stegene hvor-lenge og oversikt når kun far2 har rett og det er adopsjon', async () => {
        const barnet = {
            antallBarn: '1',
            erFødsel: false,
            fødselsdato: dayjs().format(ISO_DATE_FORMAT),
