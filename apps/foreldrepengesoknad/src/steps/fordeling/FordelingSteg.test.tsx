...
describe('Fordeling - MorAleneomsorgDekning80EttBarnFør1Okt2021', () => {
    ...
    mswTest('skal vise riktig informasjon om mor skal trekkes en dag av fellesperioden', async ({ setHandlers }) => {
        setHandlers(MorAleneomsorgDekning80EttBarnFør1Okt2021.parameters.msw);
        const utils = render(
            <MorAleneomsorgDekning80EttBarnFør1Okt2021
                gåTilNesteSide={gåTilNesteSide}
    ...
    mswTest('kan ikke angi feil format for oppstartdato', async ({ setHandlers }) => {
        setHandlers(MorAleneomsorgDekning80EttBarnFør1Okt2021.parameters.msw);
        const utils = render(
            <MorAleneomsorgDekning80EttBarnFør1Okt2021
                gåTilNesteSide={gåTilNesteSide}
    ...
    mswTest('kan ikke angi for sen oppstartsdato', async ({ setHandlers }) => {
        setHandlers(MorAleneomsorgDekning80EttBarnFør1Okt2021.parameters.msw);
        const utils = render(
            <MorAleneomsorgDekning80EttBarnFør1Okt2021
                gåTilNesteSide={gåTilNesteSide}
    ...
    mswTest('kan ikke angi for tidlig oppstartsdato', async ({ setHandlers }) => {
        setHandlers(MorAleneomsorgDekning80EttBarnFør1Okt2021.parameters.msw);
        const utils = render(
            <MorAleneomsorgDekning80EttBarnFør1Okt2021
                gåTilNesteSide={gåTilNesteSide}
    ...
    mswTest('kan ikke angi for oppstartsdato på en helgedag', async ({ setHandlers }) => {
        setHandlers(MorAleneomsorgDekning80EttBarnFør1Okt2021.parameters.msw);
        const utils = render(
            <MorAleneomsorgDekning80EttBarnFør1Okt2021
                gåTilNesteSide={gåTilNesteSide}
...
describe('Fordeling - MorAleneomsorgAdopsjonTrillinger', () => {
    ...
    mswTest('skal ikke kunne starte før adopsjonsdatoen', async ({ setHandlers }) => {
        setHandlers(MorAleneomsorgAdopsjonTrillinger.parameters.msw);
        const utils = render(
            <MorAleneomsorgAdopsjonTrillinger
                gåTilNesteSide={gåTilNesteSide}
...
describe('Fordeling - FarMedmorAleneomsorgFødtTvillinger', () => {
    ...
    mswTest('skal vise riktig informasjon til far med aleneomsorg med fødte tvillinger', async ({ setHandlers }) => {
    ...
    mswTest('skal ikke kunne starte før datoen for alenomsorg', async ({ setHandlers }) => {
        setHandlers(FarMedmorAleneomsorgFødtTvillinger.parameters.msw);
        const utils = render(
            <FarMedmorAleneomsorgFødtTvillinger
                gåTilNesteSide={gåTilNesteSide}
...
describe('Fordeling - FarMedmorAleneomsorgAdopsjonFireBarn', () => {
    ...
    mswTest('skal vise riktig informasjon til far med aleneomsorg der barna er adopterte', async ({ setHandlers }) => {
    ...
    mswTest('skal ikke kunne starte foreldrepengene før adopsjonsdatoen', async ({ setHandlers }) => {
        setHandlers(FarMedmorAleneomsorgAdopsjonFireBarn.parameters.msw);
        const utils = render(
            <FarMedmorAleneomsorgAdopsjonFireBarn
                gåTilNesteSide={gåTilNesteSide}
...
describe('Fordeling - MorDeltUttakEttBarnPrematurFødsel', () => {
    ...
    mswTest('skal ikke kunne gå videre med ikke utfylt informasjon', async ({ setHandlers }) => {
        setHandlers(MorDeltUttakEttBarnPrematurFødsel.parameters.msw);
        render(
            <MorDeltUttakEttBarnPrematurFødsel
                gåTilNesteSide={gåTilNesteSide}
    ...
    mswTest('skal få informasjon når hun ønsker å hoppe over fordeling av fellesperioden', async ({ setHandlers }) => {
        setHandlers(MorDeltUttakEttBarnPrematurFødsel.parameters.msw);
        render(
            <MorDeltUttakEttBarnPrematurFødsel
                gåTilNesteSide={gåTilNesteSide}
...
describe('Fordeling - MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning', () => {
    ...
    mswTest('skal ikke kunne oppgi desimaltall som antall dager', async ({ setHandlers }) => {
        setHandlers(MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning.parameters.msw);
        const utils = render(
            <MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning
                gåTilNesteSide={gåTilNesteSide}
    ...
    mswTest('skal ikke kunne oppgi tekst som antall dager', async ({ setHandlers }) => {
        setHandlers(MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning.parameters.msw);
        const utils = render(
            <MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning
                gåTilNesteSide={gåTilNesteSide}
    ...
    mswTest('skal ikke kunne oppgi negativt tall som antall dager', async ({ setHandlers }) => {
        setHandlers(MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning.parameters.msw);
        const utils = render(
            <MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning
                gåTilNesteSide={gåTilNesteSide}
    ...
    mswTest('skal ikke kunne overskride antall dager  tilgjengelig', async ({ setHandlers }) => {
        setHandlers(MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning.parameters.msw);
        const utils = render(
            <MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning
                gåTilNesteSide={gåTilNesteSide}
    ...
    mswTest('skal ikke kunne overskride antall uker og dager tilgjengelig', async ({ setHandlers }) => {
        setHandlers(MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning.parameters.msw);
        const utils = render(
            <MorDeltUttakEttBarnetter1Juli2024Med80ProsentDekning
                gåTilNesteSide={gåTilNesteSide}
...
describe('Fordeling - MorDeltUttakEttBarnTermin', () => {
    ...
    mswTest('skal vise riktig informasjon til mor med delt uttak som søker på termin', async ({ setHandlers }) => {
    ...
    mswTest('skal vise riktig informasjon til mor ønsker å starte dagen før termin', async ({ setHandlers }) => {
        setHandlers(MorDeltUttakEttBarnTermin.parameters.msw);
        const utils = render(
            <MorDeltUttakEttBarnTermin
                gåTilNesteSide={gåTilNesteSide}
    ...
    mswTest('skal vise riktig informasjon til mor skal bruke 1 dag av fellesperioden', async ({ setHandlers }) => {
        setHandlers(MorDeltUttakEttBarnTermin.parameters.msw);
        const utils = render(
            <MorDeltUttakEttBarnTermin
                gåTilNesteSide={gåTilNesteSide}
...
describe('Fordeling - FarMedmorSøkerDeltUttakEttBarnFødtFør1Okt2021', () => {
    ...
    mswTest('skal ikke kunne begynne uttaket før fødsel', async ({ setHandlers }) => {
        setHandlers(FarMedmorSøkerDeltUttakEttBarnFødtFør1Okt2021.parameters.msw);
        const utils = render(
            <FarMedmorSøkerDeltUttakEttBarnFødtFør1Okt2021
                gåTilNesteSide={gåTilNesteSide}
...
describe('Fordeling - FarMedmorSøkerDeltUttakEttBarnFødtPrematurt', () => {
    ...
    mswTest('skal ikke kunne begynne uttaket før fødselsdato', async ({ setHandlers }) => {
        MockDate.set(new Date('2024-02-25'));
        setHandlers(FarMedmorSøkerDeltUttakEttBarnFødtPrematurt.parameters.msw);
        const utils = render(
            <FarMedmorSøkerDeltUttakEttBarnFødtPrematurt
...
describe('Fordeling - BareMorHarRettTermin', () => {
    ...
    mswTest('skal vise riktig informasjon til mor søker på termin, kun mor har rett', async ({ setHandlers }) => {
...
describe('Fordeling - BareMorHarRettAdopsjon', () => {
    ...
    mswTest('skal vise riktig informasjon til mor søker på adopsjon, kun mor har rett', async ({ setHandlers }) => {
...
describe('Fordeling - BareFarHarRettOgMorErIkkeUførFødtBarn', () => {
    ...
    mswTest('kan ikke starte tidligere enn 2 uker før fødsel', async ({ setHandlers }) => {
        MockDate.set(new Date('2024-02-21'));
        setHandlers(BareFarHarRettOgMorErIkkeUførFødtBarn.parameters.msw);
        const utils = render(
            <BareFarHarRettOgMorErIkkeUførFødtBarn
...
describe('Fordeling - BareFarHarRettTvillingerFødtFør1Okt2021', () => {
    ...
    mswTest('kan ikke starte tidligere enn to uker før fødsel', async ({ setHandlers }) => {
...
describe('Fordeling - BareFarHarRettAdopsjonMorErUfør', () => {
    ...
    mswTest('kan ikke starte tidligere enn adopsjonsdatoen', async ({ setHandlers }) => {
        setHandlers(BareFarHarRettAdopsjonMorErUfør.parameters.msw);
        const utils = render(
            <BareFarHarRettAdopsjonMorErUfør
                gåTilNesteSide={gåTilNesteSide}
