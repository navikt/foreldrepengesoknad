...
export const FordelingPåvirkninger = ({
    ...
    const visInfoMorSykISinPeriode = førsteOkt2021Gjelder && deltUttak;
    ...
    const visInfoPrematurFødsel = erIkkeFødtBarn || kunFarEllerMedmorHarRett || fødtFørUke33;
