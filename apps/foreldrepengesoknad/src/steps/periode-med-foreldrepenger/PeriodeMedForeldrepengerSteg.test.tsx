...
describe('<PeriodeMedForeldrepengerSteg>', () => {
    mswTest('skal søke som far eller medmor og ha aleneomsorg', async ({ setHandlers }) => {
    ...
    mswTest('skal søke som far eller medmor der begge har rett', async ({ setHandlers }) => {
        const gåTilNesteSide = vi.fn();
        const mellomlagreSøknadOgNaviger = vi.fn();
    ...
    mswTest('skal søke adopsjon som mor med aleneomsorg', async ({ setHandlers }) => {
        const gåTilNesteSide = vi.fn();
        const mellomlagreSøknadOgNaviger = vi.fn();
    ...
    mswTest('skal søke adopsjon som mor med delt uttak', async ({ setHandlers }) => {
        const gåTilNesteSide = vi.fn();
        const mellomlagreSøknadOgNaviger = vi.fn();
    ...
    mswTest('skal søke som mor delt uttak for prematur fødsel', async ({ setHandlers }) => {
        const gåTilNesteSide = vi.fn();
        const mellomlagreSøknadOgNaviger = vi.fn();
    ...
    mswTest('skal søke som mor ved fødsel av tvillinger', async ({ setHandlers }) => {
        const gåTilNesteSide = vi.fn();
        const mellomlagreSøknadOgNaviger = vi.fn();
    ...
    mswTest('skal søke som mor ved fødsel av trillinger', async ({ setHandlers }) => {
        const gåTilNesteSide = vi.fn();
        const mellomlagreSøknadOgNaviger = vi.fn();
    ...
    mswTest('skal søke som far der mor allerede har laget uttaksplan', async ({ setHandlers }) => {
        const gåTilNesteSide = vi.fn();
        const mellomlagreSøknadOgNaviger = vi.fn();
