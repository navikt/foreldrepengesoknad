...
import { ForsendelseStatus, Saker_fpoversikt, SvpPersonDto_fpoversikt } from '@navikt/fp-types';

export const urlPrefiks = import.meta.env.BASE_URL;

export const API_URLS = {
    søkerInfo: `${urlPrefiks}/fpoversikt/api/person/svangerskapspenger`,
...
export const søkerinfoOptions = () =>
    queryOptions({
        queryKey: ['SØKERINFO'],
        queryFn: () => ky.get(API_URLS.søkerInfo, { timeout: 30000 }).json<SvpPersonDto_fpoversikt>(),
        staleTime: Infinity,
    });
