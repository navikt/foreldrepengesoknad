import { bemUtils, Block, intlUtils, validateRequiredTextInputField } from '@navikt/fp-common';
import FormikFileUploader from '@navikt/fp-common/src/common/components/formik-file-uploader/FormikFileUploader';
...
import './andreInntekterModal.css';
