...
const BODD_I_NORGE = 'Jeg har bodd i Norge';
const SKAL_BO = 'Hvor skal du bo de neste 12 månedene?';
const SKAL_BO_I_NORGE = 'Jeg skal bo i Norge';
...
describe('<Utlandsopphold>', () => {
    ...
    it('skal ikke vise feilmelding hvis spørsmål besvart', async () => {
        ...
        expect(await screen.findByText(HAR_BODD)).toBeInTheDocument();
        expect(await screen.findByText(SKAL_BO)).toBeInTheDocument();
