...
Default.test('velger arbeidstaker eller frilanser', async ({ canvas, args }) => {
    ...
    await expect(args.setArbeidssituasjon).toHaveBeenNthCalledWith(1, {
...
Default.test('velger utbetaling fra Nav', async ({ canvas, args }) => {
    await expect(canvas.findByText('Hvor mye kan jeg få i foreldrepenger?')).resolves.toBeInTheDocument();
    await expect(canvas.getByText('Hva er din nåværende arbeidssituasjon?')).toBeInTheDocument();
...
Default.test('velger både arbeidstaker og utbetaling', async ({ canvas, args }) => {
    await expect(canvas.findByText('Hvor mye kan jeg få i foreldrepenger?')).resolves.toBeInTheDocument();
    await expect(canvas.getByText('Hva er din nåværende arbeidssituasjon?')).toBeInTheDocument();
...
Default.test('velger selvstendig næringsdrivende', async ({ canvas }) => {
    await expect(canvas.findByText('Hvor mye kan jeg få i foreldrepenger?')).resolves.toBeInTheDocument();
    await expect(canvas.getByText('Hva er din nåværende arbeidssituasjon?')).toBeInTheDocument();
...
Default.test('velger lav månedsinntekt', async ({ canvas, args }) => {
    await expect(canvas.findByText('Hvor mye kan jeg få i foreldrepenger?')).resolves.toBeInTheDocument();
    await expect(canvas.getByText('Hva er din nåværende arbeidssituasjon?')).toBeInTheDocument();
...
Default.test('velger høy månedsinntekt', async ({ canvas, args }) => {
    await expect(canvas.findByText('Hvor mye kan jeg få i foreldrepenger?')).resolves.toBeInTheDocument();
    await expect(canvas.getByText('Hva er din nåværende arbeidssituasjon?')).toBeInTheDocument();
