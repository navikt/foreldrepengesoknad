import{j as e}from"./iframe-BwrAlRtk.js";import{P as f}from"./ProgressStepper-BUt0DOFI.js";import{V as n}from"./VStack-ufOV30p2.js";import{B as g}from"./Label-D1i9Xy4F.js";import{M as s}from"./message-Cg4b-B-Z.js";import"./preload-helper-D9Z9MdNV.js";import"./Button-AbD8l1sj.js";import"./useId-CfZki_Mv.js";import"./i18n.hooks-DiWxMp5x.js";import"./composeEventHandlers-krbYd5LM.js";import"./ChevronDown-DAguXf6x.js";import"./useId-BRc_4k2m.js";import"./BasePrimitive-BD_-r4rq.js";const i=({steps:t,onStepChange:l,children:o,hideHeader:d,someFieldsOptional:p=!1,noFieldsRequired:m=!1})=>{const a=t.findIndex(u=>u.isSelected);if(a===-1)throw new Error("Ingen valgte steg funnet");const c=t[a].label;return e.jsxs(n,{gap:"space-24",children:[e.jsx("div",{role:"presentation",children:e.jsx(f,{steps:t,hideHeader:d,onStepChange:l})}),!m&&e.jsx(g,{children:p?e.jsx(s,{id:"Step.HarValgfrieFelt"}):e.jsx(s,{id:"Step.HarObligatoriskeFelt"})}),e.jsx("section",{"aria-label":`Steg ${a+1} av ${t.length}:  ${c}`,children:e.jsx(n,{gap:"space-16",children:o})})]})};i.__docgenInfo={description:"",methods:[],displayName:"Step",props:{steps:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: TYPE;
    label: string;
    isSelected: boolean;
