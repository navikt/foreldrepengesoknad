import{j as e}from"./iframe-CzvxAsdE.js";import{P as f}from"./ProgressStepper-9kbH7hXI.js";import{V as n}from"./VStack-ss1yuSUJ.js";import{B as g}from"./Label-CBOnfThl.js";import{M as s}from"./message-D_EpcCGZ.js";import"./preload-helper-D9Z9MdNV.js";import"./Button-Yt2POf_m.js";import"./useId-CzwjkWfw.js";import"./i18n.hooks-BohMi911.js";import"./composeEventHandlers-krbYd5LM.js";import"./ChevronDown-B7JcE9ww.js";import"./useId-eOVQ3KyD.js";import"./BasePrimitive-Y_K4nKSD.js";const i=({steps:t,onStepChange:l,children:o,hideHeader:d,someFieldsOptional:p=!1,noFieldsRequired:m=!1})=>{const a=t.findIndex(u=>u.isSelected);if(a===-1)throw new Error("Ingen valgte steg funnet");const c=t[a].label;return e.jsxs(n,{gap:"space-24",children:[e.jsx("div",{role:"presentation",children:e.jsx(f,{steps:t,hideHeader:d,onStepChange:l})}),!m&&e.jsx(g,{children:p?e.jsx(s,{id:"Step.HarValgfrieFelt"}):e.jsx(s,{id:"Step.HarObligatoriskeFelt"})}),e.jsx("section",{"aria-label":`Steg ${a+1} av ${t.length}:  ${c}`,children:e.jsx(n,{gap:"space-16",children:o})})]})};i.__docgenInfo={description:"",methods:[],displayName:"Step",props:{steps:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: TYPE;
    label: string;
    isSelected: boolean;
