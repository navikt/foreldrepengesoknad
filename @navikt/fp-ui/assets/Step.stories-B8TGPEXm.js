import{j as e}from"./iframe-Bli2v4av.js";import{P as f}from"./ProgressStepper-T1mmzUeS.js";import{V as n}from"./VStack-DcqHFEgP.js";import{B as g}from"./Label-BPOj6CQ4.js";import{M as s}from"./message-DfbYLGBT.js";import"./preload-helper-PPVm8Dsz.js";import"./Button-DaxeuJdm.js";import"./useId-CgkVphQd.js";import"./i18n.hooks-R6ZgpsTR.js";import"./Provider-BJC-N1Lt.js";import"./composeEventHandlers-krbYd5LM.js";import"./ChevronDown-BXzIvDL1.js";import"./useId-BdceqQkC.js";import"./useClientLayoutEffect-C9ypL2Pl.js";import"./BasePrimitive-CQGeRCPe.js";const i=({steps:t,onStepChange:o,children:l,hideHeader:d,someFieldsOptional:p=!1,noFieldsRequired:m=!1})=>{const a=t.findIndex(u=>u.isSelected);if(a===-1)throw new Error("Ingen valgte steg funnet");const c=t[a].label;return e.jsxs(n,{gap:"space-24",children:[e.jsx("div",{role:"presentation",children:e.jsx(f,{steps:t,hideHeader:d,onStepChange:o})}),!m&&e.jsx(g,{children:p?e.jsx(s,{id:"Step.HarValgfrieFelt"}):e.jsx(s,{id:"Step.HarObligatoriskeFelt"})}),e.jsx("section",{"aria-label":`Steg ${a+1} av ${t.length}:  ${c}`,children:e.jsx(n,{gap:"space-16",children:l})})]})};i.__docgenInfo={description:"",methods:[],displayName:"Step",props:{steps:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: TYPE;
    label: string;
    isSelected: boolean;
