import{j as e}from"./iframe-DSz8ReYh.js";import{V as u}from"./VStack-Peu-wM8q.js";import"./useId-CwLZ0wO0.js";import{H as k}from"./Label-Dt8eTnSf.js";import{M as g}from"./message-DACHHXw4.js";import{L as x}from"./Link-4q4e1p5y.js";import{B as v}from"./Box-Bf3IrUiU.js";import"./BasePrimitive-BMb1PmPD.js";const h="_background_ycpd6_1",j="_box_ycpd6_6",_="_lenkepanel_ycpd6_18",t={background:h,box:j,lenkepanel:_},p=({links:o})=>e.jsx("div",{className:t.background,children:e.jsx("div",{className:t.box,children:e.jsxs(u,{gap:"2",children:[o.length>1&&e.jsx(k,{size:"small",level:"2",children:e.jsx(g,{id:"AndreVeivisereLinkPanel.AndreVeivisere"})}),o.map(s=>e.jsx(x,{inlineText:!0,href:s.url,rel:"noreferrer",className:t.lenkepanel,children:e.jsx(v,{padding:"4",background:"surface-default",borderRadius:"xlarge",shadow:"small",children:s.content})},s.url))]})})});p.__docgenInfo={description:"",methods:[],displayName:"AndreVeivisereLinkPanel",props:{links:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    url: string;
