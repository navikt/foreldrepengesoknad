import{j as e}from"./iframe-DPaEgbQd.js";import{P as f}from"./ProgressStepper-DhXOwUH9.js";import{V as n}from"./VStack-iymPSTZb.js";import{B as g}from"./Label-WkxgEZfB.js";import{M as s}from"./message-DaV5mS96.js";import"./preload-helper-D9Z9MdNV.js";import"./Button-D6tkyZ3Q.js";import"./useId-B7-nZWcC.js";import"./i18n.hooks-DGLenOwA.js";import"./ChevronDown-DHoV9uq0.js";import"./useId-NeWmF6y6.js";import"./BasePrimitive-CFrUMjB8.js";const i=({steps:t,onStepChange:l,children:o,hideHeader:d,someFieldsOptional:p=!1,noFieldsRequired:m=!1})=>{const a=t.findIndex(u=>u.isSelected);if(a===-1)throw new Error("Ingen valgte steg funnet");const c=t[a].label;return e.jsxs(n,{gap:"space-24",children:[e.jsx("div",{role:"presentation",children:e.jsx(f,{steps:t,hideHeader:d,onStepChange:l})}),!m&&e.jsx(g,{children:p?e.jsx(s,{id:"Step.HarValgfrieFelt"}):e.jsx(s,{id:"Step.HarObligatoriskeFelt"})}),e.jsx("section",{"aria-label":`Steg ${a+1} av ${t.length}:  ${c}`,children:e.jsx(n,{gap:"space-16",children:o})})]})};i.__docgenInfo={description:"",methods:[],displayName:"Step",props:{steps:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: TYPE;
    label: string;
    isSelected: boolean;
