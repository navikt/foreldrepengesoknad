import{j as e}from"./iframe-D5iggaTh.js";import{P as f}from"./ProgressStepper-DsO-ItZL.js";import{V as n}from"./VStack-0WeJ-T0z.js";import{B as g}from"./Label-DnRVExZZ.js";import{M as s}from"./message-BbOLvsOb.js";import"./preload-helper-D9Z9MdNV.js";import"./Button-BckL4IHt.js";import"./useId-CYVG1c8X.js";import"./i18n.hooks-BO8WA2VU.js";import"./composeEventHandlers-krbYd5LM.js";import"./ChevronDown-CgZxSTef.js";import"./useId-BIoWU4-b.js";import"./BasePrimitive-BlFrEWF0.js";const i=({steps:t,onStepChange:l,children:o,hideHeader:d,someFieldsOptional:p=!1,noFieldsRequired:m=!1})=>{const a=t.findIndex(u=>u.isSelected);if(a===-1)throw new Error("Ingen valgte steg funnet");const c=t[a].label;return e.jsxs(n,{gap:"space-24",children:[e.jsx("div",{role:"presentation",children:e.jsx(f,{steps:t,hideHeader:d,onStepChange:l})}),!m&&e.jsx(g,{children:p?e.jsx(s,{id:"Step.HarValgfrieFelt"}):e.jsx(s,{id:"Step.HarObligatoriskeFelt"})}),e.jsx("section",{"aria-label":`Steg ${a+1} av ${t.length}:  ${c}`,children:e.jsx(n,{gap:"space-16",children:o})})]})};i.__docgenInfo={description:"",methods:[],displayName:"Step",props:{steps:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: TYPE;
    label: string;
    isSelected: boolean;
