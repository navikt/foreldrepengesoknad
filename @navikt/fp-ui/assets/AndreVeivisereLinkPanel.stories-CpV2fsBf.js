import{j as e}from"./iframe-BEzWpe36.js";import{V as u}from"./VStack-CYiUcyfJ.js";import"./useId-DyUK3sKC.js";import{H as k}from"./Label-Bj-RlbHa.js";import{M as g}from"./message-BFcghhzl.js";import{L as x}from"./Link-CnLHQc5w.js";import{B as v}from"./Box-CIAqjG_C.js";import"./BasePrimitive-6VbHgWbZ.js";const h="_background_ycpd6_1",j="_box_ycpd6_6",_="_lenkepanel_ycpd6_18",t={background:h,box:j,lenkepanel:_},p=({links:o})=>e.jsx("div",{className:t.background,children:e.jsx("div",{className:t.box,children:e.jsxs(u,{gap:"2",children:[o.length>1&&e.jsx(k,{size:"small",level:"2",children:e.jsx(g,{id:"AndreVeivisereLinkPanel.AndreVeivisere"})}),o.map(s=>e.jsx(x,{inlineText:!0,href:s.url,rel:"noreferrer",className:t.lenkepanel,children:e.jsx(v,{padding:"4",background:"surface-default",borderRadius:"xlarge",shadow:"small",children:s.content})},s.url))]})})});p.__docgenInfo={description:"",methods:[],displayName:"AndreVeivisereLinkPanel",props:{links:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    url: string;
