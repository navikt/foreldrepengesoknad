import{j as e}from"./iframe-D86TD-V_.js";import{P as f}from"./ProgressStepper-DOrCZJYX.js";import{V as n}from"./VStack-CxwVvgVG.js";import{B as g}from"./Label-KlUKLB3D.js";import{M as s}from"./message-CfqrntDX.js";import"./preload-helper-D9Z9MdNV.js";import"./Button-B9dGG5SG.js";import"./useId-Bq8VJCT1.js";import"./i18n.hooks-DkWkPjRe.js";import"./composeEventHandlers-krbYd5LM.js";import"./ChevronDown-zl3A4-zF.js";import"./useId-BABXT350.js";import"./BasePrimitive-D-HGWUga.js";const i=({steps:t,onStepChange:l,children:o,hideHeader:d,someFieldsOptional:p=!1,noFieldsRequired:m=!1})=>{const a=t.findIndex(u=>u.isSelected);if(a===-1)throw new Error("Ingen valgte steg funnet");const c=t[a].label;return e.jsxs(n,{gap:"space-24",children:[e.jsx("div",{role:"presentation",children:e.jsx(f,{steps:t,hideHeader:d,onStepChange:l})}),!m&&e.jsx(g,{children:p?e.jsx(s,{id:"Step.HarValgfrieFelt"}):e.jsx(s,{id:"Step.HarObligatoriskeFelt"})}),e.jsx("section",{"aria-label":`Steg ${a+1} av ${t.length}:  ${c}`,children:e.jsx(n,{gap:"space-16",children:o})})]})};i.__docgenInfo={description:"",methods:[],displayName:"Step",props:{steps:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: TYPE;
    label: string;
    isSelected: boolean;
