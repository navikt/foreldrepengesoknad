import{j as e}from"./iframe-Dt7UCgNq.js";import{P as f}from"./ProgressStepper-DaZykMbp.js";import{V as n}from"./VStack-L40jaA0b.js";import{B as g}from"./Label-DR2GnhIS.js";import{M as s}from"./message-C_R6fGYX.js";import"./preload-helper-D9Z9MdNV.js";import"./Button-BKIdqGeJ.js";import"./useId-B_zeIxHk.js";import"./i18n.hooks-DMBjUpEc.js";import"./composeEventHandlers-krbYd5LM.js";import"./ChevronDown-Jh-HHzC1.js";import"./useId-BnqoorAy.js";import"./BasePrimitive-DgG4yCjh.js";const i=({steps:t,onStepChange:l,children:o,hideHeader:d,someFieldsOptional:p=!1,noFieldsRequired:m=!1})=>{const a=t.findIndex(u=>u.isSelected);if(a===-1)throw new Error("Ingen valgte steg funnet");const c=t[a].label;return e.jsxs(n,{gap:"space-24",children:[e.jsx("div",{role:"presentation",children:e.jsx(f,{steps:t,hideHeader:d,onStepChange:l})}),!m&&e.jsx(g,{children:p?e.jsx(s,{id:"Step.HarValgfrieFelt"}):e.jsx(s,{id:"Step.HarObligatoriskeFelt"})}),e.jsx("section",{"aria-label":`Steg ${a+1} av ${t.length}:  ${c}`,children:e.jsx(n,{gap:"space-16",children:o})})]})};i.__docgenInfo={description:"",methods:[],displayName:"Step",props:{steps:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: TYPE;
    label: string;
    isSelected: boolean;
