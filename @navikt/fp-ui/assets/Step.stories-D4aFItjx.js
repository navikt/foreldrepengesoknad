import{j as e}from"./iframe-DYAoN-CL.js";import{P as f}from"./ProgressStepper-VHis1Q8E.js";import{V as n}from"./VStack-DfAC2l4I.js";import{B as g}from"./Label-Cu9Ht9J_.js";import{M as s}from"./message-DTWOTcZN.js";import"./preload-helper-D9Z9MdNV.js";import"./Button-QPvr6Goi.js";import"./useId-nKfR3DeO.js";import"./i18n.hooks-CETI8Z-I.js";import"./composeEventHandlers-krbYd5LM.js";import"./ChevronDown-rdUFBlDU.js";import"./useId-eLrIfmxI.js";import"./BasePrimitive-CHllvLNS.js";const i=({steps:t,onStepChange:l,children:o,hideHeader:d,someFieldsOptional:p=!1,noFieldsRequired:m=!1})=>{const a=t.findIndex(u=>u.isSelected);if(a===-1)throw new Error("Ingen valgte steg funnet");const c=t[a].label;return e.jsxs(n,{gap:"space-24",children:[e.jsx("div",{role:"presentation",children:e.jsx(f,{steps:t,hideHeader:d,onStepChange:l})}),!m&&e.jsx(g,{children:p?e.jsx(s,{id:"Step.HarValgfrieFelt"}):e.jsx(s,{id:"Step.HarObligatoriskeFelt"})}),e.jsx("section",{"aria-label":`Steg ${a+1} av ${t.length}:  ${c}`,children:e.jsx(n,{gap:"space-16",children:o})})]})};i.__docgenInfo={description:"",methods:[],displayName:"Step",props:{steps:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: TYPE;
    label: string;
    isSelected: boolean;
