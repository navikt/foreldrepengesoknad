...
| 'FEDREKVOTE'
| 'FORELDREPENGER'
| 'FORELDREPENGER_FØR_FØDSEL'`,elements:[{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"}],required:!0}},{key:"tom",value:{name:"string",required:!0}},{key:"trekkdager",value:{name:"number",required:!0}}]}}]}],raw:"Array<UttakPeriode_fpoversikt | UttakPeriodeAnnenpartEøs_fpoversikt>"},name:"perioder"}],return:{name:"void"}}},description:""},uttaksplanHandlinger:{required:!1,tsType:{name:"signature",type:"function",raw:"(handling: 'angre' | 'tilbakestill' | 'fjernAlt') => void",signature:{arguments:[{type:{name:"union",raw:"'angre' | 'tilbakestill' | 'fjernAlt'",elements:[{name:"literal",value:"'angre'"},{name:"literal",value:"'tilbakestill'"},{name:"literal",value:"'fjernAlt'"}]},name:"handling"}],return:{name:"void"}}},description:""}}};export{c as U};
