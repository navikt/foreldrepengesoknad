...
export const EndrePeriodeModal = forwardRef<HTMLDialogElement, Props>(({ closeModal, permisjonsperiode }, ref) => {
    ...
    const renderContent = () => {
        switch (currentStep) {
            ...
            case 'step2':
                return <ValgModalStep modalData={modalData} setModalData={setModalData} closeModal={closeModal} />;
            case 'step3':
                return (
