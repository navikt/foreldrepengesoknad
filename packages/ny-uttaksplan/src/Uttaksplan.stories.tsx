...
export const FarAleneomsorg: Story = {
    name: 'Far Aleneomrsorg',
    args: {
        familiehendelsedato: '2025-10-14',
        erFarEllerMedmor: true,
        navnPåForeldre: {
            mor: 'ingen i det hele tatt',
            farMedmor: 'Arne alenefar',
        },
        ...
        barn: {
            ...
            fødselsdatoer: ['2025-10-14'],
            antallBarn: 1,
            adopsjonsdato: '2025-10-14',
        },
        harAktivitetskravIPeriodeUtenUttak: false,
        modus: 'planlegger',
        valgtStønadskonto: {
            kontoer: [{ konto: StønadskontoType.Foreldrepenger, dager: 320 }],
            minsteretter: MINSTERETTER,
        },
