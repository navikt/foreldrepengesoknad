export enum Skjemanummer {
    ...
    DOK_INNLEGGELSE_BARN = 'FP001',
    DOK_INNLEGGELSE_MOR = 'FP002',
    DOK_INNLEGGELSE_FAR = 'FP003',
    DOK_SYKDOM_MOR = 'FP004',
    DOK_SYKDOM_FAR = 'FP005',
    DOK_UTDANNING_MOR = 'FP006',
    DOK_ARBEID_MOR = 'FP007',
    DOK_UTDANNING_OG_ARBEID_MOR = 'FP008',
