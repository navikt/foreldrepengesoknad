...
export const TidligereUtenlandsoppholdPanel = <TYPE extends string>({
    ...
    const formMethods = useFormMedUtkast<FormType>('TidligereUtenlandsoppholdPanel', {
        defaultValues: {
        ...
        <Step steps={stepConfig} onStepChange={onStepChange}>
            <RhfForm
                ...
                onSubmit={(values) => {
                    ...
                    saveOnNext(values.utenlandsoppholdSiste12Mnd);
                }}
            >
                <VStack gap="space-40">
                    ...
                    <StepButtonsHookForm<FormType>
                        ...
                        saveDataOnPreviousClick={
                            saveOnPrevious ? (values) => saveOnPrevious(values.utenlandsoppholdSiste12Mnd) : undefined
                        }
                    />
                </VStack>
            </RhfForm>
