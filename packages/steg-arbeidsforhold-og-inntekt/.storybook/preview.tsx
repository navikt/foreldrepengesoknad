...
const withIntlProvider = getIntlDecorator({
    nb: { ...nbMessages, ...uiMessages.nb, ...formHookMessages.nb, ...egenNæringMessages.nb },
    nn: { ...nnMessages, ...uiMessages.nn, ...formHookMessages.nn, ...egenNæringMessages.nn },
    en: { ...enMessages, ...uiMessages.en, ...formHookMessages.en, ...egenNæringMessages.en },
});
