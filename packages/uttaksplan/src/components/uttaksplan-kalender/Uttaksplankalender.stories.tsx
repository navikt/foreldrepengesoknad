...
export const MorAvslåttPeriodeFørste6UkeneGirTapteDager = Template.bind({});
MorAvslåttPeriodeFørste6UkeneGirTapteDager.args = {
    uttaksplan: [
        {
            id: '1',
            type: Periodetype.Uttak,
...
export const MorAvslåttPeriodeUtenTapteDager = Template.bind({});
MorAvslåttPeriodeUtenTapteDager.args = {
    uttaksplan: [
        {
            id: '1',
            type: Periodetype.Uttak,
...
export const TreSammenhengendePerioderSlåttSammen = Template.bind({});
TreSammenhengendePerioderSlåttSammen.args = {
    uttaksplan: [
        {
            type: Periodetype.Uttak,
            id: '1',
