...
describe('uttaksplanDatoavgrensninger - startdatoPermisjonMor', () => {
    ...
    it(
        'mor med ufødt barn og termin på en helg skal kunne starte foreldrepenger tidligst 12 uker før' +
            ' første uttaksdag etter termin og senest på første uttaksdag etter termindato',
        () => {
    ...
    it(
        'mor med barn født mer enn 12 uker før termin og på en helgedag skal kun kunne starte foreldrepenger' +
            ' på første uttaksdag etter fødselsdato',
        () => {
    ...
    it(
        'mor med barn født mindre enn 12 uker før termin og på en ukedag skal kunne starte foreldrepenger' +
            ' tidligst 12 uker før termin og senest på fødseldato',
        () => {
    ...
    it(
        'mor med barn født mindre enn 12 uker før termin og på en helgedag skal kunne starte foreldrepenger' +
            ' tidligst 12 uker før termin og senest første uttaksdag etter fødselsdato',
        () => {
    ...
    it(
        'mor med barn født etter termin og på en helgedag skal kunne starte foreldrepenger tidligst 12 uker før' +
            ' termin og senest på første uttaksdag etter fødselsdato',
        () => {
    ...
    it(
        'mor med barn født etter termin og med termindato på en helgedag skal kunne starte foreldrepenger tidligst' +
            ' 12 uker før første uttaksdag etter termin og senest på fødselsdato',
        () => {
