...
describe('useFormSubmitValidator', () => {
        ...
        const nyePerioder = [
            {
                ...
                tom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(5),
            },
        ];
    ...
    it('skal ikke returnere feilmelding dersom far/medmor har valgt mer enn 2 uker i intervallet to uker før famDato og seks uker etter', () => {
        ...
        const perioder = [
            {
                fom: FAMILIEHENDELSESDATO,
                tom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(15),
            },
        ];
    ...
    it('skal returnere feilmelding dersom far/medmor allerede har valgt dager og prøver å legge til flere i intervallet rundt famdato', () => {
        ...
        const perioder = [
            {
                fom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(5),
                tom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(15),
            },
        ];
    ...
    it('skal ikke returnere feilmelding dersom antall dager ikke overstiger 10', () => {
        ...
        const perioder = [
            {
                fom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(5),
                tom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(9),
            },
        ];
    ...
    it('skal ikke returnere feilmelding dersom antall graderte dagar ikke overstiger 10', () => {
        ...
        const perioder = [
            {
                fom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(5),
                tom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(20),
            },
        ];
    ...
    it('skal returnere feilmelding dersom antall graderte dagar overstiger 10', () => {
        ...
        const perioder = [
            {
                fom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(5),
                tom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(23),
            },
        ];
    ...
    it('skal returnere null dersom ingen feilmeldinger oppstår', () => {
        ...
        const perioder = [
            {
                fom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(10),
                tom: Uttaksdagen.denne(FAMILIEHENDELSESDATO).getDatoAntallUttaksdagerSenere(15),
            },
        ];
