...
export type KontoBeregningResponseDto_fpoversikt = {
    result?: {
...
export type KontoResponses = {
    /**
     * Successful operation
     */
    200: KontoBeregningResponseDto_fpoversikt;
};

export type KontoResponse = KontoResponses[keyof KontoResponses];
