...
import { FileObject, FileRejected, FileRejectionReason, Heading, UNSAFE_FileUpload, VStack } from '@navikt/ds-react';
    ...
    return (
        <VStack gap="6">
            <UNSAFE_FileUpload.Dropzone
                label={intl.formatMessage({ id: 'FileInput.Vedlegg.Lastoppknapp' })}
