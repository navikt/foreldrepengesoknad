...
WithInteractiveSteps.args = {
    steps: [
        { id: '0', label: 'Steg 1', isSelected: false, isSelectable: true },
        { id: '1', label: 'Steg 2', isSelected: false, isSelectable: true },
        { id: '2', label: 'Steg 3', isSelected: true, isSelectable: true },
        { id: '3', label: 'Steg 4', isSelected: false },
        { id: '4', label: 'Steg 5', isSelected: false },
    ],
    onStepChange: () => undefined,
