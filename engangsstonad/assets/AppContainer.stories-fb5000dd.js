var ie=Object.defineProperty;var ge=(e,s,r)=>s in e?ie(e,s,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[s]=r;var j=(e,s,r)=>(ge(e,typeof s!="symbol"?s+"":s,r),r);import{j as t,n as ce,d as de}from"./dates-542ac52b.js";import{r as p,a as pe}from"./index-f1f2c4b1.js";import{c as X,e as ue,d as me,b as fe,a as ke}from"./OmBarnet-c086ae82.js";import{D as Ee,R as Se,G as Z,I as he,J as ye,K as Ae,C as S,L as ve,n as ee,N as Ne,O as Me,Q as k,S as we,P as f,u as _e,T as xe,W as Le,X as je,E as Re,Y as Ie,Z as be,i as De}from"./useEsNavigator-e9842769.js";import{E as N,D,M as C}from"./DokumentasjonSteg-d3c81180.js";import"./index-c74c9f7f.js";import{n as Ce,a as R,b as Te,e as Pe}from"./en_US-ebe5ef1b.js";import"./_baseToString-b5f87fbe.js";import"./_createSet-915b0824.js";import{e as Oe,O as Ue}from"./OppsummeringSteg-e6cc02e0.js";import{O as Fe}from"./OmBarnetSteg-cd3c826d.js";import{S as qe}from"./SøkersituasjonSteg-2ba40a31.js";import{U as Ge}from"./UtenlandsoppholdSteg-4c38c3ec.js";import{S as Ve}from"./SenereUtenlandsoppholdSteg-e2dd855f.js";import{T as Ke}from"./TidligereUtenlandsoppholdSteg-1bdde12c.js";import{V as He}from"./Velkommen-098bca3b.js";import"./index-b580f7e8.js";import"./ErrorSummaryHookForm-a2d62aec.js";import"./isNativeReflectConstruct-554b52b6.js";import"./ExpansionCard-91de8282.js";import"./Radio-d6a7e430.js";import"./TidligereUtenlandsoppholdPanel-f42b2099.js";const{Axios:bn,AxiosError:Dn,CanceledError:Cn,isCancel:Tn,CancelToken:Pn,VERSION:On,all:Un,Cancel:Fn,isAxiosError:Be,spread:qn,toFormData:Gn,AxiosHeaders:Vn,HttpStatusCode:Kn,formToJSON:Hn,getAdapter:Bn,mergeConfig:Jn}=X;class E extends Error{constructor(r,n,d){super(r);j(this,"callId");j(this,"timestamp");this.callId=n,this.timestamp=d}}class w extends Error{constructor(){super("API_ACCESS_ERROR")}}const Je=e=>e instanceof w||e instanceof E,ne=e=>!!(e&&typeof e=="object"&&"isAxiosError"in e),T=(e,s)=>{const[r,n]=p.useState(),[d,c]=p.useState(!1),[g,o]=p.useState();return p.useEffect(()=>{let i=!1;return(async()=>{var l,a;try{c(!0);const m=await e.get(s,{withCredentials:!0,timeout:60*1e3});i||n(m.data)}catch(m){Be(m)?((l=m.response)==null?void 0:l.status)===401||((a=m.response)==null?void 0:a.status)===403?o(new w):o(new E(m.message)):m instanceof Error?o(new E(m.message)):o(new E(String(m)))}finally{c(!1)}})(),()=>{i=!0}},[e,s]),{data:r,loading:d,error:g}},$e=e=>X.create({baseURL:e,withCredentials:!0}),P="ukjent uuid",te=async(e,s,r,n,d=!1,c)=>{var g,o,i,u;try{return(await e.post(s,r,{withCredentials:!0,timeout:6e4,signal:c,headers:d?{"content-type":"application/json;"}:{}})).data}catch(l){if(ne(l)&&l.code!=="ERR_CANCELED"){if(((g=l.response)==null?void 0:g.status)===401||((o=l.response)==null?void 0:o.status)===403)throw new w;const a=l.response&&l.response.data&&l.response.data.uuid?l.response.data.uuid:P,m=a!==P?a.slice(0,8):a;throw new E(n+m,a,(u=(i=l.response)==null?void 0:i.data)==null?void 0:u.timestamp)}throw l instanceof Error?new E(l.message):new E(String(l))}},O="ukjent uuid",I=async(e,s,r,n,d)=>{var c,g;try{return(await e.delete(s,{withCredentials:!0,timeout:6e4,signal:d,data:n})).data}catch(o){if(ne(o)&&o.code!=="ERR_CANCELED"){if(((c=o.response)==null?void 0:c.status)===401||((g=o.response)==null?void 0:g.status)===403)throw new w;const i=o.response&&o.response.data&&o.response.data.uuid?o.response.data.uuid:O,u=i!==O?i.slice(0,8):i;throw new E(r+u)}throw o instanceof Error?new E(o.message):new E(String(o))}};/**
