import{j as e,M as a,V as j,g as i,C as x,H as b}from"./dateFormValidation-D0woOuLJ.js";import{P as l,u as A,a as q,n as T,b as d,C as u}from"./useEsNavigator-CH3P3Mfx.js";import{F as n,O,B as S}from"./BoIUtlandetOppsummeringspunkt-BT0fgffu.js";import"./index-DVXBtNgz.js";import{e as k,a as w,b as E}from"./OmBarnet-BV6De4cI.js";const c=r=>!!r.terminbekreftelsedato;function v({dokumentasjon:r,onVilEndreSvar:t}){return!r||r.vedlegg.length===0?null:e.jsxs(n,{children:[e.jsxs(n.Header,{children:[e.jsx(n.Heading,{level:"2",children:e.jsx(a,{id:"DokumentasjonOppsummering.tittel"})}),e.jsx(n.EditLink,{onClick:()=>t(c(r)?l.TERMINBEKREFTELSE:l.ADOPSJONSBEKREFTELSE),children:e.jsx(a,{id:"Oppsummering.EndreSvar"})})]}),e.jsx(n.Answers,{children:c(r)?e.jsx(F,{dokumentasjon:r}):e.jsx(B,{dokumentasjon:r})})]})}function B({dokumentasjon:r}){return e.jsxs(n.Answer,{children:[e.jsx(n.Label,{children:e.jsx(a,{id:"DokumentasjonOppsummering.adopsjonsdokumenter"})}),e.jsx(n.Answer,{children:e.jsx(j,{gap:"2",children:r.vedlegg.map(t=>t.filename)})})]})}function F({dokumentasjon:r}){return e.jsxs(e.Fragment,{children:[e.jsxs(n.Answer,{children:[e.jsx(n.Label,{children:e.jsx(a,{id:"DokumentasjonOppsummering.Terminbekreftelse"})}),e.jsx(n.Answer,{children:i(r.terminbekreftelsedato)})]}),e.jsxs(n.Answer,{children:[e.jsx(n.Label,{children:e.jsx(a,{id:"DokumentasjonOppsummering.TerminbekreftelseDokument"})}),e.jsx(n.Answer,{children:e.jsx(j,{gap:"2",children:r.vedlegg.map(t=>t.filename)})})]})]})}v.__docgenInfo={description:"",methods:[],displayName:"DokumentasjonOppsummering",props:{dokumentasjon:{required:!1,tsType:{name:"union",raw:"TerminDokumentasjon | Vedlegg",elements:[{name:"intersection",raw:`{
