import{u as h,j as e,V as P,c as d,B as r,M as s,f as m,g as A,A as O,n as v,C as D,H as E}from"./dateFormValidation-BZ8AOcD4.js";import{u as w,a as N,b as u,C as g}from"./useEsNavigator-x6nVy59K.js";import{e as x,a as S,b as B}from"./OmBarnet-BV6De4cI.js";import{O as y,A as F,S as L,B as _,H as f}from"./SøkerOppsummeringspunkt-ELexr77N.js";import"./index-DVXBtNgz.js";const H=n=>!!n.terminbekreftelsedato,q=({omBarnet:n,dokumentasjon:i})=>{const t=h(),o=x(n),p=S(n),l=B(n);let a;return n.antallBarn===1?a=t.formatMessage({id:"OmBarnetOppsummering.EttBarn"}):n.antallBarn===2&&!o?a=t.formatMessage({id:"OmBarnetOppsummering.Tvillinger"}):n.antallBarn===2&&o?a=t.formatMessage({id:"OmBarnetOppsummering.ToBarn"}):a=t.formatMessage({id:"OmBarnetOppsummering.FlereBarn"},{antall:n.antallBarn}),e.jsxs(P,{gap:"4",children:[e.jsxs(d,{gap:"2",children:[e.jsx(r,{children:e.jsx(s,{id:"OmBarnetOppsummering.SoknadenGjelder"})}),e.jsx(r,{children:a})]}),o&&e.jsxs(e.Fragment,{children:[e.jsxs(d,{gap:"2",children:[e.jsx(r,{children:e.jsx(s,{id:"OmBarnetOppsummering.MedAdopsjonsdato"})}),e.jsx(r,{children:m(n.adopsjonsdato)})]}),e.jsxs(d,{gap:"2",children:[e.jsx(r,{children:n.fødselsdatoer.length>1?t.formatMessage({id:"OmBarnetOppsummering.MedFødselsdatoer"}):t.formatMessage({id:"OmBarnetOppsummering.MedFødselsdato"})}),e.jsx(A,{children:n.fødselsdatoer.map((j,c)=>m(n.fødselsdatoer[c].dato)).join(", ")})]}),e.jsx(r,{style:{fontWeight:"bold"},children:e.jsx(s,{id:"OmBarnetOppsummering.VedlagtOmsorgsovertakelseBekreftelse"})}),e.jsx(O,{attachments:v(i).vedlegg})]}),l&&e.jsxs(d,{gap:"2",children:[e.jsx(r,{children:e.jsx(s,{id:"OmBarnetOppsummering.MedFødselsdato"})}),e.jsx(r,{children:m(n.fødselsdato)})]}),p&&i&&H(i)&&e.jsxs(e.Fragment,{children:[e.jsxs(d,{gap:"2",children:[e.jsx(r,{children:e.jsx(s,{id:"OmBarnetOppsummering.MedTermindato"})}),e.jsx(r,{children:m(n.termindato)})]}),e.jsxs(d,{gap:"2",children:[e.jsx(r,{children:e.jsx(s,{id:"OmBarnetOppsummering.SomErDatert"})}),e.jsx(r,{children:m(i.terminbekreftelsedato)})]}),e.jsx(r,{style:{fontWeight:"bold"},children:e.jsx(s,{id:"OmBarnetOppsummering.VedlagtTerminbekreftelse"})}),e.jsx(O,{attachments:i.vedlegg})]})]})};q.__docgenInfo={description:"",methods:[],displayName:"OmBarnetOppsummering"};const I=n=>{if(B(n))return[n.fødselsdato,f.FØDSEL];if(x(n))return[n.adopsjonsdato,f.ADOPSJON];if(S(n))return[n.termindato,f.TERMIN];throw new Error("Informasjon om barn er feil!")},M=({søker:n,sendSøknad:i,mellomlagreOgNaviger:t})=>{const o=h(),p=w(),l=N(t),a=v(u(g.OM_BARNET)),j=v(u(g.UTENLANDSOPPHOLD)),c=u(g.DOKUMENTASJON),T=u(g.UTENLANDSOPPHOLD_TIDLIGERE),b=u(g.UTENLANDSOPPHOLD_SENERE),k=I(a);return e.jsxs(D,{children:[e.jsx(E,{size:"large",children:e.jsx(s,{id:"Søknad.Pageheading"})}),e.jsx(y,{appName:"Engangsstønad",stepConfig:p,sendSøknad:i,cancelApplication:l.avbrytSøknad,goToPreviousStep:l.goToPreviousDefaultStep,onContinueLater:l.fortsettSøknadSenere,children:e.jsxs(F,{indent:!1,children:[e.jsx(L,{søker:n}),e.jsx(y.Punkt,{tittel:o.formatMessage({id:"OppsummeringSteg.OmBarnet"}),children:e.jsx(q,{omBarnet:a,dokumentasjon:c})}),e.jsx(_,{familiehendelseDato:k[0],hendelseType:k[1],utenlandsopphold:j,tidligereUtenlandsopphold:T,senereUtenlandsopphold:b})]})})]})},G=M;M.__docgenInfo={description:"",methods:[],displayName:"OppsummeringSteg",props:{søker:{required:!0,tsType:{name:"intersection",raw:`{
    fødselsdato: string;
    kjønn: Kjønn;
    bankkonto?: Bankkonto;
