import{j as e}from"./jsx-runtime-_e34SzbC.js";import{u as F,M as m}from"./index-Bomzi5Jd.js";import{S as j,h as E,i as U,e as I}from"./HvemPlanleggerUtils-CHTffTZd.js";import{b as w}from"./barnetUtils-Dtg6gkcN.js";import{h as G,a as N,b as K,u as D}from"./hvemHarRettUtils-DP-A7Fyr.js";import{a as V,b as C,w as z,f as J}from"./uttakUtils-DxdAnUVc.js";import{d as O,I as P}from"./Uttaksdagen-oR0d4Gua.js";import"./index-DVXBtNgz.js";import{C as M}from"./CalendarIconLabel-D3VA8mep.js";import{B as _}from"./Label-DFEFJLqZ.js";import{F as S}from"./FamiliehendelseLabel-CLEzLQ0W.js";import{V as Q,H as R}from"./VStack-DzX3uTsq.js";import{b as p}from"./infobox.module-DtPzhx7Z.js";const c=r=>r.charAt(0).toUpperCase()+r.slice(1),W="_srOnly_19lbm_1",x={srOnly:W},A=({utenAktivitetskrav:r=!1,tekstPart1:a,tekstPart2:t,isBluePanel:n=!1,valgtStønadskonto:o,startdato:s,sluttdato:i,visUkerAktivitetskrav:l=!0})=>{const u=F();return e.jsxs(M,{iconType:n?"blue":"green",children:[e.jsx(_,{children:l?e.jsxs(e.Fragment,{children:[r&&e.jsx(m,{id:"OversiktSteg.UkerUtenAktivitetskrav",values:{hvem:c(a),uker:V(o),hvemPart2:c(t)}}),!r&&e.jsx(m,{id:"OversiktSteg.UkerMedAktivitetskrav",values:{hvem:c(a),uker:C(o),hvemPart2:c(t)}})]}):e.jsxs(e.Fragment,{children:[r&&e.jsx(m,{id:"OversiktSteg.UtenAktivitetskrav"}),!r&&e.jsx(m,{id:"OversiktSteg.MedAktivitetskrav"})]})}),e.jsx("div",{className:x.srOnly,children:e.jsx(m,{id:"OversiktSteg.PeriodeSrOnly",values:{hvem:c(a),startdato:u.formatDate(s,{day:"2-digit",month:"long",weekday:"long",year:"numeric"}),sluttdato:u.formatDate(i,{day:"2-digit",month:"long",weekday:"long",year:"numeric"})}})})]})};A.__docgenInfo={description:"",methods:[],displayName:"AktivitetskravLabel",props:{utenAktivitetskrav:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},valgtStønadskonto:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    ...
    [MinsterettType.farRundtFødsel]: number;
    [MinsterettType.toTette]: number;
}`,signature:{properties:[]},required:!0}}]}},description:""}}};const Y=(r,a)=>[{fom:r,tom:r,color:p.PINK},{fom:O(r).add(1,"day").format(P),tom:a,color:p.BLUE}],h=(r,a,t,n,o,s)=>{const i=[];return r||i.push({fom:a,tom:O(n).subtract(1,"day").format(P),color:p.BLUE}),i.push({fom:n,tom:n,color:p.PINK}),i.push({fom:O(n).add(1,"day").format(P),tom:t,color:p.BLUE}),o&&s&&i.push({fom:o,tom:s,color:p.LIGHTGREEN}),i},Z=(r,a,t,n,o)=>[{fom:t,tom:t,color:p.PINK},{fom:r,tom:a,color:p.BLUE},{fom:n,tom:o,color:p.LIGHTGREEN}],$=(r,a,t)=>r.type===j.FAR_OG_FAR&&!t&&a!=="ingenHarRett",ee=(r,a)=>a==="kunSøker1HarRett"&&r.type===j.FAR_OG_FAR,re=(r,a)=>a==="kunSøker1HarRett"&&r.type===j.FAR,ye=(r,a,t,n,o)=>{const s=D(n),{startdatoPeriode1:i,sluttdatoPeriode1:l,familiehendelsedato:u,startdatoPeriode2:d,sluttdatoPeriode2:k}=J(s,t,r,a,o),g=w(a),y=d&&k;if($(t,s,g)||re(t,s))return Y(u,l);if(s==="beggeHarRett"&&y)return h(g,i,l,u,d,k);if(s==="kunSøker1HarRett"&&I(t))return h(g,i,l,u);if(y&&(s==="kunSøker2HarRett"||ee(t,s)||!g))return Z(i,l,u,d,k);throw Error("Ingen perioder finnes")};export{X as C,ye as l};
