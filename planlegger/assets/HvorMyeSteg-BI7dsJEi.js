import{ai as B,j as e,a3 as g,a2 as T,a4 as h,Z as n,a6 as w,a7 as D,a5 as N,aa as C,ab as R,_ as I,$ as O,ac as z,af as V,ag as P,ae as G}from"./iframe-BcebTy5A.js";import{c as U,e as K,u as f,C as y,f as $}from"./usePlanleggerNavigator-ybAgRu0A.js";import{P as W}from"./routes-Cyl7_Mgv.js";import{P as Y}from"./PlanleggerStepPage-CZl3wWXn.js";import{e as J,g as Z,a as _}from"./HvemPlanleggerUtils-CovGh7Lk.js";import{u as Q}from"./hvemHarRettUtils-BHjssFV0.js";import{a as X,f as l}from"./satserUtils-CKbEuqYd.js";import{S as ee,a as re}from"./Wallet-MDtAEtlD.js";import{S as ne}from"./Spacer-m-AKrukH.js";const te=/^\d+([,.]\d+)?$/,ae=i=>te.test(i.toString()),q=i=>r=>B(r)||ae(r)?null:i,S=({satser:i,lønnSøker:r,fornavn:u})=>{const v=X(i),a=6*v/12,x=a/21.67,s=80/100,p=(t,o)=>isNaN(t)?0:Math.round(Math.min(t,a)*o),m=(t,o)=>isNaN(t)?0:Math.round(Math.min(t*12/260,x)*o);return e.jsx(g,{gap:"4",children:e.jsx(T,{header:r<=a?e.jsx(n,{id:"HvorMyeSteg.VilFå",values:{hvem:N(u),utregning100:l(m(r,1)),utregning80:l(m(r,s))}}):e.jsx(n,{id:"HvorMyeSteg.KanFå",values:{hvem:N(u),utregning100:l(m(r,1)),utregning80:l(m(r,s))}}),color:"green",icon:e.jsx(ee,{height:24,width:24,color:"#7F8900",fontSize:"1.5rem","aria-hidden":!0}),children:e.jsxs(g,{gap:"2",children:[e.jsx(h,{children:e.jsx(n,{id:"HvorMyeSteg.Utregning",values:{utregning100:l(p(r,1)),utregning80:l(p(r,s))}})}),r>a&&e.jsxs(e.Fragment,{children:[e.jsx(h,{children:e.jsx(n,{id:"HvorMyeSteg.NAVDekker",values:{grunnbeløpet:l(v*6),a:t=>e.jsx(w,{href:D.grunnbeløpet,target:"_blank",rel:"noreferrer",inlineText:!0,children:t})}})}),e.jsx(h,{children:e.jsx(n,{id:"HvorMyeSteg.BasertPåInntekt",values:{hvem:u}})})]})]})})})};S.__docgenInfo={description:"",methods:[],displayName:"Utbetaling",props:{satser:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    engangstønad: Array<{
        fom: string;
        verdi: number;
    }>;
