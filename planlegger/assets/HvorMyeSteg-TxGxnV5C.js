import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{u as B,a as C,b as x,C as v,c as I}from"./usePlanleggerNavigator-B8T5xkBt.js";import{P as O}from"./routes-Cyl7_Mgv.js";import{P as z}from"./PlanleggerStepPage-jjtvH2XP.js";import{u as G,R as U,b as V,S as K}from"./StepButtonsHookForm-DAMtOG3B.js";import{h as T,B as y,M as n,L as w,l as D,u as W,H as Y,a as N}from"./VeiviserPage-_pnwesxq.js";import{b as $,g as J,c as R}from"./HvemPlanleggerUtils-CID24uWy.js";import{u as Q}from"./hvemHarRettUtils-D25Zomat.js";import"./index-DQLiH3RP.js";import{n as P}from"./validation-Dy1ue2_T.js";import{a as X}from"./dateFormValidation-CtPPetz8.js";import{f as Z,a as m}from"./satserUtils-Dqj76nS8.js";import{c as _}from"./stringUtils-DApHD7Y2.js";import{V as l}from"./VStack-05Ww9A8B.js";import{S as ee,a as re}from"./Wallet-BDcZwlms.js";import{S as ne}from"./Spacer-C5GDfzOr.js";const te=/^\d+([,.]\d+)?$/,ae=s=>te.test(s.toString()),q=s=>r=>X(r)||ae(r)?null:s,S=({satser:s,lønnSøker:r,fornavn:u})=>{const c=Z(s),a=6*c/12,f=a/21.67,i=80/100,p=(t,o)=>isNaN(t)?0:Math.round(Math.min(t,a)*o),g=(t,o)=>isNaN(t)?0:Math.round(Math.min(t*12/260,f)*o);return e.jsx(l,{gap:"4",children:e.jsx(T,{header:r<=a?e.jsx(n,{id:"HvorMyeSteg.VilFå",values:{hvem:_(u),utregning100:m(g(r,1)),utregning80:m(g(r,i))}}):e.jsx(n,{id:"HvorMyeSteg.KanFå",values:{hvem:_(u),utregning100:m(g(r,1)),utregning80:m(g(r,i))}}),color:"green",icon:e.jsx(ee,{height:24,width:24,color:"#7F8900",fontSize:"1.5rem","aria-hidden":!0}),children:e.jsxs(l,{gap:"2",children:[e.jsx(y,{children:e.jsx(n,{id:"HvorMyeSteg.Utregning",values:{utregning100:m(p(r,1)),utregning80:m(p(r,i))}})}),r>a&&e.jsxs(e.Fragment,{children:[e.jsx(y,{children:e.jsx(n,{id:"HvorMyeSteg.NAVDekker",values:{grunnbeløpet:m(c*6),a:t=>e.jsx(w,{href:D.grunnbeløpet,target:"_blank",rel:"noreferrer",inlineText:!0,children:t})}})}),e.jsx(y,{children:e.jsx(n,{id:"HvorMyeSteg.BasertPåInntekt",values:{hvem:u}})})]})]})})})};S.__docgenInfo={description:"",methods:[],displayName:"Utbetaling",props:{satser:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    engangstønad: Array<{
        fom: string;
        verdi: number;
    }>;
