...
}`,signature:{properties:[{key:"familiehendelsedato",value:{name:"string",required:!0}},{key:"startdatoPeriode1",value:{name:"string",required:!0}},{key:"sluttdatoPeriode1",value:{name:"string",required:!0}},{key:"startdatoPeriode2",value:{name:"string",required:!1}},{key:"sluttdatoPeriode2",value:{name:"string",required:!1}}]}},description:""},fornavnSøker1:{required:!0,tsType:{name:"string"},description:""},fornavnSøker2:{required:!1,tsType:{name:"string"},description:""}}};const ge=r=>{const t=[];for(let n=0;n<=r.uker;n++){const a=r.uker-n>=n,o=a?r.dager:0,s=a?0:r.dager;t.push({antallUkerOgDagerSøker1:{uker:r.uker-n,dager:a?r.dager:0,totaltAntallDager:(r.uker-n)*5+o},antallUkerOgDagerSøker2:{uker:n,dager:a?0:r.dager,totaltAntallDager:n*5+s}})}return t},w=(r,t,n,a,o,s)=>{const i=n.type===Z.FAR_OG_FAR,u=i&&a?a:$(r,n),d=i&&o?o:ee(r,n);return t.antallUkerOgDagerSøker1.uker===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:d,uker:t.antallUkerOgDagerSøker2.uker,dager:t.antallUkerOgDagerSøker2.dager,erOversiktSteg:s}}):t.antallUkerOgDagerSøker2.uker===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:u,uker:t.antallUkerOgDagerSøker1.uker,dager:t.antallUkerOgDagerSøker1.dager,erOversiktSteg:s}}):e.jsx(l,{id:"FordelingSteg.FordelingOptions",values:{hvem:u,hvem2:d,uker:t.antallUkerOgDagerSøker1.uker,dagerS1:t.antallUkerOgDagerSøker1.dager,uker2:t.antallUkerOgDagerSøker2.uker,dagerS2:t.antallUkerOgDagerSøker2.dager,erOversiktSteg:s}})},me=({stønadskontoer:r})=>{const t=M(),n=G(),a=H(),o=y(k.FORDELING),{dekningsgrad:s}=F(y(k.HVOR_LANG_PERIODE)),i=F(y(k.HVEM_PLANLEGGER)),u=F(y(k.ARBEIDSSITUASJON)),d=F(y(k.OM_BARNET)),f=N(k.FORDELING),v=z({defaultValues:o}),S=v.watch("antallDagerSøker1"),g=S?parseInt(S.toString(),10):void 0,h=c=>{f(c),n.goToNextDefaultStep()},p=r[s],m=te(p),T=re(u),A=D(T,i,p,d,g),B=D(T,i,p,d,g),P=X(i,t),q=Y(i,t),{ref:E,scrollToBottom:I}=ae();return e.jsx(U,{ref:E,steps:a,children:e.jsx(V,{formMethods:v,onSubmit:h,shouldUseFlexbox:!0,children:e.jsxs(O,{gap:"10",style:{flex:1},children:[e.jsxs(O,{gap:"8",children:[e.jsx(W,{size:"medium",spacing:!0,level:"2",children:e.jsx(l,{id:"FordelingSteg.Tittel"})}),e.jsx(R,{header:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTittel"}),icon:e.jsx(ue,{height:24,width:24,color:"#020C1CAD",fontSize:"1.5rem","aria-hidden":!0}),isGray:!0,children:e.jsx(b,{children:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTekst"})})}),e.jsx(ne,{isDarkBlue:o===void 0,children:e.jsx(K,{name:"antallDagerSøker1",label:e.jsx(l,{id:"FordelingSteg.FordelingTittel",values:{uker:m.uker,dager:m.dager}}),autofocusWhenEmpty:!0,validate:[oe(t.formatMessage({id:"FordelingSteg.FordelingTittel.Required"}))],customErrorFormatter:L,onChange:I,children:ge(m).map(c=>e.jsx("option",{value:c.antallUkerOgDagerSøker1.totaltAntallDager,children:w(t,c,i,P,q)},c.antallUkerOgDagerSøker1.totaltAntallDager))})}),g!==void 0&&e.jsx(_,{barnet:d,hvemPlanlegger:i,fornavnSøker1:P,fornavnSøker2:q,uttaksdata:s===Q.HUNDRE_PROSENT?A:B},g)]}),e.jsx(le,{}),e.jsx(J,{saveDataOnPreviousClick:f,goToPreviousStep:n.goToPreviousDefaultStep,useSimplifiedTexts:!0})]})})})};w.__docgenInfo={description:"",methods:[],displayName:"finnFellesperiodeFordelingOptionTekst"};me.__docgenInfo={description:"",methods:[],displayName:"FordelingSteg",props:{stønadskontoer:{required:!0,tsType:{name:"signature",type:"object",raw:`{
