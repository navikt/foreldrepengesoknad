...
}`,signature:{properties:[{key:"familiehendelsedato",value:{name:"string",required:!0}},{key:"startdatoPeriode1",value:{name:"string",required:!0}},{key:"sluttdatoPeriode1",value:{name:"string",required:!0}},{key:"startdatoPeriode2",value:{name:"string",required:!1}},{key:"sluttdatoPeriode2",value:{name:"string",required:!1}}]}},description:""},fornavnSøker1:{required:!0,tsType:{name:"string"},description:""},fornavnSøker2:{required:!1,tsType:{name:"string"},description:""}}};const me=r=>{const t=[];for(let n=0;n<=r.uker;n++){const a=r.uker-n>=n,s=a?r.dager:0,o=a?0:r.dager;t.push({antallUkerOgDagerSøker1:{uker:r.uker-n,dager:a?r.dager:0,totaltAntallDager:(r.uker-n)*5+s},antallUkerOgDagerSøker2:{uker:n,dager:a?0:r.dager,totaltAntallDager:n*5+o}})}return t},A=(r,t,n,a,s,o)=>{const i=n.type===re.FAR_OG_FAR,g=i&&a?a:te(r,n),u=i&&s?s:ne(r,n);return t.antallUkerOgDagerSøker1.uker===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:u,uker:t.antallUkerOgDagerSøker2.uker,dager:t.antallUkerOgDagerSøker2.dager,erOversiktSteg:o}}):t.antallUkerOgDagerSøker2.uker===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:g,uker:t.antallUkerOgDagerSøker1.uker,dager:t.antallUkerOgDagerSøker1.dager,erOversiktSteg:o}}):e.jsx(l,{id:"FordelingSteg.FordelingOptions",values:{hvem:g,hvem2:u,uker:t.antallUkerOgDagerSøker1.uker,dagerS1:t.antallUkerOgDagerSøker1.dager,uker2:t.antallUkerOgDagerSøker2.uker,dagerS2:t.antallUkerOgDagerSøker2.dager,erOversiktSteg:o}})},pe=({stønadskontoer:r})=>{const t=R(),n=W(),a=Z(),s=v(k.FORDELING),{dekningsgrad:o}=j(v(k.HVOR_LANG_PERIODE)),i=j(v(k.HVEM_PLANLEGGER)),g=j(v(k.ARBEIDSSITUASJON)),u=j(v(k.OM_BARNET)),f=$(k.FORDELING),c=G({defaultValues:s}),F=c.watch("antallDagerSøker1"),m=F?parseInt(F.toString(),10):void 0,h=y=>{f(y),n.goToNextDefaultStep()},p=r[o],d=se(p),P=oe(g),B=M(P,i,p,u,m),I=M(P,i,p,u,m),x=Y(i,t),q=ee(i,t),{ref:E,scrollToBottom:H}=ie();return e.jsx(Q,{ref:E,steps:a,goToStep:n.goToNextStep,children:e.jsx(U,{formMethods:c,onSubmit:h,shouldUseFlexbox:!0,children:e.jsxs(T,{gap:"10",style:{flex:1},children:[e.jsxs(T,{gap:"8",children:[e.jsx(z,{size:"medium",spacing:!0,level:"2",children:e.jsx(l,{id:"FordelingSteg.Tittel"})}),e.jsx(_,{header:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTittel"}),icon:e.jsx(ge,{height:24,width:24,color:"#020C1CAD",fontSize:"1.5rem","aria-hidden":!0}),color:"gray",children:e.jsx(b,{children:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTekst",values:{uker:d.uker,dager:d.dager,prosent:o}})})}),e.jsx(K,{isDarkBlue:s===void 0,children:e.jsx(L,{name:"antallDagerSøker1",control:c.control,label:e.jsx(l,{id:"FordelingSteg.FordelingTittel",values:{uker:d.uker,dager:d.dager}}),autofocusWhenEmpty:!0,validate:[V(t.formatMessage({id:"FordelingSteg.FordelingTittel.Required"}))],customErrorFormatter:ae,onChange:H,children:me(d).map(y=>e.jsx("option",{value:y.antallUkerOgDagerSøker1.totaltAntallDager,children:A(t,y,i,x,q)},y.antallUkerOgDagerSøker1.totaltAntallDager))})}),m!==void 0&&e.jsx(w,{barnet:u,hvemPlanlegger:i,fornavnSøker1:x,fornavnSøker2:q,uttaksdata:o===X.HUNDRE_PROSENT?B:I},m)]}),e.jsx(de,{}),e.jsx(J,{saveDataOnPreviousClick:f,goToPreviousStep:n.goToPreviousDefaultStep,useSimplifiedTexts:!0})]})})})};A.__docgenInfo={description:"",methods:[],displayName:"finnFellesperiodeFordelingOptionTekst"};pe.__docgenInfo={description:"",methods:[],displayName:"FordelingSteg",props:{stønadskontoer:{required:!0,tsType:{name:"signature",type:"object",raw:`{
