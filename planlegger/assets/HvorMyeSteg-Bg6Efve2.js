import{j as e}from"./jsx-runtime-CLpGMVip.js";import{u as E,a as L,b as S,C as v,c as B}from"./usePlanleggerNavigator-DGGRibuM.js";import{P as C}from"./routes-Cyl7_Mgv.js";import{P as I}from"./PlanleggerStepPage-CQphG9-u.js";import{u as O,R as z,b as A,S as G}from"./StepButtonsHookForm-CaAHPujx.js";import{u as _,h as w,M as a,B as y,L as V,l as D,H as U,a as N}from"./VeiviserPage-BmJqjC0L.js";import{b as K,c as W,g as P}from"./HvemPlanleggerUtils-BBpqtc-K.js";import{u as Y}from"./hvemHarRettUtils-EFarcwZ2.js";import"./index-CR__hKHy.js";import{n as R}from"./validation-DYlyn1BB.js";import{a as J}from"./dateFormValidation-DjIzFfbv.js";import{f as $,a as m}from"./satserUtils-BCtYZnpm.js";import{c as q}from"./stringUtils-DApHD7Y2.js";import{V as g}from"./VStack-CmtOnz83.js";import{S as Q,a as X}from"./Wallet-s8rUJsVh.js";import{S as Z}from"./Spacer-zSi7sa7G.js";const ee=/^\d+([,.]\d+)?$/,re=o=>ee.test(o.toString()),T=o=>r=>J(r)||re(r)?null:o,b=({satser:o,lønnSøker:r,fornavn:n})=>{const t=_().locale,c=$(o),i=6*c/12,f=i/21.67,u=80/100,p=(s,l)=>isNaN(s)?0:Math.round(Math.min(s,i)*l),d=(s,l)=>isNaN(s)?0:Math.round(Math.min(s*12/260,f)*l);return e.jsx(g,{gap:"4",children:e.jsx(w,{header:r<=i?e.jsx(a,{id:"HvorMyeSteg.VilFå",values:{hvem:q(n),utregning100:m(d(r,1),t),utregning80:m(d(r,u),t)}}):e.jsx(a,{id:"HvorMyeSteg.KanFå",values:{hvem:q(n),utregning100:m(d(r,1),t),utregning80:m(d(r,u),t)}}),color:"green",icon:e.jsx(Q,{height:24,width:24,color:"#7F8900",fontSize:"1.5rem","aria-hidden":!0}),children:e.jsxs(g,{gap:"2",children:[e.jsx(y,{children:e.jsx(a,{id:"HvorMyeSteg.Utregning",values:{utregning100:m(p(r,1),t),utregning80:m(p(r,u),t)}})}),r>i&&e.jsxs(e.Fragment,{children:[e.jsx(y,{children:e.jsx(a,{id:"HvorMyeSteg.NAVDekker",values:{grunnbeløpet:m(c*6,t),a:s=>e.jsx(V,{href:D.grunnbeløpet,target:"_blank",rel:"noreferrer",className:"lenke",inlineText:!0,children:s})}})}),e.jsx(y,{children:e.jsx(a,{id:"HvorMyeSteg.BasertPåInntekt",values:{hvem:n}})})]})]})})})};b.__docgenInfo={description:"",methods:[],displayName:"Utbetaling",props:{satser:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    engangstønad: Array<{
        fom: string;
        verdi: number;
    }>;
