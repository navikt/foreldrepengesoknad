...
}`,signature:{properties:[{key:"status",value:{name:"Arbeidsstatus",required:!1}},{key:"jobberAnnenPart",value:{name:"boolean",required:!1}}]}},description:""}}};const ne=({barnet:t,hvemPlanlegger:n,arbeidssituasjon:a,valgtStønadskonto:u,uttaksdata100:d,uttaksdata80:s,valgtDekningsgrad:m,antallUkerOgDager:o})=>{const g=I(),f=t.antallBarn,l=ee(t),S=je(t),P=re(a),j=X(n)||P==="kunSøker1HarRett"||P==="kunSøker2HarRett",h=g.formatDate(Te(t),{day:"2-digit",month:"long",year:"numeric"}),y=m===v.HUNDRE_PROSENT?d.sluttdatoPeriode1:s.sluttdatoPeriode1,k=m===v.HUNDRE_PROSENT?d.sluttdatoPeriode2:s.sluttdatoPeriode2,H=n.type===F.FAR_OG_FAR&&!l;return e.jsxs(M,{header:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.SisteDagTittel",values:{dato:g.formatDate(k||y,{day:"2-digit",month:"long",year:"numeric",weekday:"long"})}}),icon:e.jsx(W,{height:24,width:24,color:"#020C1CAD",fontSize:"1.5rem","aria-hidden":!0}),shouldFadeIn:!0,color:"green",children:[e.jsxs(i,{children:[l&&e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.SisteDagTekstAdopsjon",values:{antallBarn:f,kunEnPartSkalHa:j,dato:h}}),!l&&S&&e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.SisteDagTekstFødsel",values:{antallBarn:f,erMorDelAvSøknaden:N(n),dato:h,kunEnPartSkalHa:j}}),!l&&!S&&e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.SisteDagTekstTermin",values:{antallBarn:f,erMorDelAvSøknaden:N(n),kunEnPartSkalHa:j}})]}),(P==="kunSøker2HarRett"&&!H||P==="kunSøker1HarRett"&&n.type===F.FAR_OG_FAR&&l)&&e.jsxs(c,{gap:"2",children:[e.jsx(i,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.SisteDagTekstFar.FørsteUker",values:{uker:Y(u).uker,dager:Y(u).dager,uker2:o.uker,dager2:o.dager,b:p=>e.jsx("b",{children:p}),hvem:J(n,g),hvemPart1:z(n,g)}})}),e.jsx(i,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.SisteDagTekstFar.AndreUker",values:{uker:Z(u).uker,dager:Z(u).dager,uker2:o.uker,dager2:o.dager,a:p=>e.jsx(L,{inlineText:!0,href:B.godkjentAktivitet,rel:"noreferrer",target:"_blank",children:p}),b:p=>e.jsx("b",{children:p}),hvem:J(n,g),hvemPart1:z(n,g)}})})]})]})};ne.__docgenInfo={description:"",methods:[],displayName:"ValgtDekningsgradInfoboks",props:{barnet:{required:!0,tsType:{name:"union",raw:"Fødsel | BarnetErAdoptert",elements:[{name:"union",raw:"BarnetErFødt | BarnetErIkkeFødt",elements:[{name:"signature",type:"object",raw:`{
    erFødsel: boolean;
    antallBarn: string;
