...
}`,signature:{properties:[{key:"familiehendelsedato",value:{name:"string",required:!0}},{key:"startdatoPeriode1",value:{name:"string",required:!0}},{key:"sluttdatoPeriode1",value:{name:"string",required:!0}},{key:"startdatoPeriode2",value:{name:"string",required:!1}},{key:"sluttdatoPeriode2",value:{name:"string",required:!1}}]}},description:""},fornavnSøker1:{required:!0,tsType:{name:"string"},description:""},fornavnSøker2:{required:!1,tsType:{name:"string"},description:""}}};const ue=t=>{const r=[];for(let n=0;n<=t.uker;n++){const a=t.uker-n>=n;r.push({antallUkerOgDagerSøker1:{uker:t.uker-n,dager:a?t.dager:0},antallUkerOgDagerSøker2:{uker:n,dager:a?0:t.dager}})}return r},_=(t,r,n,a,o,s)=>{const i=n.type===Y.FAR_OG_FAR,u=i&&a?a:$(t,n),d=i&&o?o:ee(t,n);return r.antallUkerOgDagerSøker1.uker===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:d,uker:r.antallUkerOgDagerSøker2.uker,dager:r.antallUkerOgDagerSøker2.dager,erOversiktSteg:s}}):r.antallUkerOgDagerSøker2.uker===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:u,uker:r.antallUkerOgDagerSøker1.uker,dager:r.antallUkerOgDagerSøker1.dager,erOversiktSteg:s}}):e.jsx(l,{id:"FordelingSteg.FordelingOptions",values:{hvem:u,hvem2:d,uker:r.antallUkerOgDagerSøker1.uker,dagerS1:r.antallUkerOgDagerSøker1.dager,uker2:r.antallUkerOgDagerSøker2.uker,dagerS2:r.antallUkerOgDagerSøker2.dager,erOversiktSteg:s}})},ge=({stønadskontoer:t})=>{const r=D(),n=U(),a=C(),o=f(k.FORDELING),{dekningsgrad:s}=j(f(k.HVOR_LANG_PERIODE)),i=j(f(k.HVEM_PLANLEGGER)),u=j(f(k.ARBEIDSSITUASJON)),d=j(f(k.OM_BARNET)),v=G(k.FORDELING),S=V({defaultValues:o}),g=S.watch("antallUkerSøker1"),F=y=>{v(y),n.goToNextDefaultStep()},c=t[s],m=te(c),p=re(u),w=x(p,i,c,d,g),B=x(p,i,c,d,g),O=Q(i,r),T=X(i,r),{ref:A,scrollToBottom:E}=ae();return e.jsx(N,{ref:A,steps:a,children:e.jsx(K,{formMethods:S,onSubmit:F,shouldUseFlexbox:!0,children:e.jsxs(P,{gap:"10",style:{flex:1},children:[e.jsxs(P,{gap:"8",children:[e.jsx(J,{size:"medium",spacing:!0,level:"2",children:e.jsx(l,{id:"FordelingSteg.Tittel"})}),e.jsx(M,{header:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTittel"}),icon:e.jsx(de,{height:24,width:24,color:"#020C1CAD",fontSize:"1.5rem","aria-hidden":!0}),isGray:!0,children:e.jsx(h,{children:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTekst"})})}),e.jsx(ne,{isDarkBlue:o===void 0,children:e.jsx(Z,{name:"antallUkerSøker1",label:e.jsx(l,{id:"FordelingSteg.FordelingTittel",values:{uker:m.uker,dager:m.dager}}),autofocusWhenEmpty:!0,validate:[H(r.formatMessage({id:"FordelingSteg.FordelingTittel.Required"}))],customErrorFormatter:L,onChange:E,children:ue(m).map(y=>e.jsx("option",{value:y.antallUkerOgDagerSøker1.uker,children:_(r,y,i,O,T)},y.antallUkerOgDagerSøker1.uker))})}),g!==void 0&&e.jsx(R,{barnet:d,hvemPlanlegger:i,fornavnSøker1:O,fornavnSøker2:T,uttaksdata:s===W.HUNDRE_PROSENT?w:B},g)]}),e.jsx(ie,{}),e.jsx(z,{saveDataOnPreviousClick:v,goToPreviousStep:n.goToPreviousDefaultStep,useSimplifiedTexts:!0})]})})})};_.__docgenInfo={description:"",methods:[],displayName:"finnFellesperiodeFordelingOptionTekst"};ge.__docgenInfo={description:"",methods:[],displayName:"FordelingSteg",props:{stønadskontoer:{required:!0,tsType:{name:"signature",type:"object",raw:`{
