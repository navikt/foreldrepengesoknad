import{j as e}from"./jsx-runtime-CLpGMVip.js";import{u as E,a as L,b as S,C as v,c as B}from"./usePlanleggerNavigator-DXWNGG0W.js";import{P as C}from"./routes-gnI_NAHe.js";import{P as I}from"./PlanleggerStepPage-8zHC9I30.js";import{u as O,R as z,b as A,S as G}from"./StepButtonsHookForm-ATHqV2fm.js";import{u as w,M as a,B as y,H as U}from"./UttaksdagenString-DZRvsvH4.js";import{b as K,c as W,g as P}from"./HvemPlanleggerUtils-BK9nF1ca.js";import{u as Y}from"./hvemHarRettUtils-C-poRxZI.js";import{d as N,L as V,l as D,B as R}from"./VeiviserPage-CoDRGcGF.js";import"./index-CR__hKHy.js";import{n as q}from"./validation-C6jaRJB5.js";import{a as J}from"./dateFormValidation-D0AFPq5M.js";import{f as $,a as m}from"./satserUtils-bn4SJB-X.js";import{c as T}from"./stringUtils-BLFzASq_.js";import{V as g}from"./VStack-D_n2pLOa.js";import{S as Q,a as X}from"./Wallet-B13Mx5jG.js";import{S as Z}from"./Spacer-zSi7sa7G.js";const ee=/^\d+([,.]\d+)?$/,re=o=>ee.test(o.toString()),_=o=>r=>J(r)||re(r)?null:o,b=({satser:o,lønnSøker:r,fornavn:n})=>{const t=w().locale,c=$(o),s=6*c/12,f=s/21.67,u=80/100,p=(i,l)=>Math.round(Math.min(i,s)*l),d=(i,l)=>Math.round(Math.min(i*12/260,f)*l);return e.jsx(g,{gap:"4",children:e.jsx(N,{header:r<=s?e.jsx(a,{id:"HvorMyeSteg.VilFå",values:{hvem:T(n),utregning100:m(d(r,1),t),utregning80:m(d(r,u),t)}}):e.jsx(a,{id:"HvorMyeSteg.KanFå",values:{hvem:T(n),utregning100:m(d(r,1),t),utregning80:m(d(r,u),t)}}),color:"green",icon:e.jsx(Q,{height:24,width:24,color:"#7F8900",fontSize:"1.5rem","aria-hidden":!0}),children:e.jsxs(g,{gap:"2",children:[e.jsx(y,{children:e.jsx(a,{id:"HvorMyeSteg.Utregning",values:{utregning100:m(p(r,1),t),utregning80:m(p(r,u),t)}})}),r>s&&e.jsxs(e.Fragment,{children:[e.jsx(y,{children:e.jsx(a,{id:"HvorMyeSteg.NAVDekker",values:{grunnbeløpet:m(c*6,t),a:i=>e.jsx(V,{href:D.grunnbeløpet,target:"_blank",rel:"noreferrer",className:"lenke",inlineText:!0,children:i})}})}),e.jsx(y,{children:e.jsx(a,{id:"HvorMyeSteg.BasertPåInntekt",values:{hvem:n}})})]})]})})})};b.__docgenInfo={description:"",methods:[],displayName:"Utbetaling",props:{satser:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    engangstønad: Array<{
        fom: string;
        verdi: number;
    }>;
