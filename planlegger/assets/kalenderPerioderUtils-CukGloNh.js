import{j as r}from"./jsx-runtime-Cw0GR0a5.js";import{u as v,B as b,M as p,d as g,b as f}from"./Label-CdeMuET1.js";import{S as q,c as D,g as G,e as N}from"./HvemPlanleggerUtils-D1xsqW5u.js";import{b as x}from"./barnetUtils-Dtg6gkcN.js";import{h as U,a as K,b as V,u as C}from"./hvemHarRettUtils-BiyQH6Vj.js";import"./index-CTjT7uj6.js";import{c as _}from"./stringUtils-DWuGC-tf.js";import{C as R}from"./CalendarIconLabel-BHeWN7wM.js";import{h as z,f as W}from"./uttakUtils-K1iOPBcc.js";import{b as H}from"./BarnehageplassSteg-CiRjXSGV.js";import{F as P}from"./FamiliehendelseLabel-DAVp7py7.js";import{V as J,H as S}from"./VStack-CHPVCYB5.js";import{h as u}from"./VeiviserPage-C-0AxCnT.js";const Q="_srOnly_19lbm_1",M={srOnly:Q},h=({utenAktivitetskrav:e=!1,tekstPart1:t,isBluePanel:a=!1,startdato:n,sluttdato:i})=>{const s=v();return r.jsxs(R,{iconType:a?"blue":"green",children:[r.jsxs(b,{children:[" ",r.jsxs(r.Fragment,{children:[e&&r.jsx(p,{id:"OversiktSteg.UtenAktivitetskrav"}),!e&&r.jsx(p,{id:"OversiktSteg.MedAktivitetskrav"})]})]}),r.jsx("div",{className:M.srOnly,children:r.jsx(p,{id:"OversiktSteg.PeriodeSrOnly",values:{hvem:_(t),startdato:s.formatDate(n,{day:"2-digit",month:"long",weekday:"long",year:"numeric"}),sluttdato:s.formatDate(i,{day:"2-digit",month:"long",weekday:"long",year:"numeric"})}})})]})};h.__docgenInfo={description:"",methods:[],displayName:"AktivitetskravLabel",props:{utenAktivitetskrav:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},startdato:{required:!0,tsType:{name:"string"},description:""},sluttdato:{required:!0,tsType:{name:"string"},description:""},tekstPart1:{required:!0,tsType:{name:"string"},description:""},isBluePanel:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const A=({søkerTekst:e,startdato:t,sluttdato:a,isBluePanel:n=!1})=>{const i=v(),s=z(t,a);return r.jsxs(R,{iconType:n?"blue":"green",children:[r.jsx(b,{children:r.jsx(p,{id:"OversiktSteg.UkerForeldrepenger",values:{hvem:_(e)}})}),r.jsx("div",{className:M.srOnly,children:r.jsx(p,{id:"OversiktSteg.UkerForeldrepengerSlutter",values:{hvem:_(e),uker:s.uker,dager:s.dager,dato:i.formatDate(a,{day:"2-digit",month:"long",weekday:"long"})}})})]})};A.__docgenInfo={description:"",methods:[],displayName:"AntallUkerFpLabel",props:{søkerTekst:{required:!0,tsType:{name:"string"},description:""},startdato:{required:!0,tsType:{name:"string"},description:""},sluttdato:{required:!0,tsType:{name:"string"},description:""},isBluePanel:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const j=({barnet:e})=>{const t=v(),a=H(e);return r.jsx(R,{iconType:"purple",children:r.jsx(b,{children:r.jsx(p,{id:"BarnehageplassLabel.Barnehagestartdato",values:{dato:t.formatDate(a,{day:"2-digit",month:"short"})}})})})};j.__docgenInfo={description:"",methods:[],displayName:"BarnehageplassLabel",props:{barnet:{required:!0,tsType:{name:"union",raw:"Fødsel | BarnetErAdoptert",elements:[{name:"union",raw:"BarnetErFødt | BarnetErIkkeFødt",elements:[{name:"signature",type:"object",raw:`{
    erFødsel: boolean;
    antallBarn: string;
