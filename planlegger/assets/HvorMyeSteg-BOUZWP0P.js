import{ak as B,j as e,a5 as g,a4 as T,a6 as x,_ as n,a8 as w,a9 as D,a7 as A,ac as I,ad as R,$ as C,a0 as O,ae as z,ah as V,ai as P,ag as G}from"./iframe-CDdkwaUD.js";import{c as U,e as K,u as f,C as y,f as $}from"./usePlanleggerNavigator-BM-o9sks.js";import{P as W}from"./routes-Cyl7_Mgv.js";import{P as Y}from"./PlanleggerStepPage-DZShhhrE.js";import{e as J,g as Q,a as _}from"./HvemPlanleggerUtils-qWiE9Y5O.js";import{u as X}from"./hvemHarRettUtils-DIlYlrMu.js";import{a as Z,f as l}from"./satserUtils-C3ghfRzt.js";import{S as ee,a as re}from"./Wallet-llSNt_iL.js";import{S as ne}from"./Spacer-4dhhMyFQ.js";const te=/^\d+([,.]\d+)?$/,ae=i=>te.test(i.toString()),q=i=>r=>B(r)||ae(r)?null:i,S=({satser:i,lønnSøker:r,fornavn:u})=>{const p=Z(i),a=6*p/12,h=a/21.67,s=80/100,v=(t,o)=>Number.isNaN(t)?0:Math.round(Math.min(t,a)*o),m=(t,o)=>Number.isNaN(t)?0:Math.round(Math.min(t*12/260,h)*o);return e.jsx(g,{gap:"space-16",children:e.jsx(T,{header:r<=a?e.jsx(n,{id:"HvorMyeSteg.VilFå",values:{hvem:A(u),utregning100:l(m(r,1)),utregning80:l(m(r,s))}}):e.jsx(n,{id:"HvorMyeSteg.KanFå",values:{hvem:A(u),utregning100:l(m(r,1)),utregning80:l(m(r,s))}}),color:"green",icon:e.jsx(ee,{height:24,width:24,color:"var(--ax-bg-success-strong)",fontSize:"1.5rem","aria-hidden":!0}),children:e.jsxs(g,{gap:"space-8",children:[e.jsx(x,{children:e.jsx(n,{id:"HvorMyeSteg.Utregning",values:{utregning100:l(v(r,1)),utregning80:l(v(r,s))}})}),r>a&&e.jsxs(e.Fragment,{children:[e.jsx(x,{children:e.jsx(n,{id:"HvorMyeSteg.NAVDekker",values:{grunnbeløpet:l(p*6),a:t=>e.jsx(w,{href:D.grunnbeløpet,target:"_blank",rel:"noreferrer",inlineText:!0,children:t})}})}),e.jsx(x,{children:e.jsx(n,{id:"HvorMyeSteg.BasertPåInntekt",values:{hvem:u}})})]})]})})})};S.__docgenInfo={description:"",methods:[],displayName:"Utbetaling",props:{satser:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    engangstønad: Array<{
        fom: string;
        verdi: number;
    }>;
