import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{u as F,a as E,b as S,C as v,c as L}from"./usePlanleggerNavigator-CVkzx2Y2.js";import{P as B}from"./routes-kf2p-jG8.js";import{P as C}from"./PlanleggerStepPage-E_O1yaDv.js";import{u as I,R as O,b as A,S as z}from"./StepButtonsHookForm-D240UR8j.js";import{M as t,B as y,u as G,H as U}from"./Label-BxLm70D5.js";import{b as K,c as Y,g as P}from"./HvemPlanleggerUtils-D1xsqW5u.js";import{u as J}from"./hvemHarRettUtils-BiyQH6Vj.js";import{d as w,L as N,l as V,B as R}from"./VeiviserPage-D7Uw8UMB.js";import"./index-CTjT7uj6.js";import{n as q}from"./validation-4HO0J-zV.js";import{a as W}from"./dateFormValidation-BSOPccLF.js";import{f as $,a as i}from"./satserUtils-MHYhUNIZ.js";import{c as T}from"./stringUtils-DWuGC-tf.js";import{V as o}from"./VStack-CHPVCYB5.js";import{S as Q,a as X}from"./Wallet-DVjw1ed4.js";import{S as Z}from"./Spacer-BW3tgveW.js";const ee=/^\d+([,.]\d+)?$/,re=a=>ee.test(a.toString()),_=a=>r=>W(r)||re(r)?null:a,b=({satser:a,lønnSøker:r,fornavn:n})=>{const u=$(a),l=6*u/12,m=l/21.67,c=80/100,g=(s,p)=>Math.round(Math.min(s,l)*p),d=(s,p)=>Math.round(Math.min(s*12/260,m)*p);return e.jsx(o,{gap:"4",children:e.jsx(w,{header:r<=l?e.jsx(t,{id:"HvorMyeSteg.VilFå",values:{hvem:T(n),utregning100:i(d(r,1)),utregning80:i(d(r,c))}}):e.jsx(t,{id:"HvorMyeSteg.KanFå",values:{hvem:T(n),utregning100:i(d(r,1)),utregning80:i(d(r,c))}}),color:"green",icon:e.jsx(Q,{height:24,width:24,color:"#7F8900",fontSize:"1.5rem","aria-hidden":!0}),children:e.jsxs(o,{gap:"2",children:[e.jsx(y,{children:e.jsx(t,{id:"HvorMyeSteg.Utregning",values:{utregning100:i(g(r,1)),utregning80:i(g(r,c))}})}),r>l&&e.jsxs(e.Fragment,{children:[e.jsx(y,{children:e.jsx(t,{id:"HvorMyeSteg.NAVDekker",values:{grunnbeløpet:i(u*6),a:s=>e.jsx(N,{href:V.grunnbeløpet,target:"_blank",rel:"noreferrer",className:"lenke",inlineText:!0,children:s})}})}),e.jsx(y,{children:e.jsx(t,{id:"HvorMyeSteg.BasertPåInntekt",values:{hvem:n}})})]})]})})})};b.__docgenInfo={description:"",methods:[],displayName:"Utbetaling",props:{satser:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    engangstønad: Array<{
        fom: string;
        verdi: number;
    }>;
