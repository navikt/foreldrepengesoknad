import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{u as P,d as g,H as v,M as n,m as s}from"./VeiviserPage-8Wpng40q.js";import{k as h,l as b,a as c,b as f,e as R,f as _}from"./HvemPlanleggerUtils-DWx8ZgD2.js";import{l as T}from"./amplitudeUtils-1CrV70-o.js";import{b as x}from"./barnetUtils-ZKU_BOQQ.js";import{u as H,a as A}from"./hvemHarRettUtils-Qkqdw2Ow.js";import"./index-DQLiH3RP.js";import{H as S}from"./HvemPlanleggerType-CugjyLV2.js";import{H as m,V as q}from"./VStack-TyG4_st1.js";import{S as w}from"./PersonPregnant-CREdhnXO.js";import{S as E}from"./BabyWrapped-CLrMLG43.js";import{S as G}from"./Briefcase-XmJBY6Co.js";import{S as B,a as z}from"./PencilWriting-CGf_9V_u.js";import{S as I}from"./PersonGroup-nunVEGjT.js";import{E as y}from"./ExpansionCard-DSVZz3RH.js";const O=({hvemPlanlegger:r,arbeidssituasjon:a})=>{const i=P(),l=h(r),o=b(r),d=c(i,r),t=H(a),p=t==="beggeHarRett"||t==="kunSøker1HarRett";return e.jsxs(m,{gap:"5",wrap:!1,children:[e.jsx("div",{children:e.jsx(g,{color:"lightBlue",size:"medium",children:e.jsx(w,{height:22,width:22,fontSize:"1.5rem",color:"#0067C5","aria-hidden":!0})})}),e.jsxs("div",{children:[e.jsx(v,{size:"small",children:e.jsx(n,{id:"HvaErMulig.KanIkkeEndres"})}),e.jsxs(q,{gap:"2",children:[!o&&t!=="kunSøker2HarRett"&&r.type!==S.FAR&&e.jsx(e.Fragment,{children:f(r)&&R(r)?e.jsx(s,{children:e.jsx(n,{id:"HvaErMulig.TreUkerFørTermin.Alenemor",values:{b:u=>e.jsx("b",{children:u})}})}):e.jsx(s,{children:e.jsx(n,{id:"HvaErMulig.TreUkerFørTermin",values:{b:u=>e.jsx("b",{children:u})}})})}),(t==="beggeHarRett"||A(t,r)||t==="kunSøker2HarRett")&&e.jsxs(s,{children:[e.jsx(n,{id:"HvaErMulig.SeksUkerEtterFødsel",values:{b:u=>e.jsx("b",{children:u})}}),p&&!o&&e.jsx(n,{id:"HvaErMulig.SeksUkerEtterFødsel.DeFørsteUkene"}),e.jsx(n,{id:"HvaErMulig.SeksUkerEtterFødsel.OfteFårFedre",values:{erFar:l,hvem:d}})]})]})]})]})};O.__docgenInfo={description:"",methods:[],displayName:"DetteKanIkkeEndres",props:{hvemPlanlegger:{required:!0,tsType:{name:"union",raw:"MorOgFar | MorOgMedmor | FarOgFar | Mor | Far",elements:[{name:"signature",type:"object",raw:`{
