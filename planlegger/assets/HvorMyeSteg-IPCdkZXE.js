import{j as e}from"./jsx-runtime-CLpGMVip.js";import{u as I,a as O,b as S,C as y,c as z}from"./usePlanleggerNavigator-CKryOGlE.js";import{P as G}from"./routes-Cyl7_Mgv.js";import{P as U}from"./PlanleggerStepPage-BOfr6ocB.js";import{u as K,R as W,b as V,S as Y}from"./StepButtonsHookForm-BTw_nADu.js";import{u as w,h as D,M as a,B as f,L as F,l as L,H as $,a as R}from"./VeiviserPage-DY1Z8xzE.js";import{b as J,c as Q,g as P}from"./HvemPlanleggerUtils-q6zNFmnu.js";import{u as X}from"./hvemHarRettUtils-KdS7VsWV.js";import"./index-CR__hKHy.js";import{n as q}from"./validation-DYlyn1BB.js";import{a as Z}from"./dateFormValidation-Ca8r884z.js";import{f as ee,a as m}from"./satserUtils-BlNYSW0R.js";import{c as T}from"./stringUtils-DApHD7Y2.js";import{V as g}from"./VStack-2apmvZh_.js";import{S as re,a as ne}from"./Wallet-CEpMmkt_.js";import{S as te}from"./Spacer-DmBY75Fg.js";const ae=/^\d+([,.]\d+)?$/,se=l=>ae.test(l.toString()),_=l=>r=>Z(r)||se(r)?null:l,b=({satser:l,lønnSøker:r,fornavn:n})=>{const t=w().locale,p=ee(l),i=6*p/12,h=i/21.67,o=80/100,v=(s,u)=>isNaN(s)?0:Math.round(Math.min(s,i)*u),d=(s,u)=>isNaN(s)?0:Math.round(Math.min(s*12/260,h)*u);return e.jsx(g,{gap:"4",children:e.jsx(D,{header:r<=i?e.jsx(a,{id:"HvorMyeSteg.VilFå",values:{hvem:T(n),utregning100:m(d(r,1),t),utregning80:m(d(r,o),t)}}):e.jsx(a,{id:"HvorMyeSteg.KanFå",values:{hvem:T(n),utregning100:m(d(r,1),t),utregning80:m(d(r,o),t)}}),color:"green",icon:e.jsx(re,{height:24,width:24,color:"#7F8900",fontSize:"1.5rem","aria-hidden":!0}),children:e.jsxs(g,{gap:"2",children:[e.jsx(f,{children:e.jsx(a,{id:"HvorMyeSteg.Utregning",values:{utregning100:m(v(r,1),t),utregning80:m(v(r,o),t)}})}),r>i&&e.jsxs(e.Fragment,{children:[e.jsx(f,{children:e.jsx(a,{id:"HvorMyeSteg.NAVDekker",values:{grunnbeløpet:m(p*6,t),a:s=>e.jsx(F,{href:L.grunnbeløpet,target:"_blank",rel:"noreferrer",className:"lenke",inlineText:!0,children:s})}})}),e.jsx(f,{children:e.jsx(a,{id:"HvorMyeSteg.BasertPåInntekt",values:{hvem:n}})})]})]})})})};b.__docgenInfo={description:"",methods:[],displayName:"Utbetaling",props:{satser:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    engangstønad: Array<{
        fom: string;
        verdi: number;
    }>;
