...
}`,signature:{properties:[{key:"familiehendelsedato",value:{name:"string",required:!0}},{key:"startdatoPeriode1",value:{name:"string",required:!0}},{key:"sluttdatoPeriode1",value:{name:"string",required:!0}},{key:"startdatoPeriode2",value:{name:"string",required:!1}},{key:"sluttdatoPeriode2",value:{name:"string",required:!1}}]}},description:""},fornavnSøker1:{required:!0,tsType:{name:"string"},description:""},fornavnSøker2:{required:!1,tsType:{name:"string"},description:""}}};const pe=r=>{const a=[];for(let t=0;t<=r.uker;t++){const n=r.uker-t>=t,s=n?r.dager:0,o=n?0:r.dager;a.push({antallUkerOgDagerSøker1:{uker:r.uker-t,dager:n?r.dager:0,totaltAntallDager:(r.uker-t)*5+s},antallUkerOgDagerSøker2:{uker:t,dager:n?0:r.dager,totaltAntallDager:t*5+o}})}return a},B=(r,a,t,n,s,o)=>{const d=t.type===Z.FAR_OG_FAR,i=d&&n?n:$(r,t),g=d&&s?s:ee(r,t);return a.antallUkerOgDagerSøker1.uker===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:g,uker:a.antallUkerOgDagerSøker2.uker,dager:a.antallUkerOgDagerSøker2.dager,erOversiktSteg:o}}):a.antallUkerOgDagerSøker2.uker===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:i,uker:a.antallUkerOgDagerSøker1.uker,dager:a.antallUkerOgDagerSøker1.dager,erOversiktSteg:o}}):e.jsx(l,{id:"FordelingSteg.FordelingOptions",values:{hvem:i,hvem2:g,uker:a.antallUkerOgDagerSøker1.uker,dagerS1:a.antallUkerOgDagerSøker1.dager,uker2:a.antallUkerOgDagerSøker2.uker,dagerS2:a.antallUkerOgDagerSøker2.dager,erOversiktSteg:o}})},ke=({stønadskontoer:r,locale:a})=>{const t=w(),n=H(a),s=G(),o=v(p.FORDELING),{dekningsgrad:d}=h(v(p.HVOR_LANG_PERIODE)),i=h(v(p.HVEM_PLANLEGGER)),g=h(v(p.ARBEIDSSITUASJON)),k=h(v(p.OM_BARNET)),S=U(p.FORDELING),j=L({defaultValues:o}),c=j.watch("antallDagerSøker1"),m=c?parseInt(c.toString(),10):void 0,F=f=>{S(f),n.goToNextDefaultStep()},u=r[d],y=ne(u),q=te(g),E=D(q,i,u,k,m),I=D(q,i,u,k,m),P=X(i,t),x=Y(i,t),{ref:C,scrollToBottom:N}=oe();return e.jsx(z,{ref:C,steps:s,goToStep:n.goToNextStep,children:e.jsx(V,{formMethods:j,onSubmit:F,shouldUseFlexbox:!0,children:e.jsxs(R,{gap:"10",style:{flex:1},children:[e.jsxs(R,{gap:"8",children:[e.jsx(W,{size:"medium",spacing:!0,level:"2",children:e.jsx(l,{id:"FordelingSteg.Tittel"})}),e.jsx(_,{header:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTittel"}),icon:e.jsx(me,{height:24,width:24,color:"#020C1CAD",fontSize:"1.5rem","aria-hidden":!0}),color:"gray",children:e.jsx(T,{children:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTekst",values:{uker:y.uker,dager:y.dager,prosent:d}})})}),e.jsx(ae,{isDarkBlue:o===void 0,children:e.jsx(K,{name:"antallDagerSøker1",label:e.jsx(l,{id:"FordelingSteg.FordelingTittel",values:{uker:y.uker,dager:y.dager}}),autofocusWhenEmpty:!0,validate:[se(t.formatMessage({id:"FordelingSteg.FordelingTittel.Required"}))],customErrorFormatter:re,onChange:N,children:pe(y).map(f=>e.jsx("option",{value:f.antallUkerOgDagerSøker1.totaltAntallDager,children:B(t,f,i,P,x)},f.antallUkerOgDagerSøker1.totaltAntallDager))})}),m!==void 0&&e.jsx(A,{barnet:k,hvemPlanlegger:i,fornavnSøker1:P,fornavnSøker2:x,uttaksdata:d===Q.HUNDRE_PROSENT?E:I},m)]}),e.jsx(ue,{}),e.jsx(J,{saveDataOnPreviousClick:S,goToPreviousStep:n.goToPreviousDefaultStep,useSimplifiedTexts:!0})]})})})};B.__docgenInfo={description:"",methods:[],displayName:"finnFellesperiodeFordelingOptionTekst"};ke.__docgenInfo={description:"",methods:[],displayName:"FordelingSteg",props:{stønadskontoer:{required:!0,tsType:{name:"signature",type:"object",raw:`{
