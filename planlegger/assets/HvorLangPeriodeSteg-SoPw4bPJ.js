...
| 'AKTIVITETSFRI_KVOTE'`,elements:[{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"},{name:"literal",value:"'AKTIVITETSFRI_KVOTE'"}],required:!0}}]}}],raw:"KontoDto[]",required:!0}},{key:"minsteretter",value:{name:"signature",type:"object",raw:`{
    ...
    uker: number;
    dager: number;
}`,signature:{properties:[{key:"uker",value:{name:"number",required:!0}},{key:"dager",value:{name:"number",required:!0}}]}},description:""}}};const Oe=({stønadskontoer:a})=>{const n=L(),t=Re(),u=Ee(),k=S(R.HVOR_LANG_PERIODE),s=A(S(R.HVEM_PLANLEGGER)),m=A(S(R.OM_BARNET)),o=A(S(R.ARBEIDSSITUASJON)),l=U(R.HVOR_LANG_PERIODE),E=U(R.FORDELING),d=me({defaultValues:k}),T=ee(s),j=re(m),c=_=>{l(_);const de=s.type===f.FAR_OG_FAR,N=o.status===M.JOBBER&&!!o.jobberAnnenPart&&!(de&&m.erFødsel)?h.FORDELING:h.PLANEN_DERES;return N===h.PLANEN_DERES&&E(void 0),t.goToNextStep(N)},y=d.watch("dekningsgrad")??k?.dekningsgrad,p=ae(o),O=Te(s,p,n),F=a[100],g=a[80],K=y?y==="100"?F:g:void 0,se=Z(p,s,F,m),oe=Z(p,s,g,m),b=Q(F),P=Q(g),ie=y==="100"?b:P,G=p==="kunSøker1HarRett"||p==="kunSøker2HarRett",{ref:ue,scrollToBottom:le}=qe();return e.jsx(be,{ref:ue,steps:u,goToStep:t.goToNextStep,children:e.jsx(pe,{formMethods:d,onSubmit:c,shouldUseFlexbox:!0,children:e.jsxs(v,{gap:"space-40",style:{flex:1},children:[e.jsxs(v,{gap:"space-32",children:[e.jsx(ve,{size:"medium",spacing:!0,level:"2",children:e.jsx(r,{id:"HvorLangPeriodeSteg.Tittel"})}),e.jsx(x,{header:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.HvorLangPeriodeTittel"}),icon:e.jsx(W,{height:24,width:24,color:"var(--ax-bg-neutral-strong)",fontSize:"1.5rem","aria-hidden":!0}),color:"gray",children:e.jsx(i,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.HvorLangPeriodeTekst",values:{beggeHarRett:p==="beggeHarRett",uker100:b.uker,dager100:b.dager,uker80:P.uker,dager80:P.dager}})})}),!T&&G&&s.type!==f.FAR_OG_FAR&&e.jsx(ne,{hvemPlanlegger:s,arbeidssituasjon:o}),G&&s.type===f.FAR_OG_FAR&&j&&e.jsx(x,{header:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.KunEnAvFedreneHarRett"}),color:"gray",children:e.jsxs(v,{gap:"space-8",children:[e.jsx(i,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.NårBareEnHarRett"})}),e.jsx(i,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.ManFårEnDel",values:{a:_=>e.jsx(I,{inlineText:!0,href:w.godkjentAktivitet,rel:"noreferrer",target:"_blank",children:_})}})})]})}),e.jsxs(Fe,{name:"dekningsgrad",control:d.control,label:e.jsx(r,{id:"HvorLangPeriodeSteg.HvorLangPeriode",values:{deSomHarRett:O}}),validate:[ke(n.formatMessage({id:"HvorLangPeriodeSteg.HvorLangPeriode.Required"},{deSomHarRett:O}))],onChange:le,children:[e.jsx(V,{value:"100",autoFocus:!0,children:e.jsx(r,{id:"HvorLangPeriodeSteg.100",values:{uker100:b.uker,dager100:b.dager}})}),e.jsx(V,{value:"80",children:e.jsx(r,{id:"HvorLangPeriodeSteg.80",values:{uker80:P.uker,dager80:P.dager}})})]}),K&&e.jsx(v,{gap:"space-8",children:e.jsx(te,{barnet:m,hvemPlanlegger:s,arbeidssituasjon:o,valgtStønadskonto:K,uttaksdata100:se,uttaksdata80:oe,valgtDekningsgrad:y,antallUkerOgDager:ie},y)})]}),e.jsx(ye,{}),e.jsx(ce,{saveDataOnPreviousClick:l,goToPreviousStep:t.goToPreviousDefaultStep,useSimplifiedTexts:!0})]})})})};Oe.__docgenInfo={description:"",methods:[],displayName:"HvorLangPeriodeSteg",props:{stønadskontoer:{required:!0,tsType:{name:"signature",type:"object",raw:"{ '100': KontoBeregningDto; '80': KontoBeregningDto }",signature:{properties:[{key:"100",value:{name:"signature",type:"object",raw:`{
    kontoer: KontoDto[];
    minsteretter: Minsteretter;
    tillegg?: Tillegg;
}`,signature:{properties:[{key:"kontoer",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
