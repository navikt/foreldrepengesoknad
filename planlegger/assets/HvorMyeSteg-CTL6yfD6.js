import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{u as E,a as L,b as S,C as v,c as B}from"./usePlanleggerNavigator-ZMC56twb.js";import{P as C}from"./routes-gnI_NAHe.js";import{P as I}from"./PlanleggerStepPage-dojmIxg0.js";import{u as O,R as z,b as A,S as G}from"./StepButtonsHookForm-CZkCCERP.js";import{u as w,M as a,B as y,H as U}from"./UttaksdagenString-CIHKv-n2.js";import{b as K,c as W,g as P}from"./HvemPlanleggerUtils-CRuekH12.js";import{u as Y}from"./hvemHarRettUtils-DaTWCV6h.js";import{d as N,L as V,l as D,B as R}from"./VeiviserPage-BSjOxTLZ.js";import"./index-CTjT7uj6.js";import{n as q}from"./validation-DdAZ_Aa2.js";import{a as J}from"./dateFormValidation-dNhenV-l.js";import{f as $,a as m}from"./satserUtils-D5KHvrMC.js";import{c as T}from"./stringUtils-BLFzASq_.js";import{V as g}from"./VStack-CL9KkpXr.js";import{S as Q,a as X}from"./Wallet-BVwe51Pq.js";import{S as Z}from"./Spacer-BW3tgveW.js";const ee=/^\d+([,.]\d+)?$/,re=o=>ee.test(o.toString()),_=o=>r=>J(r)||re(r)?null:o,b=({satser:o,lønnSøker:r,fornavn:n})=>{const t=w().locale,c=$(o),s=6*c/12,f=s/21.67,u=80/100,p=(i,l)=>Math.round(Math.min(i,s)*l),d=(i,l)=>Math.round(Math.min(i*12/260,f)*l);return e.jsx(g,{gap:"4",children:e.jsx(N,{header:r<=s?e.jsx(a,{id:"HvorMyeSteg.VilFå",values:{hvem:T(n),utregning100:m(d(r,1),t),utregning80:m(d(r,u),t)}}):e.jsx(a,{id:"HvorMyeSteg.KanFå",values:{hvem:T(n),utregning100:m(d(r,1),t),utregning80:m(d(r,u),t)}}),color:"green",icon:e.jsx(Q,{height:24,width:24,color:"#7F8900",fontSize:"1.5rem","aria-hidden":!0}),children:e.jsxs(g,{gap:"2",children:[e.jsx(y,{children:e.jsx(a,{id:"HvorMyeSteg.Utregning",values:{utregning100:m(p(r,1),t),utregning80:m(p(r,u),t)}})}),r>s&&e.jsxs(e.Fragment,{children:[e.jsx(y,{children:e.jsx(a,{id:"HvorMyeSteg.NAVDekker",values:{grunnbeløpet:m(c*6,t),a:i=>e.jsx(V,{href:D.grunnbeløpet,target:"_blank",rel:"noreferrer",className:"lenke",inlineText:!0,children:i})}})}),e.jsx(y,{children:e.jsx(a,{id:"HvorMyeSteg.BasertPåInntekt",values:{hvem:n}})})]})]})})})};b.__docgenInfo={description:"",methods:[],displayName:"Utbetaling",props:{satser:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    engangstønad: Array<{
        fom: string;
        verdi: number;
    }>;
