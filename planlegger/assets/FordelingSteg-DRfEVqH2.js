...
}`,signature:{properties:[{key:"familiehendelsedato",value:{name:"string",required:!0}},{key:"startdatoPeriode1",value:{name:"string",required:!0}},{key:"sluttdatoPeriode1",value:{name:"string",required:!0}},{key:"startdatoPeriode2",value:{name:"string",required:!1}},{key:"sluttdatoPeriode2",value:{name:"string",required:!1}}]}},description:""},fornavnSøker1:{required:!0,tsType:{name:"string"},description:""},fornavnSøker2:{required:!1,tsType:{name:"string"},description:""}}};const me=r=>{const t=[];for(let n=0;n<=r;n++)t.push({antallUkerSøker2:n,antallUkerSøker1:r-n});return t},w=(r,t,n,a,o,s)=>{const i=n.type===X.FAR_OG_FAR,u=i&&a?a:Y(r,n),d=i&&o?o:$(r,n);return t.antallUkerSøker1===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:d,uker:t.antallUkerSøker2,erOversiktSteg:s}}):t.antallUkerSøker2===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:u,uker:t.antallUkerSøker1,erOversiktSteg:s}}):e.jsx(l,{id:"FordelingSteg.FordelingOptions",values:{hvem:u,hvem2:d,uker:t.antallUkerSøker1,uker2:t.antallUkerSøker2,erOversiktSteg:s}})},ge=({stønadskontoer:r})=>{const t=R(),n=E(),a=U(),o=f(p.FORDELING),{dekningsgrad:s}=j(f(p.HVOR_LANG_PERIODE)),i=j(f(p.HVEM_PLANLEGGER)),u=j(f(p.ARBEIDSSITUASJON)),d=j(f(p.OM_BARNET)),v=C(p.FORDELING),F=V({defaultValues:o}),m=F.watch("antallUkerSøker1"),S=y=>{v(y),n.goToNextDefaultStep()},k=r[s],c=re(k),g=ee(u),D=O(g,i,k,d,m),I=O(g,i,k,d,m),P=K(i,t),q=Q(i,t),{ref:A,scrollToBottom:B}=te();return e.jsx(N,{ref:A,steps:a,children:e.jsx(Z,{formMethods:F,onSubmit:S,shouldUseFlexbox:!0,children:e.jsxs(T,{gap:"10",style:{flex:1},children:[e.jsxs(T,{gap:"8",children:[e.jsx(oe,{size:"medium",spacing:!0,level:"2",children:e.jsx(l,{id:"FordelingSteg.Tittel"})}),e.jsx(M,{header:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTittel"}),icon:e.jsx(ue,{height:24,width:24,color:"#020C1CAD",fontSize:"1.5rem","aria-hidden":!0}),isGray:!0,children:e.jsx(b,{children:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTekst"})})}),e.jsx(H,{isDarkGreen:o===void 0,children:e.jsx(L,{name:"antallUkerSøker1",label:e.jsx(l,{id:"FordelingSteg.FordelingTittel",values:{uker:c}}),autofocusWhenEmpty:!0,validate:[G(t.formatMessage({id:"FordelingSteg.FordelingTittel.Required"}))],customErrorFormatter:z,onChange:B,children:me(c).map(y=>e.jsx("option",{value:y.antallUkerSøker1,children:w(t,y,i,P,q)},y.antallUkerSøker1))})}),m!==void 0&&e.jsx(_,{barnet:d,hvemPlanlegger:i,fornavnSøker1:P,fornavnSøker2:q,uttaksdata:s===W.HUNDRE_PROSENT?D:I},m)]}),e.jsx(se,{}),e.jsx(J,{saveDataOnPreviousClick:v,goToPreviousStep:n.goToPreviousDefaultStep,useSimplifiedTexts:!0})]})})})};w.__docgenInfo={description:"",methods:[],displayName:"finnFellesperiodeFordelingOptionTekst"};ge.__docgenInfo={description:"",methods:[],displayName:"FordelingSteg",props:{stønadskontoer:{required:!0,tsType:{name:"signature",type:"object",raw:`{
