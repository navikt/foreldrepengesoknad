import{j as e,V as F}from"./VStack-1BYz4cx9.js";import{u as le,a as me,b as M,C as j,c as J}from"./usePlanleggerNavigator-CSXZAriH.js";import{P as O}from"./routes-Cp-2uEwO.js";import{B as ke}from"./BlueRadioGroup-HcwezNgf.js";import{P as pe}from"./PlanleggerStepPage-mJcSQXyF.js";import{u as ve,R as ye,a as Q,S as ce}from"./StepButtonsHookForm-CFhcz6Nn.js";import{u as I,M as r,B as u,H as je}from"./Label-xTGzdijQ.js";import{A as E}from"./Arbeidssituasjon-CIfsLvvg.js";import{D as y}from"./Dekningsgrad-Bg_cIyqc.js";import{f as A,a as H,e as N,b as ee,S as P,g as W,c as X,d as be}from"./HvemPlanleggerUtils-D1xsqW5u.js";import{b as re,e as fe}from"./barnetUtils-Dtg6gkcN.js";import{u as te}from"./hvemHarRettUtils-CqRnCsCY.js";import{f as w,a as Y,b as Z,c as $}from"./uttakUtils-IrxiEj86.js";import{d as h,L,l as B}from"./VeiviserPage-CkT1vu0n.js";import"./index-CTjT7uj6.js";import{u as Se,i as Re}from"./dateFormValidation-CUQTHxD6.js";import{n as D}from"./validation-4HO0J-zV.js";import{S as Pe}from"./PersonGroup-DhM52ZF8.js";import{S as ne}from"./Calendar-CYQP7Vnt.js";import{S as Fe}from"./Spacer-BW3tgveW.js";const ae=({hvemPlanlegger:t,arbeidssituasjon:n})=>{const a=I(),o=n.status===E.INGEN||n.status===E.UFØR,d=n.jobberAnnenPart===!1;return e.jsxs(h,{header:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.NårBareEnPartHarRett",values:{hvem:o?A(a,t):H(a,t)}}),icon:e.jsx(Pe,{height:24,width:24,color:"#020C1CAD",fontSize:"1.5rem","aria-hidden":!0}),color:"gray",children:[d&&e.jsxs(F,{gap:"2",children:[e.jsx(u,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.NårBareMorHarRett.FårHelePerioden",values:{hvem:H(a,t)}})}),e.jsx(u,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.NårBareMorHarRett.IngenKravTilFar",values:{hvem:A(a,t),hvem2:H(a,t)}})})]}),o&&e.jsxs(F,{gap:"2",children:[e.jsx(u,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.NårBareFarHarRett.KanFåhelePerioden",values:{hvem:A(a,t),hvem2:H(a,t)}})}),e.jsx(u,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.NårBareFarHarRett.IngenKravTilMor",values:{a:s=>e.jsx(L,{inlineText:!0,href:B.godkjentAktivitet,className:"lenke",rel:"noreferrer",target:"_blank",children:s}),hvem:A(a,t),erMorHovedsøker:N(t)}})})]})]})};ae.__docgenInfo={description:"",methods:[],displayName:"NårBareEnPartHarRettInfoboks",props:{hvemPlanlegger:{required:!0,tsType:{name:"union",raw:"MorOgFar | MorOgMedmor | FarOgFar | Mor | Far",elements:[{name:"signature",type:"object",raw:`{
    ...
    uker: number;
    dager: number;
}`,signature:{properties:[{key:"uker",value:{name:"number",required:!0}},{key:"dager",value:{name:"number",required:!0}}]}},description:""}}};const Te=({stønadskontoer:t})=>{const n=I(),a=le(),o=me(),d=M(j.HVOR_LANG_PERIODE),s=D(M(j.HVEM_PLANLEGGER)),l=D(M(j.OM_BARNET)),i=D(M(j.ARBEIDSSITUASJON)),g=J(j.HVOR_LANG_PERIODE),b=J(j.FORDELING),m=ve({defaultValues:d}),T=ee(s),c=re(l),f=_=>{g(_);const ge=s.type===P.FAR_OG_FAR,z=i.status===E.JOBBER&&!!i.jobberAnnenPart&&!(ge&&l.erFødsel)?O.FORDELING:O.PLANEN_DERES;return z===O.PLANEN_DERES&&b(void 0),a.goToNextStep(z)},k=m.watch("dekningsgrad")||(d==null?void 0:d.dekningsgrad),p=te(i),q=be(s,p,n),x=t[y.HUNDRE_PROSENT],v=t[y.ÅTTI_PROSENT],oe=k===y.HUNDRE_PROSENT?x:v,U=k?oe:void 0,C=w(p,s,x,l),K=w(p,s,v,l),S=$(C),R=$(K),ie=k===y.HUNDRE_PROSENT?S:R,V=p==="kunSøker1HarRett"||p==="kunSøker2HarRett",{ref:ue,scrollToBottom:de}=Se();return e.jsx(pe,{ref:ue,steps:o,goToStep:a.goToNextStep,children:e.jsx(ye,{formMethods:m,onSubmit:f,shouldUseFlexbox:!0,children:e.jsxs(F,{gap:"10",style:{flex:1},children:[e.jsxs(F,{gap:"8",children:[e.jsx(je,{size:"medium",spacing:!0,level:"2",children:e.jsx(r,{id:"HvorLangPeriodeSteg.Tittel"})}),e.jsx(h,{header:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.HvorLangPeriodeTittel"}),icon:e.jsx(ne,{height:24,width:24,color:"#020C1CAD",fontSize:"1.5rem","aria-hidden":!0}),color:"gray",children:e.jsx(u,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.HvorLangPeriodeTekst",values:{beggeHarRett:p==="beggeHarRett",uker100:S.uker,dager100:S.dager,uker80:R.uker,dager80:R.dager}})})}),!T&&V&&s.type!==P.FAR_OG_FAR&&e.jsx(ae,{hvemPlanlegger:s,arbeidssituasjon:i}),V&&s.type===P.FAR_OG_FAR&&c&&e.jsxs(h,{header:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.KunEnAvFedreneHarRett"}),color:"gray",children:[e.jsx(u,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.NårBareEnHarRett"})}),e.jsx(u,{children:e.jsx(r,{id:"HvorLangPeriodeSteg.Infoboks.ManFårEnDel",values:{a:_=>e.jsx(L,{inlineText:!0,href:B.godkjentAktivitet,className:"lenke",rel:"noreferrer",target:"_blank",children:_})}})})]}),e.jsxs(ke,{label:e.jsx(r,{id:"HvorLangPeriodeSteg.HvorLangPeriode",values:{deSomHarRett:q}}),name:"dekningsgrad",validate:[Re(n.formatMessage({id:"HvorLangPeriodeSteg.HvorLangPeriode.Required"},{deSomHarRett:q}))],onChange:de,children:[e.jsx(Q,{value:y.HUNDRE_PROSENT,autoFocus:!0,children:e.jsx(r,{id:"HvorLangPeriodeSteg.100",values:{uker100:S.uker,dager100:S.dager}})}),e.jsx(Q,{value:y.ÅTTI_PROSENT,children:e.jsx(r,{id:"HvorLangPeriodeSteg.80",values:{uker80:R.uker,dager80:R.dager}})})]}),U&&e.jsx(se,{barnet:l,hvemPlanlegger:s,arbeidssituasjon:i,valgtStønadskonto:U,uttaksdata100:C,uttaksdata80:K,valgtDekningsgrad:k,antallUkerOgDager:ie},k)]}),e.jsx(Fe,{}),e.jsx(ce,{saveDataOnPreviousClick:g,goToPreviousStep:a.goToPreviousDefaultStep,useSimplifiedTexts:!0})]})})})};Te.__docgenInfo={description:"",methods:[],displayName:"HvorLangPeriodeSteg",props:{stønadskontoer:{required:!0,tsType:{name:"signature",type:"object",raw:`{
