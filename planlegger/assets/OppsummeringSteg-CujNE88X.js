...
| 'AKTIVITETSFRI_KVOTE'`,elements:[{name:"literal",value:"'MØDREKVOTE'"},{name:"literal",value:"'FEDREKVOTE'"},{name:"literal",value:"'FELLESPERIODE'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FORELDREPENGER_FØR_FØDSEL'"},{name:"literal",value:"'AKTIVITETSFRI_KVOTE'"}],required:!0}},{key:"dager",value:{name:"number",required:!0}}]}}],raw:"KontoDto[]",required:!0}},{key:"minsteretter",value:{name:"signature",type:"object",raw:`{
    ...
    fom: string;
    verdi: number;
}>`,required:!0}}]}},description:""}}};const Ae=({valgtStønadskonto:r,hvorLangPeriode:s,hvemPlanlegger:a,barnet:n,arbeidssituasjon:t,fordeling:l})=>{const u=le(),o=ue(t),g=Qe(n),v=xe(r).totaltAntallDager,d=l?ee(l.antallDagerSøker1):void 0,b=l?ee(v-l.antallDagerSøker1):void 0,p=er(r),y=Ue(o,a)||Ye(o,a);let x;(a.type===_.MOR_OG_MEDMOR||a.type===_.MOR_OG_FAR)&&o==="kunSøker2HarRett"&&(x=ye(ye(g).denneEllerNeste()).leggTil(30));const w=Ce(a,o),j=rr({erDeltUttak:l!==void 0,famDato:g,tilgjengeligeStønadskontoer:r.kontoer,fellesperiodeDagerMor:l?.antallDagerSøker1,bareFarMedmorHarRett:y,erAdopsjon:re(n),erFarEllerMedmor:w,startdato:x,erMorUfør:t?.status===sr.UFØR,erAleneOmOmsorg:a.type===_.FAR||a.type===_.MOR,farOgFar:a.type===_.FAR_OG_FAR}),L=Fe(r),U=a.type===_.FAR_OG_FAR,A=N(a,u),W=je(A,u.locale),q=V(a,u),$=q?je(q,u.locale):void 0,J=$e(n),Z=h(O.UTTAKSPLAN),B=C(h(O.TILPASS_PLAN)),F=Z?.at(-1)??[],ge=l!==void 0,Se=nr(ge,F,w),Pe=ar(ge,F,w);return e.jsx(m,{gap:"space-40",children:e.jsxs(E,{"aria-label":"",onToggle:de("toggle-oppgitt-informasjon"),size:"small",children:[e.jsx(E.Header,{children:e.jsxs(P,{gap:"space-24",align:"center",wrap:!1,children:[e.jsx(G,{size:"medium",color:"lightBlue",children:e.jsx(He,{height:24,width:24,fontSize:"1.5rem","aria-hidden":!0})}),e.jsx(E.Title,{size:"small",children:e.jsx(i,{id:"PlanenDeresOppsummering.Tittel",values:{erAlenesøker:K(a)}})})]})}),e.jsx(E.Content,{children:e.jsxs(m,{gap:"space-20",children:[o==="beggeHarRett"&&!U&&q&&$&&e.jsxs(I,{children:[e.jsxs(m,{gap:"space-8",children:[e.jsx(c,{children:e.jsx(i,{id:"OppsummeringSteg.DereValgte",values:{prosent:s.dekningsgrad,antallUker:L.uker,antallDager:L.dager,hvem:N(a,u),hvem2:V(a,u),uker:d?.uker||0,dager:d?.dager||0,uker2:b?.uker||0,dager2:b?.dager||0}})}),e.jsx(c,{children:e.jsx(i,{id:"OppsummeringSteg.Periodene",values:{hvem:D(W),fom:u.formatDate(j.søker1[0].fom,{day:"2-digit",month:"short",year:"numeric"}),tom:u.formatDate(j.søker1.at(-1).tom,{day:"2-digit",month:"short",year:"numeric"}),b:Y=>e.jsx("b",{children:Y})}})})]}),e.jsx(c,{children:e.jsx(i,{id:"OppsummeringSteg.Periodene",values:{hvem:D($),fom:u.formatDate(j.søker2[0].fom,{day:"2-digit",month:"short",year:"numeric"}),tom:u.formatDate(j.søker2.at(-1).tom,{day:"2-digit",month:"short",year:"numeric"}),b:Y=>e.jsx("b",{children:Y})}})})]}),(K(a)||U)&&e.jsx(I,{children:e.jsxs(m,{gap:"space-8",children:[e.jsx(H,{children:e.jsx(i,{id:"OppsummeringSteg.DereValgteFedreEllerAlene",values:{prosent:s.dekningsgrad,erAlenesøker:K(a),antallUker:L.uker,antallDager:L.dager}})}),e.jsx(H,{children:e.jsx(i,{id:"OppsummeringSteg.Periode",values:{fom:u.formatDate(j.søker1[0].fom,{day:"2-digit",month:"short",year:"numeric"}),tom:u.formatDate(j.søker1.at(-1).tom,{day:"2-digit",month:"short",year:"numeric"}),b:Y=>e.jsx("b",{children:Y})}})})]})}),o==="kunSøker2HarRett"&&!U&&q&&e.jsx(I,{children:e.jsx(m,{gap:"space-8",children:e.jsx(H,{children:e.jsx(i,{id:"OppsummeringSteg.DereValgteAktivitetskrav",values:{uker1:p.uker,dager1:p.dager,uker2:Q(r).uker-p.uker,dager2:Q(r).dager-p.dager,hvem:A,prosent:s.dekningsgrad,antallUker:Q(r).uker,dager:Q(r).dager}})})})}),e.jsx(Ke,{bareFarMedmorHarRett:y,erFarEllerMedmor:w,harAktivitetskravIPeriodeUtenUttak:!1,søkersPerioder:B?Se:j.søker1,annenPartsPerioder:B?Pe:j.søker2,navnAnnenPart:"Test",barn:ze(n),planleggerLegend:e.jsx(tr,{hvemPlanlegger:a,barnet:n,hvemHarRett:o,uttaksplan:B?F:[...j.søker1,...j.søker2]}),barnehagestartdato:J})]})})]})})};Ae.__docgenInfo={description:"",methods:[],displayName:"OppsummeringHarRett",props:{valgtStønadskonto:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    kontoer: KontoDto[];
    minsteretter: Minsteretter;
    tillegg?: Tillegg;
}`,signature:{properties:[{key:"kontoer",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
