import{j as e}from"./jsx-runtime-CLpGMVip.js";import{u as P,d as g,H as v,M as n,m as s}from"./VeiviserPage-Pm5-jesK.js";import{k as h,l as b,f as c,b as f,e as R,a as _}from"./HvemPlanleggerUtils-DbrCtw8G.js";import{l as T}from"./amplitudeUtils-1CrV70-o.js";import{b as x}from"./barnetUtils-CtVkh5VN.js";import{u as H,a as A}from"./hvemHarRettUtils-C6pOvzBv.js";import"./index-CR__hKHy.js";import{H as S}from"./HvemPlanleggerType-CugjyLV2.js";import{H as m,V as q}from"./VStack-2apmvZh_.js";import{S as w}from"./PersonPregnant-D17zo54f.js";import{S as E}from"./BabyWrapped-DCZKpL80.js";import{S as G}from"./Briefcase-Dm7XPCF2.js";import{S as B,a as z}from"./PencilWriting-BJaABnDH.js";import{S as I}from"./PersonGroup-B--Zxy9X.js";import{E as y}from"./ExpansionCard-KP0XedL0.js";const O=({hvemPlanlegger:r,arbeidssituasjon:a})=>{const i=P(),l=h(r),o=b(r),d=c(i,r),t=H(a),p=t==="beggeHarRett"||t==="kunSøker1HarRett";return e.jsxs(m,{gap:"5",wrap:!1,children:[e.jsx("div",{children:e.jsx(g,{color:"lightBlue",size:"medium",children:e.jsx(w,{height:22,width:22,fontSize:"1.5rem",color:"#0067C5","aria-hidden":!0})})}),e.jsxs("div",{children:[e.jsx(v,{size:"small",children:e.jsx(n,{id:"HvaErMulig.KanIkkeEndres"})}),e.jsxs(q,{gap:"2",children:[!o&&t!=="kunSøker2HarRett"&&r.type!==S.FAR&&e.jsx(e.Fragment,{children:f(r)&&R(r)?e.jsx(s,{children:e.jsx(n,{id:"HvaErMulig.TreUkerFørTermin.Alenemor",values:{b:u=>e.jsx("b",{children:u})}})}):e.jsx(s,{children:e.jsx(n,{id:"HvaErMulig.TreUkerFørTermin",values:{b:u=>e.jsx("b",{children:u})}})})}),(t==="beggeHarRett"||A(t,r)||t==="kunSøker2HarRett")&&e.jsxs(s,{children:[e.jsx(n,{id:"HvaErMulig.SeksUkerEtterFødsel",values:{b:u=>e.jsx("b",{children:u})}}),p&&!o&&e.jsx(n,{id:"HvaErMulig.SeksUkerEtterFødsel.DeFørsteUkene"}),e.jsx(n,{id:"HvaErMulig.SeksUkerEtterFødsel.OfteFårFedre",values:{erFar:l,hvem:d}})]})]})]})]})};O.__docgenInfo={description:"",methods:[],displayName:"DetteKanIkkeEndres",props:{hvemPlanlegger:{required:!0,tsType:{name:"union",raw:"MorOgFar | MorOgMedmor | FarOgFar | Mor | Far",elements:[{name:"signature",type:"object",raw:`{
