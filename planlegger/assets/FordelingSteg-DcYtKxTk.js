...
}`,signature:{properties:[{key:"familiehendelsedato",value:{name:"string",required:!0}},{key:"startdatoPeriode1",value:{name:"string",required:!0}},{key:"sluttdatoPeriode1",value:{name:"string",required:!0}},{key:"startdatoPeriode2",value:{name:"string",required:!1}},{key:"sluttdatoPeriode2",value:{name:"string",required:!1}}]}},description:""},fornavnSøker1:{required:!0,tsType:{name:"string"},description:""},fornavnSøker2:{required:!1,tsType:{name:"string"},description:""}}};const pe=r=>{const t=[];for(let a=0;a<=r.uker;a++){const n=r.uker-a>=a,s=n?r.dager:0,o=n?0:r.dager;t.push({antallUkerOgDagerSøker1:{uker:r.uker-a,dager:n?r.dager:0,totaltAntallDager:(r.uker-a)*5+s},antallUkerOgDagerSøker2:{uker:a,dager:n?0:r.dager,totaltAntallDager:a*5+o}})}return t},M=(r,t,a,n,s,o)=>{const i=a.type===ae.FAR_OG_FAR,g=i&&n?n:ne(r,a),d=i&&s?s:oe(r,a);return t.antallUkerOgDagerSøker1.uker===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:d,uker:t.antallUkerOgDagerSøker2.uker,dager:t.antallUkerOgDagerSøker2.dager,erOversiktSteg:o}}):t.antallUkerOgDagerSøker2.uker===0?e.jsx(l,{id:"FordelingSteg.FordelingOptionAlt",values:{hvem:g,uker:t.antallUkerOgDagerSøker1.uker,dager:t.antallUkerOgDagerSøker1.dager,erOversiktSteg:o}}):e.jsx(l,{id:"FordelingSteg.FordelingOptions",values:{hvem:g,hvem2:d,uker:t.antallUkerOgDagerSøker1.uker,dagerS1:t.antallUkerOgDagerSøker1.dager,uker2:t.antallUkerOgDagerSøker2.uker,dagerS2:t.antallUkerOgDagerSøker2.dager,erOversiktSteg:o}})},ke=({stønadskontoer:r})=>{const t=q(),a=Y(),n=Z(),s=F(c.FORDELING),{dekningsgrad:o}=b(F(c.HVOR_LANG_PERIODE)),i=b(F(c.HVEM_PLANLEGGER)),g=b(F(c.ARBEIDSSITUASJON)),d=b(F(c.OM_BARNET)),f=$(c.FORDELING),v=G({defaultValues:s}),E=v.watch("antallDagerSøker1"),m=E?Number.parseInt(E.toString(),10):void 0,R=y=>{f(y),a.goToNextDefaultStep()},p=r[o],u=ie(p),h=le(g),w=x(h,i,p,d,m),A=x(h,i,p,d,m),P=re(i,t),O=te(i,t),{ref:B,scrollToBottom:H}=ue();return e.jsx(Q,{ref:B,steps:n,goToStep:a.goToNextStep,children:e.jsx(N,{formMethods:v,onSubmit:R,shouldUseFlexbox:!0,children:e.jsxs(j,{gap:"space-40",style:{flex:1},children:[e.jsxs(j,{gap:"space-32",children:[e.jsx(U,{size:"medium",spacing:!0,level:"2",children:e.jsx(l,{id:"FordelingSteg.Tittel"})}),e.jsx(_,{header:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTittel"}),icon:e.jsx(me,{height:24,width:24,color:"var(--ax-bg-neutral-strong)",fontSize:"1.5rem","aria-hidden":!0}),color:"gray",children:e.jsx(k,{children:e.jsx(l,{id:"FordelingSteg.Infoboks.HvordanFordeleTekst",values:{uker:u.uker,dager:u.dager,prosent:o}})})}),e.jsx(C,{isDarkBlue:s===void 0,children:e.jsx(z,{name:"antallDagerSøker1",control:v.control,label:e.jsx(l,{id:"FordelingSteg.FordelingTittel",values:{uker:u.uker,dager:u.dager}}),autofocusWhenEmpty:!0,validate:[J(t.formatMessage({id:"FordelingSteg.FordelingTittel.Required"}))],customErrorFormatter:se,onChange:H,children:pe(u).map(y=>e.jsx("option",{value:y.antallUkerOgDagerSøker1.totaltAntallDager,children:M(t,y,i,P,O)},y.antallUkerOgDagerSøker1.totaltAntallDager))})}),m!==void 0&&e.jsx(I,{barnet:d,hvemPlanlegger:i,fornavnSøker1:P,fornavnSøker2:O,uttaksdata:o==="100"?w:A},m)]}),e.jsx(W,{}),e.jsx(X,{saveDataOnPreviousClick:f,goToPreviousStep:a.goToPreviousDefaultStep,useSimplifiedTexts:!0})]})})})};M.__docgenInfo={description:"",methods:[],displayName:"finnFellesperiodeFordelingOptionTekst"};ke.__docgenInfo={description:"",methods:[],displayName:"FordelingSteg",props:{stønadskontoer:{required:!0,tsType:{name:"signature",type:"object",raw:"{ '100': KontoBeregningDto; '80': KontoBeregningDto }",signature:{properties:[{key:"100",value:{name:"signature",type:"object",raw:`{
    kontoer: KontoDto[];
