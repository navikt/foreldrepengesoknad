import{ai as I,j as e,a3 as g,a2 as T,a4 as x,Y as n,a6 as w,a7 as D,a5 as A,aa as C,ab as R,Z as O,_ as z,ac as G,af as V,ag as P,ae as U}from"./iframe-gHXU7Rrw.js";import{c as K,e as Y,u as h,C as y,f as W}from"./usePlanleggerNavigator-CRGxsD_E.js";import{P as $}from"./routes-Cyl7_Mgv.js";import{P as J}from"./PlanleggerStepPage-B7Eleq4g.js";import{e as Z,g as Q,a as _}from"./HvemPlanleggerUtils-CYYnqd9w.js";import{u as X}from"./hvemHarRettUtils-CaHg86U9.js";import{u as ee}from"./useScrollBehaviour-CSDWWSTT.js";import{a as re,f as l}from"./satserUtils-4XgPU_mc.js";import{S as ne,a as te}from"./Wallet-Nd69rnbp.js";import{S as ae}from"./Spacer-LdL95rx3.js";const se=/^\d+([,.]\d+)?$/,ie=i=>se.test(i.toString()),q=i=>r=>I(r)||ie(r)?null:i,S=({satser:i,lønnSøker:r,fornavn:u})=>{const p=re(i),a=6*p/12,f=a/21.67,s=80/100,v=(t,o)=>Number.isNaN(t)?0:Math.round(Math.min(t,a)*o),m=(t,o)=>Number.isNaN(t)?0:Math.round(Math.min(t*12/260,f)*o);return e.jsx(g,{gap:"space-16",children:e.jsx(T,{header:r<=a?e.jsx(n,{id:"HvorMyeSteg.VilFå",values:{hvem:A(u),utregning100:l(m(r,1)),utregning80:l(m(r,s))}}):e.jsx(n,{id:"HvorMyeSteg.KanFå",values:{hvem:A(u),utregning100:l(m(r,1)),utregning80:l(m(r,s))}}),color:"green",icon:e.jsx(ne,{height:24,width:24,color:"var(--ax-bg-success-strong)",fontSize:"1.5rem","aria-hidden":!0}),children:e.jsxs(g,{gap:"space-8",children:[e.jsx(x,{children:e.jsx(n,{id:"HvorMyeSteg.Utregning",values:{utregning100:l(v(r,1)),utregning80:l(v(r,s))}})}),r>a&&e.jsxs(e.Fragment,{children:[e.jsx(x,{children:e.jsx(n,{id:"HvorMyeSteg.NAVDekker",values:{grunnbeløpet:l(p*6),a:t=>e.jsx(w,{href:D.grunnbeløpet,target:"_blank",rel:"noreferrer",inlineText:!0,children:t})}})}),e.jsx(x,{children:e.jsx(n,{id:"HvorMyeSteg.BasertPåInntekt",values:{hvem:u}})})]})]})})})};S.__docgenInfo={description:"",methods:[],displayName:"Utbetaling",props:{satser:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    engangstønad: Array<{
        fom: string;
        verdi: number;
    }>;
