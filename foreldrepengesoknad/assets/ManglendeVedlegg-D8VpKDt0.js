import{j as a}from"./jsx-runtime-Cw0GR0a5.js";import{u as L,C as f,a as Ve}from"./FpDataContext-BUlrLNeW.js";import{A as F,g as we,a as Be,u as Je,o as xe,p as Ye}from"./useFpNavigator-BqBK4xBk.js";import{h as Se,u as ze,R as He,S as Ce}from"./ErrorSummaryHookForm-CTShVdi1.js";import{u as E,a as ge,B as N,M as T,H as $e}from"./Label-Da2udS5t.js";import{G as b,D as Qe,g as We,p as Xe}from"./barnUtils-CKoy89tS.js";import{I as Te,S as n,a as S,A as D,g as Ze}from"./uttaksplanInfoUtils-D1gWXJkx.js";import{aV as _e,M as en,aW as nn,ad as rn,f as an,g as tn,Q as mn,Y as sn,aI as un,aJ as dn,aK as ln,aL as on,aM as kn,aX as pn,aY as En,aZ as yn,a_ as Sn,a$ as gn,b0 as Tn,b1 as _n,b2 as An,b3 as On,b4 as Rn,b5 as cn,b6 as jn,b7 as vn,b8 as Nn,b9 as In,ba as fn,bb as Ln,bc as Mn,n as U,aT as Dn,bd as Kn,b as qn,A as hn}from"./Uttaksplan-CANcJHv6.js";import{G as Ee,d as ye,b as Gn}from"./UttaksdagenString-BBvBeCjL.js";import{r as Ae}from"./index-CTjT7uj6.js";import{g as bn}from"./guid-CsArkN6i.js";import{k as Un}from"./index-D0Djxy9a.js";import{V as B}from"./VStack-DPZ5Pzm1.js";const Oe=(e,r)=>async t=>{const m=new FormData;m.append("id",t.id),m.append("vedlegg",t.file,t.filename);const i=await Un.post(`${e}/rest/storage/${r}/vedlegg`,{body:m});return{headers:{location:i.headers.get("Location")},data:await i.text()}},Fn=()=>"V".concat(bn().replace(/-/g,"")),Pn=(e,r,t,m,i)=>({id:Fn(),file:e,filename:e.name,filesize:e.size,uploaded:!1,pending:!1,type:r,skjemanummer:t,innsendingsType:m,dokumenterer:i}),Re=(e,r,t)=>Pn({name:"",size:""},e,r,Te.SEND_SENERE,t),P=(e,r)=>({...e,dokumenterer:r}),ce=(e,r)=>e.map((t,m)=>{const i=t.tom?Ee(t.tom):r.formatMessage({id:"VedleggUploader.pågående"}),s=`${Ee(t.fom)}-${i}`;return e.length===1||m===e.length-1?s:m<e.length-2?`${s}, `:`${s} ${r.formatMessage({id:"VedleggUploader.Og"})} `}).join(""),q=({attachments:e,updateAttachments:r,skjemanummer:t,labelText:m,description:i,attachmentType:s,metadataType:d,perioder:u})=>{const{watch:k}=Se(),_=k(t);return Ae.useEffect(()=>{if(_.length===0){const l=Re(s,t),o=P(l,{type:d,perioder:u});r([o])}},[r,_,s,t,d]),a.jsx(_e,{label:m,description:i,attachmentType:s,skjemanummer:t,existingAttachments:e,updateAttachments:l=>{const o=l.map(M=>P(M,{type:d,perioder:u}));r(o)},saveAttachment:Oe("./","foreldrepenger")})};q.__docgenInfo={description:"",methods:[],displayName:"VedleggUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},name:"skjemanummer"}],return:{name:"signature",type:"function",raw:"(attachments: Attachment[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    perioder?: AttachmentMetadataTidsperiode[];
    arbeidsforhold?: any;
}`,signature:{properties:[{key:"type",value:{name:"AttachmentMetadataType",required:!0}},{key:"perioder",value:{name:"Array",elements:[{name:"AttachmentMetadataTidsperiode"}],raw:"AttachmentMetadataTidsperiode[]",required:!1}},{key:"arbeidsforhold",value:{name:"any",required:!1}}]},required:!1}},{key:"id",value:{name:"string",required:!0}},{key:"filename",value:{name:"string",required:!0}},{key:"filesize",value:{name:"number",required:!0}},{key:"file",value:{name:"File",required:!0}},{key:"url",value:{name:"string",required:!1}},{key:"uuid",value:{name:"string",required:!1}},{key:"pending",value:{name:"boolean",required:!0}},{key:"uploaded",value:{name:"boolean",required:!0}},{key:"type",value:{name:"AttachmentType",required:!0}},{key:"skjemanummer",value:{name:"Skjemanummer",required:!0}},{key:"innsendingsType",value:{name:"InnsendingsType",required:!1}},{key:"error",value:{name:"any",required:!1}},{key:"beskrivelse",value:{name:"string",required:!1}}]}}],raw:"Attachment[]"},name:"attachments"}],return:{name:"void"}}}}},description:""},annenForelder:{required:!0,tsType:{name:"union",raw:"AnnenForelderIkkeOppgitt | AnnenForelderOppgitt",elements:[{name:"Common"},{name:"AnnenForelderOppgitt"}]},description:""}}};const A=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:i,termindato:s,situasjon:d,skjemanummer:u,labelText:k,description:_,attachmentType:l})=>{const o=Gn("periode-attachment-uploader"),{watch:M}=Se(),h=M(u);return Ae.useEffect(()=>{if(h.length===0){const I=Re(l,u),G=P(I,{type:D.UTTAK,perioder:t.map(K=>({fom:b(K.tidsperiode.fom),tom:b(K.tidsperiode.tom)}))});r([G])}},[r,t,h,l,u]),a.jsx(_e,{label:k,description:a.jsxs(a.Fragment,{children:[a.jsx(ge,{children:_}),t.map(I=>a.jsx("div",{className:o.block,children:a.jsx(nn,{periode:I,erAleneOmOmsorg:!1,erFarEllerMedmor:!0,navnPåForeldre:m,familiehendelsesdato:ye(i).toDate(),termindato:s?ye(s).toDate():void 0,situasjon:d,melding:void 0})},I.id))]}),attachmentType:l,skjemanummer:u,existingAttachments:e,updateAttachments:I=>{const G=I.map(K=>P(K,{type:D.UTTAK,perioder:t.map(O=>({fom:b(O.tidsperiode.fom),tom:b(O.tidsperiode.tom)}))}));return r(G)},saveAttachment:Oe("./","foreldrepenger")})};A.__docgenInfo={description:"",methods:[],displayName:"UttakUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
...
| PeriodeUtenUttakUtsettelse
| PeriodeUtenUttak
| InfoPeriode`,elements:[{name:"union",raw:"UttaksperiodeBase | ForeldrepengerFørFødselUttaksperiode",elements:[{name:"UttaksperiodeBase"},{name:"ForeldrepengerFørFødselUttaksperiode"}]},{name:"Utsettelsesperiode"},{name:"Oppholdsperiode"},{name:"Overføringsperiode"},{name:"PeriodeHull"},{name:"PeriodeUtenUttakUtsettelse"},{name:"PeriodeUtenUttak"},{name:"union",raw:"AvslåttPeriode | UttakAnnenPartInfoPeriode | UtsettelseAnnenPartInfoPeriode",elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Ne=({attachments:e,updateAttachments:r,arbeidsforholdOgInntekt:t,andreInntektskilder:m})=>{const i=E();if(!t||t&&t.harHattAndreInntektskilder===!1||!m||!m.some(d=>d.type===F.SLUTTPAKKE))return null;const s=m.filter(d=>d.type===F.SLUTTPAKKE);return a.jsx(q,{attachments:e,updateAttachments:r(n.ETTERLØNN_ELLER_SLUTTVEDERLAG),skjemanummer:n.ETTERLØNN_ELLER_SLUTTVEDERLAG,labelText:i.formatMessage({id:"manglendeVedlegg.etterlønn.tittel"},{perioder:ce(s,i),antallPerioder:s.length}),description:i.formatMessage({id:"manglendeVedlegg.etterlønn.description"}),attachmentType:S.ANNEN_INNTEKT,metadataType:D.OPPTJENING,perioder:s})};Ne.__docgenInfo={description:"",methods:[],displayName:"EtterlønnEllerSluttvederlagDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
...
| PeriodeUtenUttakUtsettelse
| PeriodeUtenUttak
| InfoPeriode`,elements:[{name:"union",raw:"UttaksperiodeBase | ForeldrepengerFørFødselUttaksperiode",elements:[{name:"UttaksperiodeBase"},{name:"ForeldrepengerFørFødselUttaksperiode"}]},{name:"Utsettelsesperiode"},{name:"Oppholdsperiode"},{name:"Overføringsperiode"},{name:"PeriodeHull"},{name:"PeriodeUtenUttakUtsettelse"},{name:"PeriodeUtenUttak"},{name:"union",raw:"AvslåttPeriode | UttakAnnenPartInfoPeriode | UtsettelseAnnenPartInfoPeriode",elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const Le=({attachments:e,updateAttachments:r,arbeidsforholdOgInntekt:t,andreInntektskilder:m})=>{const i=E();if(!t||t&&!t.harHattAndreInntektskilder||!m||!m.some(d=>d.type===F.MILITÆRTJENESTE))return null;const s=m.filter(d=>d.type===F.MILITÆRTJENESTE);return a.jsx(q,{attachments:e,updateAttachments:r(n.DOK_MILITÆR_SILVIL_TJENESTE),skjemanummer:n.DOK_MILITÆR_SILVIL_TJENESTE,labelText:i.formatMessage({id:"manglendeVedlegg.militær.tittel"},{perioder:ce(s,i),antallPerioder:s.length}),description:i.formatMessage({id:"manglendeVedlegg.militær.description"}),attachmentType:S.ANNEN_INNTEKT,metadataType:D.OPPTJENING,perioder:s})};Le.__docgenInfo={description:"",methods:[],displayName:"MilitærEllerSiviltjenesteDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
...
| PeriodeUtenUttakUtsettelse
| PeriodeUtenUttak
| InfoPeriode`,elements:[{name:"union",raw:"UttaksperiodeBase | ForeldrepengerFørFødselUttaksperiode",elements:[{name:"UttaksperiodeBase"},{name:"ForeldrepengerFørFødselUttaksperiode"}]},{name:"Utsettelsesperiode"},{name:"Oppholdsperiode"},{name:"Overføringsperiode"},{name:"PeriodeHull"},{name:"PeriodeUtenUttakUtsettelse"},{name:"PeriodeUtenUttak"},{name:"union",raw:"AvslåttPeriode | UttakAnnenPartInfoPeriode | UtsettelseAnnenPartInfoPeriode",elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Ue=({attachments:e,updateAttachments:r,søkersituasjon:t})=>{const m=E();return t.situasjon!=="adopsjon"?null:a.jsx(q,{attachments:e,updateAttachments:r(n.OMSORGSOVERTAKELSE),skjemanummer:n.OMSORGSOVERTAKELSE,labelText:m.formatMessage({id:"manglendeVedlegg.omsorgsovertakelse.tittel"}),description:m.formatMessage({id:"manglendeVedlegg.omsorgsovertakelse.description"}),attachmentType:S.OMSORGSOVERTAKELSE,metadataType:D.BARN})};Ue.__docgenInfo={description:"",methods:[],displayName:"OmsorgsovertakelseDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
...
}`,signature:{properties:[{key:"arbeidsgiverNavn",value:{name:"string",required:!0}},{key:"arbeidsgiverId",value:{name:"string",required:!0}},{key:"arbeidsgiverIdType",value:{name:"string",required:!0}},{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!1}},{key:"stillingsprosent",value:{name:"number",required:!0}}]}}],raw:"Arbeidsforhold[]"},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const wn=e=>un(e)||dn(e)||ln(e)||on(e)||kn(e)||pn(e),Bn=e=>En(e)||yn(e)||Sn(e)||gn(e)||Tn(e),Jn=e=>_n(e),xn=e=>An(e),Yn=e=>On(e)||Rn(e),zn=e=>cn(e)||jn(e),Hn=e=>vn(e)||Nn(e),Cn=e=>In(e)||fn(e),$n=e=>Ln(e)||Mn(e),Qn=e=>{const r=e[n.OMSORGSOVERTAKELSE]?e[n.OMSORGSOVERTAKELSE]:[];return g(r)},Wn=e=>{const r=e[n.DOK_AV_ALENEOMSORG]?e[n.DOK_AV_ALENEOMSORG]:[];return g(r)},Xn=e=>{const r=e[n.TERMINBEKREFTELSE]?e[n.TERMINBEKREFTELSE]:[];return g(r)},Zn=e=>{const r=e[n.DOK_MILITÆR_SILVIL_TJENESTE]?e[n.DOK_MILITÆR_SILVIL_TJENESTE]:[];return g(r)},er=e=>{const r=e[n.ETTERLØNN_ELLER_SLUTTVEDERLAG]?e[n.ETTERLØNN_ELLER_SLUTTVEDERLAG]:[];return g(r)},nr=e=>{const r=e[n.DOK_INNLEGGELSE_MOR]?e[n.DOK_INNLEGGELSE_MOR]:[];return g(r)},rr=e=>{const r=e[n.DOK_SYKDOM_MOR]?e[n.DOK_SYKDOM_MOR]:[];return g(r)},ar=e=>{const r=e[n.DOK_INNLEGGELSE_FAR]?e[n.DOK_INNLEGGELSE_FAR]:[];return g(r)},tr=e=>{const r=e[n.DOK_SYKDOM_FAR]?e[n.DOK_SYKDOM_FAR]:[];return g(r)},mr=e=>{const r=e[n.DOK_INNLEGGELSE_BARN]?e[n.DOK_INNLEGGELSE_BARN]:[];return g(r)},ir=e=>{const r=e[n.DOK_UTDANNING_MOR]?e[n.DOK_UTDANNING_MOR]:[];return g(r)},sr=e=>{const r=e[n.DOK_ARBEID_MOR]?e[n.DOK_ARBEID_MOR]:[];return g(r)},ur=e=>{const r=e[n.DOK_UTDANNING_OG_ARBEID_MOR]?e[n.DOK_UTDANNING_OG_ARBEID_MOR]:[];return g(r)},dr=e=>{const r=e[n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]?e[n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:[];return g(r)},lr=e=>{const r=e[n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]?e[n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:[];return g(r)},or=e=>e.innsendingsType===Te.SEND_SENERE,g=e=>e.filter(r=>!or(r)),kr=({mellomlagreSøknadOgNaviger:e,avbrytSøknad:r,søkerInfo:t,erEndringssøknad:m})=>{const i=E(),s=Be(t.arbeidsforhold,e,m),d=Je(t.arbeidsforhold,m),u=U(L(f.UTTAKSPLAN)),k=U(L(f.ANNEN_FORELDER)),_=U(L(f.OM_BARNET)),l=U(L(f.SØKERSITUASJON)),o=L(f.VEDLEGG)||{},M=L(f.UTTAKSPLAN_METADATA),h=L(f.ARBEIDSFORHOLD_OG_INNTEKT),I=L(f.ANDRE_INNTEKTSKILDER),G=Ve(f.VEDLEGG),K=Ze(u,M==null?void 0:M.perioderSomSkalSendesInn,m),O=xe(l.rolle),R=Dn(K,O,k),J=nr(o),x=rr(o),Y=ar(o),z=tr(o),H=mr(o),C=ir(o),$=sr(o),Q=ur(o),W=dr(o),X=lr(o),Z=Wn(o),ee=Xn(o),ne=Qn(o),re=Zn(o),ae=er(o),te=R.filter(wn),me=R.filter(Kn),ie=R.filter(xn),se=R.filter(Jn),ue=R.filter(Bn),de=R.filter(Cn),le=R.filter(zn),oe=R.filter(Hn),ke=R.filter($n),pe=R.filter(Yn),c=Ye(t.søker,k,O,i),j=We(_),v=Xe(_),Pe=p=>{const w={...o,[n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:ke.length?p[n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:[],[n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:de.length>0?p[n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:[],[n.DOK_INNLEGGELSE_MOR]:te.length>0?p[n.DOK_INNLEGGELSE_MOR]:[],[n.DOK_INNLEGGELSE_BARN]:me.length>0?p[n.DOK_INNLEGGELSE_BARN]:[],[n.DOK_INNLEGGELSE_FAR]:se.length>0?p[n.DOK_INNLEGGELSE_FAR]:[],[n.DOK_SYKDOM_MOR]:ue.length>0?p[n.DOK_SYKDOM_MOR]:[],[n.DOK_SYKDOM_FAR]:ie.length>0?p[n.DOK_SYKDOM_FAR]:[],[n.DOK_UTDANNING_MOR]:pe.length>0?p[n.DOK_UTDANNING_MOR]:[],[n.DOK_UTDANNING_OG_ARBEID_MOR]:oe.length>0?p[n.DOK_UTDANNING_OG_ARBEID_MOR]:[],[n.DOK_ARBEID_MOR]:le.length>0?p[n.DOK_ARBEID_MOR]:[],[n.DOK_AV_ALENEOMSORG]:p[n.DOK_AV_ALENEOMSORG]||[],[n.TERMINBEKREFTELSE]:p[n.TERMINBEKREFTELSE]||[],[n.OMSORGSOVERTAKELSE]:p[n.OMSORGSOVERTAKELSE]||[],[n.DOK_MILITÆR_SILVIL_TJENESTE]:p[n.DOK_MILITÆR_SILVIL_TJENESTE]||[],[n.ETTERLØNN_ELLER_SLUTTVEDERLAG]:p[n.ETTERLØNN_ELLER_SLUTTVEDERLAG]||[]};return G(w),s.goToNextDefaultStep()},V=ze({defaultValues:{[n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:X,[n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:W,[n.DOK_INNLEGGELSE_MOR]:J,[n.DOK_INNLEGGELSE_BARN]:H,[n.DOK_INNLEGGELSE_FAR]:Y,[n.DOK_SYKDOM_FAR]:z,[n.DOK_SYKDOM_MOR]:x,[n.DOK_UTDANNING_MOR]:C,[n.DOK_UTDANNING_OG_ARBEID_MOR]:Q,[n.DOK_ARBEID_MOR]:$,[n.DOK_AV_ALENEOMSORG]:Z,[n.TERMINBEKREFTELSE]:ee,[n.OMSORGSOVERTAKELSE]:ne,[n.DOK_MILITÆR_SILVIL_TJENESTE]:re,[n.ETTERLØNN_ELLER_SLUTTVEDERLAG]:ae}}),y=p=>w=>{V.setValue(p,w,{shouldDirty:!0,shouldTouch:!0}),V.clearErrors(p)};return a.jsx(qn,{bannerTitle:i.formatMessage({id:"søknad.pageheading"}),onCancel:r,onContinueLater:s.fortsettSøknadSenere,steps:d,noFieldsRequired:!0,children:a.jsx(He,{formMethods:V,onSubmit:Pe,children:a.jsxs(B,{gap:"10",children:[a.jsx(De,{attachments:J,familiehendelsesdato:j,navnPåForeldre:c,perioder:te,situasjon:l.situasjon,termindato:v,updateAttachments:y,erFarEllerMedmor:O}),a.jsx(Me,{attachments:x,familiehendelsesdato:j,navnPåForeldre:c,perioder:ue,situasjon:l.situasjon,termindato:v,updateAttachments:y,erFarEllerMedmor:O}),a.jsx(fe,{attachments:Y,familiehendelsesdato:j,navnPåForeldre:c,perioder:se,situasjon:l.situasjon,termindato:v,updateAttachments:y,erFarEllerMedmor:O}),a.jsx(Ie,{attachments:z,familiehendelsesdato:j,navnPåForeldre:c,perioder:ie,situasjon:l.situasjon,termindato:v,updateAttachments:y,erFarEllerMedmor:O}),a.jsx(ve,{attachments:H,familiehendelsesdato:j,navnPåForeldre:c,perioder:me,situasjon:l.situasjon,termindato:v,updateAttachments:y}),a.jsx(be,{attachments:C,familiehendelsesdato:j,navnPåForeldre:c,perioder:pe,situasjon:l.situasjon,termindato:v,updateAttachments:y}),a.jsx(qe,{attachments:$,familiehendelsesdato:j,navnPåForeldre:c,perioder:le,situasjon:l.situasjon,termindato:v,updateAttachments:y}),a.jsx(he,{attachments:Q,familiehendelsesdato:j,navnPåForeldre:c,perioder:oe,situasjon:l.situasjon,termindato:v,updateAttachments:y}),a.jsx(Ke,{attachments:W,familiehendelsesdato:j,navnPåForeldre:c,perioder:de,situasjon:l.situasjon,termindato:v,updateAttachments:y}),a.jsx(Ge,{attachments:X,familiehendelsesdato:j,navnPåForeldre:c,perioder:ke,situasjon:l.situasjon,termindato:v,updateAttachments:y}),a.jsx(je,{attachments:Z,updateAttachments:y,annenForelder:k}),a.jsx(Fe,{attachments:ee,updateAttachments:y,barn:_,arbeidsforhold:t.arbeidsforhold,erFarEllerMedmor:O}),a.jsx(Ue,{attachments:ne,updateAttachments:y,søkersituasjon:l}),a.jsx(Ne,{attachments:ae,updateAttachments:y,arbeidsforholdOgInntekt:h,andreInntektskilder:I}),a.jsx(Le,{attachments:re,updateAttachments:y,arbeidsforholdOgInntekt:h,andreInntektskilder:I}),a.jsxs(hn,{size:"small",variant:"info",children:[a.jsx($e,{level:"2",size:"small",children:a.jsx(T,{id:"manglendeVedlegg.duKanSende.tittel"})}),a.jsx(ge,{children:a.jsx(T,{id:"manglendeVedlegg.duKanSende.innhold"})})]}),a.jsx(Ce,{goToPreviousStep:s.goToPreviousDefaultStep})]})})})};kr.__docgenInfo={description:"",methods:[],displayName:"ManglendeVedlegg",props:{søkerInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    søker: Søker;
