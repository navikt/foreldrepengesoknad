import{Z as K,aX as H,_ as s,aY as x,aZ as J,a_ as b,a1 as _,J as E,a$ as c,U as Y,k as $,b0 as C,r as z,b1 as Z,ar as W,b2 as X,$ as F,b3 as Q,b4 as ee,b5 as ae,a0 as re,b6 as ne,a5 as P,a6 as te,a7 as le}from"./iframe-C5Ws742i.js";import{e as M,C as d}from"./FpDataContext-DYBtSZYw.js";import{n as ie,b as se,S as G}from"./useFpNavigator-CFQ3hJ6a.js";import{a as ue,l as oe,b as Ee,c as de}from"./eksisterendeSakUtils-DObNKadu.js";import{l as me,m as ve,n as Re,o as V,I as g,p as Ne,q as B,r as ke,s as S,t as Te,u as ge}from"./annenForelderUtils-DbIAKRO8.js";import{D as _e}from"./DinePlikter-q1wut9TD.js";import{g as y}from"./guid-CsArkN6i.js";import{D as Ae}from"./DinePersonopplysningerModal-BVwzNJ2I.js";const fe=()=>{const a=M();return{oppdaterSøknadIState:(e,l)=>{a(d.SØKERSITUASJON,e.søkersituasjon),a(d.OM_BARNET,e.barn),a(d.ANNEN_FORELDER,e.annenForelder),a(d.ARBEIDSFORHOLD_OG_INNTEKT,e.arbeidsforholdOgInntekt),a(d.FRILANS,e.frilans),a(d.EGEN_NÆRING,e.egenNæring),a(d.ANDRE_INNTEKTSKILDER,e.andreInntektskilder),a(d.UTENLANDSOPPHOLD,e.utenlandsopphold),a(d.UTENLANDSOPPHOLD_TIDLIGERE,e.utenlandsoppholdSiste12Mnd),a(d.UTENLANDSOPPHOLD_SENERE,e.utenlandsoppholdNeste12Mnd),a(d.PERIODE_MED_FORELDREPENGER,e.dekningsgrad),a(d.UTTAKSPLAN,e.uttaksplan),a(d.UTTAKSPLAN_METADATA,{ønskerJustertUttakVedFødsel:e.ønskerJustertUttakVedFødsel}),l&&a(d.EKSISTERENDE_SAK,l)}}};var v=(a=>(a.FØDT="født",a.UFØDT="ufødt",a.ADOPTERT="adoptert",a.IKKE_UTFYLT="ikkeUtfylt",a))(v||{});const De=(a,r)=>a.map(e=>{const l=e.sak!==void 0?U(e.sak.åpenBehandling===void 0,r):void 0,u=e.sak!==void 0?r.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"";return s.jsx(b,{value:e.id,description:e.sak!==void 0?`${u}, ${l}`:u,children:s.jsx(_,{id:"velkommen.barnVelger.ufødtBarn",values:{antallBarnTekst:Re(e.antallBarn,r),termin:E(e.termindato).format(c),b:n=>s.jsx("b",{children:n})}})},e.id)}),U=(a,r)=>a?r.formatMessage({id:"velkommen.sak.status.ferdigBehandlet"}):r.formatMessage({id:"velkommen.sak.status.underBehandling"}),Le=(a,r)=>a.map(e=>{const l=me(e.fornavn,e.fødselsdatoer,e.omsorgsovertagelse,e.alleBarnaLever,e.antallBarn,r),u=ve(e.fødselsdatoer),n=e.type===v.FØDT||e.type===v.IKKE_UTFYLT?u:E(e.omsorgsovertagelse).format(c),i=e.type===v.FØDT||e.type===v.IKKE_UTFYLT?r.formatMessage({id:"velkommen.barnVelger.født"}):r.formatMessage({id:"velkommen.barnVelger.adopsjon"}),o=e.sak!==void 0?r.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"",N=e.sak!==void 0?U(e.sak.åpenBehandling===void 0,r):void 0;return s.jsx(b,{value:e.id,description:N?`${o}, ${N}`:o,children:s.jsx("b",{children:e.alleBarnaLever?`${l} ${i} ${n}`:l})},e.id)}),h=({selectableBarn:a})=>{const r=K(),{control:e}=H();if(a.length===0)return null;const l=a.filter(i=>i.type===v.UFØDT),u=a.filter(i=>i.type!==v.UFØDT);let n=[];return u.length>0&&(n=n.concat(Le(u,r))),l.length>0&&(n=n.concat(De(l,r))),s.jsx(x,{name:"valgteBarn",control:e,label:s.jsx(_,{id:"velkommen.intro.harSaker.barnVelger.label"}),validate:[J(r.formatMessage({id:"steg.footer.spørsmålMåBesvares"}))],children:n.concat(s.jsx(b,{value:"søknad_gjeder_nytt_barn",description:r.formatMessage({id:"velkommen.intro.harSaker.barnVelger.info"}),children:s.jsx(_,{id:"omBarnet.gjelderAnnetBarn",values:{b:i=>s.jsx("b",{children:i})}})},"søknad_gjeder_nytt_barn"))})};h.__docgenInfo={description:"",methods:[],displayName:"BarnVelger",props:{selectableBarn:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: string;
    type: ValgtBarnType;
    antallBarn: number;
    sortableDato: Date;
...
| 'IKKE_OPPGITT'`,elements:[{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'UTDANNING'"},{name:"literal",value:"'KVALPROG'"},{name:"literal",value:"'INTROPROG'"},{name:"literal",value:"'TRENGER_HJELP'"},{name:"literal",value:"'INNLAGT'"},{name:"literal",value:"'ARBEID_OG_UTDANNING'"},{name:"literal",value:"'UFØRE'"},{name:"literal",value:"'IKKE_OPPGITT'"}],required:!1}},{key:"samtidigUttak",value:{name:"number",required:!1}},{key:"flerbarnsdager",value:{name:"boolean",required:!1}},{key:"forelder",value:{name:"union",raw:"'MOR' | 'FAR_MEDMOR'",elements:[{name:"literal",value:"'MOR'"},{name:"literal",value:"'FAR_MEDMOR'"}],required:!1}}]}}],raw:"UttakPeriode[]",required:!0}}]},required:!1}},{key:"barn",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    etternavn: string;
    fødselsdato?: string;
}`,signature:{properties:[{key:"fnr",value:{name:"string",required:!0}},{key:"fornavn",value:{name:"string",required:!0}},{key:"mellomnavn",value:{name:"string",required:!1}},{key:"etternavn",value:{name:"string",required:!0}},{key:"fødselsdato",value:{name:"string",required:!1}}]},required:!1}},{key:"familiehendelsesdato",value:{name:"Date",required:!1}},{key:"startdatoFørsteStønadsperiode",value:{name:"Date",required:!1}},{key:"alleBarnaLever",value:{name:"boolean",required:!0}}]}}],raw:"ValgtBarn[]"},description:""}}};E.extend(C);E.extend(ge);const pe=(a,r,e)=>a?v.ADOPTERT:r.fødselsdato!==void 0||e&&e.length>0?v.FØDT:v.UFØDT,Oe=(a,r)=>{const e=a.familiehendelse.termindato;if($(e)){const l=E(e).subtract(17,"week"),u=E(e).add(6,"week");return r.filter(n=>E(n.fødselsdato).isBetween(l,u,"day","[]"))}return[]},Ie=(a,r)=>{const e=g(a.familiehendelse.fødselsdato),l=a.barn!==void 0?a.barn.map(i=>i.fnr).flat():[],u=r.filter(i=>l.includes(i.fnr)),n=e!==void 0?r.filter(i=>V(i.fødselsdato,e)&&!u.find(o=>o.fnr===i.fnr)):[];return u.concat(n)},Se=(a,r)=>{let e;(a.barn||a.familiehendelse.fødselsdato)&&(e=Ie(a,r)),a.familiehendelse.termindato&&!a.familiehendelse.fødselsdato&&!a.barn&&(e=Oe(a,r));const l=g(ke(a.familiehendelse.termindato,a.familiehendelse.fødselsdato,a.familiehendelse.omsorgsovertakelse)),u=pe(a.gjelderAdopsjon,a.familiehendelse,e),n=g(a.familiehendelse.fødselsdato);let i;return e&&e.length>0?i=e.map(o=>E.utc(o.fødselsdato).toDate()):n!==void 0&&(i=Array(a.familiehendelse.antallBarn).fill(n)),{id:y(),type:u,antallBarn:a.familiehendelse.antallBarn,termindato:g(a.familiehendelse.termindato),omsorgsovertagelse:g(a.familiehendelse.omsorgsovertakelse),kanSøkeOmEndring:a.kanSøkeOmEndring,sak:a,fødselsdatoer:i,familiehendelsesdato:l,sortableDato:g(a.familiehendelse.termindato),startdatoFørsteStønadsperiode:a.gjeldendeVedtak!==void 0&&a.gjeldendeVedtak.perioder.length>0?Y(g(a.gjeldendeVedtak.perioder[0].fom)).denneEllerNeste():void 0,fornavn:e!==void 0&&e.length>0?e.filter(o=>o.fornavn!==void 0&&o.fornavn.trim()!=="").map(o=>[o.fornavn,o.mellomnavn!==void 0?o.mellomnavn:""].join(" ")):void 0,fnr:e!==void 0&&e.length>0?e.filter(o=>o.fnr!==void 0).map(o=>o.fnr):void 0,alleBarnaLever:e!==void 0&&e.length>0?e.every(o=>S(o)):!1}},ye=(a,r)=>{const e=a.mellomnavn!==void 0?[a.fornavn,a.mellomnavn].join(" "):a.fornavn;return{id:y(),type:v.IKKE_UTFYLT,antallBarn:1,fødselsdatoer:[E.utc(a.fødselsdato).toDate()],fornavn:e!==void 0?[e]:void 0,fnr:[a.fnr],sortableDato:E.utc(a.fødselsdato).toDate(),alleBarnaLever:S(a),annenForelder:r}},Fe=(a,r,e)=>{const l=[a].concat(r).sort(Te);if(!(l.find(n=>!S(n)&&B(n))||l.length==0))return{id:y(),type:v.IKKE_UTFYLT,antallBarn:l.length,fødselsdatoer:l.map(n=>E.utc(n.fødselsdato).toDate()),fornavn:l.map(n=>[n.fornavn,n.mellomnavn!==void 0?n.mellomnavn:""].join(" ")),fnr:l.map(n=>n.fnr),sortableDato:E.utc(l[0].fødselsdato).toDate(),alleBarnaLever:l.every(n=>S(n)),annenForelder:e}},Ge=(a,r)=>a.filter(e=>e.barn!==void 0&&e.barn.length>0||e.familiehendelse.termindato!==void 0||e.familiehendelse.fødselsdato!==void 0||e.familiehendelse.omsorgsovertakelse!==void 0).map(e=>Se(e,r)),be=(a,r,e)=>{const l=a.filter(t=>!e.find(m=>V(t.fødselsdato,g(m.familiehendelse.fødselsdato)))),u="tempFnr",n=l.map(t=>t.fnr===void 0?{...t,fnr:u+y().toString()}:t),i=r.map(t=>t.fnr).flat(),o=r.filter(t=>t.fødselsdatoer!==void 0&&t.fødselsdatoer.length>0).map(t=>t.fødselsdatoer).flat(),N=[];return n.filter(t=>!(t.dødsdato!==void 0&&o.find(m=>E(m).isSame(E.utc(t.fødselsdato),"day")))).forEach(t=>{if(!i.includes(t.fnr)&&!ie(t.fødselsdato)){const m=Ne(t.fnr,t.fødselsdato,n),A=t.annenForelder!==void 0?{fnr:t.annenForelder.fnr,fornavn:t.annenForelder.fornavn,mellomnavn:t.annenForelder.mellomnavn,etternavn:t.annenForelder.etternavn}:void 0;if(i.push(t.fnr),m.length===0){if(!B(t)){const f=ye(t,A);N.push(f)}}else{const f=Fe(t,m,A);m.forEach(D=>{i.push(D.fnr)}),f!==void 0&&N.push(f)}}}),N.map(t=>t.fnr&&t.fnr.length>0?{...t,fnr:t.fnr.filter(m=>m&&!m.startsWith(u))}:t)},qe=(a,r)=>{const e=a.filter(i=>!i.sakAvsluttet),l=a.filter(i=>i.sakAvsluttet),u=Ge(e,r),n=be(r,u,l);return u.concat(n)},Pe=(a,r)=>{var u,n;const e=r.filter(i=>i.sak!==void 0&&i.id!==a.id&&i.familiehendelsesdato!==void 0&&E(i.familiehendelsesdato).isAfter(a.familiehendelsesdato,"day"));e.sort(j);const l=e[e.length-1];if(l!==void 0)return{familiehendelsesdato:l.familiehendelsesdato,startdatoFørsteStønadsperiode:l.startdatoFørsteStønadsperiode,fnr:l.fnr,annenForelderFnr:(n=(u=l.sak)==null?void 0:u.annenPart)==null?void 0:n.fnr}},j=(a,r)=>E(a.sortableDato).isBefore(r.sortableDato,"d")?1:E(a.sortableDato).isAfter(r.sortableDato,"d")?-1:0,Ke=({saker:a,harGodkjentVilkår:r,søkerInfo:e,setHarGodkjentVilkår:l,setErEndringssøknad:u,setSøknadGjelderNyttBarn:n,mellomlagreSøknadOgNaviger:i})=>{const o=K(),N=se(e.arbeidsforhold,i),q=M(),{oppdaterSøknadIState:L}=fe(),t=z.useMemo(()=>[...qe(a,e.søker.barn)].sort(j),[a,e.søker.barn]),m=T=>{if(!T.harForståttRettigheterOgPlikter){console.error("harForståttRettigheterOgPlikter er falsy til tross for at formet skal ha validert den",T.harForståttRettigheterOgPlikter);return}l(!0);const R=t.find(k=>k.id===T.valgteBarn);if(R===void 0)return u(!1),n(!0),N.goToNextStep(G.SØKERSITUASJON);const p=Pe(R,t);q(d.BARN_FRA_NESTE_SAK,p);const O=!!R.kanSøkeOmEndring?a.find(k=>{var I;return k.saksnummer===((I=R.sak)==null?void 0:I.saksnummer)}):void 0;if(O){const k=ue(O,p==null?void 0:p.startdatoFørsteStønadsperiode,R.fødselsdatoer),I=oe(e.søker,k,o,O.annenPart,R);return L(I,k),u(!0),n(!1),N.goToNextStep(G.UTTAKSPLAN)}if(R.sak!==void 0&&R.kanSøkeOmEndring===!1){const k=Ee({...R,sak:R.sak},o,e.søker.barn,e.søker.fnr);L(k)}if(!O){const k=de(R);L(k)}return u(!1),n(!1),N.goToNextStep(G.SØKERSITUASJON)},A=Z({defaultValues:{harForståttRettigheterOgPlikter:r}}),f=A.watch("valgteBarn"),D=t.find(T=>T.id===f),w=(D==null?void 0:D.kanSøkeOmEndring)===!0?o.formatMessage({id:"velkommen.endreSøknad"}):o.formatMessage({id:"velkommen.begynnMedSøknad"});return s.jsx(W,{pageTitle:s.jsx(_,{id:"søknad.pageheading"}),children:s.jsx(X,{formMethods:A,onSubmit:m,children:s.jsxs(F,{gap:"8",children:[s.jsx(Q,{poster:!0,children:s.jsxs(F,{gap:"2",children:[s.jsx(_,{id:"velkommen.guidepanel.del1"}),s.jsx(_,{id:"velkommen.guidepanel.del2",values:{a:T=>s.jsx(ee,{rel:"noopener noreferrer",href:ae.foreldrepenger,children:T})}})]})}),s.jsx(h,{selectableBarn:t}),s.jsx(re,{variant:"info",children:s.jsx(_,{id:"velkommen.lagring.info"})}),s.jsx(ne,{name:"harForståttRettigheterOgPlikter",control:A.control,label:o.formatMessage({id:"velkommen.samtykke"}),validate:[T=>T!==!0?o.formatMessage({id:"valideringsfeil.velkommen.harForståttRettigheterOgPlikter.påkrevd"}):null],children:s.jsx(F,{gap:"5",children:s.jsxs(P,{gap:"1",children:[s.jsx(te,{children:s.jsx(_,{id:"velkommen.samtykkeIntro.del1"})}),s.jsx(_e,{})]})})}),s.jsx(P,{justify:"center",children:s.jsx(le,{type:"submit",variant:"primary",children:w})}),s.jsx(Ae,{})]})})})};Ke.__docgenInfo={description:"",methods:[],displayName:"Forside",props:{saker:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    saksnummer: string;
    sakAvsluttet: boolean;
    kanSøkeOmEndring: boolean;
    sakTilhørerMor: boolean;
