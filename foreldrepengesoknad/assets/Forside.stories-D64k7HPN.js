import{X as x}from"./iframe-B9NybJHr.js";import{F as er}from"./FpDataContext-QKqGo80U.js";import{M as nr,S as ar}from"./useFpNavigator-BHz0Eyhq.js";import{F as q}from"./Forside-DW4T2eW_.js";import"./preload-helper-D9Z9MdNV.js";import"./eksisterendeSakUtils-BN1SJKln.js";import"./annenForelderUtils-DVWnw9IL.js";import"./DinePlikter-Do8icdMA.js";import"./List-CdWTfOWE.js";import"./DinePersonopplysningerModal-DMuEKS54.js";const{action:_}=__STORYBOOK_MODULE_ACTIONS__,sr=()=>()=>(_("button-click")(),Promise.resolve()),w={fnr:"19047815714",fornavn:"TALENTFULL",etternavn:"MYGG",kjønn:"K",fødselsdato:"1978-04-19",barn:[]},z=(n,y)=>{const $=y.map(rr=>({fnr:rr}));return{...n,barn:$}},o=n=>({dekningsgrad:"HUNDRE",familiehendelse:{fødselsdato:n.fødselsdato,omsorgsovertakelse:n.omsorgsovertakelse,antallBarn:n.antallBarn,termindato:n.termindato},gjeldendeVedtak:{perioder:[]},harAnnenForelderTilsvarendeRettEØS:!1,gjelderAdopsjon:n.gjelderAdopsjon,kanSøkeOmEndring:n.kanSøkeOmEndring,morUføretrygd:!1,rettighetType:"BEGGE_RETT",sakAvsluttet:n.sakErAvsluttet,sakTilhørerMor:!0,saksnummer:"123456",ønskerJustertUttakVedFødsel:!1,oppdatertTidspunkt:"2022-05-06",åpenBehandling:n.åpenbehandlingTilstand!==void 0?{tilstand:n.åpenbehandlingTilstand,søknadsperioder:[]}:void 0,annenPart:{fnr:"123456789"}}),e=n=>({...w,barn:n}),a="2022-12-06",or="2022-12-08",t={fnr:"1",fornavn:"Oriental",etternavn:"Bokhylle",fødselsdato:a,kjønn:"K"},V={...t,dødsdato:"2022-12-07"},C={fnr:"2",fornavn:"Vakker",etternavn:"Bokhylle",fødselsdato:a,kjønn:"K"},Q={...C,dødsdato:"2022-12-07"},d={fødselsdato:a,dødsdato:a,kjønn:"K",fnr:"2",fornavn:"Vakker",etternavn:"Bokhylle"},W=!1,s={fnr:"3",fornavn:"Evig",mellomnavn:"Lykkelig",etternavn:"Vår",fødselsdato:a,kjønn:"M"},Y={...s,mellomnavn:void 0,fnr:"4",fornavn:"Grønn"},tr={...s,mellomnavn:void 0,fnr:"5",fornavn:"Sommerlig"},J=o({kanSøkeOmEndring:!0,gjelderAdopsjon:!1,antallBarn:1,sakErAvsluttet:W,fødselsdato:a}),l=o({kanSøkeOmEndring:!1,gjelderAdopsjon:!1,antallBarn:1,sakErAvsluttet:W,termindato:"2024-06-28",åpenbehandlingTilstand:"UNDER_BEHANDLING"}),dr=o({kanSøkeOmEndring:!0,gjelderAdopsjon:!0,antallBarn:1,sakErAvsluttet:!1,omsorgsovertakelse:or,fødselsdato:a,åpenbehandlingTilstand:"UNDER_BEHANDLING"}),lr=o({kanSøkeOmEndring:!1,gjelderAdopsjon:!1,antallBarn:1,sakErAvsluttet:!0,fødselsdato:a}),kr=o({kanSøkeOmEndring:!0,gjelderAdopsjon:!1,antallBarn:1,sakErAvsluttet:!1,fødselsdato:a}),X=o({kanSøkeOmEndring:!0,gjelderAdopsjon:!0,antallBarn:1,sakErAvsluttet:!1,omsorgsovertakelse:a,fødselsdato:a}),R=o({kanSøkeOmEndring:!1,gjelderAdopsjon:!1,antallBarn:2,sakErAvsluttet:!1,fødselsdato:a,åpenbehandlingTilstand:"UNDER_BEHANDLING"}),Z=o({kanSøkeOmEndring:!0,gjelderAdopsjon:!1,antallBarn:3,sakErAvsluttet:!1,fødselsdato:a}),Ir={title:"pages/Forside",component:q,render:({onDispatch:n,...y})=>x.jsx(nr,{initialEntries:[ar.VELKOMMEN],children:x.jsx(er,{onDispatch:n,children:x.jsx(q,{...y})})})},r={args:{harGodkjentVilkår:!1,saker:[],søkerInfo:{søker:w,arbeidsforhold:[]},setErEndringssøknad:_("button-click"),setHarGodkjentVilkår:_("button-click"),setSøknadGjelderNyttBarn:_("button-click"),mellomlagreSøknadOgNaviger:sr()}},k={args:{...r.args,harGodkjentVilkår:!0}},i={args:{...r.args,saker:[J],søkerInfo:{søker:e([s]),arbeidsforhold:[]}}},g={args:{...r.args,saker:[l]}},c={args:{...r.args,saker:[dr],søkerInfo:{søker:e([s]),arbeidsforhold:[]}}},f={args:{...r.args,saker:[lr],søkerInfo:{søker:e([s]),arbeidsforhold:[]}}},m={args:{...r.args,saker:[J,{...l,saksnummer:"555555"}],søkerInfo:{søker:e([s]),arbeidsforhold:[]}}},p={args:{...r.args,saker:[kr]}},u={args:{...r.args,saker:[X]}},S={args:{...r.args,saker:[X],søkerInfo:{søker:e([s]),arbeidsforhold:[]}}},B={args:{...r.args,saker:[R],søkerInfo:{søker:e([s,Y]),arbeidsforhold:[]}}},v={args:{...r.args,saker:[Z],søkerInfo:{søker:e([s,Y,tr]),arbeidsforhold:[]}}},I={args:{...r.args,saker:[],søkerInfo:{søker:e([t]),arbeidsforhold:[]}}},D={args:{...r.args,saker:[],søkerInfo:{søker:e([t,C]),arbeidsforhold:[]}}},h={args:{...r.args,saker:[],søkerInfo:{søker:e([V]),arbeidsforhold:[]}}},E={args:{...r.args,saker:[],søkerInfo:{søker:e([V,Q]),arbeidsforhold:[]}}},M={args:{...r.args,saker:[],søkerInfo:{søker:e([d]),arbeidsforhold:[]}}},b={args:{...r.args,saker:[],søkerInfo:{søker:e([d,d]),arbeidsforhold:[]}}},T={args:{...r.args,saker:[],søkerInfo:{søker:e([t,d]),arbeidsforhold:[]}}},H={args:{...r.args,saker:[],søkerInfo:{søker:e([t,Q]),arbeidsforhold:[]}}},j={args:{...r.args,saker:[R],søkerInfo:{søker:e([t,d]),arbeidsforhold:[]}}},A={args:{...r.args,saker:[J],søkerInfo:{søker:e([V]),arbeidsforhold:[]}}},O={args:{...r.args,saker:[X],søkerInfo:{søker:e([V]),arbeidsforhold:[]}}},F={args:{...r.args,saker:[z(R,["1","2"])],søkerInfo:{søker:e([t,C]),arbeidsforhold:[]}}},L={args:{...r.args,saker:[z(R,["1"])],søkerInfo:{søker:e([t,d]),arbeidsforhold:[]}}},P={args:{...r.args,saker:[Z],søkerInfo:{søker:e([s,Y,d]),arbeidsforhold:[]}}},U={args:{...r.args,saker:[l],søkerInfo:{søker:e([{fnr:"1",fornavn:"Hanne",etternavn:"Brokkoli",fødselsdato:"2024-03-01",kjønn:"K"}]),arbeidsforhold:[]}}},K={args:{...r.args,saker:[l],søkerInfo:{søker:e([{fnr:"1",fornavn:"Hanne",etternavn:"Brokkoli",fødselsdato:"2024-08-09",kjønn:"K"}]),arbeidsforhold:[]}}},N={args:{...r.args,saker:[l],søkerInfo:{søker:e([{fnr:"1",fornavn:"Hanne",etternavn:"Brokkoli",fødselsdato:"2024-02-29",kjønn:"K"}]),arbeidsforhold:[]}}},G={args:{...r.args,saker:[l],søkerInfo:{søker:e([{fnr:"1",fornavn:"Hanne",etternavn:"Brokkoli",fødselsdato:"2024-08-10",kjønn:"K"}]),arbeidsforhold:[]}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
