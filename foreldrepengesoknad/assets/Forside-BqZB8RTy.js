import{Z as M,_ as E,aS as H,aT as J,aU as P,a1 as D,I as o,aV as q,U as x,k as Y,aW as $,r as C,aX as z,aY as W,$ as F,aZ as Z,a6 as y,a5 as X,a_ as Q,a$ as ee,b0 as ae,a0 as ne,b1 as re,a7 as te,a8 as le}from"./iframe-GpYekqdz.js";import{e as b,C as R}from"./FpDataContext-B_jojrpr.js";import{n as Ee,b as ie,S as K}from"./useFpNavigator-BeG2U3Gj.js";import{a as se,l as ue,b as oe,c as Re}from"./eksisterendeSakUtils-h3WylN6y.js";import{l as de,m as Ne,n as me,o as c,I as A,p as Te,q as B,r as _e,s as p,t as ve,u as Ae}from"./barnUtils-C0i3yXms.js";import{D as De}from"./DinePlikter-mo5CYwCL.js";import{g as G}from"./guid-CsArkN6i.js";import{D as Le}from"./DinePersonopplysningerModal-CslNiomZ.js";const Ie=()=>{const a=b();return{oppdaterSøknadIState:(e,l)=>{a(R.SØKERSITUASJON,e.søkersituasjon),a(R.OM_BARNET,e.barn),a(R.ANNEN_FORELDER,e.annenForelder),a(R.ARBEIDSFORHOLD_OG_INNTEKT,e.arbeidsforholdOgInntekt),a(R.FRILANS,e.frilans),a(R.EGEN_NÆRING,e.egenNæring),a(R.ANDRE_INNTEKTSKILDER,e.andreInntektskilder),a(R.UTENLANDSOPPHOLD,e.utenlandsopphold),a(R.UTENLANDSOPPHOLD_TIDLIGERE,e.utenlandsoppholdSiste12Mnd),a(R.UTENLANDSOPPHOLD_SENERE,e.utenlandsoppholdNeste12Mnd),a(R.PERIODE_MED_FORELDREPENGER,e.dekningsgrad),a(R.UTTAKSPLAN,e.uttaksplan),a(R.UTTAKSPLAN_METADATA,{ønskerJustertUttakVedFødsel:e.ønskerJustertUttakVedFødsel}),l&&a(R.EKSISTERENDE_SAK,l)}}};var N=(a=>(a.FØDT="født",a.UFØDT="ufødt",a.ADOPTERT="adoptert",a.IKKE_UTFYLT="ikkeUtfylt",a))(N||{});const Oe=(a,n)=>a.map(e=>{const l=e.sak!==void 0?U(e.sak.åpenBehandling===void 0,n):void 0,i=e.sak!==void 0?n.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"";return E.jsx(P,{value:e.id,description:e.sak!==void 0?`${i}, ${l}`:i,children:E.jsx(D,{id:"velkommen.barnVelger.ufødtBarn",values:{antallBarnTekst:me(e.antallBarn,n),termin:o(e.termindato).format(q),b:r=>E.jsx("b",{children:r})}})},e.id)}),U=(a,n)=>a?n.formatMessage({id:"velkommen.sak.status.ferdigBehandlet"}):n.formatMessage({id:"velkommen.sak.status.underBehandling"}),ke=(a,n)=>a.map(e=>{const l=de(e.fornavn,e.fødselsdatoer,e.omsorgsovertagelse,e.alleBarnaLever,e.antallBarn,n),i=Ne(e.fødselsdatoer),r=e.type===N.FØDT||e.type===N.IKKE_UTFYLT?i:o(e.omsorgsovertagelse).format(q),u=e.type===N.FØDT||e.type===N.IKKE_UTFYLT?n.formatMessage({id:"velkommen.barnVelger.født"}):n.formatMessage({id:"velkommen.barnVelger.adopsjon"}),s=e.sak!==void 0?n.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"",T=e.sak!==void 0?U(e.sak.åpenBehandling===void 0,n):void 0;return E.jsx(P,{value:e.id,description:T?`${s}, ${T}`:s,children:E.jsx("b",{children:e.alleBarnaLever?`${l} ${u} ${r}`:l})},e.id)}),h=({selectableBarn:a})=>{const n=M();if(a.length===0)return null;const e=a.filter(r=>r.type===N.UFØDT),l=a.filter(r=>r.type!==N.UFØDT);let i=[];return l.length>0&&(i=i.concat(ke(l,n))),e.length>0&&(i=i.concat(Oe(e,n))),E.jsx(H,{name:"valgteBarn",label:E.jsx(D,{id:"velkommen.intro.harSaker.barnVelger.label"}),validate:[J(n.formatMessage({id:"steg.footer.spørsmålMåBesvares"}))],children:i.concat(E.jsx(P,{value:"søknad_gjeder_nytt_barn",description:n.formatMessage({id:"velkommen.intro.harSaker.barnVelger.info"}),children:E.jsx(D,{id:"omBarnet.gjelderAnnetBarn",values:{b:r=>E.jsx("b",{children:r})}})},"søknad_gjeder_nytt_barn"))})};h.__docgenInfo={description:"",methods:[],displayName:"BarnVelger",props:{selectableBarn:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: string;
    type: ValgtBarnType;
    antallBarn: number;
    sortableDato: Date;
...
| 'IKKE_OPPGITT'`,elements:[{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'UTDANNING'"},{name:"literal",value:"'KVALPROG'"},{name:"literal",value:"'INTROPROG'"},{name:"literal",value:"'TRENGER_HJELP'"},{name:"literal",value:"'INNLAGT'"},{name:"literal",value:"'ARBEID_OG_UTDANNING'"},{name:"literal",value:"'UFØRE'"},{name:"literal",value:"'IKKE_OPPGITT'"}],required:!1}},{key:"samtidigUttak",value:{name:"number",required:!1}},{key:"flerbarnsdager",value:{name:"boolean",required:!1}},{key:"forelder",value:{name:"union",raw:"'MOR' | 'FAR_MEDMOR'",elements:[{name:"literal",value:"'MOR'"},{name:"literal",value:"'FAR_MEDMOR'"}],required:!1}}]}}],raw:"UttakPeriode[]",required:!0}}]},required:!1}},{key:"barn",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    etternavn: string;
    fødselsdato?: string;
}`,signature:{properties:[{key:"fnr",value:{name:"string",required:!0}},{key:"fornavn",value:{name:"string",required:!0}},{key:"mellomnavn",value:{name:"string",required:!1}},{key:"etternavn",value:{name:"string",required:!0}},{key:"fødselsdato",value:{name:"string",required:!1}}]},required:!1}},{key:"familiehendelsesdato",value:{name:"Date",required:!1}},{key:"startdatoFørsteStønadsperiode",value:{name:"Date",required:!1}},{key:"alleBarnaLever",value:{name:"boolean",required:!0}}]}}],raw:"ValgtBarn[]"},description:""}}};o.extend($);o.extend(Ae);const ge=(a,n,e)=>a?N.ADOPTERT:n.fødselsdato!==void 0||e&&e.length>0?N.FØDT:N.UFØDT,Se=(a,n)=>{const e=a.familiehendelse.termindato;if(Y(e)){const l=o(e).subtract(17,"week"),i=o(e).add(6,"week");return n.filter(r=>o(r.fødselsdato).isBetween(l,i,"day","[]"))}return[]},fe=(a,n)=>{const e=A(a.familiehendelse.fødselsdato),l=a.barn!==void 0?a.barn.map(u=>u.fnr).flat():[],i=n.filter(u=>l.includes(u.fnr)),r=e!==void 0?n.filter(u=>c(u.fødselsdato,e)&&!i.find(s=>s.fnr===u.fnr)):[];return i.concat(r)},Fe=(a,n)=>{let e;(a.barn||a.familiehendelse.fødselsdato)&&(e=fe(a,n)),a.familiehendelse.termindato&&!a.familiehendelse.fødselsdato&&!a.barn&&(e=Se(a,n));const l=A(_e(a.familiehendelse.termindato,a.familiehendelse.fødselsdato,a.familiehendelse.omsorgsovertakelse)),i=ge(a.gjelderAdopsjon,a.familiehendelse,e),r=A(a.familiehendelse.fødselsdato);let u;return e&&e.length>0?u=e.map(s=>o.utc(s.fødselsdato).toDate()):r!==void 0&&(u=Array(a.familiehendelse.antallBarn).fill(r)),{id:G(),type:i,antallBarn:a.familiehendelse.antallBarn,termindato:A(a.familiehendelse.termindato),omsorgsovertagelse:A(a.familiehendelse.omsorgsovertakelse),kanSøkeOmEndring:a.kanSøkeOmEndring,sak:a,fødselsdatoer:u,familiehendelsesdato:l,sortableDato:A(a.familiehendelse.termindato),startdatoFørsteStønadsperiode:a.gjeldendeVedtak!==void 0&&a.gjeldendeVedtak.perioder.length>0?x(A(a.gjeldendeVedtak.perioder[0].fom)).denneEllerNeste():void 0,fornavn:e!==void 0&&e.length>0?e.filter(s=>s.fornavn!==void 0&&s.fornavn.trim()!=="").map(s=>[s.fornavn,s.mellomnavn!==void 0?s.mellomnavn:""].join(" ")):void 0,fnr:e!==void 0&&e.length>0?e.filter(s=>s.fnr!==void 0).map(s=>s.fnr):void 0,alleBarnaLever:e!==void 0&&e.length>0?e.every(s=>p(s)):!1}},pe=(a,n)=>{const e=a.mellomnavn!==void 0?[a.fornavn,a.mellomnavn].join(" "):a.fornavn;return{id:G(),type:N.IKKE_UTFYLT,antallBarn:1,fødselsdatoer:[o.utc(a.fødselsdato).toDate()],fornavn:e!==void 0?[e]:void 0,fnr:[a.fnr],sortableDato:o.utc(a.fødselsdato).toDate(),alleBarnaLever:p(a),annenForelder:n}},Ge=(a,n,e)=>{const l=[a].concat(n).sort(ve);if(!(l.find(r=>!p(r)&&B(r))||l.length==0))return{id:G(),type:N.IKKE_UTFYLT,antallBarn:l.length,fødselsdatoer:l.map(r=>o.utc(r.fødselsdato).toDate()),fornavn:l.map(r=>[r.fornavn,r.mellomnavn!==void 0?r.mellomnavn:""].join(" ")),fnr:l.map(r=>r.fnr),sortableDato:o.utc(l[0].fødselsdato).toDate(),alleBarnaLever:l.every(r=>p(r)),annenForelder:e}},ye=(a,n)=>a.filter(e=>e.barn!==void 0&&e.barn.length>0||e.familiehendelse.termindato!==void 0||e.familiehendelse.fødselsdato!==void 0||e.familiehendelse.omsorgsovertakelse!==void 0).map(e=>Fe(e,n)),Ke=(a,n,e)=>{const l=a.filter(t=>!e.find(d=>c(t.fødselsdato,A(d.familiehendelse.fødselsdato)))),i="tempFnr",r=l.map(t=>t.fnr===void 0?{...t,fnr:i+G().toString()}:t),u=n.map(t=>t.fnr).flat(),s=n.filter(t=>t.fødselsdatoer!==void 0&&t.fødselsdatoer.length>0).map(t=>t.fødselsdatoer).flat(),T=[];return r.filter(t=>!(t.dødsdato!==void 0&&s.find(d=>o(d).isSame(o.utc(t.fødselsdato),"day")))).forEach(t=>{if(!u.includes(t.fnr)&&!Ee(t.fødselsdato)){const d=Te(t.fnr,t.fødselsdato,r),I=t.annenForelder!==void 0?{fnr:t.annenForelder.fnr,fornavn:t.annenForelder.fornavn,mellomnavn:t.annenForelder.mellomnavn,etternavn:t.annenForelder.etternavn}:void 0;if(u.push(t.fnr),d.length===0){if(!B(t)){const L=pe(t,I);T.push(L)}}else{const L=Ge(t,d,I);d.forEach(O=>{u.push(O.fnr)}),L!==void 0&&T.push(L)}}}),T.map(t=>t.fnr&&t.fnr.length>0?{...t,fnr:t.fnr.filter(d=>d&&!d.startsWith(i))}:t)},Pe=(a,n)=>{const e=a.filter(u=>!u.sakAvsluttet),l=a.filter(u=>u.sakAvsluttet),i=ye(e,n),r=Ke(n,i,l);return i.concat(r)},Ve=(a,n)=>{var i,r;const e=n.filter(u=>u.sak!==void 0&&u.id!==a.id&&u.familiehendelsesdato!==void 0&&o(u.familiehendelsesdato).isAfter(a.familiehendelsesdato,"day"));e.sort(j);const l=e[e.length-1];if(l!==void 0)return{familiehendelsesdato:l.familiehendelsesdato,startdatoFørsteStønadsperiode:l.startdatoFørsteStønadsperiode,fnr:l.fnr,annenForelderFnr:(r=(i=l.sak)==null?void 0:i.annenPart)==null?void 0:r.fnr}},j=(a,n)=>o(a.sortableDato).isBefore(n.sortableDato,"d")?1:o(a.sortableDato).isAfter(n.sortableDato,"d")?-1:0,Me=({saker:a,harGodkjentVilkår:n,søkerInfo:e,setHarGodkjentVilkår:l,setErEndringssøknad:i,setSøknadGjelderNyttBarn:r,mellomlagreSøknadOgNaviger:u})=>{const s=M(),T=ie(e.arbeidsforhold,u),V=b(),{oppdaterSøknadIState:k}=Ie(),t=C.useMemo(()=>[...Pe(a,e.søker.barn)].sort(j),[a,e.søker.barn]),d=v=>{if(!v.harForståttRettigheterOgPlikter){console.error("harForståttRettigheterOgPlikter er falsy til tross for at formet skal ha validert den",v.harForståttRettigheterOgPlikter);return}l(!0);const m=t.find(_=>_.id===v.valgteBarn);if(m===void 0)return i(!1),r(!0),T.goToNextStep(K.SØKERSITUASJON);const g=Ve(m,t);V(R.BARN_FRA_NESTE_SAK,g);const S=!!m.kanSøkeOmEndring?a.find(_=>{var f;return _.saksnummer===((f=m.sak)==null?void 0:f.saksnummer)}):void 0;if(S){const _=se(S,g==null?void 0:g.startdatoFørsteStønadsperiode,m.fødselsdatoer),f=ue(e.søker,_,s,S.annenPart,m);return k(f,_),i(!0),r(!1),T.goToNextStep(K.UTTAKSPLAN)}if(m.sak!==void 0&&m.kanSøkeOmEndring===!1){const _=oe({...m,sak:m.sak},s,e.søker.barn,e.søker.fnr);k(_)}if(!S){const _=Re(m);k(_)}return i(!1),r(!1),T.goToNextStep(K.SØKERSITUASJON)},I=z({defaultValues:{harForståttRettigheterOgPlikter:n}}),L=I.watch("valgteBarn"),O=t.find(v=>v.id===L),w=(O==null?void 0:O.kanSøkeOmEndring)===!0?s.formatMessage({id:"velkommen.endreSøknad"}):s.formatMessage({id:"velkommen.begynnMedSøknad"});return E.jsx(W,{formMethods:I,onSubmit:d,children:E.jsx(F,{gap:"10",children:E.jsx(Z,{children:E.jsxs(F,{gap:"8",children:[E.jsx(y,{justify:"center",children:E.jsx(X,{size:"xlarge",children:E.jsx(D,{id:"velkommen.tittel"})})}),E.jsx(Q,{poster:!0,children:E.jsxs(F,{gap:"2",children:[E.jsx(D,{id:"velkommen.guidepanel.del1"}),E.jsx(D,{id:"velkommen.guidepanel.del2",values:{a:v=>E.jsx(ee,{rel:"noopener noreferrer",href:ae.foreldrepenger,children:v})}})]})}),E.jsx(h,{selectableBarn:t}),E.jsx(ne,{variant:"info",children:E.jsx(D,{id:"velkommen.lagring.info"})}),E.jsx(re,{name:"harForståttRettigheterOgPlikter",label:s.formatMessage({id:"velkommen.samtykke"}),validate:[v=>v!==!0?s.formatMessage({id:"valideringsfeil.velkommen.harForståttRettigheterOgPlikter.påkrevd"}):null],children:E.jsx(F,{gap:"5",children:E.jsxs(y,{gap:"1",children:[E.jsx(te,{children:E.jsx(D,{id:"velkommen.samtykkeIntro.del1"})}),E.jsx(De,{})]})})}),E.jsx(y,{justify:"center",children:E.jsx(le,{type:"submit",variant:"primary",children:w})}),E.jsx(Le,{})]})})})})};Me.__docgenInfo={description:"",methods:[],displayName:"Forside",props:{saker:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    saksnummer: string;
    sakAvsluttet: boolean;
    kanSøkeOmEndring: boolean;
    sakTilhørerMor: boolean;
