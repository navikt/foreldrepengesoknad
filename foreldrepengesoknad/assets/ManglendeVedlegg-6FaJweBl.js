import{a5 as A,D as be,l as r,a$ as Ve,r as Ae,b$ as he,bd as b,c0 as we,W as Le,E as Fe,V as Ge,c1 as Be,M as R,y as c,c2 as Se,c3 as Re,L as Ye,c4 as Je,c5 as xe,bB as Ce,c6 as ze,U as _e,B as y,c7 as He,c8 as $e,c9 as Qe,ca as We,cb as Xe,cc as Ze,cd as en,ce as nn,cf as rn,cg as an,ch as tn,ci as mn,cj as ln,ck as un,cl as sn,cm as on,cn as En,co as dn,cp as Tn,cq as Ln,cr as Sn,cs as Rn,ct as _n,cu as An,cv as Gn,b7 as pn,m as On,as as kn,b8 as In,a6 as Nn,q as gn,bt as vn}from"./iframe-BX8ZK2XF.js";import{n as q,b as D,C as O,c as Dn,g as yn,j as Mn}from"./FpDataContext-CK8OA-FM.js";import{V as W,K as G,t as n,O as Kn,P as Q,A as fn,H as V,Q as pe,a as jn,T as Pn,U as cn,d as Un,c as qn,W as bn,j as Vn,X as hn,Y as wn}from"./useFpNavigator-BLXRjRyO.js";import{a as Fn}from"./uttaksplanInfoUtils-C7WV8thJ.js";import{L as M}from"./List-DttJ2HjP.js";const Oe=({attachments:e,updateAttachments:a,annenForelder:t})=>{const m=A();return!be(t)||!t.datoForAleneomsorg?null:r.jsx(W,{attachments:e,updateAttachments:a(n.DOK_AV_ALENEOMSORG),skjemanummer:n.DOK_AV_ALENEOMSORG,labelText:m.formatMessage({id:"manglendeVedlegg.aleneomsorg.tittel"}),description:m.formatMessage({id:"manglendeVedlegg.aleneomsorg.description"}),attachmentType:G.ALENEOMSORG,metadataType:"BARN"})};Oe.__docgenInfo={description:"",methods:[],displayName:"AleneomsorgDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Ie=({attachments:e,updateAttachments:a,arbeidsforholdOgInntekt:t,andreInntektskilder:m})=>{const l=A();if(!t||t.harHattAndreInntektskilder===!1||!m||!m.some(s=>s.type===V.SLUTTPAKKE))return null;const i=m.filter(s=>s.type===V.SLUTTPAKKE);return r.jsx(W,{attachments:e,updateAttachments:a(n.ETTERLØNN_ELLER_SLUTTVEDERLAG),skjemanummer:n.ETTERLØNN_ELLER_SLUTTVEDERLAG,labelText:l.formatMessage({id:"manglendeVedlegg.etterlønn.tittel"},{perioder:pe(i,l),antallPerioder:i.length}),description:l.formatMessage({id:"manglendeVedlegg.etterlønn.description"}),attachmentType:G.ANNEN_INNTEKT,metadataType:"OPPTJENING",perioder:i})};Ie.__docgenInfo={description:"",methods:[],displayName:"EtterlønnEllerSluttvederlagDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
