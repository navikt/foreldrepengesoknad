import{bf as Oe,r as X,_ as a,bW as Re,bX as ge,Z as y,x as He,b3 as V,bY as $e,J as Te,y as Ce,G as Ze,$ as ce,bZ as Qe,a1 as T,q as G,b_ as _e,b$ as We,ar as Xe,c0 as en,c1 as nn,bs as ve,c2 as rn,I as Ae,a7 as D,D as an,a2 as tn,c3 as mn,c4 as sn,c5 as un,c6 as dn,c7 as ln,c8 as on,c9 as kn,ca as pn,cb as En,cc as yn,cd as Sn,ce as gn,cf as Tn,cg as _n,ch as An,ci as On,cj as Rn,ck as cn,cl as vn,cm as jn,cn as In,co as Nn,cp as fn,cq as Dn,cr as Ln,aY as Mn,as as Kn,aZ as qn,a0 as hn,a5 as Gn,bl as bn}from"./iframe-Gxd28MnS.js";import{b as f,C as R,c as Un}from"./FpDataContext-CGyNGwkW.js";import{A as w,j as Fn,b as Pn,a as Vn,o as wn,f as Bn}from"./useFpNavigator-B8aNkvCK.js";import{j as P,a as Jn,g as xn,f as Yn}from"./annenForelderUtils-CbZSaEzy.js";import{I as ee,A as h,b as S,S as n,c as zn}from"./uttaksplanInfoUtils-Cqgqlo4l.js";import{g as Hn}from"./guid-CsArkN6i.js";import{k as $n,u as Cn,t as Zn}from"./api-C7lcQsXu.js";import{L}from"./List-D-3Oyz74.js";const je=(e,r)=>async t=>{const m=new FormData;m.append("id",t.id),m.append("vedlegg",t.file,t.filename);const i=await $n.post(`${e}/rest/storage/${r}/vedlegg`,{body:m});return{headers:{location:i.headers.get("Location")},data:await i.text()}},Qn=()=>"V".concat(Hn().replace(/-/g,"")),Ie=(e,r,t,m,i)=>({id:Qn(),file:e,filename:e.name,filesize:e.size,uploaded:!1,pending:!1,type:r,skjemanummer:t,innsendingsType:m,dokumenterer:i}),Ne=(e,r,t)=>Ie({name:"",size:""},e,r,ee.SEND_SENERE,t),Wn=(e,r,t)=>Ie({name:"",size:""},e,r,ee.AUTOMATISK,t),F=(e,r)=>({...e,dokumenterer:r}),fe=(e,r)=>e.map((t,m)=>{const i=t.tom?ge(t.tom):r.formatMessage({id:"VedleggUploader.pågående"}),s=`${ge(t.fom)}-${i}`;return e.length===1||m===e.length-1?s:m<e.length-2?`${s}, `:`${s} ${r.formatMessage({id:"VedleggUploader.Og"})} `}).join(""),b=({attachments:e,updateAttachments:r,skjemanummer:t,labelText:m,description:i,attachmentType:s,metadataType:d,perioder:u})=>{const{watch:k}=Oe(),E=k(t);return X.useEffect(()=>{if(E.length===0){const l=Ne(s,t),o=F(l,{type:d,perioder:u});r([o])}},[r,E,s,t,d]),a.jsx(Re,{label:m,description:i,attachmentType:s,skjemanummer:t,existingAttachments:e,updateAttachments:l=>{const o=l.map(A=>F(A,{type:d,perioder:u}));r(o)},saveAttachment:je("./","foreldrepenger")})};b.__docgenInfo={description:"",methods:[],displayName:"VedleggUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},name:"skjemanummer"}],return:{name:"signature",type:"function",raw:"(attachments: Attachment[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    perioder?: AttachmentMetadataTidsperiode[];
    arbeidsforhold?: any;
}`,signature:{properties:[{key:"type",value:{name:"AttachmentMetadataType",required:!0}},{key:"perioder",value:{name:"Array",elements:[{name:"AttachmentMetadataTidsperiode"}],raw:"AttachmentMetadataTidsperiode[]",required:!1}},{key:"arbeidsforhold",value:{name:"any",required:!1}}]},required:!1}},{key:"id",value:{name:"string",required:!0}},{key:"filename",value:{name:"string",required:!0}},{key:"filesize",value:{name:"number",required:!0}},{key:"file",value:{name:"File",required:!0}},{key:"url",value:{name:"string",required:!1}},{key:"uuid",value:{name:"string",required:!1}},{key:"pending",value:{name:"boolean",required:!0}},{key:"uploaded",value:{name:"boolean",required:!0}},{key:"type",value:{name:"AttachmentType",required:!0}},{key:"skjemanummer",value:{name:"Skjemanummer",required:!0}},{key:"innsendingsType",value:{name:"InnsendingsType",required:!1}},{key:"error",value:{name:"any",required:!1}},{key:"beskrivelse",value:{name:"string",required:!1}}]}}],raw:"Attachment[]"},name:"attachments"}],return:{name:"void"}}}}},description:""},annenForelder:{required:!0,tsType:{name:"union",raw:"AnnenForelderIkkeOppgitt | AnnenForelderOppgitt",elements:[{name:"Common"},{name:"AnnenForelderOppgitt"}]},description:""}}};const Xn="_periodeAttachmentUploader_jo11m_1",er={periodeAttachmentUploader:Xn},c=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:i,termindato:s,situasjon:d,skjemanummer:u,labelText:k,description:E,attachmentType:l})=>{const{watch:o}=Oe(),A=o(u);return X.useEffect(()=>{if(A.length===0){const O=Ne(l,u),M=F(O,{type:h.UTTAK,perioder:t.map(K=>({fom:P(K.tidsperiode.fom),tom:P(K.tidsperiode.tom)}))});r([M])}},[r,t,A,l,u]),a.jsx(Re,{label:k,description:a.jsxs(a.Fragment,{children:[a.jsx(V,{children:E}),t.map(O=>a.jsx("div",{className:er.periodeAttachmentUploader,children:a.jsx($e,{periode:O,erAleneOmOmsorg:!1,erFarEllerMedmor:!0,navnPåForeldre:m,familiehendelsesdato:Te(i).toDate(),termindato:s?Te(s).toDate():void 0,situasjon:d,melding:void 0})},O.id))]}),attachmentType:l,skjemanummer:u,existingAttachments:e,updateAttachments:O=>{const M=O.map(K=>F(K,{type:h.UTTAK,perioder:t.map(U=>({fom:P(U.tidsperiode.fom),tom:P(U.tidsperiode.tom)}))}));return r(M)},saveAttachment:je("./","foreldrepenger")})};c.__docgenInfo={description:"",methods:[],displayName:"UttakUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
...
| Skjemanummer.OMSORGSOVERTAKELSE
| Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},description:""},labelText:{required:!0,tsType:{name:"string"},description:""},description:{required:!0,tsType:{name:"union",raw:"string | React.ReactNode",elements:[{name:"string"},{name:"ReactReactNode",raw:"React.ReactNode"}]},description:""},attachmentType:{required:!0,tsType:{name:"AttachmentType"},description:""}}};const Le=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:i,situasjon:s,termindato:d})=>{const u=y();return t.length===0?null:a.jsx(c,{attachments:e,updateAttachments:r(n.DOK_INNLEGGELSE_BARN),perioder:t,navnPåForeldre:m,familiehendelsesdato:i,termindato:d,situasjon:s,skjemanummer:n.DOK_INNLEGGELSE_BARN,labelText:u.formatMessage({id:"manglendeVedlegg.barnInnlagt.label"}),description:u.formatMessage({id:"manglendeVedlegg.barnInnlagt.description"}),attachmentType:S.UTSETTELSE_SYKDOM})};Le.__docgenInfo={description:"",methods:[],displayName:"BarnInnlagtDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
