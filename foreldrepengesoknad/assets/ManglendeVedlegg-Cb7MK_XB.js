import{aU as Oe,r as X,_ as a,bW as Re,bX as ge,Z as y,x as He,b4 as w,bY as $e,J as Te,y as Ce,G as Qe,$ as ce,bZ as Ze,a1 as T,q as G,b_ as _e,b$ as We,ar as Xe,c0 as en,c1 as nn,bs as ve,c2 as rn,I as Ae,a7 as L,D as an,a2 as tn,c3 as mn,c4 as un,c5 as sn,c6 as dn,c7 as ln,c8 as on,c9 as kn,ca as pn,cb as En,cc as yn,cd as Sn,ce as gn,cf as Tn,cg as _n,ch as An,ci as On,cj as Rn,ck as cn,cl as vn,cm as jn,cn as In,co as Nn,cp as Dn,cq as Ln,cr as Mn,a_ as fn,as as Kn,at as qn,a$ as hn,a0 as Gn,a5 as bn,bl as Un}from"./iframe-C5y15oMk.js";import{b as D,C as R,c as Fn}from"./FpDataContext-IB0i85UD.js";import{A as V,j as Pn,b as wn,a as Vn,o as Bn,f as Jn}from"./useFpNavigator-DXfT-ElB.js";import{j as P,a as xn,g as Yn,f as zn}from"./annenForelderUtils-lvjTX-jH.js";import{I as ee,A as h,b as S,S as n,c as Hn}from"./uttaksplanInfoUtils-Cqgqlo4l.js";import{g as $n}from"./guid-CsArkN6i.js";import{k as Cn,u as Qn,t as Zn}from"./api-D2TiTrPi.js";import{L as M}from"./List--KI15SmQ.js";const je=(e,r)=>async t=>{const m=new FormData;m.append("id",t.id),m.append("vedlegg",t.file,t.filename);const i=await Cn.post(`${e}/rest/storage/${r}/vedlegg`,{body:m});return{headers:{location:i.headers.get("Location")},data:await i.text()}},Wn=()=>"V".concat($n().replace(/-/g,"")),Ie=(e,r,t,m,i)=>({id:Wn(),file:e,filename:e.name,filesize:e.size,uploaded:!1,pending:!1,type:r,skjemanummer:t,innsendingsType:m,dokumenterer:i,url:null}),Ne=(e,r,t)=>Ie({name:""},e,r,ee.SEND_SENERE,t),Xn=(e,r,t)=>Ie({name:""},e,r,ee.AUTOMATISK,t),F=(e,r)=>({...e,dokumenterer:r}),De=(e,r)=>e.map((t,m)=>{const i=t.tom?ge(t.tom):r.formatMessage({id:"VedleggUploader.pågående"}),u=`${ge(t.fom)}-${i}`;return e.length===1||m===e.length-1?u:m<e.length-2?`${u}, `:`${u} ${r.formatMessage({id:"VedleggUploader.Og"})} `}).join(""),b=({attachments:e,updateAttachments:r,skjemanummer:t,labelText:m,description:i,attachmentType:u,metadataType:d,perioder:s})=>{const{watch:k}=Oe(),E=k(t);return X.useEffect(()=>{if(E.length===0){const l=Ne(u,t),o=F(l,{type:d,perioder:s});r([o])}},[r,E,u,t,d]),a.jsx(Re,{label:m,description:i,attachmentType:u,skjemanummer:t,existingAttachments:e,updateAttachments:l=>{const o=l.map(A=>F(A,{type:d,perioder:s}));r(o)},saveAttachment:je("./","foreldrepenger")})};b.__docgenInfo={description:"",methods:[],displayName:"VedleggUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| PeriodeUtenUttakUtsettelse
| PeriodeUtenUttak
| InfoPeriode`,elements:[{name:"union",raw:"UttaksperiodeBase | ForeldrepengerFørFødselUttaksperiode",elements:[{name:"UttaksperiodeBase"},{name:"ForeldrepengerFørFødselUttaksperiode"}]},{name:"Utsettelsesperiode"},{name:"Oppholdsperiode"},{name:"Overføringsperiode"},{name:"PeriodeHull"},{name:"PeriodeUtenUttakUtsettelse"},{name:"PeriodeUtenUttak"},{name:"union",raw:"AvslåttPeriode | UttakAnnenPartInfoPeriode | UtsettelseAnnenPartInfoPeriode",elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Fe=()=>a.jsxs(ce,{gap:"2",children:[a.jsx(Ze,{children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.label"})}),a.jsx(w,{className:"text-text-subtle",children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.beskrivelse.1"})}),a.jsx(w,{className:"text-text-subtle",children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.beskrivelse.2"})})]});Fe.__docgenInfo={description:"",methods:[],displayName:"IngenDokumentasjonPåkrevd"};const Pe=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:i,situasjon:u,erFarEllerMedmor:d,termindato:s})=>{if(t.length===0)return null;const k=y(),E=G(D(R.ANNEN_FORELDER)),l=G(D(R.OM_BARNET)),o=_e(E)?E.fnr:void 0,A=r(n.DOK_ARBEID_MOR);if(o&&!We(E)){const O=_e(E)&&d&&E.harRettPåForeldrepengerINorge===!1,f=ar(t,l,O,o),K=Qn({...Zn(f),enabled:!!f});if(K.isPending)return a.jsx(Xe,{className:"self-center",size:"large"});if(!(K.data??!0))return a.jsx(rr,{perioder:t,updateDokArbeidMorAttachment:A})}return a.jsx(c,{attachments:e,updateAttachments:A,perioder:t,navnPåForeldre:m,familiehendelsesdato:i,termindato:s,situasjon:u,skjemanummer:n.DOK_ARBEID_MOR,labelText:k.formatMessage({id:"manglendeVedlegg.morJobber.label"}),description:k.formatMessage({id:"manglendeVedlegg.morJobber.description"},{navn:m.mor}),attachmentType:S.MORS_AKTIVITET_DOKUMENTASJON})},rr=({updateDokArbeidMorAttachment:e,perioder:r})=>(X.useEffect(()=>{const t=Xn(S.MORS_AKTIVITET_DOKUMENTASJON,n.DOK_ARBEID_MOR),m=F(t,{type:h.UTTAK,perioder:r.map(i=>({fom:Ae(i.tidsperiode.fom),tom:Ae(i.tidsperiode.tom)}))});e([m])},[]),a.jsx(Fe,{})),ar=(e,r,t,m)=>{const i=(en(r)||nn(r))&&r.fnr!==void 0&&r.fnr.length>0?r.fnr[0]:void 0;return{annenPartFødselsnummer:m,barnFødselsnummer:i,familiehendelse:ve(r),perioder:e.map(u=>({fom:u.tidsperiode.fom.toISOString(),tom:u.tidsperiode.tom.toISOString(),periodeType:t&&rn(u)?"UTSETTELSE":"UTTAK"}))}};Pe.__docgenInfo={description:"",methods:[],displayName:"MorJobberDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
