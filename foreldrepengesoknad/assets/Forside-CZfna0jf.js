import{a5 as P,a$ as j,l as i,b0 as H,b1 as x,b2 as F,M as p,W as E,b3 as q,X as J,b4 as Y,b5 as $,b6 as C,r as z,b7 as W,m as X,b8 as Q,V as S,b9 as Z,ba as ee,bb as ae,a6 as re,bc as ne,H as b,B as te,o as le}from"./iframe-Cv_p28kA.js";import{p as K,C as d,q as ie,r as se,s as oe,t as c,I as f,v as ue,w as V,x as Ee,y as D,z as de}from"./FpDataContext-2RRjiYhG.js";import{g as L,C as me,d as ve,S as I,D as ke,E as Re,F as _e,G as Ne}from"./useFpNavigator-PyG5LcMF.js";import{D as ge}from"./DinePlikter-BM0t86fG.js";import{D as fe}from"./DinePersonopplysningerModal-BCcS-XD7.js";const pe=()=>{const a=K();return{oppdaterSøknadIState:(e,n)=>{a(d.SØKERSITUASJON,e.søkersituasjon),a(d.OM_BARNET,e.barn),a(d.ANNEN_FORELDER,e.annenForelder),a(d.ARBEIDSFORHOLD_OG_INNTEKT,e.arbeidsforholdOgInntekt),a(d.FRILANS,e.frilans),a(d.EGEN_NÆRING,e.egenNæring),a(d.ANDRE_INNTEKTSKILDER,e.andreInntektskilder),a(d.UTENLANDSOPPHOLD,e.utenlandsopphold),a(d.UTENLANDSOPPHOLD_TIDLIGERE,e.utenlandsoppholdSiste12Mnd),a(d.UTENLANDSOPPHOLD_SENERE,e.utenlandsoppholdNeste12Mnd),a(d.PERIODE_MED_FORELDREPENGER,e.dekningsgrad),a(d.UTTAKSPLAN,e.uttaksplan),a(d.UTTAKSPLAN_METADATA,{ønskerJustertUttakVedFødsel:e.ønskerJustertUttakVedFødsel}),n&&a(d.EKSISTERENDE_SAK,n)}}};var v=(a=>(a.FØDT="født",a.UFØDT="ufødt",a.ADOPTERT="adoptert",a.IKKE_UTFYLT="ikkeUtfylt",a))(v||{});const Te=(a,r)=>a.map(e=>{const n=e.sak?M(e.sak.åpenBehandling===void 0,r):void 0,s=e.sak?r.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"";return i.jsx(F,{value:e.id,description:e.sak?`${s}, ${n}`:s,children:i.jsx(p,{id:"velkommen.barnVelger.ufødtBarn",values:{antallBarnTekst:oe(e.antallBarn,r),termin:E(e.termindato).format(q),b:t=>i.jsx("b",{children:t})}})},e.id)}),M=(a,r)=>a?r.formatMessage({id:"velkommen.sak.status.ferdigBehandlet"}):r.formatMessage({id:"velkommen.sak.status.underBehandling"}),Ae=(a,r)=>a.map(e=>{const n=ie(e.fornavn,e.fødselsdatoer,e.omsorgsovertagelse,e.alleBarnaLever,e.antallBarn,r),s=se(e.fødselsdatoer),t=e.type===v.FØDT||e.type===v.IKKE_UTFYLT?s:E(e.omsorgsovertagelse).format(q),o=e.type===v.FØDT||e.type===v.IKKE_UTFYLT?r.formatMessage({id:"velkommen.barnVelger.født"}):r.formatMessage({id:"velkommen.barnVelger.adopsjon"}),u=e.sak?r.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"",R=e.sak?M(e.sak.åpenBehandling===void 0,r):void 0;return i.jsx(F,{value:e.id,description:R?`${u}, ${R}`:u,children:i.jsx("b",{children:e.alleBarnaLever?`${n} ${o} ${t}`:n})},e.id)}),B=({selectableBarn:a})=>{const r=P(),{control:e}=j();if(a.length===0)return null;const n=a.filter(o=>o.type===v.UFØDT),s=a.filter(o=>o.type!==v.UFØDT);let t=[];return s.length>0&&(t=t.concat(Ae(s,r))),n.length>0&&(t=t.concat(Te(n,r))),i.jsx(H,{name:"valgteBarn",control:e,label:i.jsx(p,{id:"velkommen.intro.harSaker.barnVelger.label"}),validate:[x(r.formatMessage({id:"steg.footer.spørsmålMåBesvares"}))],children:t.concat(i.jsx(F,{value:"søknad_gjeder_nytt_barn",description:r.formatMessage({id:"velkommen.intro.harSaker.barnVelger.info"}),children:i.jsx(p,{id:"omBarnet.gjelderAnnetBarn",values:{b:o=>i.jsx("b",{children:o})}})},"søknad_gjeder_nytt_barn"))})};B.__docgenInfo={description:"",methods:[],displayName:"BarnVelger",props:{selectableBarn:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: string;
    type: ValgtBarnType;
    antallBarn: number;
    sortableDato: Date;
...
| 'PROSESSERER'`,elements:[{name:"literal",value:"'UNDER_BEHANDLING'"},{name:"literal",value:"'VENT_TIDLIG_SØKNAD'"},{name:"literal",value:"'VENT_MELDEKORT'"},{name:"literal",value:"'VENT_DOKUMENTASJON'"},{name:"literal",value:"'VENT_INNTEKTSMELDING'"},{name:"literal",value:"'PROSESSERER'"}],required:!0}}]},required:!1}},{key:"ønskerJustertUttakVedFødsel",value:{name:"boolean",required:!1}}]},required:!1}},{key:"annenForelder",value:{name:"signature",type:"object",raw:`{
    ...
    mellomnavn?: string;
    etternavn: string;
}`,signature:{properties:[{key:"fornavn",value:{name:"string",required:!0}},{key:"mellomnavn",value:{name:"string",required:!1}},{key:"etternavn",value:{name:"string",required:!0}}]},required:!0}}]},required:!1}},{key:"familiehendelsesdato",value:{name:"Date",required:!1}},{key:"startdatoFørsteStønadsperiode",value:{name:"Date",required:!1}},{key:"alleBarnaLever",value:{name:"boolean",required:!0}}]}}],raw:"ValgtBarn[]"},description:""}}};E.extend(C);E.extend(de);const De=(a,r,e)=>a?v.ADOPTERT:r.fødselsdato!==void 0||e&&e.length>0?v.FØDT:v.UFØDT,Le=(a,r)=>{const e=a.familiehendelse.termindato;if($(e)){const n=E(e).subtract(17,"week"),s=E(e).add(6,"week");return r.filter(t=>E(t.fødselsdato).isBetween(n,s,"day","[]"))}return[]},Oe=(a,r)=>{const e=f(a.familiehendelse.fødselsdato),n=a.barn?a.barn.flatMap(o=>o.fnr):[],s=r.filter(o=>n.includes(o.fnr)),t=e?r.filter(o=>c(o.fødselsdato,e)&&!s.some(u=>u.fnr===o.fnr)):[];return s.concat(t)},ye=(a,r)=>{let e;(a.barn||a.familiehendelse.fødselsdato)&&(e=Oe(a,r)),a.familiehendelse.termindato&&!a.familiehendelse.fødselsdato&&!a.barn&&(e=Le(a,r));const n=f(Ee(a.familiehendelse.termindato,a.familiehendelse.fødselsdato,a.familiehendelse.omsorgsovertakelse)),s=De(a.gjelderAdopsjon,a.familiehendelse,e),t=f(a.familiehendelse.fødselsdato);let o;return e&&e.length>0?o=e.map(u=>E.utc(u.fødselsdato).toDate()):t!==void 0&&(o=new Array(a.familiehendelse.antallBarn).fill(t)),{id:L(),type:s,antallBarn:a.familiehendelse.antallBarn,termindato:f(a.familiehendelse.termindato),omsorgsovertagelse:f(a.familiehendelse.omsorgsovertakelse),kanSøkeOmEndring:a.kanSøkeOmEndring,sak:a,fødselsdatoer:o,familiehendelsesdato:n,sortableDato:f(a.familiehendelse.termindato),startdatoFørsteStønadsperiode:a.gjeldendeVedtak!==void 0&&a.gjeldendeVedtak.perioder.length>0?J(f(a.gjeldendeVedtak.perioder[0].fom)).denneEllerNeste():void 0,fornavn:e!==void 0&&e.length>0?e.filter(u=>u.navn?.fornavn!==void 0&&u.navn.fornavn.trim()!=="").map(u=>[u.navn?.fornavn,u.navn?.mellomnavn??""].join(" ")):void 0,fnr:e!==void 0&&e.length>0?e.filter(u=>u.fnr!==void 0).map(u=>u.fnr):void 0,alleBarnaLever:e!==void 0&&e.length>0?e.every(u=>D(u)):!1}},Se=(a,r)=>{const e=a.navn?.mellomnavn?[a.navn.fornavn,a.navn.mellomnavn].join(" "):a.navn?.fornavn;return{id:L(),type:v.IKKE_UTFYLT,antallBarn:1,fødselsdatoer:[E.utc(a.fødselsdato).toDate()],fornavn:e?[e]:void 0,fnr:[a.fnr],sortableDato:E.utc(a.fødselsdato).toDate(),alleBarnaLever:D(a),annenForelder:r}},Ie=(a,r,e)=>{const n=[a].concat(r).sort(Y);if(!(n.some(t=>!D(t)&&V(t))||n.length==0))return{id:L(),type:v.IKKE_UTFYLT,antallBarn:n.length,fødselsdatoer:n.map(t=>E.utc(t.fødselsdato).toDate()),fornavn:n.map(t=>[t.navn?.fornavn??"",t.navn?.mellomnavn??""].join(" ")),fnr:n.map(t=>t.fnr),sortableDato:E.utc(n[0].fødselsdato).toDate(),alleBarnaLever:n.every(t=>D(t)),annenForelder:e}},Fe=(a,r)=>a.filter(e=>e.barn!==void 0&&e.barn.length>0||e.familiehendelse.termindato!==void 0||e.familiehendelse.fødselsdato!==void 0||e.familiehendelse.omsorgsovertakelse!==void 0).map(e=>ye(e,r)),Ge=(a,r,e)=>{const n=a.filter(l=>!e.some(m=>c(l.fødselsdato,f(m.familiehendelse.fødselsdato)))),s="tempFnr",t=n.map(l=>l.fnr===void 0?{...l,fnr:s+L().toString()}:l),o=r.flatMap(l=>l.fnr),u=r.filter(l=>l.fødselsdatoer!==void 0&&l.fødselsdatoer.length>0).flatMap(l=>l.fødselsdatoer),R=[],O=t.filter(l=>!(l.dødsdato!==void 0&&u.some(m=>E(m).isSame(E.utc(l.fødselsdato),"day"))));for(const l of O)if(!o.includes(l.fnr)&&!me(l.fødselsdato)){const m=ue(l.fnr,l.fødselsdato,t);if(o.push(l.fnr),m.length===0){if(!V(l)){const g=Se(l,l.annenPart);R.push(g)}}else{const g=Ie(l,m,l.annenPart);for(const y of m)o.push(y.fnr);g!==void 0&&R.push(g)}}return R.map(l=>l.fnr&&l.fnr.length>0?{...l,fnr:l.fnr.filter(m=>m&&!m.startsWith(s))}:l)},be=(a,r)=>{const e=a.filter(o=>!o.sakAvsluttet),n=a.filter(o=>o.sakAvsluttet),s=Fe(e,r),t=Ge(r,s,n);return s.concat(t)},Pe=(a,r)=>{const e=r.filter(s=>s.sak!==void 0&&s.id!==a.id&&s.familiehendelsesdato!==void 0&&E(s.familiehendelsesdato).isAfter(a.familiehendelsesdato,"day"));e.sort(U);const n=e.at(-1);if(n!==void 0)return{familiehendelsesdato:n.familiehendelsesdato,startdatoFørsteStønadsperiode:n.startdatoFørsteStønadsperiode,fnr:n.fnr,annenForelderFnr:n.sak?.annenPart?.fnr}},U=(a,r)=>E(a.sortableDato).isBefore(r.sortableDato,"d")?1:E(a.sortableDato).isAfter(r.sortableDato,"d")?-1:0,qe=({saker:a,harGodkjentVilkår:r,søkerInfo:e,setHarGodkjentVilkår:n,setErEndringssøknad:s,setSøknadGjelderNyttBarn:t,mellomlagreSøknadOgNaviger:o})=>{const u=P(),R=ve(e.arbeidsforhold,o),O=K(),{oppdaterSøknadIState:T}=pe(),l=z.useMemo(()=>[...be(a,e.person.barn)].sort(U),[a,e.person.barn]),m=N=>{if(!N.harForståttRettigheterOgPlikter){console.error("harForståttRettigheterOgPlikter er falsy til tross for at formet skal ha validert den",N.harForståttRettigheterOgPlikter);return}n(!0);const k=l.find(_=>_.id===N.valgteBarn);if(k===void 0)return s(!1),t(!0),R.goToNextStep(I.SØKERSITUASJON);const G=Pe(k,l);O(d.BARN_FRA_NESTE_SAK,G);const A=!!k.kanSøkeOmEndring?a.find(_=>_.saksnummer===k.sak?.saksnummer):void 0;if(A){const _=ke(A,G?.startdatoFørsteStønadsperiode,k.fødselsdatoer),w=Re(e.person,_,u,A.annenPart,k);return T(w,_),s(!0),t(!1),R.goToNextStep(I.UTTAKSPLAN)}if(k.sak!==void 0&&k.kanSøkeOmEndring===!1){const _=_e({...k,sak:k.sak},u,e.person.barn,e.person.fnr);T(_)}if(!A){const _=Ne(k);T(_)}return s(!1),t(!1),R.goToNextStep(I.SØKERSITUASJON)},g=W({defaultValues:{harForståttRettigheterOgPlikter:r}}),y=g.watch("valgteBarn"),h=l.find(N=>N.id===y)?.kanSøkeOmEndring===!0?u.formatMessage({id:"velkommen.endreSøknad"}):u.formatMessage({id:"velkommen.begynnMedSøknad"});return i.jsx(X,{pageTitle:i.jsx(p,{id:"søknad.pageheading"}),children:i.jsx(Q,{formMethods:g,onSubmit:m,children:i.jsxs(S,{gap:"space-32",children:[i.jsx(Z,{poster:!0,children:i.jsxs(S,{gap:"space-8",children:[i.jsx(p,{id:"velkommen.guidepanel.del1"}),i.jsx(p,{id:"velkommen.guidepanel.del2",values:{a:N=>i.jsx(ee,{rel:"noopener noreferrer",href:ae.foreldrepenger,children:N})}})]})}),i.jsx(B,{selectableBarn:l}),i.jsx(re,{variant:"info",children:i.jsx(p,{id:"velkommen.lagring.info"})}),i.jsx(ne,{name:"harForståttRettigheterOgPlikter",control:g.control,label:u.formatMessage({id:"velkommen.samtykke"}),validate:[N=>N?null:u.formatMessage({id:"valideringsfeil.velkommen.harForståttRettigheterOgPlikter.påkrevd"})],children:i.jsx(S,{gap:"space-20",children:i.jsxs(b,{gap:"space-4",children:[i.jsx(te,{children:i.jsx(p,{id:"velkommen.samtykkeIntro.del1"})}),i.jsx(ge,{})]})})}),i.jsx(b,{justify:"center",children:i.jsx(le,{type:"submit",variant:"primary",children:h})}),i.jsx(fe,{})]})})})};qe.__docgenInfo={description:"",methods:[],displayName:"Forside",props:{saker:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    annenPart?: Person_fpoversikt;
    barn?: Person_fpoversikt[];
    dekningsgrad?: DekningsgradSak_fpoversikt;
    familiehendelse: Familiehendelse_fpoversikt;
