import{aZ as Ae,r as X,l as t,b_ as De,b$ as Ee,a6 as k,C as He,ba as F,c0 as Ce,U as ve,D as $e,V as Oe,c1 as Qe,M as S,x as w,c2 as Se,c3 as Ze,L as We,c4 as Xe,c5 as er,by as Ne,c6 as rr,T as Te,B as I,J as nr,a8 as tr,c7 as ar,c8 as ir,c9 as sr,ca as mr,cb as ur,cc as lr,cd as or,ce as dr,cf as pr,cg as gr,ch as yr,ci as kr,cj as Er,ck as vr,cl as Sr,cm as Tr,cn as Ar,co as Dr,cp as Or,cq as Nr,cr as _r,cs as Rr,ct as jr,cu as cr,cv as Ir,b4 as fr,m as br,at as Lr,b5 as qr,a7 as Kr,q as Gr,bq as wr}from"./iframe-nuihC56X.js";import{b as c,C as D,c as hr}from"./FpDataContext-CU9ax49h.js";import{A as V,j as Pr,b as Mr,a as Ur,o as Fr,f as Vr}from"./useFpNavigator-D7usOBgR.js";import{j as U,a as Br,g as Jr,f as xr}from"./annenForelderUtils-3ocJRZ7l.js";import{A as G,b as E,S as r,c as Yr}from"./uttaksplanInfoUtils-DmaNmK1p.js";import{k as zr,A as _e,u as Hr,t as Cr}from"./index-BXE-RbKe.js";import{g as $r}from"./eksisterendeSakUtils-BCowvDlE.js";import{L as f}from"./List-fA6h6thd.js";const Re=e=>async n=>{const a=new FormData;return a.append("id",n.id),a.append("vedlegg",n.file,n.filename),{data:await(await zr.post(e,{body:a})).json()}},Qr=()=>"V".concat($r().replace(/-/g,"")),je=(e,n,a,i,m)=>({id:Qr(),file:e,filename:e.name,filesize:e.size,uploaded:!1,pending:!1,type:n,skjemanummer:a,innsendingsType:i,dokumenterer:m}),ce=(e,n,a)=>je({name:""},e,n,"SEND_SENERE",a),Zr=(e,n,a)=>je({name:""},e,n,"AUTOMATISK",a),M=(e,n)=>({...e,dokumenterer:n}),Ie=(e,n)=>e.map((a,i)=>{const m=a.tom?Ee(a.tom):n.formatMessage({id:"VedleggUploader.pågående"}),s=`${Ee(a.fom)}-${m}`;return e.length===1||i===e.length-1?s:i<e.length-2?`${s}, `:`${s} ${n.formatMessage({id:"VedleggUploader.Og"})} `}).join(""),h=({attachments:e,updateAttachments:n,skjemanummer:a,labelText:i,description:m,attachmentType:s,metadataType:l,perioder:u})=>{const{watch:p}=Ae(),y=p(a);return X.useEffect(()=>{if(y.length===0){const o=ce(s,a),d=M(o,{type:l,perioder:u});n([d])}},[n,y,s,a,l]),t.jsx(De,{label:i,description:m,attachmentType:s,skjemanummer:a,existingAttachments:e,updateAttachments:o=>{const d=o.map(b=>M(b,{type:l,perioder:u}));n(d)},saveAttachment:Re(_e.sendVedlegg)})};h.__docgenInfo={description:"",methods:[],displayName:"VedleggUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
