import{aZ as Ae,r as X,l as a,b_ as Oe,b$ as ye,a6 as g,C as He,ba as F,c0 as Ce,U as Se,D as $e,V as _e,c1 as Qe,M as T,x as P,c2 as Te,c3 as Ze,L as We,c4 as Xe,c5 as en,by as Ne,c6 as nn,T as ve,B as f,J as rn,a8 as an,c7 as tn,c8 as mn,c9 as un,ca as sn,cb as ln,cc as on,cd as dn,ce as En,cf as pn,cg as kn,ch as gn,ci as yn,cj as Sn,ck as Tn,cl as vn,cm as An,cn as On,co as _n,cp as Nn,cq as Rn,cr as Dn,cs as In,ct as Ln,cu as fn,cv as jn,b4 as Kn,m as cn,at as Gn,b5 as qn,a7 as Mn,q as Pn,bq as bn}from"./iframe-DYhcwcKA.js";import{b as L,C as O,c as Un}from"./FpDataContext-Bx28Axgs.js";import{A as V,j as hn,b as wn,a as Fn,o as Vn,f as Bn}from"./useFpNavigator-a443d3wj.js";import{j as w,a as Jn,g as xn,f as Yn}from"./annenForelderUtils-Bb1j5cEK.js";import{A as M,b as y,S as n,c as zn}from"./uttaksplanInfoUtils-DmaNmK1p.js";import{k as Hn,A as Re,u as Cn,t as $n}from"./index-BiUK_abL.js";import{g as Qn}from"./eksisterendeSakUtils-INcwg-EC.js";import{L as j}from"./List-Cr7AMIkY.js";const De=e=>async r=>{const t=new FormData;return t.append("id",r.id),t.append("vedlegg",r.file,r.filename),{data:await(await Hn.post(e,{body:t})).json()}},Zn=()=>"V".concat(Qn().replace(/-/g,"")),Ie=(e,r,t,m,u)=>({id:Zn(),file:e,filename:e.name,filesize:e.size,uploaded:!1,pending:!1,type:r,skjemanummer:t,innsendingsType:m,dokumenterer:u}),Le=(e,r,t)=>Ie({name:""},e,r,"SEND_SENERE",t),Wn=(e,r,t)=>Ie({name:""},e,r,"AUTOMATISK",t),h=(e,r)=>({...e,dokumenterer:r}),fe=(e,r)=>e.map((t,m)=>{const u=t.tom?ye(t.tom):r.formatMessage({id:"VedleggUploader.pågående"}),i=`${ye(t.fom)}-${u}`;return e.length===1||m===e.length-1?i:m<e.length-2?`${i}, `:`${i} ${r.formatMessage({id:"VedleggUploader.Og"})} `}).join(""),b=({attachments:e,updateAttachments:r,skjemanummer:t,labelText:m,description:u,attachmentType:i,metadataType:l,perioder:s})=>{const{watch:E}=Ae(),k=E(t);return X.useEffect(()=>{if(k.length===0){const o=Le(i,t),d=h(o,{type:l,perioder:s});r([d])}},[r,k,i,t,l]),a.jsx(Oe,{label:m,description:u,attachmentType:i,skjemanummer:t,existingAttachments:e,updateAttachments:o=>{const d=o.map(K=>h(K,{type:l,perioder:s}));r(d)},saveAttachment:De(Re.sendVedlegg)})};b.__docgenInfo={description:"",methods:[],displayName:"VedleggUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},name:"skjemanummer"}],return:{name:"signature",type:"function",raw:"(attachments: Attachment[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    fom: string;
    tom?: string;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!1}}]}}],raw:"ÅpenPeriodeDto[]",required:!1}},{key:"type",value:{name:"union",raw:"'BARN' | 'OPPTJENING' | 'UTTAK' | 'TILRETTELEGGING'",elements:[{name:"literal",value:"'BARN'"},{name:"literal",value:"'OPPTJENING'"},{name:"literal",value:"'UTTAK'"},{name:"literal",value:"'TILRETTELEGGING'"}],required:!0}}]},required:!1}},{key:"id",value:{name:"string",required:!0}},{key:"filename",value:{name:"string",required:!0}},{key:"filesize",value:{name:"number",required:!0}},{key:"file",value:{name:"File",required:!0}},{key:"uuid",value:{name:"string",required:!1}},{key:"pending",value:{name:"boolean",required:!0}},{key:"uploaded",value:{name:"boolean",required:!0}},{key:"type",value:{name:"AttachmentType",required:!0}},{key:"skjemanummer",value:{name:"Skjemanummer",required:!0}},{key:"innsendingsType",value:{name:"union",raw:"'LASTET_OPP' | 'SEND_SENERE' | 'AUTOMATISK'",elements:[{name:"literal",value:"'LASTET_OPP'"},{name:"literal",value:"'SEND_SENERE'"},{name:"literal",value:"'AUTOMATISK'"}],required:!0}},{key:"error",value:{name:"any",required:!1}},{key:"beskrivelse",value:{name:"string",required:!1}}]}}],raw:"Attachment[]"},name:"attachments"}],return:{name:"void"}}}}},description:""},annenForelder:{required:!0,tsType:{name:"union",raw:"AnnenForelderIkkeOppgitt | AnnenForelderOppgitt",elements:[{name:"Common"},{name:"AnnenForelderOppgitt"}]},description:""}}};const _=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:u,termindato:i,situasjon:l,skjemanummer:s,labelText:E,description:k,attachmentType:o})=>{const{watch:d}=Ae(),K=d(s);return X.useEffect(()=>{if(K.length===0){const A=Le(o,s),c=h(A,{type:M.UTTAK,perioder:t.map(G=>({fom:w(G.tidsperiode.fom),tom:w(G.tidsperiode.tom)}))});r([c])}},[r,t,K,o,s]),a.jsx(Oe,{label:E,description:a.jsxs(a.Fragment,{children:[a.jsx(F,{children:k}),t.map(A=>a.jsx("div",{className:"my-4",children:a.jsx(Ce,{periode:A,erAleneOmOmsorg:!1,erFarEllerMedmor:!0,navnPåForeldre:m,familiehendelsesdato:Se(u).toDate(),termindato:i?Se(i).toDate():void 0,situasjon:l,melding:void 0})},A.id))]}),attachmentType:o,skjemanummer:s,existingAttachments:e,updateAttachments:A=>{const c=A.map(G=>h(G,{type:M.UTTAK,perioder:t.map(U=>({fom:w(U.tidsperiode.fom),tom:w(U.tidsperiode.tom)}))}));return r(c)},saveAttachment:De(Re.sendVedlegg)})};_.__docgenInfo={description:"",methods:[],displayName:"UttakUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const ce=({attachments:e,updateAttachments:r,arbeidsforholdOgInntekt:t,andreInntektskilder:m})=>{const u=g();if(!t||t&&t.harHattAndreInntektskilder===!1||!m||!m.some(l=>l.type===V.SLUTTPAKKE))return null;const i=m.filter(l=>l.type===V.SLUTTPAKKE);return a.jsx(b,{attachments:e,updateAttachments:r(n.ETTERLØNN_ELLER_SLUTTVEDERLAG),skjemanummer:n.ETTERLØNN_ELLER_SLUTTVEDERLAG,labelText:u.formatMessage({id:"manglendeVedlegg.etterlønn.tittel"},{perioder:fe(i,u),antallPerioder:i.length}),description:u.formatMessage({id:"manglendeVedlegg.etterlønn.description"}),attachmentType:y.ANNEN_INNTEKT,metadataType:M.OPPTJENING,perioder:i})};ce.__docgenInfo={description:"",methods:[],displayName:"EtterlønnEllerSluttvederlagDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const Me=({attachments:e,updateAttachments:r,arbeidsforholdOgInntekt:t,andreInntektskilder:m})=>{const u=g();if(!t||t&&!t.harHattAndreInntektskilder||!m||!m.some(l=>l.type===V.MILITÆRTJENESTE))return null;const i=m.filter(l=>l.type===V.MILITÆRTJENESTE);return a.jsx(b,{attachments:e,updateAttachments:r(n.DOK_MILITÆR_SILVIL_TJENESTE),skjemanummer:n.DOK_MILITÆR_SILVIL_TJENESTE,labelText:u.formatMessage({id:"manglendeVedlegg.militær.tittel"},{perioder:fe(i,u),antallPerioder:i.length}),description:u.formatMessage({id:"manglendeVedlegg.militær.description"}),attachmentType:y.ANNEN_INNTEKT,metadataType:M.OPPTJENING,perioder:i})};Me.__docgenInfo={description:"",methods:[],displayName:"MilitærEllerSiviltjenesteDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const be=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:u,situasjon:i,termindato:l,erFarEllerMedmor:s})=>{const E=g();if(t.length===0)return null;const k=t.some(o=>o.type===$e.Uttak&&o.erMorForSyk===!0&&o.konto==="FEDREKVOTE");return a.jsx(_,{attachments:e,updateAttachments:r(n.DOK_INNLEGGELSE_MOR),perioder:t,navnPåForeldre:m,familiehendelsesdato:u,termindato:l,situasjon:i,skjemanummer:n.DOK_INNLEGGELSE_MOR,labelText:k?E.formatMessage({id:"manglendeVedlegg.morInnlagtEllerSyk.label"},{navn:m.mor,erFarEllerMedmor:s}):E.formatMessage({id:"manglendeVedlegg.morInnlagt.label"},{navn:m.mor,erFarEllerMedmor:s}),description:k?E.formatMessage({id:"manglendeVedlegg.morInnlagtEllerSyk.description"},{navn:m.mor,erFarEllerMedmor:s}):E.formatMessage({id:"manglendeVedlegg.morInnlagt.description"},{navn:m.mor,erFarEllerMedmor:s}),attachmentType:y.UTSETTELSE_SYKDOM})};be.__docgenInfo={description:"",methods:[],displayName:"MorInnlagtDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const he=()=>a.jsxs(_e,{gap:"space-8",children:[a.jsx(Qe,{children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.label"})}),a.jsx(F,{className:"text-ax-text-neutral-subtle",children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.beskrivelse.1"})}),a.jsx(F,{className:"text-ax-text-neutral-subtle",children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.beskrivelse.2"})})]});he.__docgenInfo={description:"",methods:[],displayName:"IngenDokumentasjonPåkrevd"};const we=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:u,situasjon:i,erFarEllerMedmor:l,termindato:s})=>{if(t.length===0)return null;const E=g(),k=P(L(O.ANNEN_FORELDER)),o=P(L(O.OM_BARNET)),d=Te(k)?k.fnr:void 0,K=r(n.DOK_ARBEID_MOR);if(d&&!Ze(k)){const A=Te(k)&&l&&k.harRettPåForeldrepengerINorge===!1,c=er(t,o,A,d),G=Cn({...$n(c),enabled:!!c});if(G.isPending)return a.jsx(We,{className:"self-center",size:"large"});if(!(G.data??!0))return a.jsx(Xn,{perioder:t,updateDokArbeidMorAttachment:K})}return a.jsx(_,{attachments:e,updateAttachments:K,perioder:t,navnPåForeldre:m,familiehendelsesdato:u,termindato:s,situasjon:i,skjemanummer:n.DOK_ARBEID_MOR,labelText:E.formatMessage({id:"manglendeVedlegg.morJobber.label"}),description:E.formatMessage({id:"manglendeVedlegg.morJobber.description"},{navn:m.mor}),attachmentType:y.MORS_AKTIVITET_DOKUMENTASJON})},Xn=({updateDokArbeidMorAttachment:e,perioder:r})=>(X.useEffect(()=>{const t=Wn(y.MORS_AKTIVITET_DOKUMENTASJON,n.DOK_ARBEID_MOR),m=h(t,{type:M.UTTAK,perioder:r.map(u=>({fom:ve(u.tidsperiode.fom),tom:ve(u.tidsperiode.tom)}))});e([m])},[]),a.jsx(he,{})),er=(e,r,t,m)=>{const u=(Xe(r)||en(r))&&r.fnr!==void 0&&r.fnr.length>0?r.fnr[0]:void 0;return{annenPartFødselsnummer:m,barnFødselsnummer:u,familiehendelse:Ne(r),perioder:e.map(i=>({fom:i.tidsperiode.fom.toISOString(),tom:i.tidsperiode.tom.toISOString(),periodeType:t&&nn(i)?"UTSETTELSE":"UTTAK"}))}};we.__docgenInfo={description:"",methods:[],displayName:"MorJobberDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Je=({attachments:e,updateAttachments:r,søkersituasjon:t})=>{const m=g();return t.situasjon!=="adopsjon"?null:a.jsx(b,{attachments:e,updateAttachments:r(n.OMSORGSOVERTAKELSE),skjemanummer:n.OMSORGSOVERTAKELSE,labelText:m.formatMessage({id:"manglendeVedlegg.omsorgsovertakelse.tittel"}),description:m.formatMessage({id:"manglendeVedlegg.omsorgsovertakelse.description"}),attachmentType:y.OMSORGSOVERTAKELSE,metadataType:M.BARN})};Je.__docgenInfo={description:"",methods:[],displayName:"OmsorgsovertakelseDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},name:"skjemanummer"}],return:{name:"signature",type:"function",raw:"(attachments: Attachment[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    situasjon?: Situasjon;
}`,signature:{properties:[{key:"situasjon",value:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}],required:!1}}]}},description:""}}};const nr=(e,r)=>e?r?Jn(r):!1:!0,xe=({attachments:e,updateAttachments:r,barn:t,arbeidsforhold:m,erFarEllerMedmor:u})=>{const i=g(),l=hn(m,rn(t),u,Ne(t));return!an(t)||l.length>0&&!u||!nr(u,t.termindato)?null:a.jsx(b,{attachments:e,updateAttachments:r(n.TERMINBEKREFTELSE),skjemanummer:n.TERMINBEKREFTELSE,labelText:i.formatMessage({id:"manglendeVedlegg.terminbekreftelse.tittel"}),description:i.formatMessage({id:u?"manglendeVedlegg.terminbekreftelse.description.farMedmor":"manglendeVedlegg.terminbekreftelse.description"}),attachmentType:y.TERMINBEKREFTELSE,metadataType:M.BARN})};xe.__docgenInfo={description:"",methods:[],displayName:"TerminbekreftelseDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
