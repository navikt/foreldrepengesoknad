import{j as e}from"./jsx-runtime-_e34SzbC.js";import{k as l}from"./Tidsperioden-Dc48v2NC.js";import"./index--IHLcpuH.js";import"./index-DVXBtNgz.js";import{s as m}from"./useFpNavigator-Cz3ua1mF.js";import"./_baseToString-CUxX9raG.js";import"./_createSet-BJbToUt4.js";import{B as u,H as g,V as p}from"./VStack-DueXo9sZ.js";import{b as v,B as s}from"./Link-SOWRV7cb.js";import{M as i}from"./message-DeLtoR4y.js";import{S as f}from"./BabyWrapped-B-EXJU7p.js";const c=({person:r,fødselsnummerForVisning:t,fødselsdatoForVisning:a,altTekstHvisUkjentNavn:n,visEtternavn:o})=>{const d=l("circle");return e.jsx(u,{padding:"4",background:"surface-alt-3-subtle",borderRadius:"medium",children:e.jsxs(g,{justify:"space-between",align:"start",children:[e.jsxs(p,{gap:"2",style:{width:"85%"},children:[e.jsx(v,{children:n!==void 0?n:m(r.fornavn,r.etternavn,o,r.mellomnavn)}),t!==void 0&&e.jsx(s,{children:e.jsx(i,{id:"registrertePersonalia.fødselsnummer",values:{fnr:t}})}),!n&&a!==void 0&&e.jsx(s,{children:e.jsx(i,{id:"registrertePersonalia.fødselsdato",values:{fødselsdato:a}})})]}),e.jsx("div",{className:d.block,children:e.jsx(f,{height:24,width:24,color:"#005B82"})})]})})};c.__docgenInfo={description:"",methods:[],displayName:"RegistrertePersonalia",props:{person:{required:!0,tsType:{name:"union",raw:"SøkerAnnenForelder | SøkerBarn",elements:[{name:"intersection",raw:`{
    fødselsdato?: string;
