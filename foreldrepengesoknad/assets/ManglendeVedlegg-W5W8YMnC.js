import{j as a}from"./jsx-runtime-Cw0GR0a5.js";import{u as D,C as f,a as Ve}from"./FpDataContext-BUlrLNeW.js";import{A as F,g as we,a as Be,u as Je,o as xe,p as Ye}from"./useFpNavigator-WIwCZxad.js";import{h as Se,u as ze,R as He,S as Ce}from"./ErrorSummaryHookForm-DIPKgYWN.js";import{u as E,B as ge,a as N,M as T,H as $e}from"./Label-CHcQrBTs.js";import{G as b,D as Qe,g as We,p as Xe}from"./barnUtils-y8Sk8GhT.js";import{I as Te,S as n,a as S,A as M,g as Ze}from"./uttaksplanInfoUtils-D1gWXJkx.js";import{be as Ee,bf as _e,Y as en,bg as nn,m as rn,au as an,f as tn,g as mn,_ as sn,aa as un,b0 as dn,b1 as ln,b2 as on,b3 as kn,b4 as pn,bh as En,bi as yn,bj as Sn,bk as gn,bl as Tn,bm as _n,bn as An,bo as On,bp as Rn,bq as cn,br as jn,bs as vn,bt as Nn,bu as In,bv as fn,bw as Dn,bx as Ln,by as Mn,n as U,bc as Kn,bz as qn,b as hn,E as Gn}from"./Uttaksplan-D5GrSPw2.js";import{d as ye}from"./dates-CnjFIE5s.js";import{r as Ae}from"./index-CTjT7uj6.js";import{g as bn}from"./guid-CsArkN6i.js";import{k as Un}from"./index-D0Djxy9a.js";import{V as B}from"./VStack-CqTcH1lX.js";const Oe=(e,r)=>async t=>{const m=new FormData;m.append("id",t.id),m.append("vedlegg",t.file,t.filename);const i=await Un.post(`${e}/rest/storage/${r}/vedlegg`,{body:m});return{headers:{location:i.headers.get("Location")},data:await i.text()}},Fn=()=>"V".concat(bn().replace(/-/g,"")),Pn=(e,r,t,m,i)=>({id:Fn(),file:e,filename:e.name,filesize:e.size,uploaded:!1,pending:!1,type:r,skjemanummer:t,innsendingsType:m,dokumenterer:i}),Re=(e,r,t)=>Pn({name:"",size:""},e,r,Te.SEND_SENERE,t),P=(e,r)=>({...e,dokumenterer:r}),ce=(e,r)=>e.map((t,m)=>{const i=t.tom?Ee(t.tom):r.formatMessage({id:"VedleggUploader.pågående"}),s=`${Ee(t.fom)}-${i}`;return e.length===1||m===e.length-1?s:m<e.length-2?`${s}, `:`${s} ${r.formatMessage({id:"VedleggUploader.Og"})} `}).join(""),q=({attachments:e,updateAttachments:r,skjemanummer:t,labelText:m,description:i,attachmentType:s,metadataType:d,perioder:u})=>{const{watch:k}=Se(),_=k(t);return Ae.useEffect(()=>{if(_.length===0){const l=Re(s,t),o=P(l,{type:d,perioder:u});r([o])}},[r,_,s,t,d]),a.jsx(_e,{label:m,description:i,attachmentType:s,skjemanummer:t,existingAttachments:e,updateAttachments:l=>{const o=l.map(L=>P(L,{type:d,perioder:u}));r(o)},saveAttachment:Oe("./","foreldrepenger")})};q.__docgenInfo={description:"",methods:[],displayName:"VedleggUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},name:"skjemanummer"}],return:{name:"signature",type:"function",raw:"(attachments: Attachment[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    perioder?: AttachmentMetadataTidsperiode[];
    arbeidsforhold?: any;
}`,signature:{properties:[{key:"type",value:{name:"AttachmentMetadataType",required:!0}},{key:"perioder",value:{name:"Array",elements:[{name:"AttachmentMetadataTidsperiode"}],raw:"AttachmentMetadataTidsperiode[]",required:!1}},{key:"arbeidsforhold",value:{name:"any",required:!1}}]},required:!1}},{key:"id",value:{name:"string",required:!0}},{key:"filename",value:{name:"string",required:!0}},{key:"filesize",value:{name:"number",required:!0}},{key:"file",value:{name:"File",required:!0}},{key:"url",value:{name:"string",required:!1}},{key:"uuid",value:{name:"string",required:!1}},{key:"pending",value:{name:"boolean",required:!0}},{key:"uploaded",value:{name:"boolean",required:!0}},{key:"type",value:{name:"AttachmentType",required:!0}},{key:"skjemanummer",value:{name:"Skjemanummer",required:!0}},{key:"innsendingsType",value:{name:"InnsendingsType",required:!1}},{key:"error",value:{name:"any",required:!1}},{key:"beskrivelse",value:{name:"string",required:!1}}]}}],raw:"Attachment[]"},name:"attachments"}],return:{name:"void"}}}}},description:""},annenForelder:{required:!0,tsType:{name:"union",raw:"AnnenForelderIkkeOppgitt | AnnenForelderOppgitt",elements:[{name:"Common"},{name:"AnnenForelderOppgitt"}]},description:""}}};const A=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:i,termindato:s,situasjon:d,skjemanummer:u,labelText:k,description:_,attachmentType:l})=>{const o=rn("periode-attachment-uploader"),{watch:L}=Se(),h=L(u);return Ae.useEffect(()=>{if(h.length===0){const I=Re(l,u),G=P(I,{type:M.UTTAK,perioder:t.map(K=>({fom:b(K.tidsperiode.fom),tom:b(K.tidsperiode.tom)}))});r([G])}},[r,t,h,l,u]),a.jsx(_e,{label:k,description:a.jsxs(a.Fragment,{children:[a.jsx(ge,{children:_}),t.map(I=>a.jsx("div",{className:o.block,children:a.jsx(nn,{periode:I,erAleneOmOmsorg:!1,erFarEllerMedmor:!0,navnPåForeldre:m,familiehendelsesdato:ye(i).toDate(),termindato:s?ye(s).toDate():void 0,situasjon:d,melding:void 0})},I.id))]}),attachmentType:l,skjemanummer:u,existingAttachments:e,updateAttachments:I=>{const G=I.map(K=>P(K,{type:M.UTTAK,perioder:t.map(O=>({fom:b(O.tidsperiode.fom),tom:b(O.tidsperiode.tom)}))}));return r(G)},saveAttachment:Oe("./","foreldrepenger")})};A.__docgenInfo={description:"",methods:[],displayName:"UttakUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
...
| PeriodeUtenUttakUtsettelse
| PeriodeUtenUttak
| InfoPeriode`,elements:[{name:"union",raw:"UttaksperiodeBase | ForeldrepengerFørFødselUttaksperiode",elements:[{name:"UttaksperiodeBase"},{name:"ForeldrepengerFørFødselUttaksperiode"}]},{name:"Utsettelsesperiode"},{name:"Oppholdsperiode"},{name:"Overføringsperiode"},{name:"PeriodeHull"},{name:"PeriodeUtenUttakUtsettelse"},{name:"PeriodeUtenUttak"},{name:"union",raw:"AvslåttPeriode | UttakAnnenPartInfoPeriode | UtsettelseAnnenPartInfoPeriode",elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Ue=({attachments:e,updateAttachments:r,søkersituasjon:t})=>{const m=E();return t.situasjon!=="adopsjon"?null:a.jsx(q,{attachments:e,updateAttachments:r(n.OMSORGSOVERTAKELSE),skjemanummer:n.OMSORGSOVERTAKELSE,labelText:m.formatMessage({id:"manglendeVedlegg.omsorgsovertakelse.tittel"}),description:m.formatMessage({id:"manglendeVedlegg.omsorgsovertakelse.description"}),attachmentType:S.OMSORGSOVERTAKELSE,metadataType:M.BARN})};Ue.__docgenInfo={description:"",methods:[],displayName:"OmsorgsovertakelseDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
