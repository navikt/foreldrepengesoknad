import{aW as Oe,r as Z,X as a,b_ as Re,b$ as ge,W as y,v as He,b7 as w,c0 as $e,H as Te,w as Ce,E as Qe,Z as ce,c1 as We,$ as T,o as G,c2 as Ae,c3 as Xe,c4 as Ze,c5 as en,c6 as nn,bv as Ie,c7 as rn,G as _e,a4 as D,B as an,a0 as tn,c8 as mn,c9 as un,ca as sn,cb as dn,cc as ln,cd as on,ce as kn,cf as En,cg as pn,ch as yn,ci as Sn,cj as gn,ck as Tn,cl as An,cm as _n,cn as On,co as Rn,cp as cn,cq as In,cr as vn,cs as jn,ct as Nn,cu as Dn,cv as Ln,cw as Mn,b1 as fn,ap as Kn,aq as qn,b2 as hn,_ as Gn,a2 as bn,bn as Un}from"./iframe-DTWnsIe1.js";import{b as N,C as O,c as Fn}from"./FpDataContext-5f57BOqc.js";import{A as V,j as Pn,b as wn,a as Vn,o as Bn,f as Jn}from"./useFpNavigator-T943Boiz.js";import{j as P,a as xn,g as Yn,f as zn}from"./annenForelderUtils-B24xp3AB.js";import{I as ee,A as h,b as S,S as n,c as Hn}from"./uttaksplanInfoUtils-BH180WuS.js";import{g as $n}from"./eksisterendeSakUtils-Drz8hvIP.js";import{k as Cn,a as Qn,t as Wn}from"./index-Ba5nYwwA.js";import{L}from"./List-Cn0j-QaZ.js";const ve=(e,r)=>async t=>{const m=new FormData;m.append("id",t.id),m.append("vedlegg",t.file,t.filename);const i=await Cn.post(`${e}/rest/storage/${r}/vedlegg`,{body:m});return{headers:{location:i.headers.get("Location")},data:await i.text()}},Xn=()=>"V".concat($n().replace(/-/g,"")),je=(e,r,t,m,i)=>({id:Xn(),file:e,filename:e.name,filesize:e.size,uploaded:!1,pending:!1,type:r,skjemanummer:t,innsendingsType:m,dokumenterer:i,url:null}),Ne=(e,r,t)=>je({name:""},e,r,ee.SEND_SENERE,t),Zn=(e,r,t)=>je({name:""},e,r,ee.AUTOMATISK,t),F=(e,r)=>({...e,dokumenterer:r}),De=(e,r)=>e.map((t,m)=>{const i=t.tom?ge(t.tom):r.formatMessage({id:"VedleggUploader.pågående"}),u=`${ge(t.fom)}-${i}`;return e.length===1||m===e.length-1?u:m<e.length-2?`${u}, `:`${u} ${r.formatMessage({id:"VedleggUploader.Og"})} `}).join(""),b=({attachments:e,updateAttachments:r,skjemanummer:t,labelText:m,description:i,attachmentType:u,metadataType:d,perioder:s})=>{const{watch:k}=Oe(),p=k(t);return Z.useEffect(()=>{if(p.length===0){const l=Ne(u,t),o=F(l,{type:d,perioder:s});r([o])}},[r,p,u,t,d]),a.jsx(Re,{label:m,description:i,attachmentType:u,skjemanummer:t,existingAttachments:e,updateAttachments:l=>{const o=l.map(M=>F(M,{type:d,perioder:s}));r(o)},saveAttachment:ve("./","foreldrepenger")})};b.__docgenInfo={description:"",methods:[],displayName:"VedleggUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Fe=()=>a.jsxs(ce,{gap:"space-8",children:[a.jsx(We,{children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.label"})}),a.jsx(w,{className:"text-ax-text-neutral-subtle",children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.beskrivelse.1"})}),a.jsx(w,{className:"text-ax-text-neutral-subtle",children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.beskrivelse.2"})})]});Fe.__docgenInfo={description:"",methods:[],displayName:"IngenDokumentasjonPåkrevd"};const Pe=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:i,situasjon:u,erFarEllerMedmor:d,termindato:s})=>{if(t.length===0)return null;const k=y(),p=G(N(O.ANNEN_FORELDER)),l=G(N(O.OM_BARNET)),o=Ae(p)?p.fnr:void 0,M=r(n.DOK_ARBEID_MOR);if(o&&!Xe(p)){const _=Ae(p)&&d&&p.harRettPåForeldrepengerINorge===!1,f=nr(t,l,_,o),K=Qn({...Wn(f),enabled:!!f});if(K.isPending)return a.jsx(Ze,{className:"self-center",size:"large"});if(!(K.data??!0))return a.jsx(er,{perioder:t,updateDokArbeidMorAttachment:M})}return a.jsx(R,{attachments:e,updateAttachments:M,perioder:t,navnPåForeldre:m,familiehendelsesdato:i,termindato:s,situasjon:u,skjemanummer:n.DOK_ARBEID_MOR,labelText:k.formatMessage({id:"manglendeVedlegg.morJobber.label"}),description:k.formatMessage({id:"manglendeVedlegg.morJobber.description"},{navn:m.mor}),attachmentType:S.MORS_AKTIVITET_DOKUMENTASJON})},er=({updateDokArbeidMorAttachment:e,perioder:r})=>(Z.useEffect(()=>{const t=Zn(S.MORS_AKTIVITET_DOKUMENTASJON,n.DOK_ARBEID_MOR),m=F(t,{type:h.UTTAK,perioder:r.map(i=>({fom:_e(i.tidsperiode.fom),tom:_e(i.tidsperiode.tom)}))});e([m])},[]),a.jsx(Fe,{})),nr=(e,r,t,m)=>{const i=(en(r)||nn(r))&&r.fnr!==void 0&&r.fnr.length>0?r.fnr[0]:void 0;return{annenPartFødselsnummer:m,barnFødselsnummer:i,familiehendelse:Ie(r),perioder:e.map(u=>({fom:u.tidsperiode.fom.toISOString(),tom:u.tidsperiode.tom.toISOString(),periodeType:t&&rn(u)?"UTSETTELSE":"UTTAK"}))}};Pe.__docgenInfo={description:"",methods:[],displayName:"MorJobberDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
