...
| 'IKKE_OPPGITT'`,elements:[{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'UTDANNING'"},{name:"literal",value:"'KVALPROG'"},{name:"literal",value:"'INTROPROG'"},{name:"literal",value:"'TRENGER_HJELP'"},{name:"literal",value:"'INNLAGT'"},{name:"literal",value:"'ARBEID_OG_UTDANNING'"},{name:"literal",value:"'UFØRE'"},{name:"literal",value:"'IKKE_OPPGITT'"}],required:!1}},{key:"samtidigUttak",value:{name:"number",required:!1}},{key:"flerbarnsdager",value:{name:"boolean",required:!1}},{key:"forelder",value:{name:"union",raw:"'MOR' | 'FAR_MEDMOR'",elements:[{name:"literal",value:"'MOR'"},{name:"literal",value:"'FAR_MEDMOR'"}],required:!1}}]}}],raw:"UttakPeriode[]",required:!0}}]},required:!1}},{key:"barn",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    etternavn: string;
    fødselsdato?: string;
}`,signature:{properties:[{key:"fnr",value:{name:"string",required:!0}},{key:"fornavn",value:{name:"string",required:!0}},{key:"mellomnavn",value:{name:"string",required:!1}},{key:"etternavn",value:{name:"string",required:!0}},{key:"fødselsdato",value:{name:"string",required:!1}}]},required:!1}},{key:"familiehendelsesdato",value:{name:"Date",required:!1}},{key:"startdatoFørsteStønadsperiode",value:{name:"Date",required:!1}},{key:"alleBarnaLever",value:{name:"boolean",required:!0}}]}}],raw:"ValgtBarn[]"},description:""}}};o.extend(C);o.extend(ge);const Oe=(a,r,e)=>a?R.ADOPTERT:r.fødselsdato!==void 0||e&&e.length>0?R.FØDT:R.UFØDT,pe=(a,r)=>{const e=a.familiehendelse.termindato;if($(e)){const l=o(e).subtract(17,"week"),s=o(e).add(6,"week");return r.filter(t=>o(t.fødselsdato).isBetween(l,s,"day","[]"))}return[]},Ie=(a,r)=>{const e=g(a.familiehendelse.fødselsdato),l=a.barn!==void 0?a.barn.map(E=>E.fnr).flat():[],s=r.filter(E=>l.includes(E.fnr)),t=e!==void 0?r.filter(E=>V(E.fødselsdato,e)&&!s.find(u=>u.fnr===E.fnr)):[];return s.concat(t)},Se=(a,r)=>{let e;(a.barn||a.familiehendelse.fødselsdato)&&(e=Ie(a,r)),a.familiehendelse.termindato&&!a.familiehendelse.fødselsdato&&!a.barn&&(e=pe(a,r));const l=g(ke(a.familiehendelse.termindato,a.familiehendelse.fødselsdato,a.familiehendelse.omsorgsovertakelse)),s=Oe(a.gjelderAdopsjon,a.familiehendelse,e),t=g(a.familiehendelse.fødselsdato);let E;return e&&e.length>0?E=e.map(u=>o.utc(u.fødselsdato).toDate()):t!==void 0&&(E=Array(a.familiehendelse.antallBarn).fill(t)),{id:p(),type:s,antallBarn:a.familiehendelse.antallBarn,termindato:g(a.familiehendelse.termindato),omsorgsovertagelse:g(a.familiehendelse.omsorgsovertakelse),kanSøkeOmEndring:a.kanSøkeOmEndring,sak:a,fødselsdatoer:E,familiehendelsesdato:l,sortableDato:g(a.familiehendelse.termindato),startdatoFørsteStønadsperiode:a.gjeldendeVedtak!==void 0&&a.gjeldendeVedtak.perioder.length>0?Y(g(a.gjeldendeVedtak.perioder[0].fom)).denneEllerNeste():void 0,fornavn:e!==void 0&&e.length>0?e.filter(u=>u.fornavn!==void 0&&u.fornavn.trim()!=="").map(u=>[u.fornavn,u.mellomnavn!==void 0?u.mellomnavn:""].join(" ")):void 0,fnr:e!==void 0&&e.length>0?e.filter(u=>u.fnr!==void 0).map(u=>u.fnr):void 0,alleBarnaLever:e!==void 0&&e.length>0?e.every(u=>O(u)):!1}},ye=(a,r)=>{const e=a.mellomnavn!==void 0?[a.fornavn,a.mellomnavn].join(" "):a.fornavn;return{id:p(),type:R.IKKE_UTFYLT,antallBarn:1,fødselsdatoer:[o.utc(a.fødselsdato).toDate()],fornavn:e!==void 0?[e]:void 0,fnr:[a.fnr],sortableDato:o.utc(a.fødselsdato).toDate(),alleBarnaLever:O(a),annenForelder:r}},Fe=(a,r,e)=>{const l=[a].concat(r).sort(Te);if(!(l.find(t=>!O(t)&&M(t))||l.length==0))return{id:p(),type:R.IKKE_UTFYLT,antallBarn:l.length,fødselsdatoer:l.map(t=>o.utc(t.fødselsdato).toDate()),fornavn:l.map(t=>[t.fornavn,t.mellomnavn!==void 0?t.mellomnavn:""].join(" ")),fnr:l.map(t=>t.fnr),sortableDato:o.utc(l[0].fødselsdato).toDate(),alleBarnaLever:l.every(t=>O(t)),annenForelder:e}},Ge=(a,r)=>a.filter(e=>e.barn!==void 0&&e.barn.length>0||e.familiehendelse.termindato!==void 0||e.familiehendelse.fødselsdato!==void 0||e.familiehendelse.omsorgsovertakelse!==void 0).map(e=>Se(e,r)),Pe=(a,r,e)=>{const l=a.filter(n=>!e.find(m=>V(n.fødselsdato,g(m.familiehendelse.fødselsdato)))),s="tempFnr",t=l.map(n=>n.fnr===void 0?{...n,fnr:s+p().toString()}:n),E=r.map(n=>n.fnr).flat(),u=r.filter(n=>n.fødselsdatoer!==void 0&&n.fødselsdatoer.length>0).map(n=>n.fødselsdatoer).flat(),N=[];return t.filter(n=>!(n.dødsdato!==void 0&&u.find(m=>o(m).isSame(o.utc(n.fødselsdato),"day")))).forEach(n=>{if(!E.includes(n.fnr)&&!ie(n.fødselsdato)){const m=Ne(n.fnr,n.fødselsdato,t),D=n.annenForelder!==void 0?{fnr:n.annenForelder.fnr,fornavn:n.annenForelder.fornavn,mellomnavn:n.annenForelder.mellomnavn,etternavn:n.annenForelder.etternavn}:void 0;if(E.push(n.fnr),m.length===0){if(!M(n)){const A=ye(n,D);N.push(A)}}else{const A=Fe(n,m,D);m.forEach(G=>{E.push(G.fnr)}),A!==void 0&&N.push(A)}}}),N.map(n=>n.fnr&&n.fnr.length>0?{...n,fnr:n.fnr.filter(m=>m&&!m.startsWith(s))}:n)},Ke=(a,r)=>{const e=a.filter(E=>!E.sakAvsluttet),l=a.filter(E=>E.sakAvsluttet),s=Ge(e,r),t=Pe(r,s,l);return s.concat(t)},be=(a,r)=>{const e=r.filter(s=>s.sak!==void 0&&s.id!==a.id&&s.familiehendelsesdato!==void 0&&o(s.familiehendelsesdato).isAfter(a.familiehendelsesdato,"day"));e.sort(h);const l=e.at(-1);if(l!==void 0)return{familiehendelsesdato:l.familiehendelsesdato,startdatoFørsteStønadsperiode:l.startdatoFørsteStønadsperiode,fnr:l.fnr,annenForelderFnr:l.sak?.annenPart?.fnr}},h=(a,r)=>o(a.sortableDato).isBefore(r.sortableDato,"d")?1:o(a.sortableDato).isAfter(r.sortableDato,"d")?-1:0,qe=({saker:a,harGodkjentVilkår:r,søkerInfo:e,setHarGodkjentVilkår:l,setErEndringssøknad:s,setSøknadGjelderNyttBarn:t,mellomlagreSøknadOgNaviger:E})=>{const u=b(),N=se(e.arbeidsforhold,E),F=c(),{oppdaterSøknadIState:f}=Ae(),n=z.useMemo(()=>[...Ke(a,e.søker.barn)].sort(h),[a,e.søker.barn]),m=T=>{if(!T.harForståttRettigheterOgPlikter){console.error("harForståttRettigheterOgPlikter er falsy til tross for at formet skal ha validert den",T.harForståttRettigheterOgPlikter);return}l(!0);const v=n.find(k=>k.id===T.valgteBarn);if(v===void 0)return s(!1),t(!0),N.goToNextStep(S.SØKERSITUASJON);const P=be(v,n);F(d.BARN_FRA_NESTE_SAK,P);const L=!!v.kanSøkeOmEndring?a.find(k=>k.saksnummer===v.sak?.saksnummer):void 0;if(L){const k=Ee(L,P?.startdatoFørsteStønadsperiode,v.fødselsdatoer),j=ue(e.søker,k,u,L.annenPart,v);return f(j,k),s(!0),t(!1),N.goToNextStep(S.UTTAKSPLAN)}if(v.sak!==void 0&&v.kanSøkeOmEndring===!1){const k=oe({...v,sak:v.sak},u,e.søker.barn,e.søker.fnr);f(k)}if(!L){const k=de(v);f(k)}return s(!1),t(!1),N.goToNextStep(S.SØKERSITUASJON)},D=Z({defaultValues:{harForståttRettigheterOgPlikter:r}}),A=D.watch("valgteBarn"),w=n.find(T=>T.id===A)?.kanSøkeOmEndring===!0?u.formatMessage({id:"velkommen.endreSøknad"}):u.formatMessage({id:"velkommen.begynnMedSøknad"});return i.jsx(W,{pageTitle:i.jsx(_,{id:"søknad.pageheading"}),children:i.jsx(Q,{formMethods:D,onSubmit:m,children:i.jsxs(I,{gap:"space-32",children:[i.jsx(X,{poster:!0,children:i.jsxs(I,{gap:"space-8",children:[i.jsx(_,{id:"velkommen.guidepanel.del1"}),i.jsx(_,{id:"velkommen.guidepanel.del2",values:{a:T=>i.jsx(ee,{rel:"noopener noreferrer",href:ae.foreldrepenger,children:T})}})]})}),i.jsx(U,{selectableBarn:n}),i.jsx(re,{variant:"info",children:i.jsx(_,{id:"velkommen.lagring.info"})}),i.jsx(ne,{name:"harForståttRettigheterOgPlikter",control:D.control,label:u.formatMessage({id:"velkommen.samtykke"}),validate:[T=>T!==!0?u.formatMessage({id:"valideringsfeil.velkommen.harForståttRettigheterOgPlikter.påkrevd"}):null],children:i.jsx(I,{gap:"space-20",children:i.jsxs(K,{gap:"space-4",children:[i.jsx(te,{children:i.jsx(_,{id:"velkommen.samtykkeIntro.del1"})}),i.jsx(_e,{})]})})}),i.jsx(K,{justify:"center",children:i.jsx(le,{type:"submit",variant:"primary",children:w})}),i.jsx(De,{})]})})})};qe.__docgenInfo={description:"",methods:[],displayName:"Forside",props:{saker:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    saksnummer: string;
    sakAvsluttet: boolean;
    kanSøkeOmEndring: boolean;
    sakTilhørerMor: boolean;
