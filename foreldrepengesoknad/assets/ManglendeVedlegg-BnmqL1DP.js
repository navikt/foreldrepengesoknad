import{aX as Oe,r as W,l as a,bY as _e,bZ as ye,a4 as g,C as Ce,b8 as F,b_ as $e,T as Se,D as Qe,V as Ne,b$ as Xe,M as T,x as P,c0 as Te,c1 as ve,L as Ze,c2 as We,c3 as en,bw as Re,c4 as nn,Q as Ae,B as f,J as rn,a6 as an,c5 as tn,c6 as mn,c7 as un,c8 as sn,c9 as ln,ca as on,cb as dn,cc as En,cd as pn,ce as kn,cf as gn,cg as yn,ch as Sn,ci as Tn,cj as vn,ck as An,cl as On,cm as _n,cn as Nn,co as Rn,cp as Dn,cq as In,cr as Ln,cs as fn,ct as jn,b2 as Kn,m as cn,ar as Gn,b3 as qn,a5 as Mn,q as Pn,bo as bn}from"./iframe-B4WE4l2S.js";import{b as L,C as O,c as Un}from"./FpDataContext-hlHQefgQ.js";import{A as V,j as hn,b as wn,a as Fn,o as Vn,f as Bn}from"./useFpNavigator-CdIHd26a.js";import{j as w,a as Jn,g as xn,f as Yn}from"./annenForelderUtils-CiZcqz2o.js";import{A as M,b as y,S as n,c as zn}from"./uttaksplanInfoUtils-DmaNmK1p.js";import{k as Hn,A as De,u as Cn,t as $n}from"./index-CK92jtoJ.js";import{g as Qn}from"./eksisterendeSakUtils-B4cOy8ba.js";import{L as j}from"./List-DGDZBOjD.js";const Ie=e=>async r=>{const t=new FormData;return t.append("id",r.id),t.append("vedlegg",r.file,r.filename),{data:await(await Hn.post(e,{body:t})).json()}},Xn=()=>"V".concat(Qn().replace(/-/g,"")),Le=(e,r,t,m,u)=>({id:Xn(),file:e,filename:e.name,filesize:e.size,uploaded:!1,pending:!1,type:r,skjemanummer:t,innsendingsType:m,dokumenterer:u}),fe=(e,r,t)=>Le({name:""},e,r,"SEND_SENERE",t),Zn=(e,r,t)=>Le({name:""},e,r,"AUTOMATISK",t),h=(e,r)=>({...e,dokumenterer:r}),je=(e,r)=>e.map((t,m)=>{const u=t.tom?ye(t.tom):r.formatMessage({id:"VedleggUploader.pågående"}),i=`${ye(t.fom)}-${u}`;return e.length===1||m===e.length-1?i:m<e.length-2?`${i}, `:`${i} ${r.formatMessage({id:"VedleggUploader.Og"})} `}).join(""),b=({attachments:e,updateAttachments:r,skjemanummer:t,labelText:m,description:u,attachmentType:i,metadataType:l,perioder:s})=>{const{watch:E}=Oe(),p=E(t);return W.useEffect(()=>{if(p.length===0){const o=fe(i,t),d=h(o,{type:l,perioder:s});r([d])}},[r,p,i,t,l]),a.jsx(_e,{label:m,description:u,attachmentType:i,skjemanummer:t,existingAttachments:e,updateAttachments:o=>{const d=o.map(K=>h(K,{type:l,perioder:s}));r(d)},saveAttachment:Ie(De.sendVedlegg)})};b.__docgenInfo={description:"",methods:[],displayName:"VedleggUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const we=()=>a.jsxs(Ne,{gap:"space-8",children:[a.jsx(Xe,{children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.label"})}),a.jsx(F,{className:"text-ax-text-neutral-subtle",children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.beskrivelse.1"})}),a.jsx(F,{className:"text-ax-text-neutral-subtle",children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.beskrivelse.2"})})]});we.__docgenInfo={description:"",methods:[],displayName:"IngenDokumentasjonPåkrevd"};const Fe=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:u,situasjon:i,erFarEllerMedmor:l,termindato:s})=>{const E=g(),p=P(L(O.ANNEN_FORELDER)),o=P(L(O.OM_BARNET)),d=Te(p)?p.fnr:void 0,K=r(n.DOK_ARBEID_MOR),A=Te(p)&&l&&p.harRettPåForeldrepengerINorge===!1,c=er(t,o,A,d||""),G=Cn({...$n(c),enabled:!!d&&!ve(p)&&!!c});if(t.length===0)return null;if(d&&!ve(p)){if(G.isPending)return a.jsx(Ze,{className:"self-center",size:"large"});if(!(G.data??!0))return a.jsx(Wn,{perioder:t,updateDokArbeidMorAttachment:K})}return a.jsx(_,{attachments:e,updateAttachments:K,perioder:t,navnPåForeldre:m,familiehendelsesdato:u,termindato:s,situasjon:i,skjemanummer:n.DOK_ARBEID_MOR,labelText:E.formatMessage({id:"manglendeVedlegg.morJobber.label"}),description:E.formatMessage({id:"manglendeVedlegg.morJobber.description"},{navn:m.mor}),attachmentType:y.MORS_AKTIVITET_DOKUMENTASJON})},Wn=({updateDokArbeidMorAttachment:e,perioder:r})=>(W.useEffect(()=>{const t=Zn(y.MORS_AKTIVITET_DOKUMENTASJON,n.DOK_ARBEID_MOR),m=h(t,{type:M.UTTAK,perioder:r.map(u=>({fom:Ae(u.tidsperiode.fom),tom:Ae(u.tidsperiode.tom)}))});e([m])},[]),a.jsx(we,{})),er=(e,r,t,m)=>{const u=(We(r)||en(r))&&r.fnr!==void 0&&r.fnr.length>0?r.fnr[0]:void 0;return{annenPartFødselsnummer:m,barnFødselsnummer:u,familiehendelse:Re(r),perioder:e.map(i=>({fom:i.tidsperiode.fom.toISOString(),tom:i.tidsperiode.tom.toISOString(),periodeType:t&&nn(i)?"UTSETTELSE":"UTTAK"}))}};Fe.__docgenInfo={description:"",methods:[],displayName:"MorJobberDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
