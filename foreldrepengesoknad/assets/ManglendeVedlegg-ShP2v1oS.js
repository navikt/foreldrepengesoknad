import{a5 as _,D as be,l as r,a_ as Ve,r as _e,b_ as he,bc as b,b$ as we,W as Le,E as Fe,V as Ge,c0 as Be,M as R,y as c,c1 as Se,c2 as Re,L as Ye,c3 as Je,c4 as xe,bA as Ce,c5 as ze,U as Ae,B as D,c6 as He,c7 as Qe,c8 as $e,c9 as We,ca as Xe,cb as Ze,cc as en,cd as nn,ce as rn,cf as an,cg as tn,ch as mn,ci as ln,cj as un,ck as sn,cl as on,cm as En,cn as dn,co as Tn,cp as Ln,cq as Sn,cr as Rn,cs as An,ct as _n,cu as Gn,b6 as pn,m as On,as as kn,b7 as In,a6 as Nn,q as gn,bs as vn}from"./iframe-aNCkZ7Kj.js";import{n as q,b as y,C as O,c as yn,g as Dn,j as Mn}from"./FpDataContext-pWbQF407.js";import{V as W,K as G,t as n,O as Kn,P as $,A as fn,H as V,Q as pe,a as jn,T as Pn,U as cn,d as Un,c as qn,W as bn,j as Vn,X as hn,Y as wn}from"./useFpNavigator-DGXJ6t9V.js";import{a as Fn}from"./uttaksplanInfoUtils-C7WV8thJ.js";import{L as M}from"./List-QMpBo8n9.js";const Oe=({attachments:e,updateAttachments:a,annenForelder:t})=>{const m=_();return!be(t)||!t.datoForAleneomsorg?null:r.jsx(W,{attachments:e,updateAttachments:a(n.DOK_AV_ALENEOMSORG),skjemanummer:n.DOK_AV_ALENEOMSORG,labelText:m.formatMessage({id:"manglendeVedlegg.aleneomsorg.tittel"}),description:m.formatMessage({id:"manglendeVedlegg.aleneomsorg.description"}),attachmentType:G.ALENEOMSORG,metadataType:"BARN"})};Oe.__docgenInfo={description:"",methods:[],displayName:"AleneomsorgDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Ie=({attachments:e,updateAttachments:a,arbeidsforholdOgInntekt:t,andreInntektskilder:m})=>{const l=_();if(!t||t&&t.harHattAndreInntektskilder===!1||!m||!m.some(s=>s.type===V.SLUTTPAKKE))return null;const i=m.filter(s=>s.type===V.SLUTTPAKKE);return r.jsx(W,{attachments:e,updateAttachments:a(n.ETTERLØNN_ELLER_SLUTTVEDERLAG),skjemanummer:n.ETTERLØNN_ELLER_SLUTTVEDERLAG,labelText:l.formatMessage({id:"manglendeVedlegg.etterlønn.tittel"},{perioder:pe(i,l),antallPerioder:i.length}),description:l.formatMessage({id:"manglendeVedlegg.etterlønn.description"}),attachmentType:G.ANNEN_INNTEKT,metadataType:"OPPTJENING",perioder:i})};Ie.__docgenInfo={description:"",methods:[],displayName:"EtterlønnEllerSluttvederlagDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const ve=({attachments:e,updateAttachments:a,arbeidsforholdOgInntekt:t,andreInntektskilder:m})=>{const l=_();if(!t||t&&!t.harHattAndreInntektskilder||!m||!m.some(s=>s.type===V.MILITÆRTJENESTE))return null;const i=m.filter(s=>s.type===V.MILITÆRTJENESTE);return r.jsx(W,{attachments:e,updateAttachments:a(n.DOK_MILITÆR_SILVIL_TJENESTE),skjemanummer:n.DOK_MILITÆR_SILVIL_TJENESTE,labelText:l.formatMessage({id:"manglendeVedlegg.militær.tittel"},{perioder:pe(i,l),antallPerioder:i.length}),description:l.formatMessage({id:"manglendeVedlegg.militær.description"}),attachmentType:G.ANNEN_INNTEKT,metadataType:"OPPTJENING",perioder:i})};ve.__docgenInfo={description:"",methods:[],displayName:"MilitærEllerSiviltjenesteDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| 'KRYPTERING_MELLOMLAGRING'`,elements:[{name:"literal",value:"'IKKE_TILGANG'"},{name:"literal",value:"'DUPLIKAT_FORSENDELSE'"},{name:"literal",value:"'MELLOMLAGRING'"},{name:"literal",value:"'MELLOMLAGRING_VEDLEGG'"},{name:"literal",value:"'MELLOMLAGRING_VEDLEGG_VIRUSSCAN_TIMEOUT'"},{name:"literal",value:"'MELLOMLAGRING_VEDLEGG_PASSORD_BESKYTTET'"},{name:"literal",value:"'KRYPTERING_MELLOMLAGRING'"}]},{name:"literal",value:"'NO_DATA'"}],required:!1}},{key:"beskrivelse",value:{name:"string",required:!1}}]}}],raw:"Attachment[]"},name:"attachments"}],return:{name:"void"}}}}},description:""},arbeidsforholdOgInntekt:{required:!0,tsType:{name:"union",raw:"ArbeidsforholdOgInntektFp | undefined",elements:[{name:"intersection",raw:`{
    ...
    harJobbetSomFrilans: boolean;
    harJobbetSomSelvstendigNæringsdrivende: boolean;
}`,signature:{properties:[{key:"harJobbetSomFrilans",value:{name:"boolean",required:!0}},{key:"harJobbetSomSelvstendigNæringsdrivende",value:{name:"boolean",required:!0}}]}}]},{name:"undefined"}]},description:""},andreInntektskilder:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:"SluttpakkeInntekt | MilitærtjenesteInntekt | JobbIUtlandetInntekt",elements:[{name:"SluttpakkeInntekt"},{name:"MilitærtjenesteInntekt"},{name:"JobbIUtlandetInntekt"}]}],raw:"AndreInntektskilder[]"},description:""}}};const ye=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:l,situasjon:i,termindato:s,erFarEllerMedmor:u})=>{const o=_();return t.length===0?null:r.jsx(k,{attachments:e,updateAttachments:a(n.DOK_SYKDOM_MOR),perioder:t,navnPåForeldre:m,familiehendelsesdato:l,termindato:s,situasjon:i,skjemanummer:n.DOK_SYKDOM_MOR,labelText:o.formatMessage({id:"manglendeVedlegg.morForSyk.label"},{navn:m.mor,erFarEllerMedmor:u}),description:o.formatMessage({id:"manglendeVedlegg.morForSyk.description"},{navn:m.mor,erFarEllerMedmor:u}),attachmentType:G.UTSETTELSE_SYKDOM})};ye.__docgenInfo={description:"",methods:[],displayName:"MorForSykDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const De=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:l,situasjon:i,termindato:s,erFarEllerMedmor:u})=>{const o=_();if(t.length===0)return null;const L=t.some(E=>E.type===Fe.Uttak&&E.erMorForSyk===!0&&E.konto==="FEDREKVOTE");return r.jsx(k,{attachments:e,updateAttachments:a(n.DOK_INNLEGGELSE_MOR),perioder:t,navnPåForeldre:m,familiehendelsesdato:l,termindato:s,situasjon:i,skjemanummer:n.DOK_INNLEGGELSE_MOR,labelText:L?o.formatMessage({id:"manglendeVedlegg.morInnlagtEllerSyk.label"},{navn:m.mor,erFarEllerMedmor:u}):o.formatMessage({id:"manglendeVedlegg.morInnlagt.label"},{navn:m.mor,erFarEllerMedmor:u}),description:L?o.formatMessage({id:"manglendeVedlegg.morInnlagtEllerSyk.description"},{navn:m.mor,erFarEllerMedmor:u}):o.formatMessage({id:"manglendeVedlegg.morInnlagt.description"},{navn:m.mor,erFarEllerMedmor:u}),attachmentType:G.UTSETTELSE_SYKDOM})};De.__docgenInfo={description:"",methods:[],displayName:"MorInnlagtDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const je=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:l,situasjon:i,termindato:s})=>{const u=_();return t.length===0?null:r.jsx(k,{attachments:e,updateAttachments:a(n.DOK_UTDANNING_OG_ARBEID_MOR),perioder:t,navnPåForeldre:m,familiehendelsesdato:l,termindato:s,situasjon:i,skjemanummer:n.DOK_UTDANNING_OG_ARBEID_MOR,labelText:u.formatMessage({id:"manglendeVedlegg.studererOgJobber.label"}),description:r.jsxs(r.Fragment,{children:[r.jsx(D,{children:r.jsx(R,{id:"manglendeVedlegg.studererOgJobber.description.tittel",values:{navn:m.mor}})}),r.jsxs(M,{children:[r.jsx(M.Item,{children:r.jsx(D,{children:r.jsx(R,{id:"manglendeVedlegg.studerer.description.punkt1"})})}),r.jsx(M.Item,{children:r.jsx(D,{children:r.jsx(R,{id:"manglendeVedlegg.studerer.description.punkt2"})})}),r.jsx(M.Item,{children:r.jsx(D,{children:r.jsx(R,{id:"manglendeVedlegg.studerer.description.punkt3"})})}),r.jsx(M.Item,{children:r.jsx(D,{children:r.jsx(R,{id:"manglendeVedlegg.studerer.description.punkt4"})})})]})]}),attachmentType:G.MORS_AKTIVITET_DOKUMENTASJON})};je.__docgenInfo={description:"",methods:[],displayName:"MorJobberOgStudererDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const ce=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:l,situasjon:i,termindato:s})=>{const u=_();return t.length===0?null:r.jsx(k,{attachments:e,updateAttachments:a(n.DOK_UTDANNING_MOR),perioder:t,navnPåForeldre:m,familiehendelsesdato:l,termindato:s,situasjon:i,skjemanummer:n.DOK_UTDANNING_MOR,labelText:u.formatMessage({id:"manglendeVedlegg.studerer.label"}),description:r.jsxs(r.Fragment,{children:[r.jsx(D,{children:r.jsx(R,{id:"manglendeVedlegg.studerer.description.tittel",values:{navn:m.mor}})}),r.jsxs(M,{as:"ul",children:[r.jsx(M.Item,{children:r.jsx(D,{children:r.jsx(R,{id:"manglendeVedlegg.studerer.description.punkt1"})})}),r.jsx(M.Item,{children:r.jsx(D,{children:r.jsx(R,{id:"manglendeVedlegg.studerer.description.punkt2"})})}),r.jsx(M.Item,{children:r.jsx(D,{children:r.jsx(R,{id:"manglendeVedlegg.studerer.description.punkt3"})})}),r.jsx(M.Item,{children:r.jsx(D,{children:r.jsx(R,{id:"manglendeVedlegg.studerer.description.punkt4"})})})]})]}),attachmentType:G.MORS_AKTIVITET_DOKUMENTASJON})};ce.__docgenInfo={description:"",methods:[],displayName:"MorStudererDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
