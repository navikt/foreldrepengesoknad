import{Z as K,_ as i,aT as H,aU as x,aV as q,a1 as _,J as E,aW as c,U as J,k as Y,aX as $,r as C,aY as z,aZ as W,$ as S,a_ as Z,a6 as G,a5 as X,a$ as Q,b0 as ee,b1 as ae,a0 as re,b2 as ne,a7 as te,a8 as le}from"./iframe-CTd5WESe.js";import{e as V,C as d}from"./FpDataContext-B7530weJ.js";import{n as ie,b as se,S as b}from"./useFpNavigator-CDYhn2JZ.js";import{a as ue,l as oe,b as Ee,c as de}from"./eksisterendeSakUtils-B4-BosNb.js";import{l as me,m as ve,n as Re,o as M,I as g,p as Ne,q as B,r as ke,s as y,t as Te,u as ge}from"./barnUtils-D5qLIe2o.js";import{D as _e}from"./DinePlikter-0HTtFkWI.js";import{g as F}from"./guid-CsArkN6i.js";import{D as Ae}from"./DinePersonopplysningerModal-3hQBeNkJ.js";const fe=()=>{const a=V();return{oppdaterSøknadIState:(e,l)=>{a(d.SØKERSITUASJON,e.søkersituasjon),a(d.OM_BARNET,e.barn),a(d.ANNEN_FORELDER,e.annenForelder),a(d.ARBEIDSFORHOLD_OG_INNTEKT,e.arbeidsforholdOgInntekt),a(d.FRILANS,e.frilans),a(d.EGEN_NÆRING,e.egenNæring),a(d.ANDRE_INNTEKTSKILDER,e.andreInntektskilder),a(d.UTENLANDSOPPHOLD,e.utenlandsopphold),a(d.UTENLANDSOPPHOLD_TIDLIGERE,e.utenlandsoppholdSiste12Mnd),a(d.UTENLANDSOPPHOLD_SENERE,e.utenlandsoppholdNeste12Mnd),a(d.PERIODE_MED_FORELDREPENGER,e.dekningsgrad),a(d.UTTAKSPLAN,e.uttaksplan),a(d.UTTAKSPLAN_METADATA,{ønskerJustertUttakVedFødsel:e.ønskerJustertUttakVedFødsel}),l&&a(d.EKSISTERENDE_SAK,l)}}};var v=(a=>(a.FØDT="født",a.UFØDT="ufødt",a.ADOPTERT="adoptert",a.IKKE_UTFYLT="ikkeUtfylt",a))(v||{});const De=(a,r)=>a.map(e=>{const l=e.sak!==void 0?h(e.sak.åpenBehandling===void 0,r):void 0,s=e.sak!==void 0?r.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"";return i.jsx(q,{value:e.id,description:e.sak!==void 0?`${s}, ${l}`:s,children:i.jsx(_,{id:"velkommen.barnVelger.ufødtBarn",values:{antallBarnTekst:Re(e.antallBarn,r),termin:E(e.termindato).format(c),b:n=>i.jsx("b",{children:n})}})},e.id)}),h=(a,r)=>a?r.formatMessage({id:"velkommen.sak.status.ferdigBehandlet"}):r.formatMessage({id:"velkommen.sak.status.underBehandling"}),Le=(a,r)=>a.map(e=>{const l=me(e.fornavn,e.fødselsdatoer,e.omsorgsovertagelse,e.alleBarnaLever,e.antallBarn,r),s=ve(e.fødselsdatoer),n=e.type===v.FØDT||e.type===v.IKKE_UTFYLT?s:E(e.omsorgsovertagelse).format(c),o=e.type===v.FØDT||e.type===v.IKKE_UTFYLT?r.formatMessage({id:"velkommen.barnVelger.født"}):r.formatMessage({id:"velkommen.barnVelger.adopsjon"}),u=e.sak!==void 0?r.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"",N=e.sak!==void 0?h(e.sak.åpenBehandling===void 0,r):void 0;return i.jsx(q,{value:e.id,description:N?`${u}, ${N}`:u,children:i.jsx("b",{children:e.alleBarnaLever?`${l} ${o} ${n}`:l})},e.id)}),U=({selectableBarn:a})=>{const r=K();if(a.length===0)return null;const e=a.filter(n=>n.type===v.UFØDT),l=a.filter(n=>n.type!==v.UFØDT);let s=[];return l.length>0&&(s=s.concat(Le(l,r))),e.length>0&&(s=s.concat(De(e,r))),i.jsx(H,{name:"valgteBarn",label:i.jsx(_,{id:"velkommen.intro.harSaker.barnVelger.label"}),validate:[x(r.formatMessage({id:"steg.footer.spørsmålMåBesvares"}))],children:s.concat(i.jsx(q,{value:"søknad_gjeder_nytt_barn",description:r.formatMessage({id:"velkommen.intro.harSaker.barnVelger.info"}),children:i.jsx(_,{id:"omBarnet.gjelderAnnetBarn",values:{b:n=>i.jsx("b",{children:n})}})},"søknad_gjeder_nytt_barn"))})};U.__docgenInfo={description:"",methods:[],displayName:"BarnVelger",props:{selectableBarn:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: string;
    type: ValgtBarnType;
    antallBarn: number;
    sortableDato: Date;
