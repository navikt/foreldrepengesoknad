import{j as E}from"./jsx-runtime-CLpGMVip.js";import{b as c,C as o}from"./FpDataContext-DWIUkGg8.js";import{e as x,a as Y,S as P}from"./useFpNavigator-D3Aim9gA.js";import{r as C}from"./index-DI2V0i71.js";import{b as $,c as M,u as z,R as W,g as Q}from"./ErrorSummaryHookForm-Tz0puhvS.js";import{u as b,M as D,H as X,a as Z,b as ee}from"./index-CUhEbLO6.js";import{m as ne,l as ae,a as re,b as te}from"./eksisterendeSakUtils-C8XQ1LgX.js";import{d,e as q,l as le}from"./dates-AkG-ZPn6.js";import{i as Ee,G as ie,U as se,H as ue,L as de,C as oe,J as Re,E as Ne}from"./Uttaksplan-BfWnJuI7.js";import{b as me,c as Te,d as _e,t as ve,e as B,I as A,h as Ae,i as U,j as De,k as G,s as Le}from"./barnUtils-CtCUs5-7.js";import{D as Ie}from"./DinePlikter-BnqtEaxM.js";import{g as y}from"./guid-CsArkN6i.js";import{D as Oe}from"./DinePersonopplysningerModal-2ipS-fum.js";import{V as p,H as V,B as ke}from"./VStack-fPKKixrv.js";const ge=()=>{const n=c();return{oppdaterSøknadIState:(e,t)=>{n(o.SØKERSITUASJON,e.søkersituasjon),n(o.OM_BARNET,e.barn),n(o.ANNEN_FORELDER,e.annenForelder),n(o.ARBEIDSFORHOLD_OG_INNTEKT,e.arbeidsforholdOgInntekt),n(o.FRILANS,e.frilans),n(o.EGEN_NÆRING,e.egenNæring),n(o.ANDRE_INNTEKTSKILDER,e.andreInntektskilder),n(o.UTENLANDSOPPHOLD,e.utenlandsopphold),n(o.UTENLANDSOPPHOLD_TIDLIGERE,e.utenlandsoppholdSiste12Mnd),n(o.UTENLANDSOPPHOLD_SENERE,e.utenlandsoppholdNeste12Mnd),n(o.PERIODE_MED_FORELDREPENGER,e.dekningsgrad),n(o.UTTAKSPLAN,e.uttaksplan),n(o.UTTAKSPLAN_METADATA,{ønskerJustertUttakVedFødsel:e.ønskerJustertUttakVedFødsel}),t&&n(o.EKSISTERENDE_SAK,t)}}};var N=(n=>(n.FØDT="født",n.UFØDT="ufødt",n.ADOPTERT="adoptert",n.IKKE_UTFYLT="ikkeUtfylt",n))(N||{});const fe=(n,a)=>n.map(e=>{const t=e.sak!==void 0?h(e.sak.åpenBehandling===void 0,a):void 0,i=e.sak!==void 0?a.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"";return E.jsx(M,{value:e.id,description:e.sak!==void 0?`${i}, ${t}`:i,children:E.jsx(D,{id:"velkommen.barnVelger.ufødtBarn",values:{antallBarnTekst:me(e.antallBarn,a),termin:d(e.termindato).format(q),b:r=>E.jsx("b",{children:r})}})},e.id)}),h=(n,a)=>n?a.formatMessage({id:"velkommen.sak.status.ferdigBehandlet"}):a.formatMessage({id:"velkommen.sak.status.underBehandling"}),Se=(n,a)=>n.map(e=>{const t=Te(e.fornavn,e.fødselsdatoer,e.omsorgsovertagelse,e.alleBarnaLever,e.antallBarn,a),i=_e(e.fødselsdatoer),r=e.type===N.FØDT||e.type===N.IKKE_UTFYLT?i:d(e.omsorgsovertagelse).format(q),s=e.type===N.FØDT||e.type===N.IKKE_UTFYLT?a.formatMessage({id:"velkommen.barnVelger.født"}):a.formatMessage({id:"velkommen.barnVelger.adopsjon"}),u=e.sak!==void 0?a.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"",v=e.sak!==void 0?h(e.sak.åpenBehandling===void 0,a):void 0;return E.jsx(M,{value:e.id,description:v?`${u}, ${v}`:u,children:E.jsx("b",{children:e.alleBarnaLever?`${t} ${s} ${r}`:t})},e.id)}),j=({selectableBarn:n})=>{const a=b();if(n.length===0)return null;const e=n.filter(r=>r.type===N.UFØDT),t=n.filter(r=>r.type!==N.UFØDT);let i=[];return t.length>0&&(i=i.concat(Se(t,a))),e.length>0&&(i=i.concat(fe(e,a))),E.jsx($,{name:"valgteBarn",label:E.jsx(D,{id:"velkommen.intro.harSaker.barnVelger.label"}),validate:[Ee(a.formatMessage({id:"steg.footer.spørsmålMåBesvares"}))],children:i.concat(E.jsx(M,{value:"søknad_gjeder_nytt_barn",description:a.formatMessage({id:"velkommen.intro.harSaker.barnVelger.info"}),children:E.jsx(D,{id:"omBarnet.gjelderAnnetBarn",values:{b:r=>E.jsx("b",{children:r})}})},"søknad_gjeder_nytt_barn"))})};j.__docgenInfo={description:"",methods:[],displayName:"BarnVelger",props:{selectableBarn:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: string;
    type: ValgtBarnType;
    antallBarn: number;
    sortableDato: Date;
...
| 'IKKE_OPPGITT'`,elements:[{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'UTDANNING'"},{name:"literal",value:"'KVALPROG'"},{name:"literal",value:"'INTROPROG'"},{name:"literal",value:"'TRENGER_HJELP'"},{name:"literal",value:"'INNLAGT'"},{name:"literal",value:"'ARBEID_OG_UTDANNING'"},{name:"literal",value:"'UFØRE'"},{name:"literal",value:"'IKKE_OPPGITT'"}],required:!1}},{key:"samtidigUttak",value:{name:"number",required:!1}},{key:"flerbarnsdager",value:{name:"boolean",required:!1}},{key:"forelder",value:{name:"union",raw:"'MOR' | 'FAR_MEDMOR'",elements:[{name:"literal",value:"'MOR'"},{name:"literal",value:"'FAR_MEDMOR'"}],required:!1}}]}}],raw:"UttakPeriode[]",required:!0}}]},required:!1}},{key:"barn",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    etternavn: string;
    fødselsdato?: string;
}`,signature:{properties:[{key:"fnr",value:{name:"string",required:!0}},{key:"fornavn",value:{name:"string",required:!0}},{key:"mellomnavn",value:{name:"string",required:!1}},{key:"etternavn",value:{name:"string",required:!0}},{key:"fødselsdato",value:{name:"string",required:!1}}]},required:!1}},{key:"familiehendelsesdato",value:{name:"Date",required:!1}},{key:"startdatoFørsteStønadsperiode",value:{name:"Date",required:!1}},{key:"alleBarnaLever",value:{name:"boolean",required:!0}}]}}],raw:"ValgtBarn[]"},description:""}}};d.extend(ie);d.extend(ve);const Fe=(n,a,e)=>n?N.ADOPTERT:a.fødselsdato!==void 0||e&&e.length>0?N.FØDT:N.UFØDT,pe=(n,a)=>{const e=n.familiehendelse.termindato;if(ue(e)){const t=d(e).subtract(17,"week"),i=d(e).add(6,"week");return a.filter(r=>d(r.fødselsdato).isBetween(t,i,"day","[]"))}return[]},Ge=(n,a)=>{const e=A(n.familiehendelse.fødselsdato),t=n.barn!==void 0?n.barn.map(s=>s.fnr).flat():[],i=a.filter(s=>t.includes(s.fnr)),r=e!==void 0?a.filter(s=>B(s.fødselsdato,e)&&!i.find(u=>u.fnr===s.fnr)):[];return i.concat(r)},ye=(n,a)=>{let e;(n.barn||n.familiehendelse.fødselsdato)&&(e=Ge(n,a)),n.familiehendelse.termindato&&!n.familiehendelse.fødselsdato&&!n.barn&&(e=pe(n,a));const t=A(De(n.familiehendelse.termindato,n.familiehendelse.fødselsdato,n.familiehendelse.omsorgsovertakelse)),i=Fe(n.gjelderAdopsjon,n.familiehendelse,e),r=A(n.familiehendelse.fødselsdato);let s;return e&&e.length>0?s=e.map(u=>d.utc(u.fødselsdato).toDate()):r!==void 0&&(s=Array(n.familiehendelse.antallBarn).fill(r)),{id:y(),type:i,antallBarn:n.familiehendelse.antallBarn,termindato:A(n.familiehendelse.termindato),omsorgsovertagelse:A(n.familiehendelse.omsorgsovertakelse),kanSøkeOmEndring:n.kanSøkeOmEndring,sak:n,fødselsdatoer:s,familiehendelsesdato:t,sortableDato:A(n.familiehendelse.termindato),startdatoFørsteStønadsperiode:n.gjeldendeVedtak!==void 0&&n.gjeldendeVedtak.perioder.length>0?se(A(n.gjeldendeVedtak.perioder[0].fom)).denneEllerNeste():void 0,fornavn:e!==void 0&&e.length>0?e.filter(u=>u.fornavn!==void 0&&u.fornavn.trim()!=="").map(u=>[u.fornavn,u.mellomnavn!==void 0?u.mellomnavn:""].join(" ")):void 0,fnr:e!==void 0&&e.length>0?e.filter(u=>u.fnr!==void 0).map(u=>u.fnr):void 0,alleBarnaLever:e!==void 0&&e.length>0?e.every(u=>G(u)):!1}},Ke=(n,a)=>{const e=n.mellomnavn!==void 0?[n.fornavn,n.mellomnavn].join(" "):n.fornavn;return{id:y(),type:N.IKKE_UTFYLT,antallBarn:1,fødselsdatoer:[d.utc(n.fødselsdato).toDate()],fornavn:e!==void 0?[e]:void 0,fnr:[n.fnr],sortableDato:d.utc(n.fødselsdato).toDate(),alleBarnaLever:G(n),annenForelder:a}},Pe=(n,a,e)=>{const t=[n].concat(a).sort(Le);if(!(t.find(r=>!G(r)&&U(r))||t.length==0))return{id:y(),type:N.IKKE_UTFYLT,antallBarn:t.length,fødselsdatoer:t.map(r=>d.utc(r.fødselsdato).toDate()),fornavn:t.map(r=>[r.fornavn,r.mellomnavn!==void 0?r.mellomnavn:""].join(" ")),fnr:t.map(r=>r.fnr),sortableDato:d.utc(t[0].fødselsdato).toDate(),alleBarnaLever:t.every(r=>G(r)),annenForelder:e}},Ve=(n,a)=>n.filter(e=>e.barn!==void 0&&e.barn.length>0||e.familiehendelse.termindato!==void 0||e.familiehendelse.fødselsdato!==void 0||e.familiehendelse.omsorgsovertakelse!==void 0).map(e=>ye(e,a)),Me=(n,a,e)=>{const t=n.filter(l=>!e.find(R=>B(l.fødselsdato,A(R.familiehendelse.fødselsdato)))),i="tempFnr",r=t.map(l=>l.fnr===void 0?{...l,fnr:i+y().toString()}:l),s=a.map(l=>l.fnr).flat(),u=a.filter(l=>l.fødselsdatoer!==void 0&&l.fødselsdatoer.length>0).map(l=>l.fødselsdatoer).flat(),v=[];return r.filter(l=>!(l.dødsdato!==void 0&&u.find(R=>d(R).isSame(d.utc(l.fødselsdato),"day")))).forEach(l=>{if(!s.includes(l.fnr)&&!x(l.fødselsdato)){const R=Ae(l.fnr,l.fødselsdato,r),I=l.annenForelder!==void 0?{fnr:l.annenForelder.fnr,fornavn:l.annenForelder.fornavn,mellomnavn:l.annenForelder.mellomnavn,etternavn:l.annenForelder.etternavn}:void 0;if(s.push(l.fnr),R.length===0){if(!U(l)){const O=Ke(l,I);v.push(O)}}else{const O=Pe(l,R,I);R.forEach(g=>{s.push(g.fnr)}),O!==void 0&&v.push(O)}}}),v.map(l=>l.fnr&&l.fnr.length>0?{...l,fnr:l.fnr.filter(R=>R&&!R.startsWith(i))}:l)},ce=(n,a)=>{const e=n.filter(s=>!s.sakAvsluttet),t=n.filter(s=>s.sakAvsluttet),i=Ve(e,a),r=Me(a,i,t);return i.concat(r)},be=(n,a)=>{var i,r;const e=a.filter(s=>s.sak!==void 0&&s.id!==n.id&&s.familiehendelsesdato!==void 0&&d(s.familiehendelsesdato).isAfter(n.familiehendelsesdato,"day"));e.sort(w);const t=e[e.length-1];if(t!==void 0)return{familiehendelsesdato:t.familiehendelsesdato,startdatoFørsteStønadsperiode:t.startdatoFørsteStønadsperiode,fnr:t.fnr,annenForelderFnr:(r=(i=t.sak)==null?void 0:i.annenPart)==null?void 0:r.fnr}},w=(n,a)=>d(n.sortableDato).isBefore(a.sortableDato,"d")?1:d(n.sortableDato).isAfter(a.sortableDato,"d")?-1:0,qe=({locale:n,saker:a,onChangeLocale:e,harGodkjentVilkår:t,søkerInfo:i,setHarGodkjentVilkår:r,setErEndringssøknad:s,setSøknadGjelderNyttBarn:u,mellomlagreSøknadOgNaviger:v})=>{const L=b(),k=Y(i.arbeidsforhold,v),l=c(),{oppdaterSøknadIState:R}=ge(),I=C.useMemo(()=>[...ce(a,i.søker.barn)].sort(w),[a,i.søker.barn]),O=_=>{if(!_.harForståttRettigheterOgPlikter){console.error("harForståttRettigheterOgPlikter er falsy til tross for at formet skal ha validert den",_.harForståttRettigheterOgPlikter);return}r(!0);const m=I.find(T=>T.id===_.valgteBarn);if(m===void 0)return s(!1),u(!0),k.goToNextStep(P.SØKERSITUASJON);const f=be(m,I);l(o.BARN_FRA_NESTE_SAK,f);const S=!!m.kanSøkeOmEndring?a.find(T=>{var F;return T.saksnummer===((F=m.sak)==null?void 0:F.saksnummer)}):void 0;if(S){const T=ne(S,f==null?void 0:f.startdatoFørsteStønadsperiode,m.fødselsdatoer),F=ae(i.søker,T,L,S.annenPart,m);return R(F,T),s(!0),u(!1),k.goToNextStep(P.UTTAKSPLAN)}if(m.sak!==void 0&&m.kanSøkeOmEndring===!1){const T=re({...m,sak:m.sak},L,i.søker.barn,i.søker.fnr);R(T)}if(!S){const T=te(m);R(T)}return s(!1),u(!1),k.goToNextStep(P.SØKERSITUASJON)},g=z({defaultValues:{harForståttRettigheterOgPlikter:t}}),H=g.watch("valgteBarn"),K=I.find(_=>_.id===H),J=(K==null?void 0:K.kanSøkeOmEndring)===!0?L.formatMessage({id:"velkommen.endreSøknad"}):L.formatMessage({id:"velkommen.begynnMedSøknad"});return E.jsx(W,{formMethods:g,onSubmit:O,children:E.jsxs(p,{gap:"10",children:[E.jsx(de,{locale:n,availableLocales:["nb","nn"],toggleLanguage:e}),E.jsx(oe,{children:E.jsxs(p,{gap:"8",children:[E.jsx(V,{justify:"center",children:E.jsx(X,{size:"xlarge",children:E.jsx(D,{id:"velkommen.tittel"})})}),E.jsx(Re,{poster:!0,children:E.jsxs(p,{gap:"2",children:[E.jsx(D,{id:"velkommen.guidepanel.del1"}),E.jsx(D,{id:"velkommen.guidepanel.del2",values:{a:_=>E.jsx(Z,{rel:"noopener noreferrer",href:le.foreldrepenger,children:_})}})]})}),E.jsx(j,{selectableBarn:I}),E.jsx(Ne,{variant:"info",children:E.jsx(D,{id:"velkommen.lagring.info"})}),E.jsx(Q,{name:"harForståttRettigheterOgPlikter",label:L.formatMessage({id:"velkommen.samtykke"}),validate:[_=>_!==!0?L.formatMessage({id:"valideringsfeil.velkommen.harForståttRettigheterOgPlikter.påkrevd"}):null],children:E.jsx(p,{gap:"5",children:E.jsxs(V,{gap:"1",children:[E.jsx(ee,{children:E.jsx(D,{id:"velkommen.samtykkeIntro.del1"})}),E.jsx(Ie,{})]})})}),E.jsx(V,{justify:"center",children:E.jsx(ke,{type:"submit",variant:"primary",children:J})}),E.jsx(Oe,{})]})})]})})};qe.__docgenInfo={description:"",methods:[],displayName:"Forside",props:{onChangeLocale:{required:!0,tsType:{name:"signature",type:"function",raw:"(locale: LocaleNo) => void",signature:{arguments:[{type:{name:"union",raw:"'nb' | 'nn'",elements:[{name:"literal",value:"'nb'"},{name:"literal",value:"'nn'"}]},name:"locale"}],return:{name:"void"}}},description:""},locale:{required:!0,tsType:{name:"union",raw:"'nb' | 'nn'",elements:[{name:"literal",value:"'nb'"},{name:"literal",value:"'nn'"}]},description:""},saker:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    saksnummer: string;
    sakAvsluttet: boolean;
    kanSøkeOmEndring: boolean;
    sakTilhørerMor: boolean;
