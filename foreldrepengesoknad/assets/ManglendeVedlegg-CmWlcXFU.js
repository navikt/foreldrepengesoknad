import{a_ as Ae,r as Z,l as t,c0 as De,c1 as Ee,a7 as k,C as He,bb as F,c2 as Ce,W as ve,D as $e,O as Qe,V as Oe,c3 as We,M as S,x as w,c4 as Se,c5 as Xe,L as Ze,c6 as er,c7 as rr,bz as Ne,c8 as nr,U as Te,B as I,J as tr,a9 as ar,c9 as ir,ca as sr,cb as mr,cc as ur,cd as lr,ce as or,cf as dr,cg as pr,ch as gr,ci as yr,cj as kr,ck as Er,cl as vr,cm as Sr,cn as Tr,co as Ar,cp as Dr,cq as Or,cr as Nr,cs as _r,ct as Rr,cu as jr,cv as cr,cw as Ir,cx as fr,b5 as br,m as Lr,au as qr,b6 as Kr,a8 as Gr,q as wr,br as hr}from"./iframe-RMFhRmYV.js";import{b as c,C as D,c as Pr}from"./FpDataContext-C_LH7Orl.js";import{A as V,j as Mr,b as Ur,a as Fr,o as Vr,f as Br}from"./useFpNavigator-Bz8JiZ4k.js";import{j as U,a as Jr,g as xr,f as Yr}from"./annenForelderUtils-C0qJhOc9.js";import{A as G,b as E,S as r,c as zr}from"./uttaksplanInfoUtils-DmaNmK1p.js";import{k as Hr,A as _e,u as Cr,t as $r}from"./index-Cz6y2jRY.js";import{g as Qr}from"./eksisterendeSakUtils-CxWmePza.js";import{L as f}from"./List-CUVFxDZD.js";const Re=e=>async n=>{const a=new FormData;return a.append("id",n.id),a.append("vedlegg",n.file,n.filename),{data:await(await Hr.post(e,{body:a})).json()}},Wr=()=>"V".concat(Qr().replace(/-/g,"")),je=(e,n,a,i,m)=>({id:Wr(),file:e,filename:e.name,filesize:e.size,uploaded:!1,pending:!1,type:n,skjemanummer:a,innsendingsType:i,dokumenterer:m}),ce=(e,n,a)=>je({name:""},e,n,"SEND_SENERE",a),Xr=(e,n,a)=>je({name:""},e,n,"AUTOMATISK",a),M=(e,n)=>({...e,dokumenterer:n}),Ie=(e,n)=>e.map((a,i)=>{const m=a.tom?Ee(a.tom):n.formatMessage({id:"VedleggUploader.pågående"}),s=`${Ee(a.fom)}-${m}`;return e.length===1||i===e.length-1?s:i<e.length-2?`${s}, `:`${s} ${n.formatMessage({id:"VedleggUploader.Og"})} `}).join(""),h=({attachments:e,updateAttachments:n,skjemanummer:a,labelText:i,description:m,attachmentType:s,metadataType:l,perioder:u})=>{const{watch:p}=Ae(),y=p(a);return Z.useEffect(()=>{if(y.length===0){const o=ce(s,a),d=M(o,{type:l,perioder:u});n([d])}},[n,y,s,a,l]),t.jsx(De,{label:i,description:m,attachmentType:s,skjemanummer:a,existingAttachments:e,updateAttachments:o=>{const d=o.map(b=>M(b,{type:l,perioder:u}));n(d)},saveAttachment:Re(_e.sendVedlegg)})};h.__docgenInfo={description:"",methods:[],displayName:"VedleggUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},name:"skjemanummer"}],return:{name:"signature",type:"function",raw:"(attachments: Attachment[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    situasjon?: Situasjon;
}`,signature:{properties:[{key:"situasjon",value:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}],required:!1}}]}},description:""}}};const rn=(e,n)=>e?n?Jr(n):!1:!0,xe=({attachments:e,updateAttachments:n,barn:a,arbeidsforhold:i,erFarEllerMedmor:m})=>{const s=k(),l=Mr(i,tr(a),m,Ne(a));return!ar(a)||l.length>0&&!m||!rn(m,a.termindato)?null:t.jsx(h,{attachments:e,updateAttachments:n(r.TERMINBEKREFTELSE),skjemanummer:r.TERMINBEKREFTELSE,labelText:s.formatMessage({id:"manglendeVedlegg.terminbekreftelse.tittel"}),description:s.formatMessage({id:m?"manglendeVedlegg.terminbekreftelse.description.farMedmor":"manglendeVedlegg.terminbekreftelse.description"}),attachmentType:E.TERMINBEKREFTELSE,metadataType:G.BARN})};xe.__docgenInfo={description:"",methods:[],displayName:"TerminbekreftelseDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},name:"skjemanummer"}],return:{name:"signature",type:"function",raw:"(attachments: Attachment[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    fom: string;
    tom?: string;
}`,signature:{properties:[{key:"arbeidsgiverId",value:{name:"string",required:!0}},{key:"arbeidsgiverIdType",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!0}},{key:"stillingsprosent",value:{name:"number",required:!0}},{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!1}}]}}],raw:"Arbeidsforhold[]"},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const nn=e=>ir(e)||sr(e)||mr(e)||ur(e)||lr(e)||or(e),tn=e=>gr(e)||yr(e)||kr(e)||Er(e)||vr(e),an=e=>pr(e),sn=e=>dr(e),mn=e=>jr(e)||cr(e),un=e=>Ar(e)||Dr(e),ln=e=>Or(e)||Nr(e),on=e=>Sr(e)||Tr(e),dn=e=>_r(e)||Rr(e),pn=e=>{const n=e[r.OMSORGSOVERTAKELSE]?e[r.OMSORGSOVERTAKELSE]:[];return T(n)},gn=e=>{const n=e[r.DOK_AV_ALENEOMSORG]?e[r.DOK_AV_ALENEOMSORG]:[];return T(n)},yn=e=>{const n=e[r.TERMINBEKREFTELSE]?e[r.TERMINBEKREFTELSE]:[];return T(n)},kn=e=>{const n=e[r.DOK_MILITÆR_SILVIL_TJENESTE]?e[r.DOK_MILITÆR_SILVIL_TJENESTE]:[];return T(n)},En=e=>{const n=e[r.ETTERLØNN_ELLER_SLUTTVEDERLAG]?e[r.ETTERLØNN_ELLER_SLUTTVEDERLAG]:[];return T(n)},vn=e=>{const n=e[r.DOK_INNLEGGELSE_MOR]?e[r.DOK_INNLEGGELSE_MOR]:[];return T(n)},Sn=e=>{const n=e[r.DOK_SYKDOM_MOR]?e[r.DOK_SYKDOM_MOR]:[];return T(n)},Tn=e=>{const n=e[r.DOK_INNLEGGELSE_FAR]?e[r.DOK_INNLEGGELSE_FAR]:[];return T(n)},An=e=>{const n=e[r.DOK_SYKDOM_FAR]?e[r.DOK_SYKDOM_FAR]:[];return T(n)},Dn=e=>{const n=e[r.DOK_INNLEGGELSE_BARN]?e[r.DOK_INNLEGGELSE_BARN]:[];return T(n)},On=e=>{const n=e[r.DOK_UTDANNING_MOR]?e[r.DOK_UTDANNING_MOR]:[];return T(n)},Nn=e=>{const n=e[r.DOK_ARBEID_MOR]?e[r.DOK_ARBEID_MOR]:[];return T(n)},_n=e=>{const n=e[r.DOK_UTDANNING_OG_ARBEID_MOR]?e[r.DOK_UTDANNING_OG_ARBEID_MOR]:[];return T(n)},Rn=e=>{const n=e[r.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]?e[r.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:[];return T(n)},jn=e=>{const n=e[r.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]?e[r.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:[];return T(n)},cn=e=>e.innsendingsType==="SEND_SENERE",T=e=>e.filter(n=>!cn(n)),In=({mellomlagreSøknadOgNaviger:e,avbrytSøknad:n,søkerInfo:a,erEndringssøknad:i})=>{const m=k(),s=Ur(a.arbeidsforhold,e,i),l=Fr(a.arbeidsforhold,i),u=w(c(D.UTTAKSPLAN)),p=w(c(D.ANNEN_FORELDER)),y=w(c(D.OM_BARNET)),o=w(c(D.SØKERSITUASJON)),d=c(D.VEDLEGG)||{},b=c(D.UTTAKSPLAN_METADATA),A=c(D.ARBEIDSFORHOLD_OG_INNTEKT),L=c(D.ANDRE_INNTEKTSKILDER),q=Pr(D.VEDLEGG),P=zr(u,b?.perioderSomSkalSendesInn,i),K=Vr(o.rolle),N=Ir(P,K,p),ee=vn(d),re=Sn(d),ne=Tn(d),te=An(d),ae=Dn(d),ie=On(d),se=Nn(d),me=_n(d),ue=Rn(d),le=jn(d),oe=gn(d),de=yn(d),pe=pn(d),ge=kn(d),ye=En(d),B=N.filter(nn),J=N.filter(fr),x=N.filter(sn),Y=N.filter(an),z=N.filter(tn),H=N.filter(on),ke=N.filter(un),C=N.filter(ln),$=N.filter(dn),Q=N.filter(mn),_=Br(a.søker,p,K,m),R=xr(y),j=Yr(y),Ye=g=>{const X={...d,[r.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:$.length?g[r.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:[],[r.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:H.length>0?g[r.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:[],[r.DOK_INNLEGGELSE_MOR]:B.length>0?g[r.DOK_INNLEGGELSE_MOR]:[],[r.DOK_INNLEGGELSE_BARN]:J.length>0?g[r.DOK_INNLEGGELSE_BARN]:[],[r.DOK_INNLEGGELSE_FAR]:Y.length>0?g[r.DOK_INNLEGGELSE_FAR]:[],[r.DOK_SYKDOM_MOR]:z.length>0?g[r.DOK_SYKDOM_MOR]:[],[r.DOK_SYKDOM_FAR]:x.length>0?g[r.DOK_SYKDOM_FAR]:[],[r.DOK_UTDANNING_MOR]:Q.length>0?g[r.DOK_UTDANNING_MOR]:[],[r.DOK_UTDANNING_OG_ARBEID_MOR]:C.length>0?g[r.DOK_UTDANNING_OG_ARBEID_MOR]:[],[r.DOK_ARBEID_MOR]:ke.length>0?g[r.DOK_ARBEID_MOR]:[],[r.DOK_AV_ALENEOMSORG]:g[r.DOK_AV_ALENEOMSORG]||[],[r.TERMINBEKREFTELSE]:g[r.TERMINBEKREFTELSE]||[],[r.OMSORGSOVERTAKELSE]:g[r.OMSORGSOVERTAKELSE]||[],[r.DOK_MILITÆR_SILVIL_TJENESTE]:g[r.DOK_MILITÆR_SILVIL_TJENESTE]||[],[r.ETTERLØNN_ELLER_SLUTTVEDERLAG]:g[r.ETTERLØNN_ELLER_SLUTTVEDERLAG]||[]};return q(X),s.goToNextDefaultStep()},W=br({defaultValues:{[r.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:le,[r.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:ue,[r.DOK_INNLEGGELSE_MOR]:ee,[r.DOK_INNLEGGELSE_BARN]:ae,[r.DOK_INNLEGGELSE_FAR]:ne,[r.DOK_SYKDOM_FAR]:te,[r.DOK_SYKDOM_MOR]:re,[r.DOK_UTDANNING_MOR]:ie,[r.DOK_UTDANNING_OG_ARBEID_MOR]:me,[r.DOK_ARBEID_MOR]:se,[r.DOK_AV_ALENEOMSORG]:oe,[r.TERMINBEKREFTELSE]:de,[r.OMSORGSOVERTAKELSE]:pe,[r.DOK_MILITÆR_SILVIL_TJENESTE]:ge,[r.ETTERLØNN_ELLER_SLUTTVEDERLAG]:ye}}),v=g=>X=>{W.setValue(g,X,{shouldDirty:!0,shouldTouch:!0}),W.clearErrors(g)},ze=[B,J,x,Y,z,H,C,$,Q].flat().length===0;return t.jsx(Lr,{pageTitle:m.formatMessage({id:"søknad.pageheading"}),children:t.jsx(qr,{steps:l,noFieldsRequired:!0,children:t.jsx(Kr,{formMethods:W,onSubmit:Ye,children:t.jsxs(Oe,{gap:"space-40",children:[t.jsx(he,{attachments:ee,familiehendelsesdato:R,navnPåForeldre:_,perioder:B,situasjon:o.situasjon,termindato:j,updateAttachments:v,erFarEllerMedmor:K}),t.jsx(we,{attachments:re,familiehendelsesdato:R,navnPåForeldre:_,perioder:z,situasjon:o.situasjon,termindato:j,updateAttachments:v,erFarEllerMedmor:K}),t.jsx(Ke,{attachments:ne,familiehendelsesdato:R,navnPåForeldre:_,perioder:Y,situasjon:o.situasjon,termindato:j,updateAttachments:v,erFarEllerMedmor:K}),t.jsx(qe,{attachments:te,familiehendelsesdato:R,navnPåForeldre:_,perioder:x,situasjon:o.situasjon,termindato:j,updateAttachments:v,erFarEllerMedmor:K}),t.jsx(be,{attachments:ae,familiehendelsesdato:R,navnPåForeldre:_,perioder:J,situasjon:o.situasjon,termindato:j,updateAttachments:v}),t.jsx(Be,{attachments:ie,familiehendelsesdato:R,navnPåForeldre:_,perioder:Q,situasjon:o.situasjon,termindato:j,updateAttachments:v}),t.jsx(Ue,{attachments:se,familiehendelsesdato:R,navnPåForeldre:_,perioder:ke,situasjon:o.situasjon,erFarEllerMedmor:K,termindato:j,updateAttachments:v}),t.jsx(Fe,{attachments:me,familiehendelsesdato:R,navnPåForeldre:_,perioder:C,situasjon:o.situasjon,termindato:j,updateAttachments:v}),t.jsx(Pe,{attachments:ue,familiehendelsesdato:R,navnPåForeldre:_,perioder:H,situasjon:o.situasjon,termindato:j,updateAttachments:v}),t.jsx(Ve,{attachments:le,familiehendelsesdato:R,navnPåForeldre:_,perioder:$,situasjon:o.situasjon,termindato:j,updateAttachments:v}),t.jsx(fe,{attachments:oe,updateAttachments:v,annenForelder:p}),t.jsx(xe,{attachments:de,updateAttachments:v,barn:y,arbeidsforhold:a.arbeidsforhold,erFarEllerMedmor:K}),t.jsx(Je,{attachments:pe,updateAttachments:v,søkersituasjon:o}),t.jsx(Le,{attachments:ye,updateAttachments:v,arbeidsforholdOgInntekt:A,andreInntektskilder:L}),t.jsx(Ge,{attachments:ge,updateAttachments:v,arbeidsforholdOgInntekt:A,andreInntektskilder:L}),!ze&&t.jsxs(Gr,{size:"small",variant:"info",children:[t.jsx(wr,{level:"2",size:"small",children:t.jsx(S,{id:"manglendeVedlegg.duKanSende.tittel"})}),t.jsx(F,{children:t.jsx(S,{id:"manglendeVedlegg.duKanSende.innhold"})})]}),t.jsx(hr,{goToPreviousStep:s.goToPreviousDefaultStep,onAvsluttOgSlett:n,onFortsettSenere:s.fortsettSøknadSenere})]})})})})};In.__docgenInfo={description:"",methods:[],displayName:"ManglendeVedlegg",props:{søkerInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
