import{Z as q,aY as H,_ as i,aZ as x,a_ as J,a$ as y,a1 as _,J as o,b0 as K,U as Y,k as $,b1 as C,r as z,b2 as Z,ar as W,b3 as Q,$ as I,b4 as X,b5 as ee,b6 as ae,a0 as re,b7 as ne,a5 as b,a6 as te,a7 as le}from"./iframe-DAkwh5qa.js";import{e as c,C as d}from"./FpDataContext-BSMdgobt.js";import{n as ie,b as se,S}from"./useFpNavigator-r7K5qD8o.js";import{a as ue,l as Ee,b as oe,c as de}from"./eksisterendeSakUtils-BbFN9fxi.js";import{l as me,m as ve,n as Re,o as V,I as T,p as Ne,q as M,r as ke,s as p,t as ge,u as Te}from"./annenForelderUtils-CaLJcbv0.js";import{D as _e}from"./DinePlikter-B2QxX6W4.js";import{g as O}from"./guid-CsArkN6i.js";import{D as Ae}from"./DinePersonopplysningerModal-DB38mFE4.js";const fe=()=>{const a=c();return{oppdaterSøknadIState:(e,l)=>{a(d.SØKERSITUASJON,e.søkersituasjon),a(d.OM_BARNET,e.barn),a(d.ANNEN_FORELDER,e.annenForelder),a(d.ARBEIDSFORHOLD_OG_INNTEKT,e.arbeidsforholdOgInntekt),a(d.FRILANS,e.frilans),a(d.EGEN_NÆRING,e.egenNæring),a(d.ANDRE_INNTEKTSKILDER,e.andreInntektskilder),a(d.UTENLANDSOPPHOLD,e.utenlandsopphold),a(d.UTENLANDSOPPHOLD_TIDLIGERE,e.utenlandsoppholdSiste12Mnd),a(d.UTENLANDSOPPHOLD_SENERE,e.utenlandsoppholdNeste12Mnd),a(d.PERIODE_MED_FORELDREPENGER,e.dekningsgrad),a(d.UTTAKSPLAN,e.uttaksplan),a(d.UTTAKSPLAN_METADATA,{ønskerJustertUttakVedFødsel:e.ønskerJustertUttakVedFødsel}),l&&a(d.EKSISTERENDE_SAK,l)}}};var v=(a=>(a.FØDT="født",a.UFØDT="ufødt",a.ADOPTERT="adoptert",a.IKKE_UTFYLT="ikkeUtfylt",a))(v||{});const De=(a,r)=>a.map(e=>{const l=e.sak!==void 0?B(e.sak.åpenBehandling===void 0,r):void 0,s=e.sak!==void 0?r.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"";return i.jsx(y,{value:e.id,description:e.sak!==void 0?`${s}, ${l}`:s,children:i.jsx(_,{id:"velkommen.barnVelger.ufødtBarn",values:{antallBarnTekst:Re(e.antallBarn,r),termin:o(e.termindato).format(K),b:t=>i.jsx("b",{children:t})}})},e.id)}),B=(a,r)=>a?r.formatMessage({id:"velkommen.sak.status.ferdigBehandlet"}):r.formatMessage({id:"velkommen.sak.status.underBehandling"}),Le=(a,r)=>a.map(e=>{const l=me(e.fornavn,e.fødselsdatoer,e.omsorgsovertagelse,e.alleBarnaLever,e.antallBarn,r),s=ve(e.fødselsdatoer),t=e.type===v.FØDT||e.type===v.IKKE_UTFYLT?s:o(e.omsorgsovertagelse).format(K),u=e.type===v.FØDT||e.type===v.IKKE_UTFYLT?r.formatMessage({id:"velkommen.barnVelger.født"}):r.formatMessage({id:"velkommen.barnVelger.adopsjon"}),E=e.sak!==void 0?r.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"",N=e.sak!==void 0?B(e.sak.åpenBehandling===void 0,r):void 0;return i.jsx(y,{value:e.id,description:N?`${E}, ${N}`:E,children:i.jsx("b",{children:e.alleBarnaLever?`${l} ${u} ${t}`:l})},e.id)}),U=({selectableBarn:a})=>{const r=q(),{control:e}=H();if(a.length===0)return null;const l=a.filter(u=>u.type===v.UFØDT),s=a.filter(u=>u.type!==v.UFØDT);let t=[];return s.length>0&&(t=t.concat(Le(s,r))),l.length>0&&(t=t.concat(De(l,r))),i.jsx(x,{name:"valgteBarn",control:e,label:i.jsx(_,{id:"velkommen.intro.harSaker.barnVelger.label"}),validate:[J(r.formatMessage({id:"steg.footer.spørsmålMåBesvares"}))],children:t.concat(i.jsx(y,{value:"søknad_gjeder_nytt_barn",description:r.formatMessage({id:"velkommen.intro.harSaker.barnVelger.info"}),children:i.jsx(_,{id:"omBarnet.gjelderAnnetBarn",values:{b:u=>i.jsx("b",{children:u})}})},"søknad_gjeder_nytt_barn"))})};U.__docgenInfo={description:"",methods:[],displayName:"BarnVelger",props:{selectableBarn:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: string;
    type: ValgtBarnType;
    antallBarn: number;
    sortableDato: Date;
...
| 'IKKE_OPPGITT'`,elements:[{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'UTDANNING'"},{name:"literal",value:"'KVALPROG'"},{name:"literal",value:"'INTROPROG'"},{name:"literal",value:"'TRENGER_HJELP'"},{name:"literal",value:"'INNLAGT'"},{name:"literal",value:"'ARBEID_OG_UTDANNING'"},{name:"literal",value:"'UFØRE'"},{name:"literal",value:"'IKKE_OPPGITT'"}],required:!1}},{key:"samtidigUttak",value:{name:"number",required:!1}},{key:"flerbarnsdager",value:{name:"boolean",required:!1}},{key:"forelder",value:{name:"union",raw:"'MOR' | 'FAR_MEDMOR'",elements:[{name:"literal",value:"'MOR'"},{name:"literal",value:"'FAR_MEDMOR'"}],required:!1}}]}}],raw:"UttakPeriode[]",required:!0}}]},required:!1}},{key:"barn",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    etternavn: string;
    fødselsdato?: string;
}`,signature:{properties:[{key:"fnr",value:{name:"string",required:!0}},{key:"fornavn",value:{name:"string",required:!0}},{key:"mellomnavn",value:{name:"string",required:!1}},{key:"etternavn",value:{name:"string",required:!0}},{key:"fødselsdato",value:{name:"string",required:!1}}]},required:!1}},{key:"familiehendelsesdato",value:{name:"Date",required:!1}},{key:"startdatoFørsteStønadsperiode",value:{name:"Date",required:!1}},{key:"alleBarnaLever",value:{name:"boolean",required:!0}}]}}],raw:"ValgtBarn[]"},description:""}}};o.extend(C);o.extend(Te);const pe=(a,r,e)=>a?v.ADOPTERT:r.fødselsdato!==void 0||e&&e.length>0?v.FØDT:v.UFØDT,Oe=(a,r)=>{const e=a.familiehendelse.termindato;if($(e)){const l=o(e).subtract(17,"week"),s=o(e).add(6,"week");return r.filter(t=>o(t.fødselsdato).isBetween(l,s,"day","[]"))}return[]},Ie=(a,r)=>{const e=T(a.familiehendelse.fødselsdato),l=a.barn!==void 0?a.barn.map(u=>u.fnr).flat():[],s=r.filter(u=>l.includes(u.fnr)),t=e!==void 0?r.filter(u=>V(u.fødselsdato,e)&&!s.find(E=>E.fnr===u.fnr)):[];return s.concat(t)},Se=(a,r)=>{let e;(a.barn||a.familiehendelse.fødselsdato)&&(e=Ie(a,r)),a.familiehendelse.termindato&&!a.familiehendelse.fødselsdato&&!a.barn&&(e=Oe(a,r));const l=T(ke(a.familiehendelse.termindato,a.familiehendelse.fødselsdato,a.familiehendelse.omsorgsovertakelse)),s=pe(a.gjelderAdopsjon,a.familiehendelse,e),t=T(a.familiehendelse.fødselsdato);let u;return e&&e.length>0?u=e.map(E=>o.utc(E.fødselsdato).toDate()):t!==void 0&&(u=Array(a.familiehendelse.antallBarn).fill(t)),{id:O(),type:s,antallBarn:a.familiehendelse.antallBarn,termindato:T(a.familiehendelse.termindato),omsorgsovertagelse:T(a.familiehendelse.omsorgsovertakelse),kanSøkeOmEndring:a.kanSøkeOmEndring,sak:a,fødselsdatoer:u,familiehendelsesdato:l,sortableDato:T(a.familiehendelse.termindato),startdatoFørsteStønadsperiode:a.gjeldendeVedtak!==void 0&&a.gjeldendeVedtak.perioder.length>0?Y(T(a.gjeldendeVedtak.perioder[0].fom)).denneEllerNeste():void 0,fornavn:e!==void 0&&e.length>0?e.filter(E=>E.fornavn!==void 0&&E.fornavn.trim()!=="").map(E=>[E.fornavn,E.mellomnavn!==void 0?E.mellomnavn:""].join(" ")):void 0,fnr:e!==void 0&&e.length>0?e.filter(E=>E.fnr!==void 0).map(E=>E.fnr):void 0,alleBarnaLever:e!==void 0&&e.length>0?e.every(E=>p(E)):!1}},ye=(a,r)=>{const e=a.mellomnavn!==void 0?[a.fornavn,a.mellomnavn].join(" "):a.fornavn;return{id:O(),type:v.IKKE_UTFYLT,antallBarn:1,fødselsdatoer:[o.utc(a.fødselsdato).toDate()],fornavn:e!==void 0?[e]:void 0,fnr:[a.fnr],sortableDato:o.utc(a.fødselsdato).toDate(),alleBarnaLever:p(a),annenForelder:r}},Fe=(a,r,e)=>{const l=[a].concat(r).sort(ge);if(!(l.find(t=>!p(t)&&M(t))||l.length==0))return{id:O(),type:v.IKKE_UTFYLT,antallBarn:l.length,fødselsdatoer:l.map(t=>o.utc(t.fødselsdato).toDate()),fornavn:l.map(t=>[t.fornavn,t.mellomnavn!==void 0?t.mellomnavn:""].join(" ")),fnr:l.map(t=>t.fnr),sortableDato:o.utc(l[0].fødselsdato).toDate(),alleBarnaLever:l.every(t=>p(t)),annenForelder:e}},Ge=(a,r)=>a.filter(e=>e.barn!==void 0&&e.barn.length>0||e.familiehendelse.termindato!==void 0||e.familiehendelse.fødselsdato!==void 0||e.familiehendelse.omsorgsovertakelse!==void 0).map(e=>Se(e,r)),Pe=(a,r,e)=>{const l=a.filter(n=>!e.find(m=>V(n.fødselsdato,T(m.familiehendelse.fødselsdato)))),s="tempFnr",t=l.map(n=>n.fnr===void 0?{...n,fnr:s+O().toString()}:n),u=r.map(n=>n.fnr).flat(),E=r.filter(n=>n.fødselsdatoer!==void 0&&n.fødselsdatoer.length>0).map(n=>n.fødselsdatoer).flat(),N=[];return t.filter(n=>!(n.dødsdato!==void 0&&E.find(m=>o(m).isSame(o.utc(n.fødselsdato),"day")))).forEach(n=>{if(!u.includes(n.fnr)&&!ie(n.fødselsdato)){const m=Ne(n.fnr,n.fødselsdato,t),A=n.annenForelder!==void 0?{fnr:n.annenForelder.fnr,fornavn:n.annenForelder.fornavn,mellomnavn:n.annenForelder.mellomnavn,etternavn:n.annenForelder.etternavn}:void 0;if(u.push(n.fnr),m.length===0){if(!M(n)){const f=ye(n,A);N.push(f)}}else{const f=Fe(n,m,A);m.forEach(G=>{u.push(G.fnr)}),f!==void 0&&N.push(f)}}}),N.map(n=>n.fnr&&n.fnr.length>0?{...n,fnr:n.fnr.filter(m=>m&&!m.startsWith(s))}:n)},be=(a,r)=>{const e=a.filter(u=>!u.sakAvsluttet),l=a.filter(u=>u.sakAvsluttet),s=Ge(e,r),t=Pe(r,s,l);return s.concat(t)},qe=(a,r)=>{const e=r.filter(s=>s.sak!==void 0&&s.id!==a.id&&s.familiehendelsesdato!==void 0&&o(s.familiehendelsesdato).isAfter(a.familiehendelsesdato,"day"));e.sort(h);const l=e[e.length-1];if(l!==void 0)return{familiehendelsesdato:l.familiehendelsesdato,startdatoFørsteStønadsperiode:l.startdatoFørsteStønadsperiode,fnr:l.fnr,annenForelderFnr:l.sak?.annenPart?.fnr}},h=(a,r)=>o(a.sortableDato).isBefore(r.sortableDato,"d")?1:o(a.sortableDato).isAfter(r.sortableDato,"d")?-1:0,Ke=({saker:a,harGodkjentVilkår:r,søkerInfo:e,setHarGodkjentVilkår:l,setErEndringssøknad:s,setSøknadGjelderNyttBarn:t,mellomlagreSøknadOgNaviger:u})=>{const E=q(),N=se(e.arbeidsforhold,u),F=c(),{oppdaterSøknadIState:D}=fe(),n=z.useMemo(()=>[...be(a,e.søker.barn)].sort(h),[a,e.søker.barn]),m=g=>{if(!g.harForståttRettigheterOgPlikter){console.error("harForståttRettigheterOgPlikter er falsy til tross for at formet skal ha validert den",g.harForståttRettigheterOgPlikter);return}l(!0);const R=n.find(k=>k.id===g.valgteBarn);if(R===void 0)return s(!1),t(!0),N.goToNextStep(S.SØKERSITUASJON);const P=qe(R,n);F(d.BARN_FRA_NESTE_SAK,P);const L=!!R.kanSøkeOmEndring?a.find(k=>k.saksnummer===R.sak?.saksnummer):void 0;if(L){const k=ue(L,P?.startdatoFørsteStønadsperiode,R.fødselsdatoer),w=Ee(e.søker,k,E,L.annenPart,R);return D(w,k),s(!0),t(!1),N.goToNextStep(S.UTTAKSPLAN)}if(R.sak!==void 0&&R.kanSøkeOmEndring===!1){const k=oe({...R,sak:R.sak},E,e.søker.barn,e.søker.fnr);D(k)}if(!L){const k=de(R);D(k)}return s(!1),t(!1),N.goToNextStep(S.SØKERSITUASJON)},A=Z({defaultValues:{harForståttRettigheterOgPlikter:r}}),f=A.watch("valgteBarn"),j=n.find(g=>g.id===f)?.kanSøkeOmEndring===!0?E.formatMessage({id:"velkommen.endreSøknad"}):E.formatMessage({id:"velkommen.begynnMedSøknad"});return i.jsx(W,{pageTitle:i.jsx(_,{id:"søknad.pageheading"}),children:i.jsx(Q,{formMethods:A,onSubmit:m,children:i.jsxs(I,{gap:"space-32",children:[i.jsx(X,{poster:!0,children:i.jsxs(I,{gap:"space-8",children:[i.jsx(_,{id:"velkommen.guidepanel.del1"}),i.jsx(_,{id:"velkommen.guidepanel.del2",values:{a:g=>i.jsx(ee,{rel:"noopener noreferrer",href:ae.foreldrepenger,children:g})}})]})}),i.jsx(U,{selectableBarn:n}),i.jsx(re,{variant:"info",children:i.jsx(_,{id:"velkommen.lagring.info"})}),i.jsx(ne,{name:"harForståttRettigheterOgPlikter",control:A.control,label:E.formatMessage({id:"velkommen.samtykke"}),validate:[g=>g!==!0?E.formatMessage({id:"valideringsfeil.velkommen.harForståttRettigheterOgPlikter.påkrevd"}):null],children:i.jsx(I,{gap:"space-20",children:i.jsxs(b,{gap:"space-4",children:[i.jsx(te,{children:i.jsx(_,{id:"velkommen.samtykkeIntro.del1"})}),i.jsx(_e,{})]})})}),i.jsx(b,{justify:"center",children:i.jsx(le,{type:"submit",variant:"primary",children:j})}),i.jsx(Ae,{})]})})})};Ke.__docgenInfo={description:"",methods:[],displayName:"Forside",props:{saker:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    saksnummer: string;
    sakAvsluttet: boolean;
    kanSøkeOmEndring: boolean;
    sakTilhørerMor: boolean;
