import{a4 as b,aX as j,l as i,aY as H,aZ as x,a_ as F,M as p,T as E,a$ as K,U as J,b0 as Y,b1 as $,r as C,b2 as z,m as W,b3 as X,V as y,b4 as Z,b5 as Q,b6 as ee,a5 as ae,b7 as re,H as P,B as ne,o as te}from"./iframe-Dmr2Xk0e.js";import{e as q,C as d}from"./FpDataContext-C8cVxE23.js";import{n as le,b as ie,S as I}from"./useFpNavigator-BzCUTurL.js";import{g as L,b as se,l as oe,c as ue,d as Ee}from"./eksisterendeSakUtils-CEgJ-AQF.js";import{l as de,m as me,n as ve,o as c,I as T,p as Re,q as V,r as ke,s as A,t as Ne,u as _e}from"./annenForelderUtils-shRlbNJP.js";import{D as ge}from"./DinePlikter-DKDJ7lqK.js";import{D as Te}from"./DinePersonopplysningerModal-DJG8nEqT.js";const pe=()=>{const a=q();return{oppdaterSøknadIState:(e,n)=>{a(d.SØKERSITUASJON,e.søkersituasjon),a(d.OM_BARNET,e.barn),a(d.ANNEN_FORELDER,e.annenForelder),a(d.ARBEIDSFORHOLD_OG_INNTEKT,e.arbeidsforholdOgInntekt),a(d.FRILANS,e.frilans),a(d.EGEN_NÆRING,e.egenNæring),a(d.ANDRE_INNTEKTSKILDER,e.andreInntektskilder),a(d.UTENLANDSOPPHOLD,e.utenlandsopphold),a(d.UTENLANDSOPPHOLD_TIDLIGERE,e.utenlandsoppholdSiste12Mnd),a(d.UTENLANDSOPPHOLD_SENERE,e.utenlandsoppholdNeste12Mnd),a(d.PERIODE_MED_FORELDREPENGER,e.dekningsgrad),a(d.UTTAKSPLAN,e.uttaksplan),a(d.UTTAKSPLAN_METADATA,{ønskerJustertUttakVedFødsel:e.ønskerJustertUttakVedFødsel}),n&&a(d.EKSISTERENDE_SAK,n)}}};var v=(a=>(a.FØDT="født",a.UFØDT="ufødt",a.ADOPTERT="adoptert",a.IKKE_UTFYLT="ikkeUtfylt",a))(v||{});const fe=(a,r)=>a.map(e=>{const n=e.sak?M(e.sak.åpenBehandling===void 0,r):void 0,s=e.sak?r.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"";return i.jsx(F,{value:e.id,description:e.sak?`${s}, ${n}`:s,children:i.jsx(p,{id:"velkommen.barnVelger.ufødtBarn",values:{antallBarnTekst:ve(e.antallBarn,r),termin:E(e.termindato).format(K),b:t=>i.jsx("b",{children:t})}})},e.id)}),M=(a,r)=>a?r.formatMessage({id:"velkommen.sak.status.ferdigBehandlet"}):r.formatMessage({id:"velkommen.sak.status.underBehandling"}),De=(a,r)=>a.map(e=>{const n=de(e.fornavn,e.fødselsdatoer,e.omsorgsovertagelse,e.alleBarnaLever,e.antallBarn,r),s=me(e.fødselsdatoer),t=e.type===v.FØDT||e.type===v.IKKE_UTFYLT?s:E(e.omsorgsovertagelse).format(K),o=e.type===v.FØDT||e.type===v.IKKE_UTFYLT?r.formatMessage({id:"velkommen.barnVelger.født"}):r.formatMessage({id:"velkommen.barnVelger.adopsjon"}),u=e.sak?r.formatMessage({id:"velkommen.barnVelger.saksnummer"},{saksnummer:e.sak.saksnummer}):"",k=e.sak?M(e.sak.åpenBehandling===void 0,r):void 0;return i.jsx(F,{value:e.id,description:k?`${u}, ${k}`:u,children:i.jsx("b",{children:e.alleBarnaLever?`${n} ${o} ${t}`:n})},e.id)}),B=({selectableBarn:a})=>{const r=b(),{control:e}=j();if(a.length===0)return null;const n=a.filter(o=>o.type===v.UFØDT),s=a.filter(o=>o.type!==v.UFØDT);let t=[];return s.length>0&&(t=t.concat(De(s,r))),n.length>0&&(t=t.concat(fe(n,r))),i.jsx(H,{name:"valgteBarn",control:e,label:i.jsx(p,{id:"velkommen.intro.harSaker.barnVelger.label"}),validate:[x(r.formatMessage({id:"steg.footer.spørsmålMåBesvares"}))],children:t.concat(i.jsx(F,{value:"søknad_gjeder_nytt_barn",description:r.formatMessage({id:"velkommen.intro.harSaker.barnVelger.info"}),children:i.jsx(p,{id:"omBarnet.gjelderAnnetBarn",values:{b:o=>i.jsx("b",{children:o})}})},"søknad_gjeder_nytt_barn"))})};B.__docgenInfo={description:"",methods:[],displayName:"BarnVelger",props:{selectableBarn:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    id: string;
    type: ValgtBarnType;
    antallBarn: number;
    sortableDato: Date;
...
| 'PROSESSERER'`,elements:[{name:"literal",value:"'UNDER_BEHANDLING'"},{name:"literal",value:"'VENT_TIDLIG_SØKNAD'"},{name:"literal",value:"'VENT_MELDEKORT'"},{name:"literal",value:"'VENT_DOKUMENTASJON'"},{name:"literal",value:"'VENT_INNTEKTSMELDING'"},{name:"literal",value:"'PROSESSERER'"}],required:!0}}]},required:!1}},{key:"ønskerJustertUttakVedFødsel",value:{name:"boolean",required:!1}}]},required:!1}},{key:"annenForelder",value:{name:"signature",type:"object",raw:`{
    ...
    mellomnavn?: string;
    etternavn: string;
}`,signature:{properties:[{key:"fornavn",value:{name:"string",required:!0}},{key:"mellomnavn",value:{name:"string",required:!1}},{key:"etternavn",value:{name:"string",required:!0}}]},required:!0}}]},required:!1}},{key:"familiehendelsesdato",value:{name:"Date",required:!1}},{key:"startdatoFørsteStønadsperiode",value:{name:"Date",required:!1}},{key:"alleBarnaLever",value:{name:"boolean",required:!0}}]}}],raw:"ValgtBarn[]"},description:""}}};E.extend($);E.extend(_e);const Ae=(a,r,e)=>a?v.ADOPTERT:r.fødselsdato!==void 0||e&&e.length>0?v.FØDT:v.UFØDT,Le=(a,r)=>{const e=a.familiehendelse.termindato;if(Y(e)){const n=E(e).subtract(17,"week"),s=E(e).add(6,"week");return r.filter(t=>E(t.fødselsdato).isBetween(n,s,"day","[]"))}return[]},Oe=(a,r)=>{const e=T(a.familiehendelse.fødselsdato),n=a.barn?a.barn.flatMap(o=>o.fnr):[],s=r.filter(o=>n.includes(o.fnr)),t=e?r.filter(o=>c(o.fødselsdato,e)&&!s.some(u=>u.fnr===o.fnr)):[];return s.concat(t)},Se=(a,r)=>{let e;(a.barn||a.familiehendelse.fødselsdato)&&(e=Oe(a,r)),a.familiehendelse.termindato&&!a.familiehendelse.fødselsdato&&!a.barn&&(e=Le(a,r));const n=T(ke(a.familiehendelse.termindato,a.familiehendelse.fødselsdato,a.familiehendelse.omsorgsovertakelse)),s=Ae(a.gjelderAdopsjon,a.familiehendelse,e),t=T(a.familiehendelse.fødselsdato);let o;return e&&e.length>0?o=e.map(u=>E.utc(u.fødselsdato).toDate()):t!==void 0&&(o=new Array(a.familiehendelse.antallBarn).fill(t)),{id:L(),type:s,antallBarn:a.familiehendelse.antallBarn,termindato:T(a.familiehendelse.termindato),omsorgsovertagelse:T(a.familiehendelse.omsorgsovertakelse),kanSøkeOmEndring:a.kanSøkeOmEndring,sak:a,fødselsdatoer:o,familiehendelsesdato:n,sortableDato:T(a.familiehendelse.termindato),startdatoFørsteStønadsperiode:a.gjeldendeVedtak!==void 0&&a.gjeldendeVedtak.perioder.length>0?J(T(a.gjeldendeVedtak.perioder[0].fom)).denneEllerNeste():void 0,fornavn:e!==void 0&&e.length>0?e.filter(u=>u.navn.fornavn!==void 0&&u.navn.fornavn.trim()!=="").map(u=>[u.navn.fornavn,u.navn.mellomnavn??""].join(" ")):void 0,fnr:e!==void 0&&e.length>0?e.filter(u=>u.fnr!==void 0).map(u=>u.fnr):void 0,alleBarnaLever:e!==void 0&&e.length>0?e.every(u=>A(u)):!1}},ye=(a,r)=>{const e=a.navn.mellomnavn?[a.navn.fornavn,a.navn.mellomnavn].join(" "):a.navn.fornavn;return{id:L(),type:v.IKKE_UTFYLT,antallBarn:1,fødselsdatoer:[E.utc(a.fødselsdato).toDate()],fornavn:e?[e]:void 0,fnr:[a.fnr],sortableDato:E.utc(a.fødselsdato).toDate(),alleBarnaLever:A(a),annenForelder:r}},Ie=(a,r,e)=>{const n=[a].concat(r).sort(Ne);if(!(n.some(t=>!A(t)&&V(t))||n.length==0))return{id:L(),type:v.IKKE_UTFYLT,antallBarn:n.length,fødselsdatoer:n.map(t=>E.utc(t.fødselsdato).toDate()),fornavn:n.map(t=>[t.navn.fornavn,t.navn.mellomnavn??""].join(" ")),fnr:n.map(t=>t.fnr),sortableDato:E.utc(n[0].fødselsdato).toDate(),alleBarnaLever:n.every(t=>A(t)),annenForelder:e}},Fe=(a,r)=>a.filter(e=>e.barn!==void 0&&e.barn.length>0||e.familiehendelse.termindato!==void 0||e.familiehendelse.fødselsdato!==void 0||e.familiehendelse.omsorgsovertakelse!==void 0).map(e=>Se(e,r)),Ge=(a,r,e)=>{const n=a.filter(l=>!e.some(m=>c(l.fødselsdato,T(m.familiehendelse.fødselsdato)))),s="tempFnr",t=n.map(l=>l.fnr===void 0?{...l,fnr:s+L().toString()}:l),o=r.flatMap(l=>l.fnr),u=r.filter(l=>l.fødselsdatoer!==void 0&&l.fødselsdatoer.length>0).flatMap(l=>l.fødselsdatoer),k=[],O=t.filter(l=>!(l.dødsdato!==void 0&&u.some(m=>E(m).isSame(E.utc(l.fødselsdato),"day"))));for(const l of O)if(!o.includes(l.fnr)&&!le(l.fødselsdato)){const m=Re(l.fnr,l.fødselsdato,t);if(o.push(l.fnr),m.length===0){if(!V(l)){const g=ye(l,l.annenPart);k.push(g)}}else{const g=Ie(l,m,l.annenPart);for(const S of m)o.push(S.fnr);g!==void 0&&k.push(g)}}return k.map(l=>l.fnr&&l.fnr.length>0?{...l,fnr:l.fnr.filter(m=>m&&!m.startsWith(s))}:l)},Pe=(a,r)=>{const e=a.filter(o=>!o.sakAvsluttet),n=a.filter(o=>o.sakAvsluttet),s=Fe(e,r),t=Ge(r,s,n);return s.concat(t)},be=(a,r)=>{const e=r.filter(s=>s.sak!==void 0&&s.id!==a.id&&s.familiehendelsesdato!==void 0&&E(s.familiehendelsesdato).isAfter(a.familiehendelsesdato,"day"));e.sort(U);const n=e.at(-1);if(n!==void 0)return{familiehendelsesdato:n.familiehendelsesdato,startdatoFørsteStønadsperiode:n.startdatoFørsteStønadsperiode,fnr:n.fnr,annenForelderFnr:n.sak?.annenPart?.fnr}},U=(a,r)=>E(a.sortableDato).isBefore(r.sortableDato,"d")?1:E(a.sortableDato).isAfter(r.sortableDato,"d")?-1:0,Ke=({saker:a,harGodkjentVilkår:r,søkerInfo:e,setHarGodkjentVilkår:n,setErEndringssøknad:s,setSøknadGjelderNyttBarn:t,mellomlagreSøknadOgNaviger:o})=>{const u=b(),k=ie(e.arbeidsforhold,o),O=q(),{oppdaterSøknadIState:f}=pe(),l=C.useMemo(()=>[...Pe(a,e.person.barn)].sort(U),[a,e.person.barn]),m=_=>{if(!_.harForståttRettigheterOgPlikter){console.error("harForståttRettigheterOgPlikter er falsy til tross for at formet skal ha validert den",_.harForståttRettigheterOgPlikter);return}n(!0);const R=l.find(N=>N.id===_.valgteBarn);if(R===void 0)return s(!1),t(!0),k.goToNextStep(I.SØKERSITUASJON);const G=be(R,l);O(d.BARN_FRA_NESTE_SAK,G);const D=!!R.kanSøkeOmEndring?a.find(N=>N.saksnummer===R.sak?.saksnummer):void 0;if(D){const N=se(D,G?.startdatoFørsteStønadsperiode,R.fødselsdatoer),w=oe(e.person,N,u,D.annenPart,R);return f(w,N),s(!0),t(!1),k.goToNextStep(I.UTTAKSPLAN)}if(R.sak!==void 0&&R.kanSøkeOmEndring===!1){const N=ue({...R,sak:R.sak},u,e.person.barn,e.person.fnr);f(N)}if(!D){const N=Ee(R);f(N)}return s(!1),t(!1),k.goToNextStep(I.SØKERSITUASJON)},g=z({defaultValues:{harForståttRettigheterOgPlikter:r}}),S=g.watch("valgteBarn"),h=l.find(_=>_.id===S)?.kanSøkeOmEndring===!0?u.formatMessage({id:"velkommen.endreSøknad"}):u.formatMessage({id:"velkommen.begynnMedSøknad"});return i.jsx(W,{pageTitle:i.jsx(p,{id:"søknad.pageheading"}),children:i.jsx(X,{formMethods:g,onSubmit:m,children:i.jsxs(y,{gap:"space-32",children:[i.jsx(Z,{poster:!0,children:i.jsxs(y,{gap:"space-8",children:[i.jsx(p,{id:"velkommen.guidepanel.del1"}),i.jsx(p,{id:"velkommen.guidepanel.del2",values:{a:_=>i.jsx(Q,{rel:"noopener noreferrer",href:ee.foreldrepenger,children:_})}})]})}),i.jsx(B,{selectableBarn:l}),i.jsx(ae,{variant:"info",children:i.jsx(p,{id:"velkommen.lagring.info"})}),i.jsx(re,{name:"harForståttRettigheterOgPlikter",control:g.control,label:u.formatMessage({id:"velkommen.samtykke"}),validate:[_=>_?null:u.formatMessage({id:"valideringsfeil.velkommen.harForståttRettigheterOgPlikter.påkrevd"})],children:i.jsx(y,{gap:"space-20",children:i.jsxs(P,{gap:"space-4",children:[i.jsx(ne,{children:i.jsx(p,{id:"velkommen.samtykkeIntro.del1"})}),i.jsx(ge,{})]})})}),i.jsx(P,{justify:"center",children:i.jsx(te,{type:"submit",variant:"primary",children:h})}),i.jsx(Te,{})]})})})};Ke.__docgenInfo={description:"",methods:[],displayName:"Forside",props:{saker:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    annenPart?: Person_fpoversikt;
    barn?: Person_fpoversikt[];
    dekningsgrad?: DekningsgradSak_fpoversikt;
    familiehendelse: Familiehendelse_fpoversikt;
