import{a5 as y,D as he,l as r,b0 as je,r as ye,c0 as we,be as h,c1 as Ve,W as Te,E as Fe,V as Ge,c2 as Be,M as v,y as U,c3 as ge,c4 as ve,L as Ye,c5 as xe,c6 as Je,bC as Ce,c7 as ze,U as Le,B as M,c8 as He,c9 as Qe,ca as We,cb as $e,cc as Xe,cd as Ze,ce as en,cf as nn,cg as rn,ch as an,ci as tn,cj as ln,ck as sn,cl as un,cm as mn,cn as on,co as dn,cp as En,cq as pn,cr as Tn,cs as gn,ct as vn,cu as Ln,cv as yn,cw as Gn,b8 as An,m as kn,as as In,b9 as Rn,a6 as Nn,q as Sn,bu as On}from"./iframe-DAM02hdi.js";import{n as K,b as _,C as k,c as _n,g as Mn,j as Dn}from"./FpDataContext-CExf8kTs.js";import{V as $,K as G,t as n,O as fn,P as W,A as Pn,H as j,Q as Ae,a as cn,T as qn,U as Un,d as bn,c as Kn,W as hn,j as jn,X as wn,Y as Vn}from"./useFpNavigator-mFToXMAm.js";import{a as Fn}from"./uttaksplanInfoUtils-C7WV8thJ.js";import{L as D}from"./List-jWq-9iHE.js";const ke=({attachments:e,updateAttachments:a,annenForelder:t})=>{const i=y();return!he(t)||!t.datoForAleneomsorg?null:r.jsx($,{attachments:e,updateAttachments:a(n.DOK_AV_ALENEOMSORG),skjemanummer:n.DOK_AV_ALENEOMSORG,labelText:i.formatMessage({id:"manglendeVedlegg.aleneomsorg.tittel"}),description:i.formatMessage({id:"manglendeVedlegg.aleneomsorg.description"}),attachmentType:G.ALENEOMSORG,metadataType:"BARN"})};ke.__docgenInfo={description:"",methods:[],displayName:"AleneomsorgDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| 'KRYPTERING_MELLOMLAGRING'`,elements:[{name:"literal",value:"'IKKE_TILGANG'"},{name:"literal",value:"'DUPLIKAT_FORSENDELSE'"},{name:"literal",value:"'MELLOMLAGRING'"},{name:"literal",value:"'MELLOMLAGRING_VEDLEGG'"},{name:"literal",value:"'MELLOMLAGRING_VEDLEGG_VIRUSSCAN_TIMEOUT'"},{name:"literal",value:"'MELLOMLAGRING_VEDLEGG_PASSORD_BESKYTTET'"},{name:"literal",value:"'KRYPTERING_MELLOMLAGRING'"}]},{name:"literal",value:"'NO_DATA'"}],required:!1}},{key:"beskrivelse",value:{name:"string",required:!1}}]}}],raw:"Attachment[]"},name:"attachments"}],return:{name:"void"}}}}},description:""},annenForelder:{required:!0,tsType:{name:"union",raw:"AnnenForelderIkkeOppgitt | AnnenForelderOppgitt",elements:[{name:"signature",type:"object",raw:`{
    kanIkkeOppgis: true;
}`,signature:{properties:[{key:"kanIkkeOppgis",value:{name:"literal",value:"true",required:!0}}]}},{name:"AnnenForelderOppgitt"}]},description:""}}};const I=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:i,familiehendelsesdato:s,termindato:l,situasjon:m,skjemanummer:u,labelText:o,description:T,attachmentType:d})=>{const{watch:E}=je(),q=E(u);return ye.useEffect(()=>{if(q.length===0){const A=fn(d,u),f=W(A,{type:"UTTAK",perioder:t.map(P=>({fom:K(P.tidsperiode.fom),tom:K(P.tidsperiode.tom)}))});a([f])}},[a,t,q,d,u]),r.jsx(we,{label:o,description:r.jsxs(r.Fragment,{children:[r.jsx(h,{children:T}),t.map(A=>r.jsx("div",{className:"my-4",children:r.jsx(Ve,{periode:A,erAleneOmOmsorg:!1,erFarEllerMedmor:!0,navnPåForeldre:i,familiehendelsesdato:Te(s).toDate(),termindato:l?Te(l).toDate():void 0,situasjon:m,melding:void 0})},A.id))]}),attachmentType:d,skjemanummer:u,existingAttachments:e,updateAttachments:A=>{const f=A.map(P=>W(P,{type:"UTTAK",perioder:t.map(b=>({fom:K(b.tidsperiode.fom),tom:K(b.tidsperiode.tom)}))}));return a(f)},uploadPath:Pn.sendVedlegg})};I.__docgenInfo={description:"",methods:[],displayName:"UttakUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Re=({attachments:e,updateAttachments:a,arbeidsforholdOgInntekt:t,andreInntektskilder:i})=>{const s=y();if(!t||t.harHattAndreInntektskilder===!1||!i||!i.some(m=>m.type===j.SLUTTPAKKE))return null;const l=i.filter(m=>m.type===j.SLUTTPAKKE);return r.jsx($,{attachments:e,updateAttachments:a(n.ETTERLØNN_ELLER_SLUTTVEDERLAG),skjemanummer:n.ETTERLØNN_ELLER_SLUTTVEDERLAG,labelText:s.formatMessage({id:"manglendeVedlegg.etterlønn.tittel"},{perioder:Ae(l,s),antallPerioder:l.length}),description:s.formatMessage({id:"manglendeVedlegg.etterlønn.description"}),attachmentType:G.ANNEN_INNTEKT,metadataType:"OPPTJENING",perioder:l})};Re.__docgenInfo={description:"",methods:[],displayName:"EtterlønnEllerSluttvederlagDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const Oe=({attachments:e,updateAttachments:a,arbeidsforholdOgInntekt:t,andreInntektskilder:i})=>{const s=y();if(!t||t&&!t.harHattAndreInntektskilder||!i||!i.some(m=>m.type===j.MILITÆRTJENESTE))return null;const l=i.filter(m=>m.type===j.MILITÆRTJENESTE);return r.jsx($,{attachments:e,updateAttachments:a(n.DOK_MILITÆR_SILVIL_TJENESTE),skjemanummer:n.DOK_MILITÆR_SILVIL_TJENESTE,labelText:s.formatMessage({id:"manglendeVedlegg.militær.tittel"},{perioder:Ae(l,s),antallPerioder:l.length}),description:s.formatMessage({id:"manglendeVedlegg.militær.description"}),attachmentType:G.ANNEN_INNTEKT,metadataType:"OPPTJENING",perioder:l})};Oe.__docgenInfo={description:"",methods:[],displayName:"MilitærEllerSiviltjenesteDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
