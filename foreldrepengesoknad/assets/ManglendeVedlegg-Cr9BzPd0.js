...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Fe=()=>a.jsxs(ce,{gap:"space-8",children:[a.jsx(We,{children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.label"})}),a.jsx(w,{className:"text-ax-text-neutral-subtle",children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.beskrivelse.1"})}),a.jsx(w,{className:"text-ax-text-neutral-subtle",children:a.jsx(T,{id:"dokumentasjon.ikke.påkrevd.beskrivelse.2"})})]});Fe.__docgenInfo={description:"",methods:[],displayName:"IngenDokumentasjonPåkrevd"};const Pe=({attachments:e,updateAttachments:r,perioder:t,navnPåForeldre:m,familiehendelsesdato:i,situasjon:u,erFarEllerMedmor:d,termindato:s})=>{if(t.length===0)return null;const k=y(),p=G(N(O.ANNEN_FORELDER)),l=G(N(O.OM_BARNET)),o=Ae(p)?p.fnr:void 0,M=r(n.DOK_ARBEID_MOR);if(o&&!Xe(p)){const _=Ae(p)&&d&&p.harRettPåForeldrepengerINorge===!1,f=ar(t,l,_,o),K=Qn({...Wn(f),enabled:!!f});if(K.isPending)return a.jsx(Ze,{className:"self-center",size:"large"});if(!(K.data??!0))return a.jsx(rr,{perioder:t,updateDokArbeidMorAttachment:M})}return a.jsx(R,{attachments:e,updateAttachments:M,perioder:t,navnPåForeldre:m,familiehendelsesdato:i,termindato:s,situasjon:u,skjemanummer:n.DOK_ARBEID_MOR,labelText:k.formatMessage({id:"manglendeVedlegg.morJobber.label"}),description:k.formatMessage({id:"manglendeVedlegg.morJobber.description"},{navn:m.mor}),attachmentType:S.MORS_AKTIVITET_DOKUMENTASJON})},rr=({updateDokArbeidMorAttachment:e,perioder:r})=>(Z.useEffect(()=>{const t=Zn(S.MORS_AKTIVITET_DOKUMENTASJON,n.DOK_ARBEID_MOR),m=F(t,{type:h.UTTAK,perioder:r.map(i=>({fom:_e(i.tidsperiode.fom),tom:_e(i.tidsperiode.tom)}))});e([m])},[]),a.jsx(Fe,{})),ar=(e,r,t,m)=>{const i=(en(r)||nn(r))&&r.fnr!==void 0&&r.fnr.length>0?r.fnr[0]:void 0;return{annenPartFødselsnummer:m,barnFødselsnummer:i,familiehendelse:Ie(r),perioder:e.map(u=>({fom:u.tidsperiode.fom.toISOString(),tom:u.tidsperiode.tom.toISOString(),periodeType:t&&rn(u)?"UTSETTELSE":"UTTAK"}))}};Pe.__docgenInfo={description:"",methods:[],displayName:"MorJobberDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: AttachmentMetadata;
    id: string;
    filename: string;
    filesize: number;
