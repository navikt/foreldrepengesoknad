import{a4 as T,C as he,l as r,aX as we,r as ye,bY as Fe,b8 as U,bZ as Ve,T as ke,D as Be,V as ve,b_ as Je,M as S,x as P,b$ as ge,c0 as Se,L as xe,c1 as Ye,c2 as ze,bw as He,c3 as Ce,Q as Te,B as j,c4 as Qe,c5 as $e,c6 as Xe,c7 as Ze,c8 as We,c9 as en,ca as nn,cb as rn,cc as an,cd as tn,ce as mn,cf as sn,cg as un,ch as ln,ci as on,cj as dn,ck as En,cl as pn,cm as kn,cn as gn,co as Sn,cp as Tn,cq as yn,cr as vn,cs as An,b2 as On,m as _n,ar as Nn,b3 as Rn,a5 as Dn,q as In,bo as Ln}from"./iframe-BZJZhiuz.js";import{n as b,b as L,C as O,c as jn,g as fn,j as Kn}from"./FpDataContext-nWCjpqI_.js";import{V as w,P as y,v as n,Q as cn,T as X,U as Gn,A as Mn,J as h,W as Ae,a as Pn,X as qn,Y as bn,d as Un,c as hn,Z as wn,j as Fn,_ as Vn}from"./useFpNavigator-2qlk8-GX.js";import{a as Bn}from"./uttaksplanInfoUtils-POPbPuO9.js";import{L as f}from"./List-DyEJqtBB.js";const Oe=({attachments:e,updateAttachments:a,annenForelder:t})=>{const m=T();return!he(t)||!t.datoForAleneomsorg?null:r.jsx(w,{attachments:e,updateAttachments:a(n.DOK_AV_ALENEOMSORG),skjemanummer:n.DOK_AV_ALENEOMSORG,labelText:m.formatMessage({id:"manglendeVedlegg.aleneomsorg.tittel"}),description:m.formatMessage({id:"manglendeVedlegg.aleneomsorg.description"}),attachmentType:y.ALENEOMSORG,metadataType:"BARN"})};Oe.__docgenInfo={description:"",methods:[],displayName:"AleneomsorgDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},name:"skjemanummer"}],return:{name:"signature",type:"function",raw:"(attachments: Attachment[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    fom: string;
    tom?: string;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!1}}]}}],raw:"ÅpenPeriodeDto[]",required:!1}},{key:"type",value:{name:"union",raw:"'BARN' | 'OPPTJENING' | 'UTTAK' | 'TILRETTELEGGING'",elements:[{name:"literal",value:"'BARN'"},{name:"literal",value:"'OPPTJENING'"},{name:"literal",value:"'UTTAK'"},{name:"literal",value:"'TILRETTELEGGING'"}],required:!0}}]},required:!1}},{key:"id",value:{name:"string",required:!0}},{key:"filename",value:{name:"string",required:!0}},{key:"filesize",value:{name:"number",required:!0}},{key:"file",value:{name:"File",required:!0}},{key:"uuid",value:{name:"string",required:!1}},{key:"pending",value:{name:"boolean",required:!0}},{key:"uploaded",value:{name:"boolean",required:!0}},{key:"type",value:{name:"AttachmentType",required:!0}},{key:"skjemanummer",value:{name:"Skjemanummer",required:!0}},{key:"innsendingsType",value:{name:"union",raw:"'LASTET_OPP' | 'SEND_SENERE' | 'AUTOMATISK'",elements:[{name:"literal",value:"'LASTET_OPP'"},{name:"literal",value:"'SEND_SENERE'"},{name:"literal",value:"'AUTOMATISK'"}],required:!0}},{key:"error",value:{name:"any",required:!1}},{key:"beskrivelse",value:{name:"string",required:!1}}]}}],raw:"Attachment[]"},name:"attachments"}],return:{name:"void"}}}}},description:""},annenForelder:{required:!0,tsType:{name:"union",raw:"AnnenForelderIkkeOppgitt | AnnenForelderOppgitt",elements:[{name:"Common"},{name:"AnnenForelderOppgitt"}]},description:""}}};const _=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:s,termindato:i,situasjon:l,skjemanummer:u,labelText:o,description:k,attachmentType:d})=>{const{watch:E}=we(),M=E(u);return ye.useEffect(()=>{if(M.length===0){const A=cn(d,u),K=X(A,{type:"UTTAK",perioder:t.map(c=>({fom:b(c.tidsperiode.fom),tom:b(c.tidsperiode.tom)}))});a([K])}},[a,t,M,d,u]),r.jsx(Fe,{label:o,description:r.jsxs(r.Fragment,{children:[r.jsx(U,{children:k}),t.map(A=>r.jsx("div",{className:"my-4",children:r.jsx(Ve,{periode:A,erAleneOmOmsorg:!1,erFarEllerMedmor:!0,navnPåForeldre:m,familiehendelsesdato:ke(s).toDate(),termindato:i?ke(i).toDate():void 0,situasjon:l,melding:void 0})},A.id))]}),attachmentType:d,skjemanummer:u,existingAttachments:e,updateAttachments:A=>{const K=A.map(c=>X(c,{type:"UTTAK",perioder:t.map(q=>({fom:b(q.tidsperiode.fom),tom:b(q.tidsperiode.tom)}))}));return a(K)},saveAttachment:Gn(Mn.sendVedlegg)})};_.__docgenInfo={description:"",methods:[],displayName:"UttakUploader",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| Skjemanummer.OMSORGSOVERTAKELSE
| Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},description:""},labelText:{required:!0,tsType:{name:"string"},description:""},description:{required:!0,tsType:{name:"union",raw:"string | React.ReactNode",elements:[{name:"string"},{name:"ReactReactNode",raw:"React.ReactNode"}]},description:""},attachmentType:{required:!0,tsType:{name:"AttachmentType"},description:""}}};const _e=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:s,situasjon:i,termindato:l})=>{const u=T();return t.length===0?null:r.jsx(_,{attachments:e,updateAttachments:a(n.DOK_INNLEGGELSE_BARN),perioder:t,navnPåForeldre:m,familiehendelsesdato:s,termindato:l,situasjon:i,skjemanummer:n.DOK_INNLEGGELSE_BARN,labelText:u.formatMessage({id:"manglendeVedlegg.barnInnlagt.label"}),description:u.formatMessage({id:"manglendeVedlegg.barnInnlagt.description"}),attachmentType:y.UTSETTELSE_SYKDOM})};_e.__docgenInfo={description:"",methods:[],displayName:"BarnInnlagtDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Ne=({attachments:e,updateAttachments:a,arbeidsforholdOgInntekt:t,andreInntektskilder:m})=>{const s=T();if(!t||t&&t.harHattAndreInntektskilder===!1||!m||!m.some(l=>l.type===h.SLUTTPAKKE))return null;const i=m.filter(l=>l.type===h.SLUTTPAKKE);return r.jsx(w,{attachments:e,updateAttachments:a(n.ETTERLØNN_ELLER_SLUTTVEDERLAG),skjemanummer:n.ETTERLØNN_ELLER_SLUTTVEDERLAG,labelText:s.formatMessage({id:"manglendeVedlegg.etterlønn.tittel"},{perioder:Ae(i,s),antallPerioder:i.length}),description:s.formatMessage({id:"manglendeVedlegg.etterlønn.description"}),attachmentType:y.ANNEN_INNTEKT,metadataType:"OPPTJENING",perioder:i})};Ne.__docgenInfo={description:"",methods:[],displayName:"EtterlønnEllerSluttvederlagDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const Ie=({attachments:e,updateAttachments:a,arbeidsforholdOgInntekt:t,andreInntektskilder:m})=>{const s=T();if(!t||t&&!t.harHattAndreInntektskilder||!m||!m.some(l=>l.type===h.MILITÆRTJENESTE))return null;const i=m.filter(l=>l.type===h.MILITÆRTJENESTE);return r.jsx(w,{attachments:e,updateAttachments:a(n.DOK_MILITÆR_SILVIL_TJENESTE),skjemanummer:n.DOK_MILITÆR_SILVIL_TJENESTE,labelText:s.formatMessage({id:"manglendeVedlegg.militær.tittel"},{perioder:Ae(i,s),antallPerioder:i.length}),description:s.formatMessage({id:"manglendeVedlegg.militær.description"}),attachmentType:y.ANNEN_INNTEKT,metadataType:"OPPTJENING",perioder:i})};Ie.__docgenInfo={description:"",methods:[],displayName:"MilitærEllerSiviltjenesteDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},name:"skjemanummer"}],return:{name:"signature",type:"function",raw:"(attachments: Attachment[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    harJobbetSomFrilans: boolean;
    harJobbetSomSelvstendigNæringsdrivende: boolean;
}`,signature:{properties:[{key:"harJobbetSomFrilans",value:{name:"boolean",required:!0}},{key:"harJobbetSomSelvstendigNæringsdrivende",value:{name:"boolean",required:!0}}]}}]},{name:"undefined"}]},description:""},andreInntektskilder:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:"SluttpakkeInntekt | MilitærtjenesteInntekt | JobbIUtlandetInntekt",elements:[{name:"SluttpakkeInntekt"},{name:"MilitærtjenesteInntekt"},{name:"JobbIUtlandetInntekt"}]}],raw:"AndreInntektskilder[]"},description:""}}};const Le=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:s,situasjon:i,termindato:l,erFarEllerMedmor:u})=>{const o=T();return t.length===0?null:r.jsx(_,{attachments:e,updateAttachments:a(n.DOK_SYKDOM_MOR),perioder:t,navnPåForeldre:m,familiehendelsesdato:s,termindato:l,situasjon:i,skjemanummer:n.DOK_SYKDOM_MOR,labelText:o.formatMessage({id:"manglendeVedlegg.morForSyk.label"},{navn:m.mor,erFarEllerMedmor:u}),description:o.formatMessage({id:"manglendeVedlegg.morForSyk.description"},{navn:m.mor,erFarEllerMedmor:u}),attachmentType:y.UTSETTELSE_SYKDOM})};Le.__docgenInfo={description:"",methods:[],displayName:"MorForSykDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const je=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:s,situasjon:i,termindato:l,erFarEllerMedmor:u})=>{const o=T();if(t.length===0)return null;const k=t.some(d=>d.type===Be.Uttak&&d.erMorForSyk===!0&&d.konto==="FEDREKVOTE");return r.jsx(_,{attachments:e,updateAttachments:a(n.DOK_INNLEGGELSE_MOR),perioder:t,navnPåForeldre:m,familiehendelsesdato:s,termindato:l,situasjon:i,skjemanummer:n.DOK_INNLEGGELSE_MOR,labelText:k?o.formatMessage({id:"manglendeVedlegg.morInnlagtEllerSyk.label"},{navn:m.mor,erFarEllerMedmor:u}):o.formatMessage({id:"manglendeVedlegg.morInnlagt.label"},{navn:m.mor,erFarEllerMedmor:u}),description:k?o.formatMessage({id:"manglendeVedlegg.morInnlagtEllerSyk.description"},{navn:m.mor,erFarEllerMedmor:u}):o.formatMessage({id:"manglendeVedlegg.morInnlagt.description"},{navn:m.mor,erFarEllerMedmor:u}),attachmentType:y.UTSETTELSE_SYKDOM})};je.__docgenInfo={description:"",methods:[],displayName:"MorInnlagtDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""},erFarEllerMedmor:{required:!0,tsType:{name:"boolean"},description:""}}};const fe=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:s,situasjon:i,termindato:l})=>{const u=T();return t.length===0?null:r.jsx(_,{attachments:e,updateAttachments:a(n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET),perioder:t,navnPåForeldre:m,familiehendelsesdato:s,termindato:l,situasjon:i,skjemanummer:n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET,labelText:u.formatMessage({id:"manglendeVedlegg.introduksjonsprogram.tittel"}),description:u.formatMessage({id:"manglendeVedlegg.introduksjonsprogram.description"},{navn:m.mor}),attachmentType:y.MORS_AKTIVITET_DOKUMENTASJON})};fe.__docgenInfo={description:"",methods:[],displayName:"MorIntroduksjonsprogrammetDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Me=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:s,situasjon:i,termindato:l})=>{const u=T();return t.length===0?null:r.jsx(_,{attachments:e,updateAttachments:a(n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM),perioder:t,navnPåForeldre:m,familiehendelsesdato:s,termindato:l,situasjon:i,skjemanummer:n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM,labelText:u.formatMessage({id:"manglendeVedlegg.kvalifiseringsprogram.tittel"}),description:u.formatMessage({id:"manglendeVedlegg.kvalifiseringsprogram.description"},{navn:m.mor}),attachmentType:y.MORS_AKTIVITET_DOKUMENTASJON})};Me.__docgenInfo={description:"",methods:[],displayName:"MorKvalifiseringsprogrammetDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| UttakAnnenPartInfoPeriode
| UttakAnnenPartEØSInfoPeriode
| UtsettelseAnnenPartInfoPeriode`,elements:[{name:"AvslåttPeriode"},{name:"UttakAnnenPartInfoPeriode"},{name:"UttakAnnenPartEØSInfoPeriode"},{name:"UtsettelseAnnenPartInfoPeriode"}]}]}],raw:"Periode[]"},description:""},navnPåForeldre:{required:!0,tsType:{name:"NavnPåForeldre"},description:""},familiehendelsesdato:{required:!0,tsType:{name:"string"},description:""},termindato:{required:!0,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},situasjon:{required:!0,tsType:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}]},description:""}}};const Pe=({attachments:e,updateAttachments:a,perioder:t,navnPåForeldre:m,familiehendelsesdato:s,situasjon:i,termindato:l})=>{const u=T();return t.length===0?null:r.jsx(_,{attachments:e,updateAttachments:a(n.DOK_UTDANNING_MOR),perioder:t,navnPåForeldre:m,familiehendelsesdato:s,termindato:l,situasjon:i,skjemanummer:n.DOK_UTDANNING_MOR,labelText:u.formatMessage({id:"manglendeVedlegg.studerer.label"}),description:r.jsxs(r.Fragment,{children:[r.jsx(j,{children:r.jsx(S,{id:"manglendeVedlegg.studerer.description.tittel",values:{navn:m.mor}})}),r.jsxs(f,{as:"ul",children:[r.jsx(f.Item,{children:r.jsx(j,{children:r.jsx(S,{id:"manglendeVedlegg.studerer.description.punkt1"})})}),r.jsx(f.Item,{children:r.jsx(j,{children:r.jsx(S,{id:"manglendeVedlegg.studerer.description.punkt2"})})}),r.jsx(f.Item,{children:r.jsx(j,{children:r.jsx(S,{id:"manglendeVedlegg.studerer.description.punkt3"})})}),r.jsx(f.Item,{children:r.jsx(j,{children:r.jsx(S,{id:"manglendeVedlegg.studerer.description.punkt4"})})})]})]}),attachmentType:y.MORS_AKTIVITET_DOKUMENTASJON})};Pe.__docgenInfo={description:"",methods:[],displayName:"MorStudererDokumentasjon",props:{attachments:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    dokumenterer?: Dokumenterer;
    id: string;
    filename: string;
    filesize: number;
...
| Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE`,elements:[{name:"Skjemanummer.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM"},{name:"Skjemanummer.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET"},{name:"Skjemanummer.DOK_INNLEGGELSE_BARN"},{name:"Skjemanummer.DOK_INNLEGGELSE_MOR"},{name:"Skjemanummer.DOK_INNLEGGELSE_FAR"},{name:"Skjemanummer.DOK_SYKDOM_MOR"},{name:"Skjemanummer.DOK_SYKDOM_FAR"},{name:"Skjemanummer.DOK_UTDANNING_MOR"},{name:"Skjemanummer.DOK_UTDANNING_OG_ARBEID_MOR"},{name:"Skjemanummer.DOK_ARBEID_MOR"},{name:"Skjemanummer.DOK_AV_ALENEOMSORG"},{name:"Skjemanummer.TERMINBEKREFTELSE"},{name:"Skjemanummer.OMSORGSOVERTAKELSE"},{name:"Skjemanummer.ETTERLØNN_ELLER_SLUTTVEDERLAG"},{name:"Skjemanummer.DOK_MILITÆR_SILVIL_TJENESTE"}]},name:"skjemanummer"}],return:{name:"signature",type:"function",raw:"(attachments: Attachment[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    situasjon?: Situasjon;
}`,signature:{properties:[{key:"situasjon",value:{name:"union",raw:"'fødsel' | 'adopsjon' | 'omsorgsovertakelse'",elements:[{name:"literal",value:"'fødsel'"},{name:"literal",value:"'adopsjon'"},{name:"literal",value:"'omsorgsovertakelse'"}],required:!1}}]}},description:""}}};const Yn=e=>Qe(e)||$e(e)||Xe(e)||Ze(e)||We(e)||en(e),zn=e=>an(e)||tn(e)||mn(e)||sn(e)||un(e),Hn=e=>rn(e),Cn=e=>nn(e),Qn=e=>Tn(e)||yn(e),$n=e=>dn(e)||En(e),Xn=e=>pn(e)||kn(e),Zn=e=>ln(e)||on(e),Wn=e=>gn(e)||Sn(e),er=e=>{const a=e[n.OMSORGSOVERTAKELSE]?e[n.OMSORGSOVERTAKELSE]:[];return v(a)},nr=e=>{const a=e[n.DOK_AV_ALENEOMSORG]?e[n.DOK_AV_ALENEOMSORG]:[];return v(a)},rr=e=>{const a=e[n.TERMINBEKREFTELSE]?e[n.TERMINBEKREFTELSE]:[];return v(a)},ar=e=>{const a=e[n.DOK_MILITÆR_SILVIL_TJENESTE]?e[n.DOK_MILITÆR_SILVIL_TJENESTE]:[];return v(a)},tr=e=>{const a=e[n.ETTERLØNN_ELLER_SLUTTVEDERLAG]?e[n.ETTERLØNN_ELLER_SLUTTVEDERLAG]:[];return v(a)},mr=e=>{const a=e[n.DOK_INNLEGGELSE_MOR]?e[n.DOK_INNLEGGELSE_MOR]:[];return v(a)},ir=e=>{const a=e[n.DOK_SYKDOM_MOR]?e[n.DOK_SYKDOM_MOR]:[];return v(a)},sr=e=>{const a=e[n.DOK_INNLEGGELSE_FAR]?e[n.DOK_INNLEGGELSE_FAR]:[];return v(a)},ur=e=>{const a=e[n.DOK_SYKDOM_FAR]?e[n.DOK_SYKDOM_FAR]:[];return v(a)},lr=e=>{const a=e[n.DOK_INNLEGGELSE_BARN]?e[n.DOK_INNLEGGELSE_BARN]:[];return v(a)},or=e=>{const a=e[n.DOK_UTDANNING_MOR]?e[n.DOK_UTDANNING_MOR]:[];return v(a)},dr=e=>{const a=e[n.DOK_ARBEID_MOR]?e[n.DOK_ARBEID_MOR]:[];return v(a)},Er=e=>{const a=e[n.DOK_UTDANNING_OG_ARBEID_MOR]?e[n.DOK_UTDANNING_OG_ARBEID_MOR]:[];return v(a)},pr=e=>{const a=e[n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]?e[n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:[];return v(a)},kr=e=>{const a=e[n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]?e[n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:[];return v(a)},gr=e=>e.innsendingsType==="SEND_SENERE",v=e=>e.filter(a=>!gr(a)),Sr=({mellomlagreSøknadOgNaviger:e,avbrytSøknad:a,søkerInfo:t,erEndringssøknad:m})=>{const s=T(),i=Un(t.arbeidsforhold,e,m),l=hn(t.arbeidsforhold,m),u=P(L(O.UTTAKSPLAN)),o=P(L(O.ANNEN_FORELDER)),k=P(L(O.OM_BARNET)),d=P(L(O.SØKERSITUASJON)),E=L(O.VEDLEGG)||{},M=L(O.UTTAKSPLAN_METADATA),A=L(O.ARBEIDSFORHOLD_OG_INNTEKT),K=L(O.ANDRE_INNTEKTSKILDER),c=jn(O.VEDLEGG),q=Bn(u,M?.perioderSomSkalSendesInn,m),G=wn(d.rolle),N=vn(q,G,o),Z=mr(E),W=ir(E),ee=sr(E),ne=ur(E),re=lr(E),ae=or(E),te=dr(E),me=Er(E),ie=pr(E),se=kr(E),ue=nr(E),le=rr(E),oe=er(E),de=ar(E),Ee=tr(E),F=N.filter(Yn),V=N.filter(An),B=N.filter(Cn),J=N.filter(Hn),x=N.filter(zn),Y=N.filter(Zn),pe=N.filter($n),z=N.filter(Xn),H=N.filter(Wn),C=N.filter(Qn),R=Fn(t.person,o,G,s),D=fn(k),I=Kn(k),be=p=>{const $={...E,[n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:H.length?p[n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:[],[n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:Y.length>0?p[n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:[],[n.DOK_INNLEGGELSE_MOR]:F.length>0?p[n.DOK_INNLEGGELSE_MOR]:[],[n.DOK_INNLEGGELSE_BARN]:V.length>0?p[n.DOK_INNLEGGELSE_BARN]:[],[n.DOK_INNLEGGELSE_FAR]:J.length>0?p[n.DOK_INNLEGGELSE_FAR]:[],[n.DOK_SYKDOM_MOR]:x.length>0?p[n.DOK_SYKDOM_MOR]:[],[n.DOK_SYKDOM_FAR]:B.length>0?p[n.DOK_SYKDOM_FAR]:[],[n.DOK_UTDANNING_MOR]:C.length>0?p[n.DOK_UTDANNING_MOR]:[],[n.DOK_UTDANNING_OG_ARBEID_MOR]:z.length>0?p[n.DOK_UTDANNING_OG_ARBEID_MOR]:[],[n.DOK_ARBEID_MOR]:pe.length>0?p[n.DOK_ARBEID_MOR]:[],[n.DOK_AV_ALENEOMSORG]:p[n.DOK_AV_ALENEOMSORG]||[],[n.TERMINBEKREFTELSE]:p[n.TERMINBEKREFTELSE]||[],[n.OMSORGSOVERTAKELSE]:p[n.OMSORGSOVERTAKELSE]||[],[n.DOK_MILITÆR_SILVIL_TJENESTE]:p[n.DOK_MILITÆR_SILVIL_TJENESTE]||[],[n.ETTERLØNN_ELLER_SLUTTVEDERLAG]:p[n.ETTERLØNN_ELLER_SLUTTVEDERLAG]||[]};return c($),i.goToNextDefaultStep()},Q=On({defaultValues:{[n.BEKREFTELSE_DELTAR_KVALIFISERINGSPROGRAM]:se,[n.DOK_DELTAKELSE_I_INTRODUKSJONSPROGRAMMET]:ie,[n.DOK_INNLEGGELSE_MOR]:Z,[n.DOK_INNLEGGELSE_BARN]:re,[n.DOK_INNLEGGELSE_FAR]:ee,[n.DOK_SYKDOM_FAR]:ne,[n.DOK_SYKDOM_MOR]:W,[n.DOK_UTDANNING_MOR]:ae,[n.DOK_UTDANNING_OG_ARBEID_MOR]:me,[n.DOK_ARBEID_MOR]:te,[n.DOK_AV_ALENEOMSORG]:ue,[n.TERMINBEKREFTELSE]:le,[n.OMSORGSOVERTAKELSE]:oe,[n.DOK_MILITÆR_SILVIL_TJENESTE]:de,[n.ETTERLØNN_ELLER_SLUTTVEDERLAG]:Ee}}),g=p=>$=>{Q.setValue(p,$,{shouldDirty:!0,shouldTouch:!0}),Q.clearErrors(p)},Ue=[F,V,B,J,x,Y,z,H,C].flat().length===0;return r.jsx(_n,{pageTitle:s.formatMessage({id:"søknad.pageheading"}),children:r.jsx(Nn,{steps:l,noFieldsRequired:!0,children:r.jsx(Rn,{formMethods:Q,onSubmit:be,children:r.jsxs(ve,{gap:"space-40",children:[r.jsx(je,{attachments:Z,familiehendelsesdato:D,navnPåForeldre:R,perioder:F,situasjon:d.situasjon,termindato:I,updateAttachments:g,erFarEllerMedmor:G}),r.jsx(Le,{attachments:W,familiehendelsesdato:D,navnPåForeldre:R,perioder:x,situasjon:d.situasjon,termindato:I,updateAttachments:g,erFarEllerMedmor:G}),r.jsx(De,{attachments:ee,familiehendelsesdato:D,navnPåForeldre:R,perioder:J,situasjon:d.situasjon,termindato:I,updateAttachments:g,erFarEllerMedmor:G}),r.jsx(Re,{attachments:ne,familiehendelsesdato:D,navnPåForeldre:R,perioder:B,situasjon:d.situasjon,termindato:I,updateAttachments:g,erFarEllerMedmor:G}),r.jsx(_e,{attachments:re,familiehendelsesdato:D,navnPåForeldre:R,perioder:V,situasjon:d.situasjon,termindato:I,updateAttachments:g}),r.jsx(Pe,{attachments:ae,familiehendelsesdato:D,navnPåForeldre:R,perioder:C,situasjon:d.situasjon,termindato:I,updateAttachments:g}),r.jsx(ce,{attachments:te,familiehendelsesdato:D,navnPåForeldre:R,perioder:pe,situasjon:d.situasjon,erFarEllerMedmor:G,termindato:I,updateAttachments:g}),r.jsx(Ge,{attachments:me,familiehendelsesdato:D,navnPåForeldre:R,perioder:z,situasjon:d.situasjon,termindato:I,updateAttachments:g}),r.jsx(fe,{attachments:ie,familiehendelsesdato:D,navnPåForeldre:R,perioder:Y,situasjon:d.situasjon,termindato:I,updateAttachments:g}),r.jsx(Me,{attachments:se,familiehendelsesdato:D,navnPåForeldre:R,perioder:H,situasjon:d.situasjon,termindato:I,updateAttachments:g}),r.jsx(Oe,{attachments:ue,updateAttachments:g,annenForelder:o}),r.jsx(Vn,{attachments:le,updateAttachments:g,barn:k,annenForelder:o,søkersituasjon:d,arbeidsforhold:t.arbeidsforhold,erFarEllerMedmor:G}),r.jsx(qe,{attachments:oe,updateAttachments:g,søkersituasjon:d}),r.jsx(Ne,{attachments:Ee,updateAttachments:g,arbeidsforholdOgInntekt:A,andreInntektskilder:K}),r.jsx(Ie,{attachments:de,updateAttachments:g,arbeidsforholdOgInntekt:A,andreInntektskilder:K}),!Ue&&r.jsxs(Dn,{size:"small",variant:"info",children:[r.jsx(In,{level:"2",size:"small",children:r.jsx(S,{id:"manglendeVedlegg.duKanSende.tittel"})}),r.jsx(U,{children:r.jsx(S,{id:"manglendeVedlegg.duKanSende.innhold"})})]}),r.jsx(Ln,{goToPreviousStep:i.goToPreviousDefaultStep,onAvsluttOgSlett:a,onFortsettSenere:i.fortsettSøknadSenere})]})})})})};Sr.__docgenInfo={description:"",methods:[],displayName:"ManglendeVedlegg",props:{søkerInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
