var xe=Object.defineProperty;var Le=(e,n,r)=>n in e?xe(e,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[n]=r;var j=(e,n,r)=>Le(e,typeof n!="symbol"?n+"":n,r);import{j as t}from"./tslib.es6-C_-gbNBy.js";import{S as we,M as Fe}from"./SkjemaSteg-mg1amINV.js";/* empty css              */import{r as u,a as je}from"./index-CTjT7uj6.js";import{a as Me,g as te}from"./apiInterceptor-D9XpNqGK.js";import{l as Re,ad as oe,j as De,e as ae,a2 as Pe,ae as _e,af as qe,u as Oe,ag as Ge,ah as Ce,ai as Ue,aj as Be,ak as Ve,al as Ke,i as He}from"./ByttBrowserModal-DBe_H0Dd.js";import{n as Ye,u as ie,a as le,o as ge,b as Je}from"./nn_NO-BH1gARNw.js";import"./index-9r8iugjR.js";import{h as $e,R as ze,i as R,n as b,A as _,d as h,j as Qe,k,N as We}from"./useSvpNavigator-B0jGCtvG.js";import"./dateFormValidation-DqgzgaF8.js";import{d as pe,e as Xe,C as f,c as Ze,a as v,S as en}from"./routes-BKH065He.js";import{N as nn}from"./EgenNæring-DdBVG6ty.js";import{g as rn}from"./dateUtils-YVQd4AT9.js";import{m as sn}from"./tilretteleggingUtils-CMBD_-ns.js";import{F as tn}from"./Forside-xx2l6_D5.js";import{A as on}from"./ArbeidIUtlandetStep-FyotlAm3.js";import{B as an}from"./Barnet-BIC05bWI.js";import{E as ln}from"./EgenNæringStep-A1TFod4L.js";import{F as gn}from"./FrilansStep-D_8xuiWK.js";import{I as pn}from"./InntektsinformasjonSteg-wWPgYIrQ.js";import{O as dn}from"./Oppsummering-BbRz3MN1.js";import{P as cn}from"./PerioderStep-BSA00UlV.js";import{T as un}from"./TilretteleggingStep-D4HaWHkw.js";import{U as mn}from"./UtenlandsoppholdSteg-DJQbHCTC.js";import{S as kn}from"./SenereUtenlandsoppholdSteg-D8IatC77.js";import{T as vn}from"./TidligereUtenlandsoppholdSteg-TkFuuI-v.js";import{V as fn}from"./VelgArbeid-VWgbDD36.js";import{I as En}from"./IkkeKvinne-DAoK8X3l.js";import"./ErrorSummaryHookForm-CW2jdrtX.js";import"./Checkbox-DHFPzFtv.js";import"./attachmentType-CO8SwnHI.js";import"./Bedriftsbanner-CzJnI14L.js";import"./index-BRV0Se7Z.js";import"./BoIUtlandetOppsummeringspunkt-B2PizbEV.js";import"./ConfirmationPanel-CjNb_eVg.js";import"./TidligereUtenlandsoppholdPanel-D2Jy6nFa.js";import"./ExpansionCard-Dwq8h52a.js";import"./Plus-COgd8pfS.js";import"./_baseIteratee-Dyzk-1k8.js";import"./_baseUniq-DYqiuyAy.js";import"./Frilans-B_RcwIAw.js";import"./validationUtils-UmtESEQC.js";import"./amplitudeLoggerUtils-DWSIHAqD.js";import"./velgArbeidFormUtils-XlIkFml9.js";import"./numberUtils-DCxWcr3S.js";const{Axios:Jr,AxiosError:$r,CanceledError:zr,isCancel:Qr,CancelToken:Wr,VERSION:Xr,all:Zr,Cancel:es,isAxiosError:yn,spread:ns,toFormData:rs,AxiosHeaders:ss,HttpStatusCode:ts,formToJSON:os,getAdapter:as,mergeConfig:is}=Me;class E extends Error{constructor(r,s,a){super(r);j(this,"callId");j(this,"timestamp");this.callId=s,this.timestamp=a}}class L extends Error{constructor(){super("API_ACCESS_ERROR")}}const Sn=e=>e instanceof L||e instanceof E,de=e=>!!(e&&typeof e=="object"&&"isAxiosError"in e),q=(e,n)=>{const[r,s]=u.useState(),[a,o]=u.useState(!1),[i,l]=u.useState();return u.useEffect(()=>{let d=!1;return(async()=>{var p,m;try{o(!0);const c=await e.get(n,{withCredentials:!0,timeout:60*1e3});d||s(c.data)}catch(c){yn(c)?((p=c.response)==null?void 0:p.status)===401||((m=c.response)==null?void 0:m.status)===403?l(new L):l(new E(c.message)):c instanceof Error?l(new E(c.message)):l(new E(String(c)))}finally{o(!1)}})(),()=>{d=!0}},[e,n]),{data:r,loading:a,error:i}},O="ukjent uuid",ce=async(e,n,r,s,a=!1,o)=>{var i,l,d,g,p,m;try{return(await e.post(n,r,{withCredentials:!0,timeout:6e4,signal:o,headers:a?{"content-type":"application/json;"}:{}})).data}catch(c){if(de(c)&&c.code!=="ERR_CANCELED"){if(((i=c.response)==null?void 0:i.status)===401||((l=c.response)==null?void 0:l.status)===403)throw new L;const x=(g=(d=c.response)==null?void 0:d.data)!=null&&g.uuid?c.response.data.uuid:O,he=x!==O?x.slice(0,8):x;throw new E(s+he,x,(m=(p=c.response)==null?void 0:p.data)==null?void 0:m.timestamp)}throw c instanceof Error?new E(c.message):new E(String(c))}},G="ukjent uuid",w=async(e,n,r,s,a)=>{var o,i,l,d;try{return(await e.delete(n,{withCredentials:!0,timeout:6e4,signal:a,data:s})).data}catch(g){if(de(g)&&g.code!=="ERR_CANCELED"){if(((o=g.response)==null?void 0:o.status)===401||((i=g.response)==null?void 0:i.status)===403)throw new L;const p=(d=(l=g.response)==null?void 0:l.data)!=null&&d.uuid?g.response.data.uuid:G,m=p!==G?p.slice(0,8):p;throw new E(r+m)}throw g instanceof Error?new E(g.message):new E(String(g))}},bn="From {fom} until {tom}",In={tidsperiode:bn,"tidsperiode.kort":"{fom} - {tom}"},Nn="Fra {fom} til {tom}",An={tidsperiode:Nn,"tidsperiode.kort":"{fom} - {tom}"},Tn="Frå {fom} til {tom}",hn={tidsperiode:Tn,"tidsperiode.kort":"{fom} - {tom}"},xn=e=>{window.location.href=e};var ue=(e=>(e.BARN="BARN",e.OPPTJENING="OPPTJENING",e.TILRETTELEGGING="TILRETTELEGGING",e.UTTAK="UTTAK",e))(ue||{});const me="selectedLocale",Ln=()=>sessionStorage.getItem(me)||"nb",wn=e=>{sessionStorage.setItem(me,e)},ke={nb:An,nn:hn,en:In};/**
