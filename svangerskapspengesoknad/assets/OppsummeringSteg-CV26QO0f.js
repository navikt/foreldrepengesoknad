import{j as e,aV as r,M as t,V as C,a9 as J,B as $,p as I,aW as E,aG as h,aX as z,aY as v,aZ as W,o as j,Z,d as X,a_ as Y,a$ as Q,b0 as ee,b1 as re,b2 as ne}from"./iframe-DBfPZh8u.js";import{e as d,C as u,S as c,f as A}from"./routes-CDfMNdM-.js";import{l as ie,F as x,a as se,m as R,b as q,e as te,f as ae,i as le,n as oe}from"./useSvpNavigator-DsWT3J2H.js";import{A as de}from"./queries-CzYUnvm3.js";import{L as b}from"./List-qYzip4Qw.js";import{g as P,a as ue}from"./dateUtils-BhLzG5PY.js";function F({tilretteleggingerVedlegg:n,onVilEndreSvar:s,alleArbeidsforhold:l}){return e.jsxs(r,{children:[e.jsx(r.Header,{children:e.jsx(r.Heading,{level:"2",children:e.jsx(t,{id:"oppsummering.dokumentasjon.tittel"})})}),e.jsx(r.Answers,{children:Object.keys(n).map(i=>e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(me,{tilretteleggingId:i,alleArbeidsforhold:l})}),e.jsx(r.Value,{children:e.jsx(C,{children:n[i].map(o=>o.uuid?e.jsx(J,{download:o.filename,href:`${de.hentVedlegg(o.uuid)}`,target:"_blank",children:o.filename},o.id):e.jsx($,{children:o.filename},o.id))})})]},i))}),e.jsx(r.Footer,{children:e.jsx(r.EditLink,{onClick:s,children:e.jsx(t,{id:"oppsummering.EndreSvar"})})})]})}function me({tilretteleggingId:n,alleArbeidsforhold:s}){const l=I();switch(n){case x:return e.jsx(t,{id:"oppsummering.dokumentasjon.frilanser"});case h:return e.jsx(t,{id:"oppsummering.dokumentasjon.selvstendig"});default:{const i=ie(l,n,s);return e.jsx(t,{id:"oppsummering.dokumentasjon.virksomhet",values:{arbeidsforholdNavn:E(i)}})}}}F.__docgenInfo={description:"",methods:[],displayName:"DokumentasjonOppsummering",props:{tilretteleggingerVedlegg:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    tom?: string;
}`,signature:{properties:[{key:"arbeidsgiverId",value:{name:"string",required:!0}},{key:"arbeidsgiverIdType",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!0}},{key:"fom",value:{name:"string",required:!0}},{key:"stillingsprosent",value:{name:"number",required:!0}},{key:"tom",value:{name:"string",required:!1}}]}}],raw:"EksternArbeidsforholdDto_fpoversikt[]"},description:""}}};function D({onVilEndreSvar:n,alleArbeidsforhold:s}){const l=d(u.FERIE);if(!l)return null;const i=Object.values(l).flatMap(a=>a.feriePerioder),o=[...new Set(i.map(a=>S(a.arbeidsforhold)))];return e.jsxs(r,{children:[e.jsx(r.Header,{children:e.jsx(r.Heading,{level:"2",children:e.jsx(t,{id:"ferie.heading"})})}),e.jsx(r.Answers,{children:o.length>1?e.jsx(ge,{avtaltFerie:i,alleArbeidsforhold:s}):e.jsx(G,{avtaltFerie:i})}),e.jsx(r.Footer,{children:e.jsx(r.EditLink,{onClick:n,children:e.jsx(t,{id:"oppsummering.EndreSvar"})})})]})}const G=({avtaltFerie:n})=>e.jsxs(e.Fragment,{children:[e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"ferie.harDuPlanlagtFerie.label"})}),e.jsx(z,{ja:n.length>0})]}),n.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"ferie.antallPerioder.label"})}),e.jsx(r.Value,{children:n.length})]}),e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"oppsummering.ferie.perioder"})}),e.jsx(r.Value,{children:e.jsx(b,{children:n.map(s=>e.jsxs(b.Item,{children:[v(s.fom)," - ",v(s.tom)]},`${s.fom}-${s.tom}`))})})]})]})]}),ge=({avtaltFerie:n,alleArbeidsforhold:s})=>[...new Set(n.map(i=>S(i.arbeidsforhold)))].map(i=>{const o=n.filter(a=>S(a.arbeidsforhold)===i);return e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:E(s.find(a=>a.arbeidsgiverId===i)?.arbeidsgiverNavn)}),e.jsx(r.Value,{children:e.jsx(r.Answers,{children:e.jsx(G,{avtaltFerie:o})})})]},i)}),S=n=>{switch(n.type){case"frilanser":return"frilanser";case"selvstendig":return"selvstendig";case"privat":return n.id;case"virksomhet":return n.id}};D.__docgenInfo={description:"",methods:[],displayName:"FerieOppsummering",props:{onVilEndreSvar:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},alleArbeidsforhold:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    arbeidsgiverId: string;
    arbeidsgiverIdType: string;
    arbeidsgiverNavn: string;
    fom: string;
    stillingsprosent: number;
    tom?: string;
}`,signature:{properties:[{key:"arbeidsgiverId",value:{name:"string",required:!0}},{key:"arbeidsgiverIdType",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!0}},{key:"fom",value:{name:"string",required:!0}},{key:"stillingsprosent",value:{name:"number",required:!0}},{key:"tom",value:{name:"string",required:!1}}]}}],raw:"EksternArbeidsforholdDto_fpoversikt[]"},description:""}}};const O=({onVilEndreSvar:n})=>{const s=d(u.ARBEID_I_UTLANDET),l=I();return s?e.jsxs(r,{children:[e.jsx(r.Header,{children:e.jsx(r.Heading,{level:"2",children:e.jsx(t,{id:"steps.label.arbeidIUtlandet"})})}),e.jsx(r.Answers,{children:e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"oppsummering.arbeidIUtlandet.tittel",values:{antall:s.arbeidIUtlandet.length}})}),e.jsx(r.Value,{children:e.jsx(r.Answers,{children:s.arbeidIUtlandet.map(i=>e.jsxs(r.Answer,{children:[e.jsxs(r.Label,{children:[i.arbeidsgiverNavn," i ",W(i.land,l.locale)]}),e.jsx(r.Value,{children:e.jsx(t,{id:"JobbetIUtlandetOppsummering.arbeidsforhold.periode",values:{fom:v(i.fom),tom:i.tom?v(i.tom):l.formatMessage({id:"pågående"})}})})]},`${i.arbeidsgiverNavn}-${i.land}`))})})]})}),e.jsx(r.Footer,{children:e.jsx(r.EditLink,{onClick:n,children:e.jsx(t,{id:"oppsummering.EndreSvar"})})})]}):null};O.__docgenInfo={description:"",methods:[],displayName:"JobbetIUtlandetOppsummering",props:{onVilEndreSvar:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};function V({onVilEndreSvar:n,alleArbeidsforhold:s}){const l=j(d(u.OM_BARNET)),i=P(l);return e.jsxs(r,{children:[e.jsx(r.Header,{children:e.jsx(r.Heading,{level:"2",children:e.jsx(t,{id:"oppsummering.periode.tittel"})})}),e.jsxs(r.Answers,{children:[e.jsx(pe,{alleArbeidsforhold:s,sisteDagForSvangerskapspenger:i,termindato:l.termindato}),e.jsx(ve,{sisteDagForSvangerskapspenger:i}),e.jsx(ce,{sisteDagForSvangerskapspenger:i})]}),e.jsx(r.Footer,{children:e.jsx(r.EditLink,{onClick:n,children:e.jsx(t,{id:"oppsummering.EndreSvar"})})})]})}function pe({alleArbeidsforhold:n,sisteDagForSvangerskapspenger:s,termindato:l}){const i=j(d(u.TILRETTELEGGINGER)),o=d(u.TILRETTELEGGINGER_PERIODER),a=Object.keys(i).filter(m=>m!==x&&m!==h);return a?a.map(m=>{const g=i[m],p=o?.[m],f=n.find(T=>T.arbeidsgiverId===m),y=se(l,m,n),k=p?R(p,s,y):q(g,s,y);return e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:E(f?.arbeidsgiverNavn)}),e.jsx(r.Value,{children:e.jsx(r.Answers,{children:k.length===1?e.jsx(L,{periode:k[0]}):e.jsx(w,{perioder:k})})})]},m)}):null}function ve({sisteDagForSvangerskapspenger:n}){const s=j(d(u.TILRETTELEGGINGER)),l=d(u.TILRETTELEGGINGER_PERIODER),i=d(u.FRILANS);if(!Object.keys(s).includes(x)||!i)return null;const a=s[x],m=l?.[x],g=[{fom:i.oppstart,stillingsprosent:100}],p=m?R(m,n,g):q(a,n,g);return e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"steps.label.frilans"})}),e.jsx(r.Value,{children:e.jsxs(r.Answers,{children:[e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"skjema.risikofaktorer.frilanser"})}),e.jsx(r.Value,{children:a.risikofaktorer})]}),e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"tilrettelegging.tilretteleggingstiltak.label"})}),e.jsx(r.Value,{children:a.tilretteleggingstiltak})]}),e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"tilrettelegging.tilrettelagtArbeidFom.label.frilanser"})}),e.jsx(r.Value,{children:v(a.behovForTilretteleggingFom)})]}),p.length===1?e.jsx(L,{periode:p[0]}):e.jsx(w,{perioder:p})]})})]})}function ce({sisteDagForSvangerskapspenger:n}){const s=I(),l=j(d(u.TILRETTELEGGINGER)),i=d(u.TILRETTELEGGINGER_PERIODER),o=d(u.EGEN_NÆRING);if(!Object.keys(l).includes(h)||!o)return null;const m=l[h],g=i?.[h],p=[{fom:o.fom,tom:o.tom,stillingsprosent:100}],f=g?R(g,n,p):q(m,n,p);return e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"steps.label.næring"})}),e.jsx(r.Value,{children:e.jsxs(r.Answers,{children:[e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"skjema.risikofaktorer.selvstendig"})}),e.jsx(r.Value,{children:m.risikofaktorer})]}),e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"tilrettelegging.tilretteleggingstiltak.label"})}),e.jsx(r.Value,{children:m.tilretteleggingstiltak})]}),e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"tilrettelegging.tilrettelagtArbeidFom.label.flere",values:{navnArbeidsgiver:E(o.navnPåNæringen??s.formatMessage({id:"egenNæring"}).toLowerCase())}})}),e.jsx(r.Value,{children:v(m.behovForTilretteleggingFom)})]}),f.length===1?e.jsx(L,{periode:f[0]}):e.jsx(w,{perioder:f})]})})]})}function L({periode:n}){return e.jsxs(e.Fragment,{children:[e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"tilrettelegging.tilrettelagtArbeidType.label.en"})}),e.jsx(r.Value,{children:e.jsx(M,{stillingsprosent:n.type==="delvis"?n.stillingsprosent:void 0,tilretteleggingstype:n.type})})]}),e.jsxs(r.Answer,{children:[e.jsxs(r.Label,{children:[n.type==="ingen"&&e.jsx(t,{id:"tilrettelegging.sammePeriodeFremTilTerminFom.label.ingen"}),n.type==="delvis"&&e.jsx(t,{id:"tilrettelegging.sammePeriodeFremTilTerminFom.label.delvis"})]}),e.jsx(r.Value,{children:e.jsx(U,{periode:n})})]})]})}function w({perioder:n}){return e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"oppsummering.periode.tittel"})}),e.jsx(r.Value,{children:e.jsx(b,{children:n.map(s=>e.jsxs(b.Item,{children:[e.jsx(U,{periode:s}),":"," ",e.jsx(M,{stillingsprosent:s.type==="delvis"?s.stillingsprosent:void 0,tilretteleggingstype:s.type})]},s.fom))})})]})}function U({periode:n}){const s=j(d(u.OM_BARNET)),l=P(s),i=ue(s);if(Z(n.tom).isSame(l,"d")){if(i)return e.jsx(t,{id:"oppsummering.periode.fremTilTreUkerFørTermin",values:{fraDato:v(n.fom)}})}else return e.jsx(t,{id:"oppsummering.periode.fraTil",values:{fraDato:v(n.fom),tilDato:v(n.tom)}});return e.jsx(t,{id:"oppsummering.periode.fremTilFødsel",values:{fraDato:v(n.fom)}})}function M({tilretteleggingstype:n,stillingsprosent:s}){if(n==="hel")return e.jsx(t,{id:"oppsummering.periode.tilbakeIFullJobb"});if(n==="ingen")return e.jsx(t,{id:"oppsummering.periode.ikkeJobbe"});if(n==="delvis"&&s===void 0)throw new Error("Stillingsprosent ikke satt for delvis tilrettelegging");return e.jsx(t,{id:"oppsummering.periode.stillingsprosent",values:{stillingsprosent:s}})}V.__docgenInfo={description:"",methods:[],displayName:"PerioderOppsummering",props:{onVilEndreSvar:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},alleArbeidsforhold:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    arbeidsgiverId: string;
    arbeidsgiverIdType: string;
    arbeidsgiverNavn: string;
    fom: string;
    stillingsprosent: number;
    tom?: string;
}`,signature:{properties:[{key:"arbeidsgiverId",value:{name:"string",required:!0}},{key:"arbeidsgiverIdType",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!0}},{key:"fom",value:{name:"string",required:!0}},{key:"stillingsprosent",value:{name:"number",required:!0}},{key:"tom",value:{name:"string",required:!1}}]}}],raw:"EksternArbeidsforholdDto_fpoversikt[]"},description:""}}};const je=({sendSøknad:n,mellomlagreSøknadOgNaviger:s,avbrytSøknad:l,søkerInfo:i})=>{const o=te(i.arbeidsforhold),a=ae(s,i.arbeidsforhold),m=j(d(u.TILRETTELEGGINGER_VEDLEGG)),g=j(d(u.OM_BARNET)),p=j(d(u.ARBEIDSFORHOLD_OG_INNTEKT)),f=d(u.UTENLANDSOPPHOLD_SENERE),y=d(u.UTENLANDSOPPHOLD_TIDLIGERE),k=d(u.VALGTE_ARBEIDSFORHOLD),T=d(u.EGEN_NÆRING),K=d(u.FRILANS),_=le(i.arbeidsforhold,g.termindato),B=_.some(H=>k?.includes(H.arbeidsgiverId)),N=oe(i.arbeidsforhold,g.termindato,p,k);return e.jsx(X,{pageTitle:e.jsx(t,{id:"søknad.pageheading"}),children:e.jsxs(Y,{appName:"Svangerskapspenger",stepConfig:o,sendSøknad:n,onAvsluttOgSlett:l,goToPreviousStep:a.goToPreviousDefaultStep,onFortsettSenere:a.fortsettSøknadSenere,onStepChange:a.goToStep,children:[e.jsxs(r,{children:[e.jsx(r.Header,{children:e.jsx(r.Heading,{level:"2",children:e.jsx(t,{id:"oppsummering.omBarnet"})})}),e.jsxs(r.Answers,{children:[e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"barnet.termindato"})}),e.jsx(r.Value,{children:v(g.termindato)})]}),g.erBarnetFødt&&g.fødselsdato&&e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(t,{id:"barnet.fødselsdato"})}),e.jsx(r.Value,{children:v(g.fødselsdato)})]})]}),e.jsx(r.Footer,{children:e.jsx(r.EditLink,{onClick:()=>a.goToStep(c.BARNET),children:e.jsx(t,{id:"oppsummering.EndreSvar"})})})]}),e.jsx(Q,{onVilEndreSvar:()=>a.goToStep(c.UTENLANDSOPPHOLD),tidligereUtenlandsopphold:y??[],senereUtenlandsopphold:f??[]}),e.jsx(ee,{skalViseAlertOmIM:B,arbeidsforholdOgInntekt:p,arbeidsforhold:_,onVilEndreSvar:()=>a.goToStep(c.ARBEIDSFORHOLD_OG_INNTEKT)}),e.jsx(re,{frilans:K,onVilEndreSvar:()=>a.goToStep(c.FRILANS)}),e.jsx(ne,{egenNæring:T,onVilEndreSvar:()=>a.goToStep(c.NÆRING)}),e.jsx(O,{onVilEndreSvar:()=>a.goToStep(c.ARBEID_I_UTLANDET)}),e.jsx(F,{tilretteleggingerVedlegg:m,alleArbeidsforhold:i.arbeidsforhold,onVilEndreSvar:()=>a.goToStep(A(c.SKJEMA,N))}),e.jsx(V,{alleArbeidsforhold:i.arbeidsforhold,onVilEndreSvar:()=>a.goToStep(A(c.TILRETTELEGGING,N))}),e.jsx(D,{alleArbeidsforhold:i.arbeidsforhold,onVilEndreSvar:()=>a.goToStep(A(c.FERIE,N))})]})})};je.__docgenInfo={description:"",methods:[],displayName:"OppsummeringSteg",props:{sendSøknad:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},mellomlagreSøknadOgNaviger:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},avbrytSøknad:{required:!0,tsType:{name:"signature",type:"function",raw:"() => Promise<void>",signature:{arguments:[],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},søkerInfo:{required:!0,tsType:{name:"signature",type:"object",raw:`{
