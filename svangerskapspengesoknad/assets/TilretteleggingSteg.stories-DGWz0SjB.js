import{aP as U,aB as j,j as r,G as m,aQ as c}from"./iframe-CkPQQ1Ry.js";import{f as P,c as Z,S as I,T as J,C as s}from"./routes-Z7fEIWQS.js";import{F as k,M as $,R as Q,c as Y}from"./useSvpNavigator-DgNbvDav.js";import{T as p}from"./TilretteleggingSteg-E93GkyLj.js";import"./dateUtils-CwsuARIi.js";import"./Bedriftsbanner-r-FR21XM.js";import"./numberUtils-DCxWcr3S.js";import"./validationUtils-BY2MorN5.js";const{action:B}=__STORYBOOK_MODULE_ACTIONS__,E=()=>(...d)=>(B("button-click")(...d),Promise.resolve()),o="990322244",V="975326209",q=[{arbeidsgiverId:V,arbeidsgiverIdType:"orgnr",arbeidsgiverNavn:"Sykehuset i Vestfold",fom:"2018-04-09T00:00:00.000Z",stillingsprosent:0,tom:"2018-09-09T00:00:00.000Z"},{arbeidsgiverId:o,arbeidsgiverIdType:"orgnr",arbeidsgiverNavn:"Omsorgspartner Vestfold AS",fom:"2017-04-05T00:00:00.000Z",stillingsprosent:100}],te={title:"steps/TilretteleggingSteg",component:p,render:({gåTilNesteSide:d=B("button-click"),frilans:l,egenNæring:T,valgteArbeidsforhold:H,valgtTilretteleggingId:C,...K})=>r.jsx($,{initialEntries:[P(I.TILRETTELEGGING,C)],children:r.jsx(Z,{onDispatch:d,initialState:{[s.FRILANS]:l,[s.EGEN_NÆRING]:T,[s.VALGTE_ARBEIDSFORHOLD]:H,[s.ARBEIDSFORHOLD_OG_INNTEKT]:{harHattArbeidIUtlandet:!1,harJobbetSomFrilans:!!l,harJobbetSomSelvstendigNæringsdrivende:!!T},[s.OM_BARNET]:{erBarnetFødt:!1,termindato:m().add(45,"days").format(c),fødselsdato:m().add(45,"days").format(c)}},children:r.jsx(Q,{children:r.jsx(Y,{element:r.jsx(p,{...K}),path:`/${I.TILRETTELEGGING}/${J}`})})})})},e={args:{mellomlagreSøknadOgNaviger:E(),avbrytSøknad:E(),arbeidsforhold:q,valgtTilretteleggingId:o}},n={args:{...e.args,valgteArbeidsforhold:[o,V]}},a={args:{...e.args,arbeidsforhold:[],valgtTilretteleggingId:k,frilans:{jobberFremdelesSomFrilans:!0,oppstart:"2024-01-01"}}},i={args:{...a.args,valgteArbeidsforhold:[k,o]}},t={args:{...e.args,arbeidsforhold:[],valgtTilretteleggingId:j,egenNæring:{fom:"2024-01-01",tom:"2024-10-01",pågående:!1,registrertINorge:!0,næringstype:U.FISKER}}},g={args:{...t.args,valgteArbeidsforhold:[j,o]}};var N,G,_;e.parameters={...e.parameters,docs:{...(N=e.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
