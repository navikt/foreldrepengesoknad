import{j as e,a_ as r,M as s,V as C,ae as J,B as $,t as S,a$ as x,aL as T,b0 as z,b1 as v,b2 as Y,q as j,a1 as W,d as Q,b3 as X,b4 as Z,b5 as ee,b6 as re,b7 as ne}from"./iframe-CHAdjWow.js";import{e as d,C as u,S as c,f as N}from"./routes-D7s0K2fF.js";import{l as ie,F as h,a as te,m as R,b as I,e as se,f as ae,i as le,n as oe}from"./useSvpNavigator-DcsIIyju.js";import{A as de}from"./queries-H8WbdCKI.js";import{L as b}from"./List-xYeFhu_R.js";import{g as w,a as ue}from"./dateUtils-SjHmbm2R.js";function O({tilretteleggingerVedlegg:n,onVilEndreSvar:t,alleArbeidsforhold:l}){return e.jsxs(r,{children:[e.jsx(r.Header,{children:e.jsx(r.Heading,{level:"2",children:e.jsx(s,{id:"oppsummering.dokumentasjon.tittel"})})}),e.jsx(r.Answers,{children:Object.keys(n).map(i=>e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(me,{tilretteleggingId:i,alleArbeidsforhold:l})}),e.jsx(r.Value,{children:e.jsx(C,{children:n[i]?.map(o=>o.uuid?e.jsx(J,{download:o.filename,href:`${de.hentVedlegg(o.uuid)}`,target:"_blank",children:o.filename},o.id):e.jsx($,{children:o.filename},o.id))})})]},i))}),e.jsx(r.Footer,{children:e.jsx(r.EditLink,{onClick:t,children:e.jsx(s,{id:"oppsummering.EndreSvar"})})})]})}function me({tilretteleggingId:n,alleArbeidsforhold:t}){const l=S();switch(n){case h:return e.jsx(s,{id:"oppsummering.dokumentasjon.frilanser"});case T:return e.jsx(s,{id:"oppsummering.dokumentasjon.selvstendig"});default:{const i=ie(l,n,t);return e.jsx(s,{id:"oppsummering.dokumentasjon.virksomhet",values:{arbeidsforholdNavn:x(i)}})}}}O.__docgenInfo={description:"",methods:[],displayName:"DokumentasjonOppsummering",props:{tilretteleggingerVedlegg:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
| 'KRYPTERING_MELLOMLAGRING'`,elements:[{name:"literal",value:"'IKKE_TILGANG'"},{name:"literal",value:"'DUPLIKAT_FORSENDELSE'"},{name:"literal",value:"'MELLOMLAGRING'"},{name:"literal",value:"'MELLOMLAGRING_VEDLEGG'"},{name:"literal",value:"'MELLOMLAGRING_VEDLEGG_VIRUSSCAN_TIMEOUT'"},{name:"literal",value:"'MELLOMLAGRING_VEDLEGG_PASSORD_BESKYTTET'"},{name:"literal",value:"'KRYPTERING_MELLOMLAGRING'"}]},{name:"literal",value:"'NO_DATA'"}],required:!1}},{key:"beskrivelse",value:{name:"string",required:!1}}]}}],raw:"Attachment[]"}],raw:"Record<string, Attachment[]>"},description:""},onVilEndreSvar:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},alleArbeidsforhold:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    tom?: string;
}`,signature:{properties:[{key:"arbeidsgiverId",value:{name:"string",required:!0}},{key:"arbeidsgiverIdType",value:{name:"string",required:!0}},{key:"arbeidsgiverNavn",value:{name:"string",required:!0}},{key:"fom",value:{name:"string",required:!0}},{key:"stillingsprosent",value:{name:"number",required:!0}},{key:"tom",value:{name:"string",required:!1}}]}}],raw:"EksternArbeidsforholdDto_fpoversikt[]"},description:""}}};function D({onVilEndreSvar:n,alleArbeidsforhold:t}){const l=d(u.FERIE);if(!l)return null;const i=Object.values(l).flatMap(a=>a.feriePerioder),o=[...new Set(i.map(a=>L(a.arbeidsforhold)))];return e.jsxs(r,{children:[e.jsx(r.Header,{children:e.jsx(r.Heading,{level:"2",children:e.jsx(s,{id:"ferie.heading"})})}),e.jsx(r.Answers,{children:o.length>1?e.jsx(ge,{avtaltFerie:i,alleArbeidsforhold:t}):e.jsx(P,{avtaltFerie:i})}),e.jsx(r.Footer,{children:e.jsx(r.EditLink,{onClick:n,children:e.jsx(s,{id:"oppsummering.EndreSvar"})})})]})}const P=({avtaltFerie:n})=>e.jsxs(e.Fragment,{children:[e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(s,{id:"ferie.harDuPlanlagtFerie.label"})}),e.jsx(z,{ja:n.length>0})]}),n.length>0&&e.jsxs(e.Fragment,{children:[e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(s,{id:"ferie.antallPerioder.label"})}),e.jsx(r.Value,{children:n.length})]}),e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:e.jsx(s,{id:"oppsummering.ferie.perioder"})}),e.jsx(r.Value,{children:e.jsx(b,{children:n.map(t=>e.jsxs(b.Item,{children:[v(t.fom)," - ",v(t.tom)]},`${t.fom}-${t.tom}`))})})]})]})]}),ge=({avtaltFerie:n,alleArbeidsforhold:t})=>[...new Set(n.map(i=>L(i.arbeidsforhold)))].map(i=>{const o=n.filter(a=>L(a.arbeidsforhold)===i);return e.jsxs(r.Answer,{children:[e.jsx(r.Label,{children:x(t.find(a=>a.arbeidsgiverId===i)?.arbeidsgiverNavn)}),e.jsx(r.Value,{children:e.jsx(r.Answers,{children:e.jsx(P,{avtaltFerie:o})})})]},i)}),L=n=>{switch(n.type){case"frilanser":return"frilanser";case"selvstendig":return"selvstendig";case"privat":return n.id;case"virksomhet":return n.id}};D.__docgenInfo={description:"",methods:[],displayName:"FerieOppsummering",props:{onVilEndreSvar:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},alleArbeidsforhold:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    arbeidsgiverId: string;
    arbeidsgiverIdType: string;
    arbeidsgiverNavn: string;
    fom: string;
