import{aJ as E,j as n}from"./iframe-CfO1MyEG.js";import{f as v,c as F,S,T as D,C as s}from"./routes-CnCNwRgO.js";import{A as c}from"./queries-BUbKCMXR.js";import{h as A,H as R}from"./index-B1OBH5C7.js";import{S as m,A as I}from"./attachmentType-DJ1vFT-G.js";import{F as T,M as V,R as y,c as M}from"./useSvpNavigator-BMsp7uvD.js";import{S as u}from"./SkjemaSteg-Bhw5tjiA.js";import"./preload-helper-D9Z9MdNV.js";import"./Bedriftsbanner-iWe_ANuC.js";const{action:G}=__STORYBOOK_MODULE_ACTIONS__,a=new File(["abc".repeat(1e5)],"Filnavn1.jpg"),p=new File(["abc".repeat(5e5)],"Filnavn2.jpg"),r="990322244",_="975326209",J=[{arbeidsgiverId:_,arbeidsgiverIdType:"orgnr",arbeidsgiverNavn:"Sykehuset i Vestfold",fom:"2014-05-22T00:00:00.000Z",stillingsprosent:32.63,tom:"2019-05-31T00:00:00.000Z"},{arbeidsgiverId:r,arbeidsgiverIdType:"orgnr",arbeidsgiverNavn:"Omsorgspartner Vestfold AS",fom:"2017-04-05T00:00:00.000Z",stillingsprosent:100}],f=()=>()=>(G("button-click")(),Promise.resolve()),C={title:"steps/SkjemaSteg",component:u,render:({gåTilNesteSide:k=G("button-click"),vedlegg:O,valgteArbeidsforhold:b,valgtTilretteleggingId:N,arbeidsforholdOgInntekt:L,...h})=>n.jsx(V,{initialEntries:[v(S.SKJEMA,N)],children:n.jsx(F,{onDispatch:k,initialState:{[s.ARBEIDSFORHOLD_OG_INNTEKT]:L,[s.TILRETTELEGGINGER_VEDLEGG]:O,[s.VALGTE_ARBEIDSFORHOLD]:b,[s.OM_BARNET]:{erBarnetFødt:!1,termindato:"2024-02-18",fødselsdato:"2024-02-18"}},children:n.jsx(y,{children:n.jsx(M,{element:n.jsx(u,{...h}),path:`/${S.SKJEMA}/${D}`})})})})},e={parameters:{msw:{handlers:[A.post(c.sendVedlegg,()=>new R(JSON.stringify("uuid-test"),{status:200}))]}},args:{mellomlagreSøknadOgNaviger:f(),avbrytSøknad:f(),arbeidsforhold:J,maxAntallVedlegg:40,valgtTilretteleggingId:r,arbeidsforholdOgInntekt:{harHattArbeidIUtlandet:!1,harJobbetSomFrilans:!1,harJobbetSomSelvstendigNæringsdrivende:!1}}},t={parameters:{msw:{handlers:[A.post(c.sendVedlegg,()=>new R(null,{status:400}))]}},args:e.args},i={parameters:e.parameters,args:{...e.args,vedlegg:{[r]:[{id:"V134300149934973076055420920289127108",filename:a.name,filesize:a.size,file:a,innsendingsType:"LASTET_OPP",uploaded:!0,pending:!1,type:I.TILRETTELEGGING,skjemanummer:m.SKJEMA_FOR_TILRETTELEGGING_OG_OMPLASSERING,uuid:"Created"}]}}},l={parameters:e.parameters,args:{...e.args,valgteArbeidsforhold:[r,_]}},d={parameters:e.parameters,args:{...e.args,valgtTilretteleggingId:T,valgteArbeidsforhold:[T],arbeidsforholdOgInntekt:{harHattArbeidIUtlandet:!1,harJobbetSomFrilans:!0,harJobbetSomSelvstendigNæringsdrivende:!1}}},o={parameters:e.parameters,args:{...e.args,valgtTilretteleggingId:E,valgteArbeidsforhold:[E],arbeidsforholdOgInntekt:{harHattArbeidIUtlandet:!1,harJobbetSomFrilans:!1,harJobbetSomSelvstendigNæringsdrivende:!0}}},g={parameters:e.parameters,args:{...e.args,valgtTilretteleggingId:r,vedlegg:{[r]:[{id:"V134300149934973076055420920289127108",filename:a.name,filesize:a.size,file:a,uploaded:!0,pending:!1,type:I.TILRETTELEGGING,skjemanummer:m.SKJEMA_FOR_TILRETTELEGGING_OG_OMPLASSERING,uuid:"Created",innsendingsType:"LASTET_OPP"},{id:"V134300149934973076055420920289127101",filename:p.name,filesize:p.size,file:p,uploaded:!0,pending:!1,type:I.TILRETTELEGGING,skjemanummer:m.SKJEMA_FOR_TILRETTELEGGING_OG_OMPLASSERING,uuid:"Created",innsendingsType:"LASTET_OPP"}]},maxAntallVedlegg:2}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
