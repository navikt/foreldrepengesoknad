var Me=Object.defineProperty;var Re=(e,n,r)=>n in e?Me(e,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[n]=r;var R=(e,n,r)=>Re(e,typeof n!="symbol"?n+"":n,r);import{l as Fe,ab as te,m as je,f as oe,a1 as De,j as t,ac as Pe,ad as _e,u as qe,ae as Oe,af as Ge,ag as Ce,ah as Ue,ai as Be,aj as Ve,i as Ke}from"./ByttBrowserModal-B2UtRc96.js";import{S as He,M as Ye}from"./SkjemaSteg-5mpVsQSb.js";/* empty css              */import{r as u,a as Je}from"./index-CTjT7uj6.js";import{a as $e,g as ae}from"./apiInterceptor-DfqAa4et.js";import{n as ze,u as ie,a as le,o as ge,f as pe,e as de,b as ce,c as Qe}from"./nn_NO-D3bhp-80.js";import"./index-CYM-y3Gt.js";import{f as We,R as Xe,h as j,A as _,e as h,i as Ze,j as k,N as en}from"./useSvpNavigator-gsyib8dJ.js";import{n as S}from"./minMax-Bfiyzyfk.js";import{d as ue,e as nn,C as f,c as rn,a as v,S as sn}from"./routes-BG9bWy_0.js";import{N as tn}from"./EgenNæringPanel-9s_PEC76.js";import{g as on}from"./dateUtils-VWlGrNdu.js";import{m as an}from"./tilretteleggingUtils-DPqlZlt5.js";import{F as ln}from"./Forside-DmHHhsP8.js";import{A as gn}from"./ArbeidIUtlandetStep-CabiBmAb.js";import{A as pn}from"./ArbeidsforholdOgInntektSteg-DbJ2Q8P1.js";import{B as dn}from"./Barnet-C22RKK2y.js";import{E as cn}from"./EgenNæringStep--wnzp-RU.js";import{F as un}from"./FrilansStep-CGki96d9.js";import{O as mn}from"./Oppsummering-db-bRuHc.js";import{P as kn}from"./PerioderStep-DG_JUcRc.js";import{T as vn}from"./TilretteleggingStep-6zX6_rYl.js";import{U as fn}from"./UtenlandsoppholdSteg-DYIy5kWy.js";import{S as En}from"./SenereUtenlandsoppholdSteg-CyibApFK.js";import{T as bn}from"./TidligereUtenlandsoppholdSteg-BQvTrqw6.js";import{V as yn}from"./VelgArbeid-2nmOk52B.js";import{I as Sn}from"./IkkeKvinne-DaAo2GWw.js";import"./index-BRV0Se7Z.js";import"./attachmentType-CO8SwnHI.js";import"./Bedriftsbanner-DEk4FlQR.js";import"./ArbeidsforholdOgInntektPanel-CnKmySHg.js";import"./ReadMore-bTFsJNjU.js";import"./ExpansionCard-CtDiDXyt.js";import"./FrilansPanel-D19B72lo.js";import"./BoIUtlandetOppsummeringspunkt-BsGzztK5.js";import"./ConfirmationPanel-CH2Fs99E.js";import"./Checkbox-CQtUgJTx.js";import"./TidligereUtenlandsoppholdPanel-DYXeYWM4.js";import"./Plus-BTSR22PN.js";import"./_baseUniq-CD0pQQ78.js";import"./_overArg-BRHtLdyz.js";import"./EgenNæring-BaE2fK_g.js";import"./validationUtils-VeBJZgMD.js";import"./velgArbeidFormUtils-7BgsPbib.js";import"./numberUtils-DCxWcr3S.js";const{Axios:Qr,AxiosError:Wr,CanceledError:Xr,isCancel:Zr,CancelToken:es,VERSION:ns,all:rs,Cancel:ss,isAxiosError:In,spread:ts,toFormData:os,AxiosHeaders:as,HttpStatusCode:is,formToJSON:ls,getAdapter:gs,mergeConfig:ps}=$e;class E extends Error{constructor(r,s,a){super(r);R(this,"callId");R(this,"timestamp");this.callId=s,this.timestamp=a}}class L extends Error{constructor(){super("API_ACCESS_ERROR")}}const Nn=e=>e instanceof L||e instanceof E,me=e=>!!(e&&typeof e=="object"&&"isAxiosError"in e),q=(e,n)=>{const[r,s]=u.useState(),[a,o]=u.useState(!1),[i,l]=u.useState();return u.useEffect(()=>{let d=!1;return(async()=>{var p,m;try{o(!0);const c=await e.get(n,{withCredentials:!0,timeout:60*1e3});d||s(c.data)}catch(c){In(c)?((p=c.response)==null?void 0:p.status)===401||((m=c.response)==null?void 0:m.status)===403?l(new L):l(new E(c.message)):c instanceof Error?l(new E(c.message)):l(new E(String(c)))}finally{o(!1)}})(),()=>{d=!0}},[e,n]),{data:r,loading:a,error:i}},O="ukjent uuid",ke=async(e,n,r,s,a=!1,o)=>{var i,l,d,g,p,m;try{return(await e.post(n,r,{withCredentials:!0,timeout:6e4,signal:o,headers:a?{"content-type":"application/json;"}:{}})).data}catch(c){if(me(c)&&c.code!=="ERR_CANCELED"){if(((i=c.response)==null?void 0:i.status)===401||((l=c.response)==null?void 0:l.status)===403)throw new L;const x=(g=(d=c.response)==null?void 0:d.data)!=null&&g.uuid?c.response.data.uuid:O,we=x!==O?x.slice(0,8):x;throw new E(s+we,x,(m=(p=c.response)==null?void 0:p.data)==null?void 0:m.timestamp)}throw c instanceof Error?new E(c.message):new E(String(c))}},G="ukjent uuid",w=async(e,n,r,s,a)=>{var o,i,l,d;try{return(await e.delete(n,{withCredentials:!0,timeout:6e4,signal:a,data:s})).data}catch(g){if(me(g)&&g.code!=="ERR_CANCELED"){if(((o=g.response)==null?void 0:o.status)===401||((i=g.response)==null?void 0:i.status)===403)throw new L;const p=(d=(l=g.response)==null?void 0:l.data)!=null&&d.uuid?g.response.data.uuid:G,m=p!==G?p.slice(0,8):p;throw new E(r+m)}throw g instanceof Error?new E(g.message):new E(String(g))}};var ve=(e=>(e.BARN="BARN",e.OPPTJENING="OPPTJENING",e.TILRETTELEGGING="TILRETTELEGGING",e.UTTAK="UTTAK",e))(ve||{});const An="From {fom} until {tom}",Tn={tidsperiode:An,"tidsperiode.kort":"{fom} - {tom}"},hn="Fra {fom} til {tom}",xn={tidsperiode:hn,"tidsperiode.kort":"{fom} - {tom}"},Ln="Frå {fom} til {tom}",wn={tidsperiode:Ln,"tidsperiode.kort":"{fom} - {tom}"},Mn=e=>{window.location.href=e},fe="selectedLocale",Rn=()=>sessionStorage.getItem(fe)||"nb",Fn=e=>{sessionStorage.setItem(fe,e)},Ee={nb:xn,nn:wn,en:Tn};/**
