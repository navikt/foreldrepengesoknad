var Fe=Object.defineProperty;var Me=(e,n,r)=>n in e?Fe(e,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[n]=r;var M=(e,n,r)=>Me(e,typeof n!="symbol"?n+"":n,r);import{j as t}from"./tslib.es6-C_-gbNBy.js";import{S as Re,M as je}from"./SkjemaSteg-CIITrTZh.js";/* empty css              */import{r as u,a as De}from"./index-CTjT7uj6.js";import{a as Pe,g as te}from"./apiInterceptor-D9XpNqGK.js";import{l as _e,aa as oe,k as qe,f as ae,a0 as Oe,ab as Ge,ac as Ce,u as Ue,ad as Be,ae as Ve,af as Ke,ag as He,ah as Ye,ai as Je,i as $e}from"./ByttBrowserModal-hA4_EJpt.js";import{n as ze,u as ie,a as le,o as ge,f as pe,e as de,b as ce,c as Qe}from"./nn_NO-Cs3JTNz2.js";import"./index-9r8iugjR.js";import{f as We,R as Xe,h as j,A as _,d as h,i as Ze,j as k,N as en}from"./useSvpNavigator-hN6ZjwJs.js";import{n as S}from"./minMax-CBhZp97B.js";import{d as ue,e as nn,C as v,c as rn,a as f,S as sn}from"./routes-pb7fG1UE.js";import{N as tn}from"./EgenNæringPanel-DzwlgctW.js";import{g as on}from"./dateUtils-DCwHhaJS.js";import{m as an}from"./tilretteleggingUtils-4-Kx6R3S.js";import{F as ln}from"./Forside-Ch2yIeIh.js";import{A as gn}from"./ArbeidIUtlandetStep-DHg3Z8oy.js";import{A as pn}from"./ArbeidsforholdOgInntektSteg-CjYLnSd8.js";import{B as dn}from"./Barnet-A4P1Vl-t.js";import{E as cn}from"./EgenNæringStep-ClQuFXWG.js";import{F as un}from"./FrilansStep-BzvKUj0c.js";import{O as mn}from"./Oppsummering-BYNcjwHn.js";import{P as kn}from"./PerioderStep-C0RZPQ0d.js";import{T as fn}from"./TilretteleggingStep-7Mefr21h.js";import{U as vn}from"./UtenlandsoppholdSteg-DCJXLepW.js";import{S as En}from"./SenereUtenlandsoppholdSteg-IITJQsnM.js";import{T as bn}from"./TidligereUtenlandsoppholdSteg-CftKP2gN.js";import{V as yn}from"./VelgArbeid-Clu5Vg_n.js";import{I as Sn}from"./IkkeKvinne-BHMnmmCK.js";import"./attachmentType-CO8SwnHI.js";import"./Bedriftsbanner-CcL5dQ0-.js";import"./index-BRV0Se7Z.js";import"./BoIUtlandetOppsummeringspunkt-B0TffC0w.js";import"./ConfirmationPanel-Cpn_PBId.js";import"./Checkbox-pqO7DGhK.js";import"./ArbeidsforholdOgInntektPanel-DP4zENTQ.js";import"./ReadMore-DAemnGXK.js";import"./ExpansionCard-sVi3qrXn.js";import"./FrilansPanel-Bp2DGSPb.js";import"./TidligereUtenlandsoppholdPanel-DNFN2xv2.js";import"./Plus-D05qIHd3.js";import"./_baseIteratee-BgXxtZRV.js";import"./_baseUniq-IUta85de.js";import"./EgenNæring-BaE2fK_g.js";import"./validationUtils-wTvTg11y.js";import"./velgArbeidFormUtils-Da85eGpT.js";import"./numberUtils-DCxWcr3S.js";const{Axios:Wr,AxiosError:Xr,CanceledError:Zr,isCancel:es,CancelToken:ns,VERSION:rs,all:ss,Cancel:ts,isAxiosError:In,spread:os,toFormData:as,AxiosHeaders:is,HttpStatusCode:ls,formToJSON:gs,getAdapter:ps,mergeConfig:ds}=Pe;class E extends Error{constructor(r,s,a){super(r);M(this,"callId");M(this,"timestamp");this.callId=s,this.timestamp=a}}class L extends Error{constructor(){super("API_ACCESS_ERROR")}}const Nn=e=>e instanceof L||e instanceof E,me=e=>!!(e&&typeof e=="object"&&"isAxiosError"in e),q=(e,n)=>{const[r,s]=u.useState(),[a,o]=u.useState(!1),[i,l]=u.useState();return u.useEffect(()=>{let d=!1;return(async()=>{var p,m;try{o(!0);const c=await e.get(n,{withCredentials:!0,timeout:60*1e3});d||s(c.data)}catch(c){In(c)?((p=c.response)==null?void 0:p.status)===401||((m=c.response)==null?void 0:m.status)===403?l(new L):l(new E(c.message)):c instanceof Error?l(new E(c.message)):l(new E(String(c)))}finally{o(!1)}})(),()=>{d=!0}},[e,n]),{data:r,loading:a,error:i}},O="ukjent uuid",ke=async(e,n,r,s,a=!1,o)=>{var i,l,d,g,p,m;try{return(await e.post(n,r,{withCredentials:!0,timeout:6e4,signal:o,headers:a?{"content-type":"application/json;"}:{}})).data}catch(c){if(me(c)&&c.code!=="ERR_CANCELED"){if(((i=c.response)==null?void 0:i.status)===401||((l=c.response)==null?void 0:l.status)===403)throw new L;const x=(g=(d=c.response)==null?void 0:d.data)!=null&&g.uuid?c.response.data.uuid:O,we=x!==O?x.slice(0,8):x;throw new E(s+we,x,(m=(p=c.response)==null?void 0:p.data)==null?void 0:m.timestamp)}throw c instanceof Error?new E(c.message):new E(String(c))}},G="ukjent uuid",w=async(e,n,r,s,a)=>{var o,i,l,d;try{return(await e.delete(n,{withCredentials:!0,timeout:6e4,signal:a,data:s})).data}catch(g){if(me(g)&&g.code!=="ERR_CANCELED"){if(((o=g.response)==null?void 0:o.status)===401||((i=g.response)==null?void 0:i.status)===403)throw new L;const p=(d=(l=g.response)==null?void 0:l.data)!=null&&d.uuid?g.response.data.uuid:G,m=p!==G?p.slice(0,8):p;throw new E(r+m)}throw g instanceof Error?new E(g.message):new E(String(g))}},An="From {fom} until {tom}",Tn={tidsperiode:An,"tidsperiode.kort":"{fom} - {tom}"},hn="Fra {fom} til {tom}",xn={tidsperiode:hn,"tidsperiode.kort":"{fom} - {tom}"},Ln="Frå {fom} til {tom}",wn={tidsperiode:Ln,"tidsperiode.kort":"{fom} - {tom}"},Fn=e=>{window.location.href=e};var fe=(e=>(e.BARN="BARN",e.OPPTJENING="OPPTJENING",e.TILRETTELEGGING="TILRETTELEGGING",e.UTTAK="UTTAK",e))(fe||{});const ve="selectedLocale",Mn=()=>sessionStorage.getItem(ve)||"nb",Rn=e=>{sessionStorage.setItem(ve,e)},Ee={nb:xn,nn:wn,en:Tn};/**
