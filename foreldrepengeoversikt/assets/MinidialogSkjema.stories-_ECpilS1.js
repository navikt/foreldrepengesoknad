import{i as l,j as t}from"./iframe-_ObgTIvO.js";import{h as r,H as a}from"./index-DGt0Llg0.js";import{A as o}from"./api-BLmyi74k.js";import{M as n}from"./MinidialogSkjema-vOPBBUCJ.js";import"./preload-helper-D9Z9MdNV.js";import"./useQuery-DgkBNIex.js";import"./skjemanummer-DnkMUdAG.js";import"./chunk-TMI4QPZX-B4DqY82Q.js";const{action:i}=__STORYBOOK_MODULE_ACTIONS__,O={title:"MinidialogSkjema",component:n,decorators:[l],render:p=>t.jsx("div",{style:{backgroundColor:"white",padding:"50px"},children:t.jsx(n,{...p})})},e={parameters:{msw:{handlers:[r.post(o.lastOppFPVedlegg,()=>new a(null,{status:200}))]}},args:{onSubmit:i("button-click"),ettersendelseErSendt:!1,isSendingEttersendelse:!1,minidialog:{dialogId:"1",opprettet:"2020-01-01",saksnr:"1"},sakstype:"FORELDREPENGER",ettersendelseError:void 0}},s={parameters:{msw:{handlers:[r.post(o.lastOppFPVedlegg,()=>new a(null,{status:400}))]}},args:e.args};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
