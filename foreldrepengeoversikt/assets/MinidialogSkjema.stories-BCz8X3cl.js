import{i as l,j as t}from"./iframe-UfXC0p-1.js";import{h as r,H as a}from"./index-YuEvdJcH.js";import{A as o}from"./api-DFXOmjZu.js";import{M as n}from"./MinidialogSkjema-BDYW9Cr0.js";import"./preload-helper-D9Z9MdNV.js";import"./useQuery-CRSDkvn-.js";import"./skjemanummer-CIGqbfVD.js";import"./chunk-TMI4QPZX-Cv-Od35g.js";const{action:i}=__STORYBOOK_MODULE_ACTIONS__,O={title:"MinidialogSkjema",component:n,decorators:[l],render:p=>t.jsx("div",{style:{backgroundColor:"white",padding:"50px"},children:t.jsx(n,{...p})})},e={parameters:{msw:{handlers:[r.post(o.lastOppFPVedlegg,()=>new a(null,{status:200}))]}},args:{onSubmit:i("button-click"),ettersendelseErSendt:!1,isSendingEttersendelse:!1,minidialog:{dialogId:"1",opprettet:"2020-01-01",saksnr:"1"},sakstype:"FORELDREPENGER",ettersendelseError:void 0}},s={parameters:{msw:{handlers:[r.post(o.lastOppFPVedlegg,()=>new a(null,{status:400}))]}},args:e.args};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
