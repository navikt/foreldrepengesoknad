import{i as l,j as t}from"./iframe-Baoq88Fe.js";import{h as n,H as a}from"./index-DblHznge.js";import{M as r}from"./MinidialogSkjema-nyQsl2RO.js";import"./useQuery-D1YKbV9M.js";import"./api-hQm1_me2.js";import"./skjemanummer-B4VNiHIk.js";import"./chunk-EF7DTUVF-BvOFs0KQ.js";const{action:p}=__STORYBOOK_MODULE_ACTIONS__,E={title:"MinidialogSkjema",component:r,decorators:[l],render:o=>t.jsx("div",{style:{backgroundColor:"white",padding:"50px"},children:t.jsx(r,{...o})})},e={parameters:{msw:{handlers:[n.post(".//rest/storage/foreldrepenger/vedlegg",()=>new a(null,{status:200}))]}},args:{onSubmit:p("button-click"),ettersendelseErSendt:!1,isSendingEttersendelse:!1,minidialog:{dialogId:"1",opprettet:"2020-01-01",saksnr:"1"},sakstype:"FORELDREPENGER",ettersendelseError:void 0}},s={parameters:{msw:{handlers:[n.post(".//storage/foreldrepenger/vedlegg",()=>new a(null,{status:400}))]}},args:e.args};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
