...
export interface Props {
    face?: 'happy' | 'sad' | 'lookLeft';
}

const ChildSVG: React.StatelessComponent<Props> = (props) => {
    const { face = 'lookLeft', ...svgProps } = props;
    return (
        <svg
            width={120}
            height={120}
