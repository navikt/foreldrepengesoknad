...
import React, { forwardRef, FunctionComponent, RefObject, useImperativeHandle } from 'react';
...
const AutomatiskJusteringForm: FunctionComponent<Props> = forwardRef(
    ({ termindato, perioderMedUttakRundtFødsel, visibility, automatiskJusteringFormRef }) => {
        const intl = useIntl();
        const { submitForm } = useFormikContext();

        useImperativeHandle(automatiskJusteringFormRef, () => ({
            handleSubmit() {
                submitForm();
            },
        }));
