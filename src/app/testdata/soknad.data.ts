...
const mockSøknad: RecursivePartial<Søknad> = {
    ...
    barn: {
        fødselsdatoer: [createDatoInputVerdiFromDate(new Date('2018-03-31T00:00:00.000Z'))],
        antallBarn: 1,
        erBarnetFødt: true,
    },
    ...
    ekstrainfo: {
        uttaksplanSkjema: {
            startdatoPermisjon: createDatoInputVerdiFromDate(new Date('2018-03-12T01:00:00.000Z')),
