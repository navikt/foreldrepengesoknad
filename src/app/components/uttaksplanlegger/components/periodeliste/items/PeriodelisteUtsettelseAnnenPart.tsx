...
import { UtsettelseAnnenPartInfoPeriode } from '../../../../../types/uttaksplan/periodetyper';
...
import { getForelderNavn, getPeriodeForelderNavn, getUtsettelseTekst } from 'app/util/uttaksplan';
...
export interface Props {
    ...
    periode: UtsettelseAnnenPartInfoPeriode;
    navnPåForeldre: NavnPåForeldre;
}

const PeriodelisteUtsettelseAnnenPart: React.StatelessComponent<Props & InjectedIntlProps> = ({
    itemId,
    isExpanded,
    onToggle,
    periode,
...
export default injectIntl(PeriodelisteUtsettelseAnnenPart);
