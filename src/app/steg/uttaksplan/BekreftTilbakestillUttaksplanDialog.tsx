...
const BekreftTilbakestillUttaksplanDialog: React.StatelessComponent<Props & InjectedIntlProps> = ({
    intl,
    synlig,
    onAngre,
    onSlett
...
export default injectIntl(BekreftTilbakestillUttaksplanDialog);
